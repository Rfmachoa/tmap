...
.method public static synthetic a(Landroid/content/Context;Lcom/skt/tmap/vsm/map/VSMNavigationView;Lcom/skt/tmap/engine/navigation/route/data/MapPoint;Lcom/skt/tmap/network/AddressInfo;)V
    ...
    invoke-static {p0, p1, p2, p3}, Lfc/k;->c(Landroid/content/Context;Lcom/skt/tmap/vsm/map/VSMNavigationView;Lcom/skt/tmap/engine/navigation/route/data/MapPoint;Lcom/skt/tmap/network/AddressInfo;)V
...
.method public static synthetic c(Landroid/content/Context;Lcom/skt/tmap/vsm/map/VSMNavigationView;Lcom/skt/tmap/engine/navigation/route/data/MapPoint;Lcom/skt/tmap/network/AddressInfo;)V
    ...
    .line 2
    :goto_0
    invoke-static {p3, v0}, Lcom/skt/tmap/util/a;->c(Lcom/skt/tmap/network/AddressInfo;Z)Ljava/lang/String;
...
.method public static d(Landroid/content/Context;Lcom/skt/tmap/mapview/streaming/MapViewStreaming;)V
    ...
    .line 1
    invoke-static {p1, v0}, Lcom/skt/tmap/util/y1;->h0(Lcom/skt/tmap/vsm/map/VSMNavigationView;Z)V

    .line 2
    invoke-static {p1, v0}, Lcom/skt/tmap/util/y1;->g0(Lcom/skt/tmap/vsm/map/VSMNavigationView;Z)V

    .line 3
    invoke-static {p0, p1, v0}, Lfc/k;->n(Landroid/content/Context;Lcom/skt/tmap/mapview/streaming/MapViewStreaming;Z)V

    .line 4
    invoke-static {p0, p1, v0}, Lfc/k;->o(Landroid/content/Context;Lcom/skt/tmap/mapview/streaming/MapViewStreaming;Z)V
...
.method public static e(Landroid/content/Context;Lcom/skt/tmap/mapview/streaming/MapViewStreaming;)V
    ...
    .line 1
    invoke-static {p0, p1}, Lfc/k;->g(Landroid/content/Context;Lcom/skt/tmap/mapview/streaming/MapViewStreaming;)V

    .line 2
    invoke-static {p0, p1}, Lfc/k;->f(Landroid/content/Context;Lcom/skt/tmap/mapview/streaming/MapViewStreaming;)V
    ...
    .line 6
    invoke-static {p0}, Lcom/skt/tmap/util/TmapSharedPreference;->S(Landroid/content/Context;)Z
...
.method public static f(Landroid/content/Context;Lcom/skt/tmap/mapview/streaming/MapViewStreaming;)V
    ...
    .line 1
    :cond_0
    invoke-static {p0}, Lcom/skt/tmap/util/TmapSharedPreference;->T(Landroid/content/Context;)Z
...
.method public static l(Landroid/content/Context;Lcom/skt/tmap/vsm/map/VSMNavigationView;Lcom/skt/tmap/engine/navigation/route/data/MapPoint;)V
    ...
    .line 1
    invoke-static {p2}, Lcom/skt/tmap/util/d0;->a(Lcom/skt/tmap/engine/navigation/route/data/MapPoint;)Z
    ...
    invoke-direct {v1, p0, p1, p2}, Lfc/j;-><init>(Landroid/content/Context;Lcom/skt/tmap/vsm/map/VSMNavigationView;Lcom/skt/tmap/engine/navigation/route/data/MapPoint;)V
...
.method public static m(Landroid/content/Context;Lcom/skt/tmap/mapview/streaming/MapViewStreaming;Lcom/skt/tmap/network/ndds/dto/info/PoiFavoritesInfo;)V
    ...
    invoke-virtual {p2}, Lcom/skt/tmap/network/ndds/dto/info/PoiFavoritesInfo;->getId()I
...
.method public static n(Landroid/content/Context;Lcom/skt/tmap/mapview/streaming/MapViewStreaming;Z)V
    ...
    .line 2
    :cond_0
    invoke-static {p0, p1}, Lfc/k;->h(Landroid/content/Context;Lcom/skt/tmap/mapview/streaming/MapViewStreaming;)V
    ...
    invoke-direct {v0, p0, p1, p2}, Lfc/k$a;-><init>(Landroid/content/Context;Lcom/skt/tmap/mapview/streaming/MapViewStreaming;Landroidx/lifecycle/LiveData;)V
...
.method public static o(Landroid/content/Context;Lcom/skt/tmap/mapview/streaming/MapViewStreaming;Z)V
    ...
    .line 1
    :cond_0
    invoke-static {p0, p1}, Lfc/k;->i(Landroid/content/Context;Lcom/skt/tmap/mapview/streaming/MapViewStreaming;)V
    ...
    .line 3
    invoke-static {p0}, Lcom/skt/tmap/mvp/viewmodel/userdata/RecentLocalRepository;->j(Landroid/content/Context;)Lcom/skt/tmap/mvp/viewmodel/userdata/RecentLocalRepository;

    move-result-object p2

    invoke-virtual {p2}, Lcom/skt/tmap/mvp/viewmodel/userdata/RecentLocalRepository;->q()Landroidx/lifecycle/LiveData;

    move-result-object p2

    .line 4
    new-instance v0, Lfc/k$b;

    invoke-direct {v0, p0, p1, p2}, Lfc/k$b;-><init>(Landroid/content/Context;Lcom/skt/tmap/mapview/streaming/MapViewStreaming;Landroidx/lifecycle/LiveData;)V

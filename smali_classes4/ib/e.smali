...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 2
    new-instance v9, Lib/e$a;

    sget-object v1, Loa/d;->c:Ljava/lang/String;
    ...
    invoke-direct/range {v0 .. v8}, Lib/e$a;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    iput-object v9, p0, Lib/e;->i:Lib/e$a;
...
.method public getExecutor()Lretrofit2/Call;
    ...
    iget-object v1, p0, Lib/e;->i:Lib/e$a;
    ...
    invoke-virtual {p0}, Lib/e;->getHeaders()Ljava/util/Map;
...
.method public parseResponse(Lokhttp3/Request;Lretrofit2/Response;Ljava/lang/String;)V
    ...
    .line 2
    invoke-virtual {v0}, Lib/e$b;->d()Ljava/lang/String;

    move-result-object v1

    .line 3
    invoke-virtual {v0}, Lib/e$b;->b()Ljava/lang/String;

    move-result-object v2

    .line 4
    invoke-virtual {p0, v1, v2}, Lib/e;->u(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 6
    invoke-static {v5}, Ltc/d;->E(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {v5}, Ltc/d;->d(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {v3, v1}, Ltc/d;->h0(Landroid/content/Context;Ljava/lang/String;)V

    .line 10
    iget-object v1, p0, Lcom/skt/aicloud/mobile/service/net/http/api/nugu/NuguQueryBase;->d:Landroid/content/Context;

    invoke-static {v1, v2}, Ltc/d;->N(Landroid/content/Context;Ljava/lang/String;)V

    .line 11
    invoke-virtual {v0}, Lib/e$b;->a()Ljava/lang/String;

    move-result-object v1

    invoke-static {v1}, Ltc/d;->K(Ljava/lang/String;)V

    .line 12
    iget-object v1, p0, Lcom/skt/aicloud/mobile/service/net/http/api/nugu/NuguQueryBase;->d:Landroid/content/Context;

    invoke-virtual {v0}, Lib/e$b;->c()Ljava/lang/String;

    move-result-object v0

    invoke-static {v1, v0}, Ltc/d;->O(Landroid/content/Context;Ljava/lang/String;)V

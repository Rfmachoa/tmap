...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lib/c$b;->n:[Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lib/c$b;->f:Lhb/b;
    ...
    iput-object v0, p0, Lib/c$b;->g:Lhb/a;
...
.method public static o()Z
    ...
    invoke-static {}, Lgb/f;->c()Z

    move-result v0

    if-nez v0, :cond_1

    invoke-static {}, Lgb/f;->a()Z

    move-result v0

    if-nez v0, :cond_1

    invoke-static {}, Lgb/f;->d()Z
...
.method public c()[Ljava/lang/String;
    ...
    sget-object v0, Lib/c$b;->n:[Ljava/lang/String;
...
.method public bridge synthetic h(Landroid/content/Context;Landroid/database/Cursor;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lib/c$b;->p(Landroid/content/Context;Landroid/database/Cursor;)Lcom/skt/aicloud/mobile/service/communication/message/model/TextMessageRawData;
...
.method public i(Landroid/content/Context;)Ljava/util/List;
    ...
    .line 3
    :try_start_0
    invoke-virtual {p0}, Lib/c$b;->g()Landroid/net/Uri;

    move-result-object v1

    invoke-virtual {p0}, Lib/c$b;->c()[Ljava/lang/String;

    move-result-object v2

    invoke-virtual {p0}, Lib/c$b;->d()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {p0}, Lib/c$b;->e()[Ljava/lang/String;
    ...
    .line 5
    invoke-virtual {p0, v7}, Lib/c$b;->n(Landroid/database/Cursor;)V

    .line 6
    :cond_0
    invoke-virtual {p0, p1, v7}, Lib/c$b;->p(Landroid/content/Context;Landroid/database/Cursor;)Lcom/skt/aicloud/mobile/service/communication/message/model/TextMessageRawData;
...
.method public p(Landroid/content/Context;Landroid/database/Cursor;)Lcom/skt/aicloud/mobile/service/communication/message/model/TextMessageRawData;
    ...
    .line 3
    iput-boolean v0, v7, Lcom/skt/aicloud/mobile/service/communication/message/model/TextMessageRawData;->S0:Z

    .line 4
    iget v0, p0, Lib/c$b;->h:I
    ...
    .line 7
    iget v0, p0, Lib/c$b;->j:I

    invoke-static {p2, v0}, Lcom/skt/aicloud/mobile/service/util/g;->e(Landroid/database/Cursor;I)Ljava/lang/String;

    move-result-object v0

    iput-object v0, v7, Lcom/skt/aicloud/mobile/service/communication/message/model/TextMessageRawData;->T0:Ljava/lang/String;

    .line 8
    iget v0, p0, Lib/c$b;->k:I
    ...
    .line 9
    iget v0, p0, Lib/c$b;->l:I

    invoke-static {p2, v0}, Lcom/skt/aicloud/mobile/service/util/g;->a(Landroid/database/Cursor;I)I

    move-result v0

    iput v0, v7, Lcom/skt/aicloud/mobile/service/communication/message/model/TextMessageRawData;->V0:I

    .line 10
    iget v0, p0, Lib/c$b;->m:I
    ...
    .line 12
    iget-object v0, p0, Lib/c$b;->g:Lhb/a;

    iget-wide v2, v7, Lcom/skt/aicloud/mobile/service/communication/message/model/TextMessageRawData;->b:J

    invoke-virtual {v7}, Lcom/skt/aicloud/mobile/service/communication/message/model/TextMessageRawData;->h()J

    move-result-wide v4

    move-object v1, p1

    invoke-virtual/range {v0 .. v5}, Lhb/a;->d(Landroid/content/ContentResolver;JJ)Ljava/lang/String;
    ...
    invoke-virtual {v0, p1, p2}, Lhb/a;->g(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 14
    iget-object v0, p0, Lib/c$b;->f:Lhb/b;
    ...
    invoke-virtual/range {v0 .. v6}, Lhb/b;->b(Landroid/content/ContentResolver;JJLcom/skt/aicloud/mobile/service/communication/message/model/TextMessageRawData$Type;)Lcom/skt/aicloud/mobile/service/communication/message/model/TextMessageRawData;

    move-result-object p1

    .line 15
    invoke-static {v7, p1}, Lcom/skt/aicloud/mobile/service/communication/message/model/TextMessageRawData;->j(Lcom/skt/aicloud/mobile/service/communication/message/model/TextMessageRawData;Lcom/skt/aicloud/mobile/service/communication/message/model/TextMessageRawData;)Lcom/skt/aicloud/mobile/service/communication/message/model/TextMessageRawData;

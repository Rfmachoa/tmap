...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lfa/e;->a:Landroid/content/Intent;

    const/4 v0, 0x0

    .line 3
    iput-object v0, p0, Lfa/e;->c:Lcom/skt/aicloud/speaker/lib/model/IAladdinSpeakerService;
    ...
    iput-object v1, p0, Lfa/e;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v1, p0, Lfa/e;->e:Ljava/lang/Object;

    .line 6
    iput-object v0, p0, Lfa/e;->f:Lcom/skt/aicloud/speaker/lib/UserInfo;

    .line 7
    iput-object v0, p0, Lfa/e;->g:Lcom/skt/aicloud/speaker/lib/model/IAladdinServiceMonitorCallback;

    .line 8
    iput-boolean v2, p0, Lfa/e;->h:Z
    ...
    iput-object v0, p0, Lfa/e;->i:Landroid/os/IBinder$DeathRecipient;
    ...
    iput-object v0, p0, Lfa/e;->j:Landroid/content/ServiceConnection;

    .line 11
    iput-object p1, p0, Lfa/e;->b:Landroid/content/Context;

    return-void
.end method

.method public static synthetic a(Lfa/e;)V
    .locals 0

    .line 1
    invoke-virtual {p0}, Lfa/e;->p()V

    return-void
.end method

.method public static synthetic b(Lfa/e;)Ljava/util/concurrent/atomic/AtomicBoolean;
    .locals 0

    .line 1
    iget-object p0, p0, Lfa/e;->d:Ljava/util/concurrent/atomic/AtomicBoolean;

    return-object p0
.end method

.method public static synthetic c(Lfa/e;)Ljava/lang/Object;
    .locals 0

    .line 1
    iget-object p0, p0, Lfa/e;->e:Ljava/lang/Object;

    return-object p0
.end method

.method public static synthetic d(Lfa/e;)Lcom/skt/aicloud/speaker/lib/model/IAladdinSpeakerService;
    .locals 0

    .line 1
    iget-object p0, p0, Lfa/e;->c:Lcom/skt/aicloud/speaker/lib/model/IAladdinSpeakerService;

    return-object p0
.end method

.method public static synthetic e(Lfa/e;Lcom/skt/aicloud/speaker/lib/model/IAladdinSpeakerService;)Lcom/skt/aicloud/speaker/lib/model/IAladdinSpeakerService;
    .locals 0

    .line 1
    iput-object p1, p0, Lfa/e;->c:Lcom/skt/aicloud/speaker/lib/model/IAladdinSpeakerService;

    return-object p1
.end method

.method public static synthetic f(Lfa/e;)Z
    .locals 0

    .line 1
    iget-boolean p0, p0, Lfa/e;->h:Z

    return p0
.end method

.method public static synthetic g(Lfa/e;Landroid/os/IBinder;Z)V
    .locals 0

    .line 1
    invoke-virtual {p0, p1, p2}, Lfa/e;->u(Landroid/os/IBinder;Z)V

    return-void
.end method

.method public static synthetic h(Lfa/e;)Lcom/skt/aicloud/speaker/lib/model/IAladdinServiceMonitorCallback;
    .locals 0

    .line 1
    iget-object p0, p0, Lfa/e;->g:Lcom/skt/aicloud/speaker/lib/model/IAladdinServiceMonitorCallback;

    return-object p0
.end method

.method public static synthetic i(Lfa/e;)V
    .locals 0

    .line 1
    invoke-virtual {p0}, Lfa/e;->s()V

    return-void
.end method

.method public static synthetic j(Lfa/e;)V
    .locals 0

    .line 1
    invoke-virtual {p0}, Lfa/e;->q()V
...
.method public k(Lcom/skt/aicloud/speaker/lib/model/IAladdinServiceMonitorCallback;)V
    ...
    invoke-static {v2, v0}, Lva/a;->a(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    .line 2
    iget-object v0, p0, Lfa/e;->g:Lcom/skt/aicloud/speaker/lib/model/IAladdinServiceMonitorCallback;

    if-eqz v0, :cond_1

    iget-object v0, p0, Lfa/e;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .line 3
    iput-object p1, p0, Lfa/e;->g:Lcom/skt/aicloud/speaker/lib/model/IAladdinServiceMonitorCallback;
    ...
    iget-object p1, p0, Lfa/e;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .line 5
    iget-object p1, p0, Lfa/e;->a:Landroid/content/Intent;
    ...
    iget-object v0, p0, Lfa/e;->a:Landroid/content/Intent;
    ...
    iget-object v4, p0, Lfa/e;->a:Landroid/content/Intent;

    iget-object v5, p0, Lfa/e;->j:Landroid/content/ServiceConnection;
...
.method public l(Lcom/skt/aicloud/speaker/lib/model/IAladdinServiceMonitorCallback;Lcom/skt/aicloud/speaker/lib/UserInfo;)V
    ...
    .line 2
    iput-object p2, p0, Lfa/e;->f:Lcom/skt/aicloud/speaker/lib/UserInfo;

    .line 3
    invoke-virtual {p0, p1}, Lfa/e;->k(Lcom/skt/aicloud/speaker/lib/model/IAladdinServiceMonitorCallback;)V
...
.method public m()V
    ...
    .line 2
    iget-object v0, p0, Lfa/e;->e:Ljava/lang/Object;

    monitor-enter v0

    .line 3
    :try_start_0
    iget-object v1, p0, Lfa/e;->c:Lcom/skt/aicloud/speaker/lib/model/IAladdinSpeakerService;
    ...
    invoke-virtual {p0, v1, v2}, Lfa/e;->u(Landroid/os/IBinder;Z)V

    :cond_0
    const/4 v1, 0x0

    .line 5
    iput-object v1, p0, Lfa/e;->c:Lcom/skt/aicloud/speaker/lib/model/IAladdinSpeakerService;
    ...
    iget-object v1, p0, Lfa/e;->j:Landroid/content/ServiceConnection;
...
.method public o()Ljava/lang/String;
    ...
    iget-object v1, p0, Lfa/e;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v1, p0, Lfa/e;->g:Lcom/skt/aicloud/speaker/lib/model/IAladdinServiceMonitorCallback;
...
.method public final u(Landroid/os/IBinder;Z)V
    ...
    .line 2
    :try_start_0
    iget-object p2, p0, Lfa/e;->i:Landroid/os/IBinder$DeathRecipient;
...
.method public v(Z)V
    ...
    invoke-static {v1, v3}, Lva/a;->a(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-static {v0, v1}, Lva/a;->a(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
...
.method public w(ZLandroid/app/Notification;)V
    ...
    invoke-static {p2, v0}, Lva/a;->a(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;

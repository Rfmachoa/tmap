...
.method public constructor <init>(Lac/e;Landroidx/room/RoomDatabase;)V
    ...
    .line 1
    iput-object p1, p0, Lac/e$d;->d:Lac/e;
...
.method public d()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR ABORT `userdata_home_office` SET `id` = ?,`homePkey` = ?,`homeCustName` = ?,`homeNoorX` = ?,`homeNoorY` = ?,`homePoiId` = ?,`homeNavSeq` = ?,`homeRpFlag` = ?,`homeAddInfo` = ?,`homeInsDatetime` = ?,`officePkey` = ?,`officeCustName` = ?,`officeNoorX` = ?,`officeNoorY` = ?,`officePoiId` = ?,`officeNavSeq` = ?,`officeRpFlag` = ?,`officeAddInfo` = ?,`officeInsDatetime` = ? WHERE `id` = ?"
...
.method public bridge synthetic g(Lc3/i;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lac/e$d;->k(Lc3/i;Lcom/skt/tmap/network/ndds/dto/info/PoiMyFavorite;)V

...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lud/i;->a:Ljava/util/Set;
    ...
    iput-object v0, p0, Lud/i;->c:Ljava/util/HashMap;
    ...
    iput-object v0, p0, Lud/i;->d:Ld8/c;
...
.method public static f(JJ)J
    ...
    invoke-static {p2, p3, p0, p1}, Lud/i;->f(JJ)J
...
.method public static h(Lc8/e;)J
    .locals 7
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
...
.method public a(Lc8/c;)Lcom/coremedia/iso/IsoFile;
    ...
    .line 2
    invoke-interface {v1}, Lc8/e;->h()Ljava/util/List;

    move-result-object v3

    .line 3
    invoke-virtual {p0, v1, v3}, Lud/i;->k(Lc8/e;Ljava/util/List;)Ljava/util/List;
    ...
    .line 6
    :cond_0
    invoke-virtual {p0, v1, v5}, Lud/i;->j(Lc8/e;[J)[J
    ...
    invoke-virtual {v0, v4}, Lb8/b;->addBox(Lcom/coremedia/iso/boxes/Box;)V

    .line 12
    invoke-virtual {p0, p1}, Lud/i;->c(Lc8/c;)Lcom/coremedia/iso/boxes/MovieBox;
    ...
    .line 13
    new-instance v1, Lud/i$b;

    const/4 v3, 0x0

    invoke-direct {v1, p0, p1, v3}, Lud/i$b;-><init>(Lud/i;Lc8/c;Lud/i$a;)V

    .line 14
    invoke-virtual {v0, v1}, Lb8/b;->addBox(Lcom/coremedia/iso/boxes/Box;)V

    .line 15
    invoke-virtual {v1}, Lud/i$b;->a()J

    move-result-wide v3

    .line 16
    iget-object p1, p0, Lud/i;->a:Ljava/util/Set;
...
.method public b(Lc8/c;I)Lcom/coremedia/iso/IsoFile;
    .locals 8
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-virtual {p2, v3}, Lb8/b;->addBox(Lcom/coremedia/iso/boxes/Box;)V
    ...
    invoke-virtual {p2, v0}, Lb8/b;->addBox(Lcom/coremedia/iso/boxes/Box;)V
    ...
    invoke-direct {v0, p0, p1, v1}, Lud/i$b;-><init>(Lud/i;Lc8/c;Lud/i$a;)V

    .line 15
    invoke-virtual {p2, v0}, Lb8/b;->addBox(Lcom/coremedia/iso/boxes/Box;)V

    .line 16
    invoke-virtual {v0}, Lud/i$b;->a()J
...
.method public final c(Lc8/c;)Lcom/coremedia/iso/boxes/MovieBox;
    .locals 14
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    .line 3
    invoke-virtual {v1, v2}, Lb8/c;->setVersion(I)V
    ...
    invoke-static {v2}, Lc8/b;->a(Ljava/util/Date;)J
    ...
    .line 6
    invoke-virtual {p0, p1}, Lud/i;->i(Lc8/c;)J
    ...
    .line 8
    invoke-static {v9}, Lud/i;->h(Lc8/e;)J

    move-result-wide v10

    mul-long/2addr v10, v2

    invoke-interface {v9}, Lc8/e;->i()Lc8/f;

    move-result-object v9

    invoke-virtual {v9}, Lc8/f;->h()J
    ...
    .line 12
    invoke-interface {v3}, Lc8/e;->i()Lc8/f;

    move-result-object v4

    invoke-virtual {v4}, Lc8/f;->i()J
    ...
    .line 16
    invoke-virtual {p0, v2, p1}, Lud/i;->d(Lc8/e;Lc8/c;)Lcom/coremedia/iso/boxes/TrackBox;
    ...
    .line 17
    :cond_4
    invoke-virtual {p0, p1}, Lud/i;->e(Lc8/c;)Lcom/coremedia/iso/boxes/Box;
...
.method public final d(Lc8/e;Lc8/c;)Lcom/coremedia/iso/boxes/TrackBox;
    .locals 26
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    .line 3
    invoke-virtual {v4, v5}, Lb8/c;->setVersion(I)V

    .line 4
    invoke-interface/range {p1 .. p1}, Lc8/e;->isEnabled()Z

    move-result v6

    .line 5
    invoke-interface/range {p1 .. p1}, Lc8/e;->j()Z
    ...
    .line 6
    :cond_0
    invoke-interface/range {p1 .. p1}, Lc8/e;->g()Z
    ...
    .line 7
    :cond_1
    invoke-interface/range {p1 .. p1}, Lc8/e;->k()Z
    ...
    .line 8
    :cond_2
    invoke-virtual {v4, v6}, Lb8/c;->setFlags(I)V
    ...
    invoke-virtual {v6}, Lc8/f;->a()Ljava/util/Date;

    move-result-object v6

    invoke-static {v6}, Lc8/b;->a(Ljava/util/Date;)J
    ...
    .line 11
    invoke-static/range {p1 .. p1}, Lud/i;->h(Lc8/e;)J

    move-result-wide v6

    invoke-virtual {v0, v2}, Lud/i;->i(Lc8/c;)J
    ...
    .line 56
    invoke-virtual {v3, v4}, Lb8/b;->addBox(Lcom/coremedia/iso/boxes/Box;)V
    ...
    invoke-virtual {v7}, Lc8/f;->a()Ljava/util/Date;

    move-result-object v7

    invoke-static {v7}, Lc8/b;->a(Ljava/util/Date;)J
    ...
    invoke-virtual {v7}, Lc8/f;->d()Ljava/lang/String;
    ...
    .line 64
    invoke-virtual {v4, v6}, Lb8/b;->addBox(Lcom/coremedia/iso/boxes/Box;)V
    ...
    .line 67
    invoke-interface/range {p1 .. p1}, Lc8/e;->getHandler()Ljava/lang/String;
    ...
    .line 69
    invoke-interface/range {p1 .. p1}, Lc8/e;->f()Lcom/coremedia/iso/boxes/AbstractMediaHeaderBox;

    move-result-object v7

    invoke-virtual {v6, v7}, Lb8/b;->addBox(Lcom/coremedia/iso/boxes/Box;)V
    ...
    .line 72
    invoke-virtual {v7, v8}, Lb8/b;->addBox(Lcom/coremedia/iso/boxes/Box;)V
    ...
    .line 74
    invoke-virtual {v9, v10}, Lb8/c;->setFlags(I)V

    .line 75
    invoke-virtual {v8, v9}, Lb8/d;->addBox(Lcom/coremedia/iso/boxes/Box;)V
    ...
    .line 78
    invoke-interface/range {p1 .. p1}, Lc8/e;->b()Lcom/coremedia/iso/boxes/SampleDescriptionBox;
    ...
    .line 79
    invoke-interface/range {p1 .. p1}, Lc8/e;->c()Ljava/util/List;
    ...
    .line 84
    :cond_7
    invoke-interface/range {p1 .. p1}, Lc8/e;->a()Ljava/util/List;
    ...
    .line 88
    invoke-virtual {v7, v9}, Lb8/b;->addBox(Lcom/coremedia/iso/boxes/Box;)V

    .line 89
    :cond_8
    invoke-interface/range {p1 .. p1}, Lc8/e;->d()[J
    ...
    .line 94
    :cond_9
    invoke-interface/range {p1 .. p1}, Lc8/e;->l()Ljava/util/List;
    ...
    check-cast v10, Lc8/e;

    .line 100
    invoke-virtual {v0, v10, v2}, Lud/i;->g(Lc8/e;Lc8/c;)[I
    ...
    .line 108
    invoke-virtual {v7, v10}, Lb8/b;->addBox(Lcom/coremedia/iso/boxes/Box;)V
    ...
    .line 110
    iget-object v3, v0, Lud/i;->c:Ljava/util/HashMap;
    ...
    .line 111
    invoke-virtual {v7, v2}, Lb8/b;->addBox(Lcom/coremedia/iso/boxes/Box;)V
    ...
    .line 113
    iget-object v3, v0, Lud/i;->a:Ljava/util/Set;
    ...
    .line 120
    :cond_f
    invoke-static/range {v16 .. v17}, Lw8/b;->a(J)I
    ...
    .line 121
    iget-object v1, v0, Lud/i;->c:Ljava/util/HashMap;
    ...
    .line 123
    invoke-virtual {v1, v2}, Lb8/b;->addBox(Lcom/coremedia/iso/boxes/Box;)V

    .line 124
    invoke-virtual {v9, v1}, Lb8/b;->addBox(Lcom/coremedia/iso/boxes/Box;)V

    .line 125
    invoke-virtual {v4, v9}, Lb8/b;->addBox(Lcom/coremedia/iso/boxes/Box;)V

    return-object v24
.end method

.method public e(Lc8/c;)Lcom/coremedia/iso/boxes/Box;
    .locals 0
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
...
.method public g(Lc8/e;Lc8/c;)[I
    ...
    .line 1
    iget-object v0, p0, Lud/i;->d:Ld8/c;

    invoke-interface {v0, p1, p2}, Ld8/c;->a(Lc8/e;Lc8/c;)[J
    ...
    .line 6
    invoke-interface {p1}, Lc8/e;->h()Ljava/util/List;
...
.method public i(Lc8/c;)J
    ...
    .line 3
    invoke-interface {v2}, Lc8/e;->i()Lc8/f;
    ...
    invoke-static {v2, v3, v0, v1}, Lud/i;->f(JJ)J
...
.method public j(Lc8/e;[J)[J
    ...
    .line 1
    iget-object v0, p0, Lud/i;->c:Ljava/util/HashMap;
...
.method public k(Lc8/e;Ljava/util/List;)Ljava/util/List;
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    .line 1
    iget-object v0, p0, Lud/i;->b:Ljava/util/HashMap;
...
.method public l(Ld8/c;)V
    ...
    .line 1
    iput-object p1, p0, Lud/i;->d:Ld8/c;

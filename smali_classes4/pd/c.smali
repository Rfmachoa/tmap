...
# static fields
.field public static final X0:I = 0xfa0
...
.method public constructor <init>()V
    ...
    .line 2
    iput-boolean v0, p0, Lpd/c;->R0:Z

    return-void
.end method

.method public static synthetic I(Lpd/c;)V
    .locals 0

    invoke-virtual {p0}, Lpd/c;->R()V

    return-void
.end method

.method public static synthetic J(Lpd/c;)Landroid/widget/FrameLayout;
    .locals 0

    iget-object p0, p0, Lpd/c;->k0:Landroid/widget/FrameLayout;

    return-object p0
.end method

.method public static synthetic K(Lpd/c;Landroid/animation/AnimatorSet;)Landroid/animation/AnimatorSet;
    .locals 0

    iput-object p1, p0, Lpd/c;->W0:Landroid/animation/AnimatorSet;

    return-object p1
.end method

.method public static synthetic L(Lpd/c;Lld/a$a;Landroid/os/Bundle;)V
    .locals 0

    invoke-virtual {p0, p1, p2}, Lpd/c;->c0(Lld/a$a;Landroid/os/Bundle;)V

    return-void
.end method

.method public static synthetic M(Lpd/c;Lld/a$a;)V
    .locals 0

    invoke-virtual {p0, p1}, Lpd/c;->d0(Lld/a$a;)V

    return-void
.end method

.method public static synthetic N(Lpd/c;Lld/a$a;Landroid/os/Bundle;)V
    .locals 0

    invoke-virtual {p0, p1, p2}, Lpd/c;->b0(Lld/a$a;Landroid/os/Bundle;)V

    return-void
.end method

.method public static synthetic O(Lpd/c;)Z
    .locals 0

    iget-boolean p0, p0, Lpd/c;->V0:Z
...
# virtual methods
.method public final P(Lld/a$a;)V
    .locals 2
    ...
    invoke-virtual {p0, p1, v0}, Lpd/c;->c0(Lld/a$a;Landroid/os/Bundle;)V
...
.method public final Q()V
    ...
    .line 5
    invoke-virtual {p0, v0}, Lpd/c;->P(Lld/a$a;)V
...
.method public final R()V
    ...
    invoke-virtual {p0, v0, v1}, Lpd/c;->c0(Lld/a$a;Landroid/os/Bundle;)V

    return-void
.end method

.method public final S(Landroid/view/View;Lld/a$a;Ljava/lang/String;)Landroid/view/View;
    .locals 8
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    iget-object v3, p0, Lpd/c;->k0:Landroid/widget/FrameLayout;
    ...
    invoke-virtual {p0, v1, v0, v2}, Lpd/f;->w(Ljava/lang/String;ILandroid/view/View;)V
    ...
    .line 24
    invoke-virtual {p2, v1, v0}, Lld/a$a;->n(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 25
    invoke-virtual {p2, v1, v2}, Lld/a$a;->n(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 26
    invoke-virtual {p2, v1, v3}, Lld/a$a;->n(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 27
    invoke-virtual {p2, v1, v4}, Lld/a$a;->n(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 28
    invoke-virtual {p2, v1, v5}, Lld/a$a;->n(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v6, v7, v0}, Lld/b;->l(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v1, v6}, Lpd/f;->t(Ljava/lang/String;I)Landroid/view/View;
    ...
    invoke-direct {v0, p0, p2}, Lpd/c$h;-><init>(Lpd/c;Lld/a$a;)V

    invoke-virtual {p1, v0}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 39
    iget-boolean p1, p0, Lpd/c;->V0:Z
    ...
    new-instance v0, Lpd/c$i;

    invoke-direct {v0, p0, p2}, Lpd/c$i;-><init>(Lpd/c;Lld/a$a;)V
    ...
    new-instance v0, Lpd/c$j;

    invoke-direct {v0, p0, p2}, Lpd/c$j;-><init>(Lpd/c;Lld/a$a;)V
...
.method public final T(Z)Z
    ...
    invoke-virtual {p0, v3, v0, v4}, Lpd/c;->S(Landroid/view/View;Lld/a$a;Ljava/lang/String;)Landroid/view/View;
    ...
    .line 13
    iget-object p1, p0, Lpd/c;->k0:Landroid/widget/FrameLayout;
    ...
    invoke-virtual {p0, p1, v0, v5}, Lpd/c;->S(Landroid/view/View;Lld/a$a;Ljava/lang/String;)Landroid/view/View;
    ...
    .line 14
    iget-object v5, p0, Lpd/c;->k0:Landroid/widget/FrameLayout;
    ...
    invoke-virtual {p0, v5, p1, v6}, Lpd/c;->f0(Ljava/lang/String;Landroid/view/View;I)V
    ...
    invoke-virtual {p0, v5, v2}, Lpd/c;->U(Ljava/lang/String;Z)V
    ...
    invoke-virtual {p0, v5, v1}, Lpd/c;->U(Ljava/lang/String;Z)V
    ...
    invoke-virtual {p0, v5, v2}, Lpd/c;->V(Ljava/lang/String;Z)V
    ...
    invoke-virtual {p0, v7}, Lpd/c;->Z(Ljava/lang/String;)I
    ...
    invoke-virtual {p0, v8}, Lpd/c;->Z(Ljava/lang/String;)I
    ...
    invoke-virtual {p0, v7, v3, v2}, Lpd/c;->a0(Ljava/lang/String;Landroid/view/View;Z)Landroid/animation/AnimatorSet;
    ...
    invoke-virtual {p0, v7, v3, v1}, Lpd/c;->a0(Ljava/lang/String;Landroid/view/View;Z)Landroid/animation/AnimatorSet;
    ...
    .line 27
    new-instance v8, Lpd/c$c;

    invoke-direct {v8, p0}, Lpd/c$c;-><init>(Lpd/c;)V
    ...
    invoke-virtual {p0, v7, p1, v2}, Lpd/c;->Y(Ljava/lang/String;Landroid/view/View;Z)Landroid/animation/AnimatorSet;
    ...
    invoke-virtual {p0, v2, p1, v1}, Lpd/c;->Y(Ljava/lang/String;Landroid/view/View;Z)Landroid/animation/AnimatorSet;
    ...
    .line 33
    new-instance v7, Lpd/c$d;

    invoke-direct {v7, p0}, Lpd/c$d;-><init>(Lpd/c;)V
    ...
    .line 34
    :cond_c
    new-instance v7, Lpd/c$e;

    invoke-direct {v7, p0}, Lpd/c$e;-><init>(Lpd/c;)V
    ...
    invoke-virtual {p0, v2, v0}, Lpd/c;->X(Ljava/lang/String;Ljava/lang/String;)Landroid/animation/Animator;

    move-result-object v0

    .line 38
    iget-object v2, p0, Lpd/c;->W0:Landroid/animation/AnimatorSet;
    ...
    .line 42
    :cond_e
    iput-object v4, p0, Lpd/c;->W0:Landroid/animation/AnimatorSet;
    ...
    invoke-direct {v0, p0, v3}, Lpd/c$f;-><init>(Lpd/c;Landroid/view/View;)V
    ...
    new-instance v0, Lpd/c$g;

    invoke-direct {v0, p0, v2}, Lpd/c$g;-><init>(Lpd/c;Landroid/animation/AnimatorSet;)V
    ...
    .line 47
    :cond_10
    iput-object v2, p0, Lpd/c;->W0:Landroid/animation/AnimatorSet;
    ...
    invoke-virtual {p0, p1, v0, v3}, Lpd/c;->S(Landroid/view/View;Lld/a$a;Ljava/lang/String;)Landroid/view/View;
    ...
    invoke-virtual {p0, v3, p1, v2}, Lpd/c;->f0(Ljava/lang/String;Landroid/view/View;I)V
    ...
    invoke-virtual {p0, p1, v2}, Lpd/c;->U(Ljava/lang/String;Z)V
    ...
    invoke-virtual {p0, p1, v1}, Lpd/c;->V(Ljava/lang/String;Z)V
    ...
    invoke-virtual {p0, p1, v1}, Lpd/c;->U(Ljava/lang/String;Z)V
    ...
    invoke-virtual {p0, p1, v2}, Lpd/c;->V(Ljava/lang/String;Z)V

    .line 59
    :goto_7
    iget-object p1, p0, Lpd/c;->u:Landroid/widget/FrameLayout;

    invoke-virtual {v0}, Lld/a$a;->a()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {p0, v2}, Lpd/c;->W(Ljava/lang/String;)F
...
.method public final W(Ljava/lang/String;)F
    ...
    invoke-virtual {p0, p1}, Lpd/c;->Z(Ljava/lang/String;)I
...
.method public final X(Ljava/lang/String;Ljava/lang/String;)Landroid/animation/Animator;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lpd/c;->W(Ljava/lang/String;)F

    move-result p1

    .line 2
    invoke-virtual {p0, p2}, Lpd/c;->W(Ljava/lang/String;)F

    move-result p2

    .line 3
    iget-object v0, p0, Lpd/c;->u:Landroid/widget/FrameLayout;
...
.method public final b0(Lld/a$a;Landroid/os/Bundle;)V
    .locals 2
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-virtual {p0, v1, v0}, Lpd/c;->U(Ljava/lang/String;Z)V
    ...
    invoke-virtual {p0, p1, v0}, Lpd/c;->V(Ljava/lang/String;Z)V
...
.method public final c0(Lld/a$a;Landroid/os/Bundle;)V
    .locals 2
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
...
.method public final d0(Lld/a$a;)V
    .locals 3
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
...
.method public final e0()V
    ...
    invoke-virtual {p0, v1, v4}, Lpd/f;->t(Ljava/lang/String;I)Landroid/view/View;
    ...
    invoke-virtual {p0, v1, v7}, Lpd/f;->t(Ljava/lang/String;I)Landroid/view/View;
    ...
    .line 15
    invoke-static {v8, v0, v2, v4, v6}, Lpd/a;->a(Landroid/animation/AnimatorSet;Landroid/animation/ObjectAnimator;Landroid/animation/ObjectAnimator;Landroid/animation/ObjectAnimator;Landroid/animation/ObjectAnimator;)Landroid/animation/AnimatorSet$Builder;
    ...
    invoke-direct {v0, p0}, Lpd/c$a;-><init>(Lpd/c;)V
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    iput-object p2, p0, Lpd/c;->u:Landroid/widget/FrameLayout;
    ...
    iput-object p2, p0, Lpd/c;->k0:Landroid/widget/FrameLayout;
    ...
    invoke-virtual {p2, p3}, Lld/a;->a(Ljava/lang/String;)Lld/a$a;
    ...
    .line 6
    invoke-virtual {p2, p3, v0}, Lld/a$a;->n(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 8
    iput-boolean p3, p0, Lpd/c;->V0:Z

    .line 9
    :cond_0
    iget-object p2, p0, Lpd/c;->u:Landroid/widget/FrameLayout;

    new-instance p3, Lpd/c$b;

    invoke-direct {p3, p0}, Lpd/c$b;-><init>(Lpd/c;)V
...
.method public onResume()V
    ...
    .line 2
    invoke-virtual {p0, v0}, Lpd/c;->T(Z)Z
...
.method public u(IILandroid/os/Bundle;)V
    ...
    invoke-virtual {p3, v0}, Lld/a;->a(Ljava/lang/String;)Lld/a$a;
    ...
    .line 2
    invoke-virtual {p3}, Lld/a$a;->r()Ljava/lang/String;
    ...
    .line 4
    iput-boolean v1, p0, Lpd/c;->R0:Z

    .line 5
    invoke-virtual {p3}, Lld/a$a;->a()Ljava/lang/String;
    ...
    .line 11
    iget-object p1, p0, Lpd/c;->U0:Landroid/os/Handler;
    ...
    .line 13
    iput-object p1, p0, Lpd/c;->U0:Landroid/os/Handler;
    ...
    .line 16
    invoke-virtual {p3}, Lld/a$a;->q()Ljava/lang/String;
    ...
    .line 19
    invoke-virtual {p0, v1}, Lpd/c;->T(Z)Z

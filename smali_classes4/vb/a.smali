...
.method public static a(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    .line 1
    invoke-static {p0, p1, p2, v0}, Lvb/a;->b(IILandroid/graphics/Bitmap$Config;I)Landroid/graphics/Bitmap;
...
.method public static c(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    .line 1
    invoke-static {p0, v0}, Lvb/a;->d(Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
...
.method public static e(Landroid/graphics/Bitmap;IIIILandroid/graphics/Matrix;Z)Landroid/graphics/Bitmap;
    ...
    .line 1
    invoke-static/range {v0 .. v7}, Lvb/a;->f(Landroid/graphics/Bitmap;IIIILandroid/graphics/Matrix;ZI)Landroid/graphics/Bitmap;
...
.method public static h(Landroid/graphics/Bitmap;IIZ)Landroid/graphics/Bitmap;
    ...
    .line 1
    invoke-static {p0, p1, p2, p3, v0}, Lvb/a;->i(Landroid/graphics/Bitmap;IIZI)Landroid/graphics/Bitmap;
...
.method public static j([BII)Landroid/graphics/Bitmap;
    ...
    .line 1
    invoke-static {p0, p1, p2, v0}, Lvb/a;->k([BIII)Landroid/graphics/Bitmap;
...
.method public static l(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    .line 1
    invoke-static {p0, p1, v0}, Lvb/a;->m(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;I)Landroid/graphics/Bitmap;
...
.method public static n(Landroid/content/res/Resources;I)Landroid/graphics/Bitmap;
    ...
    .line 1
    invoke-static {p0, p1, v0}, Lvb/a;->o(Landroid/content/res/Resources;II)Landroid/graphics/Bitmap;
...
.method public static p(Ljava/io/InputStream;)Landroid/graphics/Bitmap;
    ...
    .line 1
    invoke-static {p0, v0, v1}, Lvb/a;->q(Ljava/io/InputStream;Landroid/graphics/BitmapFactory$Options;I)Landroid/graphics/Bitmap;
...
.method public static r(Landroid/content/Context;I)Landroid/graphics/Bitmap;
    ...
    .line 1
    invoke-static {p0, p1}, Landroidx/core/content/d;->i(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object p0

    .line 2
    invoke-static {p0}, Ld1/c;->r(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;

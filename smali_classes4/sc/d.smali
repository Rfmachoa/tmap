...
# static fields
.field public static final W0:Ljava/lang/String; = "NewsPlayer"

.field public static X0:Lsc/d;

.field public static Y0:Landroid/media/MediaPlayer;


# instance fields
.field public V0:Lcom/skt/aicloud/speaker/service/state/g;
...
.method public static synthetic g0(Lsc/d;Z)V
    .locals 0

    invoke-virtual {p0, p1}, Lsc/d;->i0(Z)V

    return-void
.end method

.method public static h0()Lsc/d;
    .locals 1

    .line 1
    sget-object v0, Lsc/d;->X0:Lsc/d;
...
.method public O()V
    ...
    sget-object v1, Lsc/d;->Y0:Landroid/media/MediaPlayer;
...
.method public Q(Z)V
    ...
    .line 4
    sget-object v4, Lsc/d;->Y0:Landroid/media/MediaPlayer;
    ...
    .line 7
    sput-object v2, Lsc/d;->Y0:Landroid/media/MediaPlayer;
...
.method public final i0(Z)V
    ...
    .line 1
    invoke-virtual {p0}, Lsc/d;->y()Lcom/skt/aicloud/speaker/service/state/a;
...
.method public j0(Lcom/skt/aicloud/speaker/service/state/g;)V
    ...
    iput-object p1, p0, Lsc/d;->V0:Lcom/skt/aicloud/speaker/service/state/g;

    return-void
.end method

.method public k0(Ltc/o;Landroid/content/Context;)V
    .locals 6
    ...
    .line 3
    iget-object p2, p0, Lsc/d;->V0:Lcom/skt/aicloud/speaker/service/state/g;

    invoke-virtual {p2}, Lic/a;->p0()Z
    ...
    .line 4
    invoke-virtual {p0}, Lsc/a;->stop()V

    .line 5
    :cond_0
    iget-object p2, p0, Lsc/a;->d:Ljava/lang/Object;
    ...
    sput-object v0, Lsc/d;->Y0:Landroid/media/MediaPlayer;
    ...
    invoke-virtual {p0, v1, p0, v0, v2}, Lsc/a;->P(Landroid/content/Context;Landroid/media/AudioManager$OnAudioFocusChangeListener;II)Z
    ...
    .line 10
    iget-object v0, p0, Lsc/d;->V0:Lcom/skt/aicloud/speaker/service/state/g;

    invoke-virtual {v0, v5}, Lic/a;->z0(Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 11
    :try_start_1
    invoke-virtual {p1}, Ltc/o;->k()Ljava/lang/String;
    ...
    .line 13
    invoke-virtual {p0, v1, v0}, Lsc/a;->e0(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_1
    ...
    .line 14
    :try_start_2
    sget-object v0, Lsc/d;->Y0:Landroid/media/MediaPlayer;

    invoke-virtual {p0}, Lsc/d;->z()Landroid/media/MediaPlayer$OnPreparedListener;
    ...
    invoke-direct {v1, p0}, Lsc/d$c;-><init>(Lsc/d;)V
    ...
    .line 27
    invoke-virtual {p0, v2}, Lsc/d;->i0(Z)V
...
.method public resume()V
    ...
    sget-object v7, Lsc/d;->Y0:Landroid/media/MediaPlayer;

    aput-object v7, v6, v2

    const/4 v7, 0x2

    iget-object v8, p0, Lsc/a;->i:Landroid/media/MediaPlayer$OnPreparedListener;
    ...
    .line 16
    sget-object v3, Lsc/d;->Y0:Landroid/media/MediaPlayer;
    ...
    .line 20
    invoke-virtual {p0, v5}, Lsc/d;->i0(Z)V

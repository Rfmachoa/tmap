...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lya/c$b;->n:[Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lya/c$b;->f:Lxa/b;
    ...
    iput-object v0, p0, Lya/c$b;->g:Lxa/a;
...
.method public static o()Z
    ...
    .line 1
    invoke-static {}, Lwa/f;->c()Z

    move-result v0

    if-nez v0, :cond_1

    invoke-static {}, Lwa/f;->a()Z

    move-result v0

    if-nez v0, :cond_1

    invoke-static {}, Lwa/f;->d()Z
...
.method public c()[Ljava/lang/String;
    ...
    .line 1
    sget-object v0, Lya/c$b;->n:[Ljava/lang/String;
...
.method public bridge synthetic h(Landroid/content/Context;Landroid/database/Cursor;)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1, p2}, Lya/c$b;->p(Landroid/content/Context;Landroid/database/Cursor;)Lcom/skt/aicloud/mobile/service/communication/message/model/TextMessageRawData;
...
.method public i(Landroid/content/Context;)Ljava/util/List;
    ...
    .line 3
    :try_start_0
    invoke-virtual {p0}, Lya/c$b;->g()Landroid/net/Uri;

    move-result-object v1

    invoke-virtual {p0}, Lya/c$b;->c()[Ljava/lang/String;

    move-result-object v2

    invoke-virtual {p0}, Lya/c$b;->d()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {p0}, Lya/c$b;->e()[Ljava/lang/String;
    ...
    .line 5
    invoke-virtual {p0, v7}, Lya/c$b;->n(Landroid/database/Cursor;)V

    .line 6
    :cond_0
    invoke-virtual {p0, p1, v7}, Lya/c$b;->p(Landroid/content/Context;Landroid/database/Cursor;)Lcom/skt/aicloud/mobile/service/communication/message/model/TextMessageRawData;
...
.method public p(Landroid/content/Context;Landroid/database/Cursor;)Lcom/skt/aicloud/mobile/service/communication/message/model/TextMessageRawData;
    ...
    .line 3
    iput-boolean v0, v7, Lcom/skt/aicloud/mobile/service/communication/message/model/TextMessageRawData;->Z0:Z

    .line 4
    iget v0, p0, Lya/c$b;->h:I
    ...
    .line 5
    iget v0, p0, Lya/c$b;->i:I

    invoke-static {p2, v0}, Lcom/skt/aicloud/mobile/service/util/g;->c(Landroid/database/Cursor;I)J

    move-result-wide v0

    invoke-virtual {v7, v0, v1}, Lcom/skt/aicloud/mobile/service/communication/message/model/TextMessageRawData;->m(J)V

    .line 6
    iget v0, p0, Lya/c$b;->j:I

    invoke-static {p2, v0}, Lcom/skt/aicloud/mobile/service/util/g;->e(Landroid/database/Cursor;I)Ljava/lang/String;

    move-result-object v0

    iput-object v0, v7, Lcom/skt/aicloud/mobile/service/communication/message/model/TextMessageRawData;->a1:Ljava/lang/String;

    .line 7
    iget v0, p0, Lya/c$b;->k:I

    invoke-static {p2, v0}, Lcom/skt/aicloud/mobile/service/util/g;->e(Landroid/database/Cursor;I)Ljava/lang/String;

    move-result-object v0

    iput-object v0, v7, Lcom/skt/aicloud/mobile/service/communication/message/model/TextMessageRawData;->b1:Ljava/lang/String;

    .line 8
    iget v0, p0, Lya/c$b;->l:I

    invoke-static {p2, v0}, Lcom/skt/aicloud/mobile/service/util/g;->a(Landroid/database/Cursor;I)I

    move-result v0

    iput v0, v7, Lcom/skt/aicloud/mobile/service/communication/message/model/TextMessageRawData;->c1:I

    .line 9
    iget v0, p0, Lya/c$b;->m:I
    ...
    .line 11
    iget-object v0, p0, Lya/c$b;->g:Lxa/a;
    ...
    invoke-virtual/range {v0 .. v5}, Lxa/a;->d(Landroid/content/ContentResolver;JJ)Ljava/lang/String;
    ...
    invoke-virtual {v0, p1, p2}, Lxa/a;->g(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 13
    iget-object v0, p0, Lya/c$b;->f:Lxa/b;
    ...
    invoke-virtual/range {v0 .. v6}, Lxa/b;->b(Landroid/content/ContentResolver;JJLcom/skt/aicloud/mobile/service/communication/message/model/TextMessageRawData$Type;)Lcom/skt/aicloud/mobile/service/communication/message/model/TextMessageRawData;

...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lz7/c;->f:Ljava/util/logging/Logger;
...
.method public constructor <init>(I)V
    ...
    iput-object v0, p0, Lz7/c;->d:Ly7/d;
    ...
    .line 5
    iget-object p1, p0, Lz7/c;->d:Ly7/d;

    invoke-virtual {p1, v0}, Ly7/d;->C(Ly7/c;)V

    .line 6
    new-instance p1, Lz7/b;

    invoke-direct {p1, v0}, Lz7/b;-><init>(Ly7/c;)V

    iput-object p1, p0, Lz7/c;->e:Lz7/d;
...
.method public a(Lx7/c;)V
    ...
    .line 1
    iget-boolean v1, v0, Lz7/c;->c:Z

    if-eqz v1, :cond_0

    .line 2
    iget-object v1, v0, Lz7/c;->b:Ljava/io/File;
    ...
    .line 4
    invoke-virtual {v1, v2}, Ly7/b;->a(Lx7/c;)Lcom/coremedia/iso/IsoFile;
    ...
    iget-object v4, v0, Lz7/c;->b:Ljava/io/File;
    ...
    .line 9
    :goto_0
    invoke-virtual/range {p0 .. p1}, Lz7/c;->c(Lx7/c;)Lx7/c;

    move-result-object v1

    .line 10
    invoke-virtual {v0, v1}, Lz7/c;->b(Lx7/c;)Lx7/c;

    move-result-object v1

    .line 11
    iget-boolean v2, v0, Lz7/c;->c:Z
    ...
    .line 13
    invoke-virtual {v2, v1}, Ly7/b;->a(Lx7/c;)Lcom/coremedia/iso/IsoFile;
    ...
    .line 18
    :cond_1
    iget-object v2, v0, Lz7/c;->d:Ly7/d;

    invoke-virtual {v2, v1}, Ly7/d;->a(Lx7/c;)Lcom/coremedia/iso/IsoFile;

    move-result-object v2

    .line 19
    iget-boolean v3, v0, Lz7/c;->c:Z
    ...
    .line 24
    :cond_2
    invoke-virtual {v1}, Lx7/c;->f()Ljava/util/List;
    ...
    .line 26
    iget-object v3, v0, Lz7/c;->e:Lz7/d;

    invoke-interface {v3, v1}, Lz7/d;->c(Lx7/c;)Ljava/lang/String;
    ...
    .line 29
    iget-object v5, v0, Lz7/c;->e:Lz7/d;

    invoke-interface {v5, v4}, Lz7/d;->a(Lx7/e;)J
    ...
    .line 30
    invoke-interface {v4}, Lx7/e;->i()Lx7/f;
    ...
    .line 31
    invoke-virtual {v2}, Lw7/b;->getBoxes()Ljava/util/List;
    ...
    .line 32
    invoke-interface {v4}, Lx7/e;->f()Lcom/coremedia/iso/boxes/AbstractMediaHeaderBox;
    ...
    iget-object v10, v0, Lz7/c;->b:Ljava/io/File;
    ...
    .line 38
    sget-object v5, Lz7/c;->f:Ljava/util/logging/Logger;
    ...
    invoke-interface {v5, v4, v1}, Lz7/d;->b(Lx7/e;Lx7/c;)[J
    ...
    invoke-interface {v4}, Lx7/e;->getHandler()Ljava/lang/String;
...
.method public b(Lx7/c;)Lx7/c;
    ...
    iget-wide v4, p0, Lz7/c;->a:J

    iget-object v6, p0, Lz7/c;->d:Ly7/d;

    invoke-virtual {v6}, Ly7/d;->z()Ly7/c;

    move-result-object v6

    invoke-interface {v6, v2, p1}, Ly7/c;->a(Lx7/e;Lx7/c;)[J

    move-result-object v6

    invoke-direct {v3, v2, v4, v5, v6}, Lcom/googlecode/mp4parser/authoring/tracks/d;-><init>(Lx7/e;J[J)V

    invoke-virtual {v0, v3}, Lx7/c;->a(Lx7/e;)V

    goto :goto_0
.end method

.method public final c(Lx7/c;)Lx7/c;
    .locals 5
    ...
    .line 3
    invoke-interface {v1}, Lx7/e;->getHandler()Ljava/lang/String;
    ...
    .line 4
    :cond_1
    sget-object v2, Lz7/c;->f:Ljava/util/logging/Logger;
    ...
    :cond_2
    :goto_1
    invoke-virtual {v0, v1}, Lx7/c;->a(Lx7/e;)V
...
.method public d(Z)V
    ...
    iput-boolean p1, p0, Lz7/c;->c:Z

    return-void
.end method

.method public e(Ly7/d;)V
    .locals 1

    .line 1
    iput-object p1, p0, Lz7/c;->d:Ly7/d;

    .line 2
    new-instance v0, Lz7/b;

    invoke-virtual {p1}, Ly7/d;->z()Ly7/c;

    move-result-object p1

    invoke-direct {v0, p1}, Lz7/b;-><init>(Ly7/c;)V

    iput-object v0, p0, Lz7/c;->e:Lz7/d;

    return-void
.end method

.method public f(Lz7/d;)V
    .locals 0
...
.method public g(Ljava/io/File;)V
    ...
    iput-object p1, p0, Lz7/c;->b:Ljava/io/File;

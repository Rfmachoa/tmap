...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lzc/e;->e:Landroid/media/MediaPlayer$OnCompletionListener;

    .line 4
    iput-object p1, p0, Lzc/e;->a:Landroid/content/Context;
...
.method public static synthetic a()Ljava/lang/String;
    ...
    sget-object v0, Lzc/e;->f:Ljava/lang/String;

    return-object v0
.end method

.method public static synthetic b(Lzc/e;)Lzc/d;
    .locals 0

    iget-object p0, p0, Lzc/e;->b:Lzc/d;

    return-object p0
.end method

.method public static synthetic c(Lzc/e;Z)Z
    .locals 0
...
.method public static synthetic d()Landroid/media/MediaPlayer;
    ...
    sget-object v0, Lzc/e;->g:Landroid/media/MediaPlayer;
...
.method public static synthetic e(Landroid/media/MediaPlayer;)Landroid/media/MediaPlayer;
    ...
    sput-object p0, Lzc/e;->g:Landroid/media/MediaPlayer;

    return-object p0
.end method

.method public static synthetic f(Lzc/e;ILzc/d;)Z
    .locals 0

    invoke-virtual {p0, p1, p2}, Lzc/e;->n(ILzc/d;)Z
...
.method public g()V
    ...
    .line 6
    sput-object v0, Lzc/e;->g:Landroid/media/MediaPlayer;
    ...
    invoke-virtual {v1}, Lcom/skt/aicloud/speaker/service/api/AladdinServiceManager;->getMediaStateManager()Lcom/skt/aicloud/speaker/service/api/h;
    ...
    .line 9
    invoke-virtual {v1, v2, v0, v3, v4}, Lcom/skt/aicloud/speaker/service/api/h;->T(ZLjava/lang/String;Lcom/skt/aicloud/speaker/service/player/BgmCaller;Ljava/lang/String;)V

    .line 10
    iget-object v0, p0, Lzc/e;->b:Lzc/d;
    ...
    invoke-virtual {p0, v0}, Lzc/e;->j(Lcom/skt/aicloud/speaker/lib/state/TTSState$PlayState;)V
    :try_end_0
    ...
    .line 13
    :goto_0
    sget-object v1, Lzc/e;->f:Ljava/lang/String;
...
.method public i()Z
    ...
    .line 3
    sget-object v2, Lzc/e;->f:Ljava/lang/String;
...
.method public k()V
    ...
    invoke-virtual {p0}, Lzc/e;->g()V

    return-void
.end method

.method public l(ILzc/d;)V
    .locals 2

    .line 1
    iget-object v0, p0, Lzc/e;->d:Ljc/a;
    ...
    iget-object v1, p0, Lzc/e;->a:Landroid/content/Context;

    invoke-direct {v0, v1}, Ljc/a;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lzc/e;->d:Ljc/a;
    ...
    invoke-direct {v1, p0, p1, p2}, Lzc/e$b;-><init>(Lzc/e;ILzc/d;)V
...
.method public final n(ILzc/d;)Z
    .locals 4
    ...
    const-string/jumbo v2, "tts.start : "
    ...
    .line 2
    iput-object p2, p0, Lzc/e;->b:Lzc/d;
    ...
    .line 3
    :try_start_0
    sget-object v1, Lzc/e;->g:Landroid/media/MediaPlayer;
    ...
    .line 5
    sput-object v2, Lzc/e;->g:Landroid/media/MediaPlayer;
    ...
    sput-object p1, Lzc/e;->g:Landroid/media/MediaPlayer;

    .line 7
    iput-boolean p2, p0, Lzc/e;->c:Z

    .line 8
    iget-object v1, p0, Lzc/e;->e:Landroid/media/MediaPlayer$OnCompletionListener;
    ...
    .line 9
    sget-object p1, Lzc/e;->g:Landroid/media/MediaPlayer;
    ...
    invoke-virtual {p1, v0, v2, v1, v3}, Lcom/skt/aicloud/speaker/service/api/h;->T(ZLjava/lang/String;Lcom/skt/aicloud/speaker/service/player/BgmCaller;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Lzc/e;->j(Lcom/skt/aicloud/speaker/lib/state/TTSState$PlayState;)V
    :try_end_0
    ...
    .line 14
    iget-object p1, p0, Lzc/e;->b:Lzc/d;
    ...
    .line 15
    invoke-interface {p1, v0}, Lzc/d;->onError(I)V
...
.method public o(Lcom/skt/aicloud/speaker/service/tts/EmbeddedTTS;Lzc/d;)Z
    .locals 5

    .line 1
    iget-object v0, p0, Lzc/e;->a:Landroid/content/Context;
    ...
    .line 3
    invoke-interface {p2, v1}, Lzc/d;->onError(I)V
    ...
    .line 5
    :cond_1
    iget-object p1, p0, Lzc/e;->a:Landroid/content/Context;
    ...
    invoke-virtual {v3}, Lcom/skt/aicloud/mobile/service/api/g;->e()Ltc/d;
    ...
    .line 9
    invoke-virtual {v2, v3, p1, v4}, Lbb/a;->u(Ltc/d;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 11
    invoke-virtual {p0, v0, p2}, Lzc/e;->l(ILzc/d;)V

    return v1

    .line 12
    :cond_2
    invoke-virtual {p0, v0, p2}, Lzc/e;->n(ILzc/d;)Z

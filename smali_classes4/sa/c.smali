...
.method public static synthetic a()Ljava/lang/String;
    ...
    .line 1
    sget-object v0, Lsa/c;->c:Ljava/lang/String;

    return-object v0
.end method

.method public static synthetic b(Lsa/c;)Lsa/d;
    .locals 0

    .line 1
    iget-object p0, p0, Lsa/c;->a:Lsa/d;

    return-object p0
.end method

.method public static synthetic c(Lsa/c;Z)Z
    .locals 0
...
.method public static synthetic d()Landroid/media/MediaPlayer;
    ...
    .line 1
    sget-object v0, Lsa/c;->d:Landroid/media/MediaPlayer;
...
.method public static synthetic e(Landroid/media/MediaPlayer;)Landroid/media/MediaPlayer;
    ...
    .line 1
    sput-object p0, Lsa/c;->d:Landroid/media/MediaPlayer;
...
.method public f()V
    ...
    .line 3
    :try_start_0
    iput-boolean v0, p0, Lsa/c;->b:Z

    .line 4
    sget-object v1, Lsa/c;->d:Landroid/media/MediaPlayer;
    ...
    .line 6
    sput-object v1, Lsa/c;->d:Landroid/media/MediaPlayer;
    ...
    .line 10
    sget-object v1, Lsa/c;->c:Ljava/lang/String;
...
.method public h()Z
    ...
    .line 3
    sget-object v2, Lsa/c;->c:Ljava/lang/String;
...
.method public k(Landroid/content/Context;Ljava/lang/String;Lsa/d;)Z
    .locals 1

    const/4 v0, 0x1

    .line 1
    invoke-virtual {p0, p1, p2, v0, p3}, Lsa/c;->l(Landroid/content/Context;Ljava/lang/String;ZLsa/d;)Z
...
.method public final l(Landroid/content/Context;Ljava/lang/String;ZLsa/d;)Z
    .locals 2

    .line 1
    sget-object p1, Lsa/c;->c:Ljava/lang/String;
    ...
    .line 2
    iput-object p4, p0, Lsa/c;->a:Lsa/d;
    ...
    .line 3
    :try_start_0
    sget-object p4, Lsa/c;->d:Landroid/media/MediaPlayer;
    ...
    sput-object p4, Lsa/c;->d:Landroid/media/MediaPlayer;

    .line 5
    :cond_0
    iput-boolean p3, p0, Lsa/c;->b:Z
    ...
    .line 9
    sget-object p2, Lsa/c;->d:Landroid/media/MediaPlayer;
    ...
    new-instance p4, Lsa/c$a;

    invoke-direct {p4, p0}, Lsa/c$a;-><init>(Lsa/c;)V
    ...
    new-instance p4, Lsa/c$b;

    invoke-direct {p4, p0}, Lsa/c$b;-><init>(Lsa/c;)V
    ...
    .line 15
    invoke-interface {p2, p1}, Lsa/d;->onError(I)V

...
.method public static synthetic b(Lrc/c;)Lrc/d;
    .locals 0

    iget-object p0, p0, Lrc/c;->a:Lrc/d;

    return-object p0
.end method

.method public static synthetic c(Lrc/c;Z)Z
    .locals 0
...
.method public static synthetic d()Landroid/media/MediaPlayer;
    ...
    sget-object v0, Lrc/c;->d:Landroid/media/MediaPlayer;
...
.method public static synthetic e(Landroid/media/MediaPlayer;)Landroid/media/MediaPlayer;
    ...
    sput-object p0, Lrc/c;->d:Landroid/media/MediaPlayer;
...
.method public f()V
    ...
    .line 3
    :try_start_0
    iput-boolean v0, p0, Lrc/c;->b:Z

    .line 4
    sget-object v1, Lrc/c;->d:Landroid/media/MediaPlayer;
    ...
    .line 8
    iget-object v0, p0, Lrc/c;->a:Lrc/d;
    ...
    .line 10
    sget-object v1, Lrc/c;->c:Ljava/lang/String;
...
.method public g()Z
    ...
    .line 2
    :cond_0
    iget-boolean v0, p0, Lrc/c;->b:Z

    if-nez v0, :cond_1

    invoke-virtual {p0}, Lrc/c;->h()Z
...
.method public h()Z
    ...
    .line 3
    sget-object v2, Lrc/c;->c:Ljava/lang/String;
...
.method public k(Landroid/content/Context;Ljava/lang/String;Lrc/d;)Z
    .locals 1

    const/4 v0, 0x1

    invoke-virtual {p0, p1, p2, v0, p3}, Lrc/c;->l(Landroid/content/Context;Ljava/lang/String;ZLrc/d;)Z
...
.method public final l(Landroid/content/Context;Ljava/lang/String;ZLrc/d;)Z
    .locals 2

    .line 1
    sget-object p1, Lrc/c;->c:Ljava/lang/String;
    ...
    .line 2
    iput-object p4, p0, Lrc/c;->a:Lrc/d;
    ...
    .line 3
    :try_start_0
    sget-object p4, Lrc/c;->d:Landroid/media/MediaPlayer;
    ...
    sput-object p4, Lrc/c;->d:Landroid/media/MediaPlayer;

    .line 5
    :cond_0
    iput-boolean p3, p0, Lrc/c;->b:Z
    ...
    .line 9
    sget-object p2, Lrc/c;->d:Landroid/media/MediaPlayer;
    ...
    new-instance p4, Lrc/c$a;

    invoke-direct {p4, p0}, Lrc/c$a;-><init>(Lrc/c;)V
    ...
    new-instance p4, Lrc/c$b;

    invoke-direct {p4, p0}, Lrc/c$b;-><init>(Lrc/c;)V
    ...
    .line 15
    invoke-interface {p2, p1}, Lrc/d;->onError(I)V

...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lvd/h;->a:Ljava/util/Set;
    ...
    iput-object v0, p0, Lvd/h;->b:Ljava/util/HashMap;
    ...
    iput-object v0, p0, Lvd/h;->c:Ljava/util/HashMap;
    ...
    iput-object v0, p0, Lvd/h;->d:Lj7/c;
...
.method public static f(JJ)J
    ...
    invoke-static {p2, p3, p0, p1}, Lvd/h;->f(JJ)J
...
.method public static h(Li7/e;)J
    .locals 7
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    .line 1
    invoke-interface {p0}, Li7/e;->c()Ljava/util/List;
...
.method public a(Li7/c;)Lcom/coremedia/iso/IsoFile;
    ...
    .line 2
    invoke-interface {v1}, Li7/e;->h()Ljava/util/List;

    move-result-object v3

    .line 3
    invoke-virtual {p0, v1, v3}, Lvd/h;->k(Li7/e;Ljava/util/List;)Ljava/util/List;
    ...
    .line 6
    :cond_0
    invoke-virtual {p0, v1, v5}, Lvd/h;->j(Li7/e;[J)[J
    ...
    invoke-virtual {v0, v4}, Lh7/b;->addBox(Lcom/coremedia/iso/boxes/Box;)V

    .line 12
    invoke-virtual {p0, p1}, Lvd/h;->c(Li7/c;)Lcom/coremedia/iso/boxes/MovieBox;
    ...
    .line 13
    new-instance v1, Lvd/h$b;

    .line 14
    invoke-direct {v1, p0, p1}, Lvd/h$b;-><init>(Lvd/h;Li7/c;)V

    .line 15
    invoke-virtual {v0, v1}, Lh7/b;->addBox(Lcom/coremedia/iso/boxes/Box;)V

    .line 16
    invoke-virtual {v1}, Lvd/h$b;->a()J

    move-result-wide v3

    .line 17
    iget-object p1, p0, Lvd/h;->a:Ljava/util/Set;
...
.method public b(Li7/c;I)Lcom/coremedia/iso/IsoFile;
    .locals 8
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-virtual {p2, v3}, Lh7/b;->addBox(Lcom/coremedia/iso/boxes/Box;)V
    ...
    invoke-virtual {p2, v0}, Lh7/b;->addBox(Lcom/coremedia/iso/boxes/Box;)V

    .line 14
    new-instance v0, Lvd/h$b;

    .line 15
    invoke-direct {v0, p0, p1}, Lvd/h$b;-><init>(Lvd/h;Li7/c;)V

    .line 16
    invoke-virtual {p2, v0}, Lh7/b;->addBox(Lcom/coremedia/iso/boxes/Box;)V

    .line 17
    invoke-virtual {v0}, Lvd/h$b;->a()J
...
.method public final c(Li7/c;)Lcom/coremedia/iso/boxes/MovieBox;
    .locals 14
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    .line 3
    invoke-virtual {v1, v2}, Lh7/c;->setVersion(I)V
    ...
    invoke-static {v2}, Li7/b;->a(Ljava/util/Date;)J
    ...
    .line 6
    invoke-virtual {p0, p1}, Lvd/h;->i(Li7/c;)J
    ...
    .line 8
    invoke-static {v9}, Lvd/h;->h(Li7/e;)J

    move-result-wide v10

    mul-long/2addr v10, v2

    invoke-interface {v9}, Li7/e;->i()Li7/f;

    move-result-object v9

    invoke-virtual {v9}, Li7/f;->h()J
    ...
    .line 12
    invoke-interface {v3}, Li7/e;->i()Li7/f;

    move-result-object v4

    invoke-virtual {v4}, Li7/f;->i()J
    ...
    .line 16
    invoke-virtual {p0, v2, p1}, Lvd/h;->d(Li7/e;Li7/c;)Lcom/coremedia/iso/boxes/TrackBox;
    ...
    .line 17
    :cond_4
    invoke-virtual {p0, p1}, Lvd/h;->e(Li7/c;)Lcom/coremedia/iso/boxes/Box;
...
.method public final d(Li7/e;Li7/c;)Lcom/coremedia/iso/boxes/TrackBox;
    .locals 26
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    .line 3
    invoke-virtual {v4, v5}, Lh7/c;->setVersion(I)V

    .line 4
    invoke-interface/range {p1 .. p1}, Li7/e;->isEnabled()Z

    move-result v6

    .line 5
    invoke-interface/range {p1 .. p1}, Li7/e;->j()Z
    ...
    .line 6
    :cond_0
    invoke-interface/range {p1 .. p1}, Li7/e;->g()Z
    ...
    .line 7
    :cond_1
    invoke-interface/range {p1 .. p1}, Li7/e;->k()Z
    ...
    .line 8
    :cond_2
    invoke-virtual {v4, v6}, Lh7/c;->setFlags(I)V
    ...
    invoke-virtual {v6}, Li7/f;->a()Ljava/util/Date;

    move-result-object v6

    invoke-static {v6}, Li7/b;->a(Ljava/util/Date;)J
    ...
    .line 11
    invoke-static/range {p1 .. p1}, Lvd/h;->h(Li7/e;)J

    move-result-wide v6

    invoke-virtual {v0, v2}, Lvd/h;->i(Li7/c;)J
    ...
    .line 56
    invoke-virtual {v3, v4}, Lh7/b;->addBox(Lcom/coremedia/iso/boxes/Box;)V
    ...
    invoke-virtual {v7}, Li7/f;->a()Ljava/util/Date;

    move-result-object v7

    invoke-static {v7}, Li7/b;->a(Ljava/util/Date;)J
    ...
    invoke-virtual {v7}, Li7/f;->d()Ljava/lang/String;
    ...
    .line 64
    invoke-virtual {v4, v6}, Lh7/b;->addBox(Lcom/coremedia/iso/boxes/Box;)V
    ...
    .line 67
    invoke-interface/range {p1 .. p1}, Li7/e;->getHandler()Ljava/lang/String;
    ...
    .line 69
    invoke-interface/range {p1 .. p1}, Li7/e;->f()Lcom/coremedia/iso/boxes/AbstractMediaHeaderBox;

    move-result-object v7

    invoke-virtual {v6, v7}, Lh7/b;->addBox(Lcom/coremedia/iso/boxes/Box;)V
    ...
    .line 72
    invoke-virtual {v7, v8}, Lh7/b;->addBox(Lcom/coremedia/iso/boxes/Box;)V
    ...
    .line 74
    invoke-virtual {v9, v10}, Lh7/c;->setFlags(I)V

    .line 75
    invoke-virtual {v8, v9}, Lh7/d;->addBox(Lcom/coremedia/iso/boxes/Box;)V
    ...
    .line 78
    invoke-interface/range {p1 .. p1}, Li7/e;->b()Lcom/coremedia/iso/boxes/SampleDescriptionBox;
    ...
    .line 84
    :cond_7
    invoke-interface/range {p1 .. p1}, Li7/e;->a()Ljava/util/List;
    ...
    .line 88
    invoke-virtual {v7, v9}, Lh7/b;->addBox(Lcom/coremedia/iso/boxes/Box;)V

    .line 89
    :cond_8
    invoke-interface/range {p1 .. p1}, Li7/e;->d()[J
    ...
    .line 94
    :cond_9
    invoke-interface/range {p1 .. p1}, Li7/e;->l()Ljava/util/List;
    ...
    check-cast v10, Li7/e;

    .line 100
    invoke-virtual {v0, v10, v2}, Lvd/h;->g(Li7/e;Li7/c;)[I
    ...
    .line 108
    invoke-virtual {v7, v10}, Lh7/b;->addBox(Lcom/coremedia/iso/boxes/Box;)V
    ...
    .line 110
    iget-object v3, v0, Lvd/h;->c:Ljava/util/HashMap;
    ...
    .line 111
    invoke-virtual {v7, v2}, Lh7/b;->addBox(Lcom/coremedia/iso/boxes/Box;)V
    ...
    .line 113
    iget-object v3, v0, Lvd/h;->a:Ljava/util/Set;
    ...
    .line 120
    :cond_f
    invoke-static/range {v16 .. v17}, Lc8/b;->a(J)I
    ...
    .line 121
    iget-object v1, v0, Lvd/h;->c:Ljava/util/HashMap;
    ...
    .line 123
    invoke-virtual {v1, v2}, Lh7/b;->addBox(Lcom/coremedia/iso/boxes/Box;)V

    .line 124
    invoke-virtual {v9, v1}, Lh7/b;->addBox(Lcom/coremedia/iso/boxes/Box;)V

    .line 125
    invoke-virtual {v4, v9}, Lh7/b;->addBox(Lcom/coremedia/iso/boxes/Box;)V

    return-object v24
.end method

.method public e(Li7/c;)Lcom/coremedia/iso/boxes/Box;
    .locals 0
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
...
.method public g(Li7/e;Li7/c;)[I
    ...
    .line 1
    iget-object v0, p0, Lvd/h;->d:Lj7/c;

    invoke-interface {v0, p1, p2}, Lj7/c;->a(Li7/e;Li7/c;)[J
...
.method public i(Li7/c;)J
    ...
    .line 3
    invoke-interface {v2}, Li7/e;->i()Li7/f;

    move-result-object v2

    invoke-virtual {v2}, Li7/f;->h()J

    move-result-wide v2

    invoke-static {v2, v3, v0, v1}, Lvd/h;->f(JJ)J
...
.method public j(Li7/e;[J)[J
    ...
    iget-object v0, p0, Lvd/h;->c:Ljava/util/HashMap;
...
.method public k(Li7/e;Ljava/util/List;)Ljava/util/List;
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    iget-object v0, p0, Lvd/h;->b:Ljava/util/HashMap;
...
.method public l(Lj7/c;)V
    ...
    iput-object p1, p0, Lvd/h;->d:Lj7/c;

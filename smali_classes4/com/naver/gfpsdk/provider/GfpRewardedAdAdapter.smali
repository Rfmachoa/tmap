.class public abstract Lcom/naver/gfpsdk/provider/GfpRewardedAdAdapter;
...
# static fields
.field private static final LOG_TAG:Ljava/lang/String; = "GfpRewardedAdAdapter"


# instance fields
.field public adapterListener:Lcom/naver/gfpsdk/provider/RewardedAdapterListener;
    .annotation build Landroidx/annotation/VisibleForTesting;
    .end annotation
.end field

.field public final expirationAction:Lg9/i;
    .annotation build Landroidx/annotation/VisibleForTesting;
    .end annotation
.end field
...
.method public constructor <init>(Landroid/content/Context;Lcom/naver/gfpsdk/AdParam;Lcom/naver/gfpsdk/internal/services/adcall/Ad;Lcom/naver/gfpsdk/internal/EventReporter;Landroid/os/Bundle;)V
    ...
    iput-object p1, p0, Lcom/naver/gfpsdk/provider/GfpRewardedAdAdapter;->isAdExpiration:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object p1, p0, Lcom/naver/gfpsdk/provider/GfpRewardedAdAdapter;->showAdCalled:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-direct {p1, p2}, Lg9/i;-><init>(Landroid/os/Handler;)V

    iput-object p1, p0, Lcom/naver/gfpsdk/provider/GfpRewardedAdAdapter;->expirationAction:Lg9/i;

    return-void
.end method

.method public static synthetic f(Lcom/naver/gfpsdk/provider/GfpRewardedAdAdapter;)V
    .locals 0

    invoke-direct {p0}, Lcom/naver/gfpsdk/provider/GfpRewardedAdAdapter;->lambda$adLoaded$0()V
...
.method private synthetic lambda$adLoaded$0()V
    ...
    .line 1
    sget-object v0, Lcom/naver/gfpsdk/provider/GfpRewardedAdAdapter;->LOG_TAG:Ljava/lang/String;
    ...
    .line 3
    invoke-virtual {p0}, Lcom/naver/gfpsdk/provider/GfpRewardedAdAdapter;->getExpirationDelay()Ljava/lang/Long;
    ...
    .line 6
    iget-object v0, p0, Lcom/naver/gfpsdk/provider/GfpRewardedAdAdapter;->isAdExpiration:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final adAttached()V
    ...
    .line 6
    invoke-virtual {p0}, Lcom/naver/gfpsdk/provider/GfpRewardedAdAdapter;->getCreativeType()Lcom/naver/gfpsdk/internal/services/adcall/CreativeType;
...
.method public final adClicked()V
    ...
    .line 7
    invoke-virtual {p0}, Lcom/naver/gfpsdk/provider/GfpRewardedAdAdapter;->getAdapterListener()Lcom/naver/gfpsdk/provider/RewardedAdapterListener;

    move-result-object v0

    invoke-interface {v0, p0}, Lcom/naver/gfpsdk/provider/RewardedAdapterListener;->onAdClicked(Lcom/naver/gfpsdk/provider/GfpRewardedAdAdapter;)V
...
.method public final adClosed()V
    ...
    invoke-interface {v0, p0}, Lcom/naver/gfpsdk/provider/RewardedAdapterListener;->onAdClosed(Lcom/naver/gfpsdk/provider/GfpRewardedAdAdapter;)V

    :cond_0
    return-void
.end method

.method public final adCompleted(Lcom/naver/gfpsdk/GfpRewardItem;)V
    .locals 4
    .param p1    # Lcom/naver/gfpsdk/GfpRewardItem;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    ...
    .line 2
    invoke-virtual {p1}, Lcom/naver/gfpsdk/GfpRewardItem;->getType()Ljava/lang/String;
    ...
    .line 3
    invoke-virtual {p1}, Lcom/naver/gfpsdk/GfpRewardItem;->getAmount()I
    ...
    const-string v2, "adCompleted: type[%s], amount[%d]"
    ...
    .line 9
    invoke-virtual {v0, v1}, Lcom/naver/gfpsdk/internal/EventReporter;->fireCompletedEvent(Lcom/naver/gfpsdk/internal/f;)V
    ...
    invoke-interface {v0, p0, p1}, Lcom/naver/gfpsdk/provider/RewardedAdapterListener;->onAdCompleted(Lcom/naver/gfpsdk/provider/GfpRewardedAdAdapter;Lcom/naver/gfpsdk/GfpRewardItem;)V
...
.method public final adError(Lcom/naver/gfpsdk/GfpError;)V
    ...
    .line 7
    iget-object v0, p0, Lcom/naver/gfpsdk/provider/GfpRewardedAdAdapter;->expirationAction:Lg9/i;
    ...
    invoke-interface {v0, p0, p1}, Lcom/naver/gfpsdk/provider/RewardedAdapterListener;->onAdFailedToShow(Lcom/naver/gfpsdk/provider/GfpRewardedAdAdapter;Lcom/naver/gfpsdk/GfpError;)V
    ...
    invoke-interface {v0, p0, p1}, Lcom/naver/gfpsdk/provider/RewardedAdapterListener;->onAdFailedToLoad(Lcom/naver/gfpsdk/provider/GfpRewardedAdAdapter;Lcom/naver/gfpsdk/GfpError;)V

    :goto_2
    return-void
.end method

.method public adExpired()V
    .locals 2
...
.method public final adLoaded()V
    ...
    invoke-interface {v0, p0}, Lcom/naver/gfpsdk/provider/RewardedAdapterListener;->onAdLoaded(Lcom/naver/gfpsdk/provider/GfpRewardedAdAdapter;)V
    ...
    new-instance v3, Lcom/naver/gfpsdk/provider/g;

    invoke-direct {v3, p0}, Lcom/naver/gfpsdk/provider/g;-><init>(Lcom/naver/gfpsdk/provider/GfpRewardedAdAdapter;)V

    .line 17
    invoke-virtual {v0, v1, v2, v3}, Lg9/i;->b(JLg9/i$a;)V
...
.method public final adStarted()V
    ...
    invoke-interface {v0, p0}, Lcom/naver/gfpsdk/provider/RewardedAdapterListener;->onAdStarted(Lcom/naver/gfpsdk/provider/GfpRewardedAdAdapter;)V
...
.method public destroy()V
    ...
    .line 3
    iput-object v0, p0, Lcom/naver/gfpsdk/provider/GfpRewardedAdAdapter;->adapterListener:Lcom/naver/gfpsdk/provider/RewardedAdapterListener;

    return-void
.end method

.method public final getAdapterListener()Lcom/naver/gfpsdk/provider/RewardedAdapterListener;
    .locals 1

    .line 1
    iget-object v0, p0, Lcom/naver/gfpsdk/provider/GfpRewardedAdAdapter;->adapterListener:Lcom/naver/gfpsdk/provider/RewardedAdapterListener;

    if-nez v0, :cond_0

    .line 2
    new-instance v0, Lcom/naver/gfpsdk/provider/GfpRewardedAdAdapter$a;

    invoke-direct {v0, p0}, Lcom/naver/gfpsdk/provider/GfpRewardedAdAdapter$a;-><init>(Lcom/naver/gfpsdk/provider/GfpRewardedAdAdapter;)V
...
.method public isAdInvalidated()Z
    ...
    iget-object v0, p0, Lcom/naver/gfpsdk/provider/GfpRewardedAdAdapter;->showAdCalled:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public preRequestAd()V
    ...
    .line 2
    iget-object v0, p0, Lcom/naver/gfpsdk/provider/GfpRewardedAdAdapter;->rewardedAdOptions:Lcom/naver/gfpsdk/GfpRewardedAdOptions;

    const-string v1, "Rewarded ad options is null."
...
.method public final requestAd(Lcom/naver/gfpsdk/GfpRewardedAdOptions;Lcom/naver/gfpsdk/provider/RewardedAdapterListener;)V
    .locals 0
    .param p1    # Lcom/naver/gfpsdk/GfpRewardedAdOptions;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    .param p2    # Lcom/naver/gfpsdk/provider/RewardedAdapterListener;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param

    .line 1
    iput-object p1, p0, Lcom/naver/gfpsdk/provider/GfpRewardedAdAdapter;->rewardedAdOptions:Lcom/naver/gfpsdk/GfpRewardedAdOptions;

    .line 2
    iput-object p2, p0, Lcom/naver/gfpsdk/provider/GfpRewardedAdAdapter;->adapterListener:Lcom/naver/gfpsdk/provider/RewardedAdapterListener;
...
.method public showAd(Landroid/app/Activity;)Z
    ...
    .line 1
    invoke-virtual {p0}, Lcom/naver/gfpsdk/provider/GfpRewardedAdAdapter;->adAttached()V

    .line 2
    iget-object p1, p0, Lcom/naver/gfpsdk/provider/GfpRewardedAdAdapter;->showAdCalled:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .line 3
    sget-object p1, Lcom/naver/gfpsdk/GfpErrorType;->REWARDED_RENDERING_ERROR:Lcom/naver/gfpsdk/GfpErrorType;
    ...
    const-string v1, "GFP_FAILED_TO_RENDER_REWARDED_AD"
    ...
    .line 7
    invoke-virtual {p0, p1}, Lcom/naver/gfpsdk/provider/GfpRewardedAdAdapter;->adError(Lcom/naver/gfpsdk/GfpError;)V

    return v2

    .line 8
    :cond_0
    iget-object p1, p0, Lcom/naver/gfpsdk/provider/GfpRewardedAdAdapter;->expirationAction:Lg9/i;

...
# direct methods
.method public constructor <init>(Ljava/io/InputStream;Lr8/h;Lr8/e;Z)V
    .locals 2
    ...
    invoke-direct {v0, p1}, Ls8/b;-><init>(Ljava/io/InputStream;)V

    const-string p1, "SliceHeader: first_mb_in_slice"

    .line 6
    invoke-virtual {v0, p1}, Ls8/b;->x(Ljava/lang/String;)I
    ...
    .line 15
    invoke-virtual {v0, p1, v1}, Ls8/b;->v(ILjava/lang/String;)I
    ...
    .line 18
    invoke-virtual {v0, p1}, Ls8/b;->o(Ljava/lang/String;)Z
    ...
    .line 21
    iget p1, p2, Lr8/h;->a:I

    if-nez p1, :cond_2

    .line 22
    iget p1, p2, Lr8/h;->k:I

    add-int/lit8 p1, p1, 0x4

    const-string p2, "SliceHeader: pic_order_cnt_lsb"

    invoke-virtual {v0, p1, p2}, Ls8/b;->v(ILjava/lang/String;)I
    ...
    .line 24
    invoke-virtual {v0, p1}, Ls8/b;->s(Ljava/lang/String;)I

...
.method public a(Lph/t;Lbj/g;)Ljava/net/URI;
    ...
    .line 8
    invoke-interface {p2, v3}, Lbj/g;->getAttribute(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-interface {v3}, Lph/q;->getRequestLine()Lph/a0;

    move-result-object v3

    invoke-interface {v3}, Lph/a0;->getUri()Ljava/lang/String;
    ...
    .line 10
    invoke-static {v4, v0, v2}, Lzh/i;->j(Ljava/net/URI;Lcz/msebera/android/httpclient/HttpHost;Z)Ljava/net/URI;
    ...
    .line 24
    invoke-static {v1, p1, v2}, Lzh/i;->j(Ljava/net/URI;Lcz/msebera/android/httpclient/HttpHost;Z)Ljava/net/URI;

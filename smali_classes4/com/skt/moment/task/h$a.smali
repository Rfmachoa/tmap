...
.method public a()Lcom/skt/moment/net/vo/HappenForPlace;
    ...
    invoke-static {v3}, Lcom/skt/moment/task/h;->F(Lcom/skt/moment/task/h;)Ljava/lang/String;
    ...
    invoke-static {v3}, Lcom/skt/moment/task/h;->G(Lcom/skt/moment/task/h;)Ljava/lang/String;
    ...
    invoke-static {v3}, Lcom/skt/moment/task/h;->H(Lcom/skt/moment/task/h;)Ljava/lang/Double;
    ...
    invoke-static {v3}, Lcom/skt/moment/task/h;->I(Lcom/skt/moment/task/h;)Ljava/lang/Double;
    ...
    iget-object v4, p0, Lcom/skt/moment/task/h$a;->b:Lcom/skt/moment/task/h;

    invoke-static {v4}, Lcom/skt/moment/task/h;->I(Lcom/skt/moment/task/h;)Ljava/lang/Double;
    ...
    invoke-static {v3}, Lcom/skt/moment/task/h;->J(Lcom/skt/moment/task/h;)Ljava/lang/String;
    ...
    invoke-direct {v5, v1, v3}, Lzf/l;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 17
    invoke-interface {v7, v1}, Lcom/loopj/android/http/y;->h(Z)V

    .line 18
    iget-object v1, p0, Lcom/skt/moment/task/h$a;->b:Lcom/skt/moment/task/h;

    invoke-static {v1}, Lcom/skt/moment/task/h;->L(Lcom/skt/moment/task/h;)Landroid/content/Context;

    move-result-object v3

    iget-object v1, p0, Lcom/skt/moment/task/h$a;->b:Lcom/skt/moment/task/h;

    invoke-static {v1}, Lcom/skt/moment/task/h;->M(Lcom/skt/moment/task/h;)Ljava/lang/String;

    move-result-object v1

    invoke-static {v1, v0}, Lhb/a;->h(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    const-string v6, "application/json;charset=UTF-8"

    invoke-virtual/range {v2 .. v7}, Lcom/loopj/android/http/a;->b0(Landroid/content/Context;Ljava/lang/String;Ldf/l;Ljava/lang/String;Lcom/loopj/android/http/y;)Lcom/loopj/android/http/x;
    :try_end_0
    ...
    invoke-static {v0}, Lcom/skt/moment/task/h;->K(Lcom/skt/moment/task/h;)Lcom/skt/moment/net/vo/HappenForPlace;

...
.method public static synthetic a(Lcom/skt/tmap/vsm/map/marker/VSMMarkerRouteLine$MarkerData;Ltk/h;)V
    .locals 0

    .line 1
    invoke-static {p0, p1}, Lcom/skt/tmap/vsm/map/marker/VSMMarkerRouteLine;->b(Lcom/skt/tmap/vsm/map/marker/VSMMarkerRouteLine$MarkerData;Ltk/h;)V

    return-void
.end method

.method private static b(Lcom/skt/tmap/vsm/map/marker/VSMMarkerRouteLine$MarkerData;Ltk/h;)V
    .locals 9
    ...
    .line 5
    invoke-virtual {p1, v2}, Ltk/h;->f0(I)Ltk/e;
    ...
    .line 9
    invoke-virtual {p1, v2}, Ltk/h;->H(I)Ltk/d;

    move-result-object v5

    invoke-virtual {v5}, Ltk/d;->g()I
    ...
    .line 15
    invoke-virtual {p1, v1}, Ltk/h;->R(I)Ltk/g;

    move-result-object v2

    invoke-virtual {v2}, Ltk/g;->d()I
...
.method public setRouteData(Ltk/h;)V
    .locals 3
    .param p1    # Ltk/h;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-static {v0, p1}, Lcom/skt/tmap/vsm/map/marker/VSMMarkerRouteLine;->b(Lcom/skt/tmap/vsm/map/marker/VSMMarkerRouteLine$MarkerData;Ltk/h;)V

    .line 2
    iget-object p1, p0, Lcom/skt/tmap/vsm/map/marker/VSMMarkerRouteLine;->c:Lcom/skt/tmap/vsm/map/marker/VSMMarkerRouteLine$MarkerData;

    iget-object v0, p1, Lcom/skt/tmap/vsm/map/marker/VSMMarkerRouteLine$MarkerData;->mPoints:Ljava/util/List;

    iget-object v1, p1, Lcom/skt/tmap/vsm/map/marker/VSMMarkerRouteLine$MarkerData;->mLinks:Ljava/util/List;

    iget-object v2, p1, Lcom/skt/tmap/vsm/map/marker/VSMMarkerRouteLine$MarkerData;->mManeuvers:Ljava/util/List;

    iget p1, p1, Lcom/skt/tmap/vsm/map/marker/VSMMarkerRouteLine$MarkerData;->mOppositePointIndex:I

    invoke-direct {p0, v0, v1, v2, p1}, Lcom/skt/tmap/vsm/map/marker/VSMMarkerRouteLine;->nativeSetRouteData(Ljava/util/List;Ljava/util/List;Ljava/util/List;I)V

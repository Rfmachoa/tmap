.class public final Lcom/skt/tmap/util/o1$b;
...
.method public constructor <init>(Landroid/app/Activity;Lcom/skt/tmap/engine/navigation/NavigationManager;Z)V
    ...
    .line 1
    iput-object p1, p0, Lcom/skt/tmap/util/o1$b;->a:Landroid/app/Activity;

    iput-object p2, p0, Lcom/skt/tmap/util/o1$b;->b:Lcom/skt/tmap/engine/navigation/NavigationManager;

    iput-boolean p3, p0, Lcom/skt/tmap/util/o1$b;->c:Z
...
.method public onComplete(Lcom/skt/tmap/engine/navigation/route/RouteResult;)V
    ...
    .line 1
    iget-object v0, p0, Lcom/skt/tmap/util/o1$b;->a:Landroid/app/Activity;
    ...
    .line 3
    :goto_0
    iget-object v3, p0, Lcom/skt/tmap/util/o1$b;->a:Landroid/app/Activity;

    invoke-virtual {v2}, Lcom/skt/tmap/engine/navigation/route/RoutePlanType;->getRouteOption()I

    move-result v4

    invoke-static {v3, v4}, Lcom/skt/tmap/util/TmapSharedPreference;->L2(Landroid/content/Context;I)V
    ...
    :goto_1
    invoke-static {v3, v5}, Lcom/skt/tmap/util/TmapSharedPreference;->v2(Landroid/content/Context;Ljava/lang/String;)V

    .line 5
    iget-object v3, p0, Lcom/skt/tmap/util/o1$b;->b:Lcom/skt/tmap/engine/navigation/NavigationManager;

    invoke-virtual {v3, v2}, Lcom/skt/tmap/engine/navigation/NavigationManager;->setRoutePlanType(Lcom/skt/tmap/engine/navigation/route/RoutePlanType;)V

    .line 6
    iget-object v2, p0, Lcom/skt/tmap/util/o1$b;->a:Landroid/app/Activity;

    const-string v3, "feature.realTimeAutoReroute"
    ...
    const-string v3, "feature.highwayBoardTraffic"
    ...
    :goto_2
    invoke-direct {v3, v5}, Lcom/skt/tmap/engine/navigation/network/RouteSearchData;-><init>(Lcom/skt/tmap/engine/navigation/route/data/WayPoint;)V

    invoke-virtual {v2, v3}, Lcom/skt/tmap/mvp/viewmodel/userdata/UserDataDbHelper;->u0(Lcom/skt/tmap/engine/navigation/network/RouteSearchData;)V
    ...
    .line 10
    iget-object v6, p0, Lcom/skt/tmap/util/o1$b;->a:Landroid/app/Activity;
    ...
    :cond_3
    invoke-static {v6, v7, v4}, Lcom/skt/tmap/engine/h0;->a(Landroid/content/Context;Lcom/skt/tmap/engine/navigation/data/DriveMode;Lcom/skt/tmap/engine/navigation/route/RouteOption;)Landroid/app/Notification;

    move-result-object v8

    const-string v2, "TmapNotificationManager.\u2026routeResult?.routeOption)"
    ...
    .line 14
    invoke-virtual/range {v5 .. v13}, Lcom/skt/tmap/engine/l0;->c1(Landroid/content/Context;Lcom/skt/tmap/engine/navigation/data/DriveMode;Landroid/app/Notification;IZZLcom/skt/tmap/engine/navigation/route/RouteResult;I)V
    ...
    .line 19
    iget-boolean v0, p0, Lcom/skt/tmap/util/o1$b;->c:Z

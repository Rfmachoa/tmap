.class public Lcom/skt/tmap/util/n0;
...
.method public static b(Landroid/content/Context;Lcom/skt/tmap/data/ScheduleInfo;)Ljava/lang/StringBuffer;
    ...
    invoke-static {v5}, Lcom/skt/tmap/util/k;->h([B)Z
    ...
    invoke-static {v2}, Lcom/skt/tmap/util/k;->h([B)Z
    ...
    .line 31
    :goto_6
    invoke-static {p1}, Lcom/skt/tmap/util/k;->h([B)Z
...
.method public static c(Landroid/content/Context;J)Landroid/content/Intent;
    ...
    const-string/jumbo v0, "tmap://alarm?id=schedule&rowId="
...
.method public static e(Landroid/content/Context;J)V
    ...
    .line 4
    invoke-static {p0, p1, p2}, Lcom/skt/tmap/util/n0;->d(Landroid/content/Context;J)Lcom/skt/tmap/data/ScheduleInfo;
    ...
    invoke-static {p0, v3, v4, v5, v6}, Lcom/skt/tmap/util/n0;->a(Landroid/content/Context;JJ)Ljava/lang/String;

    move-result-object v3

    .line 6
    invoke-static {p0, v2}, Lcom/skt/tmap/util/n0;->b(Landroid/content/Context;Lcom/skt/tmap/data/ScheduleInfo;)Ljava/lang/StringBuffer;

    move-result-object v2

    .line 7
    invoke-static {p0, p1, p2}, Lcom/skt/tmap/util/n0;->c(Landroid/content/Context;J)Landroid/content/Intent;
    ...
    sget-object v4, Lcom/skt/tmap/util/n0;->d:Ljava/lang/String;
    ...
    invoke-direct {p2, v4, v10, v8}, Landroid/app/NotificationChannel;-><init>(Ljava/lang/String;Ljava/lang/CharSequence;I)V
    ...
    .line 12
    invoke-virtual {p2, v9}, Landroid/app/NotificationChannel;->setShowBadge(Z)V

    .line 13
    invoke-virtual {p2, v9}, Landroid/app/NotificationChannel;->enableVibration(Z)V

    .line 14
    invoke-virtual {p2, v9}, Landroid/app/NotificationChannel;->enableLights(Z)V
    ...
    invoke-virtual {p2, v4, v10}, Landroid/app/NotificationChannel;->setSound(Landroid/net/Uri;Landroid/media/AudioAttributes;)V
    ...
    invoke-virtual {p2, v4}, Landroid/app/NotificationChannel;->setVibrationPattern([J)V

    .line 17
    invoke-virtual {p2, v9}, Landroid/app/NotificationChannel;->setLockscreenVisibility(I)V

    .line 18
    sget-object v4, Lcom/skt/tmap/util/n0;->c:Ljava/lang/String;
    ...
    invoke-direct {p2, p0, v4}, Landroidx/core/app/NotificationCompat$e;-><init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-virtual {p2, v4}, Landroidx/core/app/NotificationCompat$e;->t0(I)Landroidx/core/app/NotificationCompat$e;
    ...
    invoke-virtual {p2, v4}, Landroidx/core/app/NotificationCompat$e;->c0(Landroid/graphics/Bitmap;)Landroidx/core/app/NotificationCompat$e;
    ...
    .line 28
    invoke-virtual {p2, v9}, Landroidx/core/app/NotificationCompat$e;->r0(Z)Landroidx/core/app/NotificationCompat$e;

    .line 29
    invoke-virtual {p2, v9}, Landroidx/core/app/NotificationCompat$e;->D(Z)Landroidx/core/app/NotificationCompat$e;
    ...
    invoke-virtual {p2, v2}, Landroidx/core/app/NotificationCompat$e;->F0([J)Landroidx/core/app/NotificationCompat$e;
    ...
    invoke-virtual {p2, v4, v3, v2}, Landroidx/core/app/NotificationCompat$e;->a(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)Landroidx/core/app/NotificationCompat$e;
    ...
    invoke-virtual {p2, v4, p0, p1}, Landroidx/core/app/NotificationCompat$e;->a(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)Landroidx/core/app/NotificationCompat$e;

    const/4 p0, 0x2

    .line 39
    invoke-virtual {p2, p0}, Landroidx/core/app/NotificationCompat$e;->k0(I)Landroidx/core/app/NotificationCompat$e;

    const-string p0, "alarm"

    .line 40
    invoke-virtual {p2, p0}, Landroidx/core/app/NotificationCompat$e;->G(Ljava/lang/String;)Landroidx/core/app/NotificationCompat$e;

    .line 41
    invoke-virtual {p2, v9}, Landroidx/core/app/NotificationCompat$e;->G0(I)Landroidx/core/app/NotificationCompat$e;

    .line 42
    invoke-virtual {p2, p1, v9}, Landroidx/core/app/NotificationCompat$e;->Y(Landroid/app/PendingIntent;Z)Landroidx/core/app/NotificationCompat$e;

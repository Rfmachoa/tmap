...
.method public final isReliableLocation(Landroid/location/Location;Z)Z
    ...
    const-string/jumbo p1, "unReliable : invalid gps signal in shade area."
    ...
    const-string/jumbo p1, "unReliable : short interval"
    ...
    const-string/jumbo p1, "unReliable : inaccurate speed, & bearing"
    ...
    invoke-static {v7, v8}, Ltl/d;->K0(D)I
    ...
    :cond_6
    const-string/jumbo p1, "unReliable : low accuracy"
    ...
    :cond_8
    const-string/jumbo p1, "unReliable : shadeArea and no satellite"
    ...
    const-string/jumbo p1, "unReliable : unReachableLocation"

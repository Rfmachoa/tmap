...
.field private static logBuffer:Ljava/lang/StringBuffer; = null

.field private static okGpsLogBufferedWriter:Ljava/io/BufferedWriter; = null

.field private static okLastFileName:Ljava/lang/String; = ""

.field private static okLogBuffer:Ljava/lang/StringBuffer;

.field private static okSaveLocationDirPath:Landroid/net/Uri;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/skt/tmap/engine/navigation/location/TmapLocationManager;->okLogBuffer:Ljava/lang/StringBuffer;
...
.method public static synthetic access$100()Ljava/io/BufferedWriter;
    .locals 1

    sget-object v0, Lcom/skt/tmap/engine/navigation/location/TmapLocationManager;->okGpsLogBufferedWriter:Ljava/io/BufferedWriter;
...
.method public static flushOkLog()V
    .locals 4
    ...
    sget-object v0, Lcom/skt/tmap/engine/navigation/location/TmapLocationManager;->okLogBuffer:Ljava/lang/StringBuffer;
    ...
    .line 3
    sget-object v1, Lcom/skt/tmap/engine/navigation/location/TmapLocationManager;->okLogBuffer:Ljava/lang/StringBuffer;
    ...
    new-instance v2, Lcom/skt/tmap/engine/navigation/location/TmapLocationManager$6;

    invoke-direct {v2, v0}, Lcom/skt/tmap/engine/navigation/location/TmapLocationManager$6;-><init>(Ljava/lang/String;)V
...
.method public static declared-synchronized saveGpsLog(Landroid/location/Location;Lcom/skt/tmap/engine/navigation/data/RGData;IIF)V
    ...
    const-string/jumbo v5, "yyyyMMdd_HH"
    ...
    invoke-static {v4, v5}, Lh3/a;->j(Landroid/content/Context;Landroid/net/Uri;)Lh3/a;
    ...
    .line 14
    invoke-virtual {v4, v5}, Lh3/a;->g(Ljava/lang/String;)Lh3/a;
    ...
    .line 16
    invoke-virtual {v4, v5}, Lh3/a;->c(Ljava/lang/String;)Lh3/a;
    ...
    .line 18
    :cond_4
    invoke-virtual {v5, v3}, Lh3/a;->g(Ljava/lang/String;)Lh3/a;
    ...
    .line 20
    invoke-virtual {v5, v4, v3}, Lh3/a;->d(Ljava/lang/String;Ljava/lang/String;)Lh3/a;
    ...
    invoke-virtual {v4}, Lh3/a;->n()Landroid/net/Uri;
...
.method public static declared-synchronized saveOkGpsLog(Landroid/location/Location;Lcom/skt/tmap/engine/navigation/data/RGData;IIF)V
    .locals 8
    ...
    .line 1
    :try_start_0
    sget-object v1, Lcom/skt/tmap/engine/navigation/location/TmapLocationManager;->okSaveLocationDirPath:Landroid/net/Uri;
    ...
    const-string v3, "_ok_gps_v3.csv"
    ...
    .line 6
    sget-object v4, Lcom/skt/tmap/engine/navigation/location/TmapLocationManager;->okLastFileName:Ljava/lang/String;
    ...
    sget-object v4, Lcom/skt/tmap/engine/navigation/location/TmapLocationManager;->okGpsLogBufferedWriter:Ljava/io/BufferedWriter;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_1
    :try_start_1
    sput-object v3, Lcom/skt/tmap/engine/navigation/location/TmapLocationManager;->okLastFileName:Ljava/lang/String;

    .line 8
    invoke-static {}, Lcom/skt/tmap/engine/navigation/location/TmapLocationManager;->flushOkLog()V
    ...
    sget-object v5, Lcom/skt/tmap/engine/navigation/location/TmapLocationManager;->okSaveLocationDirPath:Landroid/net/Uri;
    ...
    sput-object v4, Lcom/skt/tmap/engine/navigation/location/TmapLocationManager;->okGpsLogBufferedWriter:Ljava/io/BufferedWriter;
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    :goto_3
    :try_start_2
    sget-object v3, Lcom/skt/tmap/engine/navigation/location/TmapLocationManager;->okGpsLogBufferedWriter:Ljava/io/BufferedWriter;

    if-eqz v3, :cond_10

    .line 22
    sget-object v3, Lcom/skt/tmap/engine/navigation/location/TmapLocationManager;->okLogBuffer:Ljava/lang/StringBuffer;
    ...
    .line 37
    sget-object p2, Lcom/skt/tmap/engine/navigation/location/TmapLocationManager;->okLogBuffer:Ljava/lang/StringBuffer;
    ...
    .line 49
    sget-object p1, Lcom/skt/tmap/engine/navigation/location/TmapLocationManager;->okLogBuffer:Ljava/lang/StringBuffer;
    ...
    .line 64
    sget-object p0, Lcom/skt/tmap/engine/navigation/location/TmapLocationManager;->okLogBuffer:Ljava/lang/StringBuffer;
...
.method public initialize(Landroid/content/Context;Lcom/skt/tmap/engine/navigation/location/TmapLocationManager$InitParam;)V
    ...
    .line 5
    sput-object v0, Lcom/skt/tmap/engine/navigation/location/TmapLocationManager;->okSaveLocationDirPath:Landroid/net/Uri;
...
.method public onLocationChanged(Landroid/location/Location;)V
    ...
    invoke-interface {v0}, Lcom/skt/tmap/engine/navigation/TmapNavigationEngineInterface;->getLastRGData()Lcom/skt/tmap/engine/navigation/data/RGData;
...
.method public saveGpsLog(Landroid/location/Location;)V
    ...
    invoke-static {p1, v3, v1, v2, v0}, Lcom/skt/tmap/engine/navigation/location/TmapLocationManager;->saveGpsLog(Landroid/location/Location;Lcom/skt/tmap/engine/navigation/data/RGData;IIF)V
...
.method public stop()V
    ...
    .line 10
    sput-object v1, Lcom/skt/tmap/engine/navigation/location/TmapLocationManager;->gpsLogBufferedWriter:Ljava/io/BufferedWriter;
    ...
    .line 13
    sput-object v1, Lcom/skt/tmap/engine/navigation/location/TmapLocationManager;->okGpsLogBufferedWriter:Ljava/io/BufferedWriter;
    :try_end_1

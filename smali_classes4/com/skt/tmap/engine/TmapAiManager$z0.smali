...
.method private synthetic e()V
    ...
    invoke-static {v1}, Lcom/skt/tmap/engine/TmapAiManager;->K(Lcom/skt/tmap/engine/TmapAiManager;)Landroid/support/v4/media/session/MediaSessionCompat;

    move-result-object v1

    invoke-virtual {v1}, Landroid/support/v4/media/session/MediaSessionCompat;->i()Landroid/support/v4/media/session/MediaSessionCompat$Token;

    move-result-object v1

    iget-object v2, p0, Lcom/skt/tmap/engine/TmapAiManager$z0;->a:Lcom/skt/tmap/engine/TmapAiManager;

    invoke-static {v2}, Lcom/skt/tmap/engine/TmapAiManager;->J(Lcom/skt/tmap/engine/TmapAiManager;)Lcom/skt/tmap/engine/h0;

    move-result-object v2

    invoke-virtual {v0, v1, v2}, Lcom/skt/voice/tyche/NuguSdkManager;->q(Landroid/support/v4/media/session/MediaSessionCompat$Token;Lcom/skt/tmap/engine/h0;)V
...
.method private synthetic f(Landroid/graphics/Bitmap;)V
    ...
    invoke-static {p1}, Lcom/skt/tmap/engine/TmapAiManager;->h0(Lcom/skt/tmap/engine/TmapAiManager;)Lcom/skt/voice/tyche/NuguSdkManager;

    move-result-object p1

    iget-object v0, p0, Lcom/skt/tmap/engine/TmapAiManager$z0;->a:Lcom/skt/tmap/engine/TmapAiManager;

    invoke-static {v0}, Lcom/skt/tmap/engine/TmapAiManager;->K(Lcom/skt/tmap/engine/TmapAiManager;)Landroid/support/v4/media/session/MediaSessionCompat;
    ...
    invoke-static {v1}, Lcom/skt/tmap/engine/TmapAiManager;->J(Lcom/skt/tmap/engine/TmapAiManager;)Lcom/skt/tmap/engine/h0;

    move-result-object v1

    invoke-virtual {p1, v0, v1}, Lcom/skt/voice/tyche/NuguSdkManager;->q(Landroid/support/v4/media/session/MediaSessionCompat$Token;Lcom/skt/tmap/engine/h0;)V
...
.method public bridge synthetic b(Ljava/lang/Object;Ljava/lang/Object;Lg7/p;Lcom/bumptech/glide/load/DataSource;Z)Z
    ...
    invoke-virtual/range {p0 .. p5}, Lcom/skt/tmap/engine/TmapAiManager$z0;->g(Landroid/graphics/Bitmap;Ljava/lang/Object;Lg7/p;Lcom/bumptech/glide/load/DataSource;Z)Z
...
.method public g(Landroid/graphics/Bitmap;Ljava/lang/Object;Lg7/p;Lcom/bumptech/glide/load/DataSource;Z)Z
    .locals 0
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,

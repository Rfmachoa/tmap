...
.method public run()V
    ...
    iput-object v1, v0, Lcom/skt/tmap/blackbox/RecordingListActivity;->S0:Landroid/net/Uri;
    ...
    .line 4
    iget-object v1, v0, Lcom/skt/tmap/blackbox/RecordingListActivity;->S0:Landroid/net/Uri;
    ...
    .line 5
    invoke-static {v0, v1}, Lcom/skt/tmap/blackbox/a;->x(Landroid/app/Activity;I)Lcom/skt/tmap/dialog/d0;

    goto :goto_0

    .line 6
    :cond_0
    invoke-virtual {v0}, Lcom/skt/tmap/blackbox/RecordingListActivity;->t5()V

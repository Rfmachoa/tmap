...
.method public final a(Landroid/content/Context;Ljava/util/List;Lkotlin/coroutines/c;)Ljava/lang/Object;
    ...
    invoke-direct {p2, p1, v2, v1, v2}, Lqc/c;-><init>(Landroid/app/Activity;ZZZ)V
    ...
    invoke-direct {p2, p1}, Lqc/c;-><init>(Landroid/content/Context;)V

    .line 9
    :goto_2
    new-instance p1, Lcom/skt/tmap/mvp/viewmodel/userdata/d$c;

    invoke-direct {p1, v0, v3}, Lcom/skt/tmap/mvp/viewmodel/userdata/d$c;-><init>(Lkotlin/coroutines/c;Lcom/skt/tmap/network/ndds/dto/request/RegistUsedFavoriteRouteRequest;)V
    ...
    .line 10
    new-instance p1, Lcom/skt/tmap/mvp/viewmodel/userdata/d$d;

    invoke-direct {p1, v0, v3}, Lcom/skt/tmap/mvp/viewmodel/userdata/d$d;-><init>(Lkotlin/coroutines/c;Lcom/skt/tmap/network/ndds/dto/request/RegistUsedFavoriteRouteRequest;)V
    ...
    .line 12
    invoke-virtual {p2, v3}, Lqc/c;->request(Lcom/skt/tmap/engine/navigation/network/ndds/dto/RequestDto;)Z
...
.method public final b(Landroid/content/Context;Ljava/util/List;Lkotlin/coroutines/c;)Ljava/lang/Object;
    ...
    .line 9
    :goto_2
    new-instance p1, Lcom/skt/tmap/mvp/viewmodel/userdata/d$e;

    invoke-direct {p1, v0, v3}, Lcom/skt/tmap/mvp/viewmodel/userdata/d$e;-><init>(Lkotlin/coroutines/c;Lcom/skt/tmap/network/ndds/dto/request/DeleteUsedFavoriteRouteRequest;)V

    invoke-virtual {p2, p1}, Lcom/skt/tmap/engine/navigation/network/NetworkRequester;->setOnComplete(Lcom/skt/tmap/engine/navigation/network/NetworkRequester$OnComplete;)V

    .line 10
    new-instance p1, Lcom/skt/tmap/mvp/viewmodel/userdata/d$f;

    invoke-direct {p1, v0, v3}, Lcom/skt/tmap/mvp/viewmodel/userdata/d$f;-><init>(Lkotlin/coroutines/c;Lcom/skt/tmap/network/ndds/dto/request/DeleteUsedFavoriteRouteRequest;)V
...
.method public final c(Landroid/content/Context;Lkotlin/coroutines/c;)Ljava/lang/Object;
    ...
    invoke-direct {v2, p1, v4, v3, v4}, Lqc/c;-><init>(Landroid/app/Activity;ZZZ)V
    ...
    invoke-direct {v2, p1}, Lqc/c;-><init>(Landroid/content/Context;)V

    .line 6
    :goto_0
    new-instance p1, Lcom/skt/tmap/mvp/viewmodel/userdata/d$a;

    invoke-direct {p1, v0, v1}, Lcom/skt/tmap/mvp/viewmodel/userdata/d$a;-><init>(Lkotlin/coroutines/c;Lcom/skt/tmap/network/ndds/dto/request/FindUsedFavoriteRouteRequest;)V
    ...
    .line 7
    new-instance p1, Lcom/skt/tmap/mvp/viewmodel/userdata/d$b;

    invoke-direct {p1, v0, v1}, Lcom/skt/tmap/mvp/viewmodel/userdata/d$b;-><init>(Lkotlin/coroutines/c;Lcom/skt/tmap/network/ndds/dto/request/FindUsedFavoriteRouteRequest;)V
    ...
    .line 9
    invoke-virtual {v2, v1}, Lqc/c;->request(Lcom/skt/tmap/engine/navigation/network/ndds/dto/RequestDto;)Z
...
.method public final d(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Lkotlin/coroutines/c;)Ljava/lang/Object;
    ...
    invoke-direct {p2, p1, v2, p3, v2}, Lqc/c;-><init>(Landroid/app/Activity;ZZZ)V
    ...
    .line 15
    :goto_0
    new-instance p1, Lcom/skt/tmap/mvp/viewmodel/userdata/d$g;

    invoke-direct {p1, v0, v1}, Lcom/skt/tmap/mvp/viewmodel/userdata/d$g;-><init>(Lkotlin/coroutines/c;Lcom/skt/tmap/network/ndds/dto/request/ModifyUsedFavoriteRouteRequest;)V

    invoke-virtual {p2, p1}, Lcom/skt/tmap/engine/navigation/network/NetworkRequester;->setOnComplete(Lcom/skt/tmap/engine/navigation/network/NetworkRequester$OnComplete;)V

    .line 16
    new-instance p1, Lcom/skt/tmap/mvp/viewmodel/userdata/d$h;

    invoke-direct {p1, v0, v1}, Lcom/skt/tmap/mvp/viewmodel/userdata/d$h;-><init>(Lkotlin/coroutines/c;Lcom/skt/tmap/network/ndds/dto/request/ModifyUsedFavoriteRouteRequest;)V
    ...
    .line 18
    invoke-virtual {p2, v1}, Lqc/c;->request(Lcom/skt/tmap/engine/navigation/network/ndds/dto/RequestDto;)Z

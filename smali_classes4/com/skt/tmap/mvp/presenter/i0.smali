...
.method public constructor <init>(Landroid/content/Context;ZLcom/skt/tmap/mvp/presenter/BasePresenter;)V
    ...
    .line 2
    iput-wide v0, p0, Lcom/skt/tmap/mvp/presenter/i0;->d:D

    const/4 v0, 0x0

    .line 3
    iput-boolean v0, p0, Lcom/skt/tmap/mvp/presenter/i0;->e:Z

    .line 4
    iput-object p1, p0, Lcom/skt/tmap/mvp/presenter/i0;->b:Landroid/content/Context;

    .line 5
    iput-boolean p2, p0, Lcom/skt/tmap/mvp/presenter/i0;->c:Z

    .line 6
    iput-object p3, p0, Lcom/skt/tmap/mvp/presenter/i0;->f:Lcom/skt/tmap/mvp/presenter/BasePresenter;

    return-void
.end method

.method public static synthetic h(Lcom/skt/tmap/mvp/presenter/i0;)D
    .locals 2

    iget-wide v0, p0, Lcom/skt/tmap/mvp/presenter/i0;->d:D

    return-wide v0
.end method

.method public static synthetic i(Lcom/skt/tmap/mvp/presenter/i0;D)D
    .locals 0

    iput-wide p1, p0, Lcom/skt/tmap/mvp/presenter/i0;->d:D

    return-wide p1
.end method

.method public static synthetic j(Lcom/skt/tmap/mvp/presenter/i0;)Z
    .locals 0

    iget-boolean p0, p0, Lcom/skt/tmap/mvp/presenter/i0;->e:Z

    return p0
.end method

.method public static synthetic k(Lcom/skt/tmap/mvp/presenter/i0;Z)Z
    .locals 0

    iput-boolean p1, p0, Lcom/skt/tmap/mvp/presenter/i0;->e:Z

    return p1
.end method

.method public static synthetic l(Lcom/skt/tmap/mvp/presenter/i0;)Landroid/content/Context;
    .locals 0

    iget-object p0, p0, Lcom/skt/tmap/mvp/presenter/i0;->b:Landroid/content/Context;

    return-object p0
.end method

.method public static synthetic m(Lcom/skt/tmap/mvp/presenter/i0;)Lse/w;
    .locals 0

    iget-object p0, p0, Lcom/skt/tmap/mvp/presenter/i0;->a:Lse/w;
...
.method public bridge synthetic b(Lse/e;)V
    ...
    invoke-virtual {p0, p1}, Lcom/skt/tmap/mvp/presenter/i0;->n(Lse/w;)V
...
.method public c(D)V
    ...
    iget-object v0, p0, Lcom/skt/tmap/mvp/presenter/i0;->a:Lse/w;

    new-instance v1, Lcom/skt/tmap/mvp/presenter/i0$a;

    invoke-direct {v1, p0, p1, p2}, Lcom/skt/tmap/mvp/presenter/i0$a;-><init>(Lcom/skt/tmap/mvp/presenter/i0;D)V

    invoke-interface {v0, v1}, Lse/w;->k0(Ljava/lang/Runnable;)V
...
.method public g(D)V
    ...
    new-instance v1, Lcom/skt/tmap/mvp/presenter/i0$b;

    invoke-direct {v1, p0, p1, p2}, Lcom/skt/tmap/mvp/presenter/i0$b;-><init>(Lcom/skt/tmap/mvp/presenter/i0;D)V
...
.method public n(Lse/w;)V
    ...
    iput-object p1, p0, Lcom/skt/tmap/mvp/presenter/i0;->a:Lse/w;
...
.method public o()Lcom/skt/tmap/engine/navigation/network/RouteSearchData;
    ...
    iget-object v0, p0, Lcom/skt/tmap/mvp/presenter/i0;->j:Lcom/skt/tmap/engine/navigation/network/RouteSearchData;
...
.method public onCreate()V
    ...
    .line 1
    iget-object v0, p0, Lcom/skt/tmap/mvp/presenter/i0;->g:Lcom/skt/tmap/engine/navigation/network/RouteSearchData;
    ...
    .line 5
    iget-object v0, p0, Lcom/skt/tmap/mvp/presenter/i0;->b:Landroid/content/Context;
    ...
    .line 6
    :cond_1
    iget-object v1, p0, Lcom/skt/tmap/mvp/presenter/i0;->a:Lse/w;

    invoke-interface {v1, v0}, Lse/w;->J3(Ljava/lang/String;)V

    .line 7
    iget-object v1, p0, Lcom/skt/tmap/mvp/presenter/i0;->a:Lse/w;

    invoke-interface {v1, v0}, Lse/w;->U4(Ljava/lang/String;)V
    ...
    invoke-interface {v1, v0}, Lse/w;->K2(Ljava/lang/String;)V
...
.method public q()Lcom/skt/tmap/engine/navigation/network/RouteSearchData;
    ...
    iget-object v0, p0, Lcom/skt/tmap/mvp/presenter/i0;->h:Lcom/skt/tmap/engine/navigation/network/RouteSearchData;
...
.method public r()Lcom/skt/tmap/engine/navigation/network/RouteSearchData;
    ...
    iget-object v0, p0, Lcom/skt/tmap/mvp/presenter/i0;->i:Lcom/skt/tmap/engine/navigation/network/RouteSearchData;
...
.method public final s()Ljava/util/List;
    ...
    .line 2
    iget-object v1, p0, Lcom/skt/tmap/mvp/presenter/i0;->h:Lcom/skt/tmap/engine/navigation/network/RouteSearchData;
    ...
    .line 4
    :cond_0
    iget-object v1, p0, Lcom/skt/tmap/mvp/presenter/i0;->i:Lcom/skt/tmap/engine/navigation/network/RouteSearchData;
...
.method public t()V
    ...
    invoke-interface {v0, v1, v2, v1}, Lse/w;->c(ZZZ)Lye/d;

    move-result-object v0

    .line 2
    new-instance v3, Lcom/skt/tmap/mvp/presenter/i0$c;

    invoke-direct {v3, p0}, Lcom/skt/tmap/mvp/presenter/i0$c;-><init>(Lcom/skt/tmap/mvp/presenter/i0;)V
    ...
    .line 3
    new-instance v3, Lcom/skt/tmap/mvp/presenter/i0$d;

    invoke-direct {v3, p0}, Lcom/skt/tmap/mvp/presenter/i0$d;-><init>(Lcom/skt/tmap/mvp/presenter/i0;)V
    ...
    .line 4
    iget-object v3, p0, Lcom/skt/tmap/mvp/presenter/i0;->g:Lcom/skt/tmap/engine/navigation/network/RouteSearchData;
    ...
    .line 5
    iget-object v4, p0, Lcom/skt/tmap/mvp/presenter/i0;->j:Lcom/skt/tmap/engine/navigation/network/RouteSearchData;
    ...
    .line 20
    iget-object v2, p0, Lcom/skt/tmap/mvp/presenter/i0;->g:Lcom/skt/tmap/engine/navigation/network/RouteSearchData;
    ...
    .line 24
    iget-object v1, p0, Lcom/skt/tmap/mvp/presenter/i0;->g:Lcom/skt/tmap/engine/navigation/network/RouteSearchData;
    ...
    .line 25
    iget-object v1, p0, Lcom/skt/tmap/mvp/presenter/i0;->j:Lcom/skt/tmap/engine/navigation/network/RouteSearchData;
    ...
    .line 31
    invoke-virtual {p0}, Lcom/skt/tmap/mvp/presenter/i0;->s()Ljava/util/List;
    ...
    .line 32
    invoke-virtual {v0, v8}, Lye/d;->request(Lcom/skt/tmap/engine/navigation/network/ndds/dto/RequestDto;)Z
...
.method public u(Landroid/content/Intent;)V
    ...
    iput-object v0, p0, Lcom/skt/tmap/mvp/presenter/i0;->g:Lcom/skt/tmap/engine/navigation/network/RouteSearchData;
    ...
    iput-object v1, p0, Lcom/skt/tmap/mvp/presenter/i0;->h:Lcom/skt/tmap/engine/navigation/network/RouteSearchData;
    ...
    iput-object v0, p0, Lcom/skt/tmap/mvp/presenter/i0;->i:Lcom/skt/tmap/engine/navigation/network/RouteSearchData;
    ...
    iput-object p1, p0, Lcom/skt/tmap/mvp/presenter/i0;->j:Lcom/skt/tmap/engine/navigation/network/RouteSearchData;

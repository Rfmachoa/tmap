.class public Lcom/skt/tmap/mvp/presenter/f;
...
.method public constructor <init>(Lcom/skt/tmap/activity/ClientCommListActivity;Lcom/skt/tmap/mvp/presenter/BasePresenter;)V
    ...
    .line 2
    iput v0, p0, Lcom/skt/tmap/mvp/presenter/f;->a:I

    .line 3
    iput-object p1, p0, Lcom/skt/tmap/mvp/presenter/f;->b:Lcom/skt/tmap/activity/ClientCommListActivity;

    .line 4
    iput-object p2, p0, Lcom/skt/tmap/mvp/presenter/f;->e:Lcom/skt/tmap/mvp/presenter/BasePresenter;

    .line 5
    new-instance p2, Ljc/e;

    invoke-direct {p2, p1}, Ljc/e;-><init>(Landroid/content/Context;)V

    iput-object p2, p0, Lcom/skt/tmap/mvp/presenter/f;->d:Ljc/e;

    return-void
.end method

.method public static synthetic g(Lcom/skt/tmap/mvp/presenter/f;)V
    .locals 0

    invoke-direct {p0}, Lcom/skt/tmap/mvp/presenter/f;->s()V

    return-void
.end method

.method public static synthetic h(Lcom/skt/tmap/mvp/presenter/f;ILcom/skt/tmap/engine/navigation/network/ndds/dto/ResponseDto;I)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/skt/tmap/mvp/presenter/f;->q(ILcom/skt/tmap/engine/navigation/network/ndds/dto/ResponseDto;I)V

    return-void
.end method

.method public static synthetic i(Lcom/skt/tmap/engine/navigation/network/ndds/dto/ResponseDto;ILjava/lang/String;Ljava/lang/String;)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lcom/skt/tmap/mvp/presenter/f;->r(Lcom/skt/tmap/engine/navigation/network/ndds/dto/ResponseDto;ILjava/lang/String;Ljava/lang/String;)V

    return-void
.end method

.method public static synthetic j(Lcom/skt/tmap/mvp/presenter/f;)Ljc/e;
    .locals 0

    .line 1
    iget-object p0, p0, Lcom/skt/tmap/mvp/presenter/f;->d:Ljc/e;

    return-object p0
.end method

.method public static synthetic k(Lcom/skt/tmap/mvp/presenter/f;Lcom/skt/tmap/data/NotiDetailInfo;)V
    .locals 0

    .line 1
    invoke-virtual {p0, p1}, Lcom/skt/tmap/mvp/presenter/f;->n(Lcom/skt/tmap/data/NotiDetailInfo;)V

    return-void
.end method

.method public static synthetic l(Lcom/skt/tmap/mvp/presenter/f;)Lcom/skt/tmap/mvp/presenter/BasePresenter;
    .locals 0

    .line 1
    iget-object p0, p0, Lcom/skt/tmap/mvp/presenter/f;->e:Lcom/skt/tmap/mvp/presenter/BasePresenter;

    return-object p0
.end method

.method public static synthetic m(Lcom/skt/tmap/mvp/presenter/f;)Llc/e;
    .locals 0

    .line 1
    iget-object p0, p0, Lcom/skt/tmap/mvp/presenter/f;->c:Llc/e;

    return-object p0
.end method

.method private synthetic q(ILcom/skt/tmap/engine/navigation/network/ndds/dto/ResponseDto;I)V
    .locals 6
    ...
    .line 2
    iget-object p3, p0, Lcom/skt/tmap/mvp/presenter/f;->d:Ljc/e;
    ...
    invoke-virtual {p3, v0}, Ljc/e;->p(Ljava/lang/String;)V
    ...
    invoke-virtual {p3}, Ljc/e;->i()Ljava/util/ArrayList;
    ...
    .line 26
    iget-object v1, p0, Lcom/skt/tmap/mvp/presenter/f;->d:Ljc/e;
    ...
    invoke-virtual {v1, v0}, Ljc/e;->q(I)V
    ...
    .line 28
    :cond_3
    iget-object p2, p0, Lcom/skt/tmap/mvp/presenter/f;->d:Ljc/e;

    invoke-virtual {p2}, Ljc/e;->b()V

    .line 29
    iget-object p2, p0, Lcom/skt/tmap/mvp/presenter/f;->d:Ljc/e;

    invoke-virtual {p2}, Ljc/e;->r()V
    ...
    invoke-virtual {p2, p3}, Ljc/e;->m(I)V

    if-ne p1, v2, :cond_4

    .line 31
    iget-object p1, p0, Lcom/skt/tmap/mvp/presenter/f;->c:Llc/e;

    iget-object p2, p0, Lcom/skt/tmap/mvp/presenter/f;->d:Ljc/e;

    invoke-virtual {p2}, Ljc/e;->h()I

    move-result p2

    invoke-interface {p1, p2}, Llc/e;->h0(I)V

    :cond_4
    return-void
.end method

.method public static synthetic r(Lcom/skt/tmap/engine/navigation/network/ndds/dto/ResponseDto;ILjava/lang/String;Ljava/lang/String;)V
    .locals 0
...
.method private synthetic s()V
    ...
    .line 1
    iget-object v0, p0, Lcom/skt/tmap/mvp/presenter/f;->d:Ljc/e;

    invoke-virtual {v0}, Ljc/e;->d()I

    move-result v0

    invoke-virtual {p0, v0}, Lcom/skt/tmap/mvp/presenter/f;->p(I)V
...
.method public b(ILjava/lang/String;)V
    ...
    .line 1
    iget-object v0, p0, Lcom/skt/tmap/mvp/presenter/f;->e:Lcom/skt/tmap/mvp/presenter/BasePresenter;

    new-instance v1, Lcom/skt/tmap/mvp/presenter/f$a;

    invoke-direct {v1, p0, p1, p2}, Lcom/skt/tmap/mvp/presenter/f$a;-><init>(Lcom/skt/tmap/mvp/presenter/f;ILjava/lang/String;)V
...
.method public c(Landroid/content/Intent;)V
    ...
    .line 1
    iget-object v0, p0, Lcom/skt/tmap/mvp/presenter/f;->b:Lcom/skt/tmap/activity/ClientCommListActivity;
...
.method public d()V
    ...
    invoke-direct {v1, p0}, Lcom/skt/tmap/mvp/presenter/e;-><init>(Lcom/skt/tmap/mvp/presenter/f;)V
...
.method public bridge synthetic e(Llc/f;)V
    ...
    invoke-virtual {p0, p1}, Lcom/skt/tmap/mvp/presenter/f;->o(Llc/e;)V
...
.method public f(ILjava/lang/String;)V
    ...
    const-string/jumbo v3, "tap.comm_button"

    invoke-virtual {v0, v3, v1, v2, p2}, Ldc/d;->l(Ljava/lang/String;JLjava/lang/String;)V
    ...
    invoke-virtual {p2, p1, v0}, Ljc/e;->c(ILandroid/app/Activity;)V
...
.method public final n(Lcom/skt/tmap/data/NotiDetailInfo;)V
    ...
    iget-object v1, p0, Lcom/skt/tmap/mvp/presenter/f;->b:Lcom/skt/tmap/activity/ClientCommListActivity;
    ...
    invoke-virtual {v0, v1}, Lyb/a;->c(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, p1}, Lyb/a;->a(Ljava/lang/String;)V

    :cond_0
    return-void
.end method

.method public o(Llc/e;)V
    .locals 0
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    .line 1
    iput-object p1, p0, Lcom/skt/tmap/mvp/presenter/f;->c:Llc/e;
...
.method public onCreate()V
    ...
    invoke-virtual {v0, v1}, Ljc/e;->u(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Ljc/e;->q(I)V
    ...
    invoke-virtual {v0, p0}, Lpb/s;->r(Lpb/s$b;)V
    ...
    invoke-virtual {v0, p0}, Lpb/s;->q(Lpb/s$e;)V
    ...
    invoke-virtual {v0, p0}, Lpb/s;->s(Lpb/s$c;)V

    .line 6
    iget-object v0, p0, Lcom/skt/tmap/mvp/presenter/f;->c:Llc/e;

    iget-object v1, p0, Lcom/skt/tmap/mvp/presenter/f;->d:Ljc/e;

    invoke-virtual {v1}, Ljc/e;->e()Lpb/s;

    move-result-object v1

    invoke-interface {v0, v1}, Llc/e;->q4(Lpb/s;)V
...
.method public onDestroy()V
    ...
    invoke-virtual {v0}, Ljc/e;->k()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Ljc/e;->l()Lcom/skt/tmap/data/NotiDetailInfo;
    ...
    .line 3
    invoke-virtual {p0, v0}, Lcom/skt/tmap/mvp/presenter/f;->n(Lcom/skt/tmap/data/NotiDetailInfo;)V

    .line 4
    :cond_0
    iget-object v0, p0, Lcom/skt/tmap/mvp/presenter/f;->d:Ljc/e;

    invoke-virtual {v0}, Ljc/e;->b()V
...
.method public final p(I)V
    ...
    invoke-interface {v0, v1, v1}, Llc/e;->X1(ZZ)Lqc/c;
    ...
    invoke-direct {v1, p0, p1}, Lcom/skt/tmap/mvp/presenter/c;-><init>(Lcom/skt/tmap/mvp/presenter/f;I)V

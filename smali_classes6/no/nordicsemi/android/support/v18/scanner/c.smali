...
.method public c(Ldm/h;)V
    ...
    invoke-virtual {v0}, Lno/nordicsemi/android/support/v18/scanner/ScanSettings;->r()Z
...
.method public h(Ljava/util/List;Lno/nordicsemi/android/support/v18/scanner/ScanSettings;Ldm/h;)V
    ...
    invoke-direct {v1, p0, p1, p2, p3}, Lno/nordicsemi/android/support/v18/scanner/a$b;-><init>(Lno/nordicsemi/android/support/v18/scanner/a;Ljava/util/List;Lno/nordicsemi/android/support/v18/scanner/ScanSettings;Ldm/h;)V
    ...
    invoke-direct {v2, p0, v3}, Lno/nordicsemi/android/support/v18/scanner/c$b;-><init>(Lno/nordicsemi/android/support/v18/scanner/c;Lno/nordicsemi/android/support/v18/scanner/c$a;)V

    .line 7
    iget-object v4, p0, Lno/nordicsemi/android/support/v18/scanner/c;->c:Landroid/bluetooth/BluetoothAdapter;

    invoke-virtual {p0, v4, p2}, Lno/nordicsemi/android/support/v18/scanner/c;->m(Landroid/bluetooth/BluetoothAdapter;Lno/nordicsemi/android/support/v18/scanner/ScanSettings;)Landroid/bluetooth/le/ScanSettings;
    ...
    .line 13
    invoke-virtual {v0, v3, v4, v2}, Landroid/bluetooth/le/BluetoothLeScanner;->startScan(Ljava/util/List;Landroid/bluetooth/le/ScanSettings;Landroid/bluetooth/le/ScanCallback;)V
...
.method public l(Lno/nordicsemi/android/support/v18/scanner/ScanFilter;)Landroid/bluetooth/le/ScanFilter;
    ...
    .line 3
    invoke-virtual {p1}, Lno/nordicsemi/android/support/v18/scanner/ScanFilter;->c()Ljava/lang/String;
    ...
    .line 4
    invoke-virtual {p1}, Lno/nordicsemi/android/support/v18/scanner/ScanFilter;->m()Landroid/os/ParcelUuid;

    move-result-object v2

    invoke-virtual {p1}, Lno/nordicsemi/android/support/v18/scanner/ScanFilter;->n()Landroid/os/ParcelUuid;
    ...
    .line 5
    invoke-virtual {p1}, Lno/nordicsemi/android/support/v18/scanner/ScanFilter;->h()I

    move-result v2

    invoke-virtual {p1}, Lno/nordicsemi/android/support/v18/scanner/ScanFilter;->e()[B
    ...
    .line 6
    invoke-virtual {p1}, Lno/nordicsemi/android/support/v18/scanner/ScanFilter;->l()Landroid/os/ParcelUuid;
    ...
    invoke-virtual {p1}, Lno/nordicsemi/android/support/v18/scanner/ScanFilter;->i()[B

    move-result-object v2

    invoke-virtual {p1}, Lno/nordicsemi/android/support/v18/scanner/ScanFilter;->j()[B
...
.method public o(Landroid/bluetooth/le/ScanResult;)Lno/nordicsemi/android/support/v18/scanner/ScanResult;
    ...
    invoke-direct/range {v1 .. v6}, Lno/nordicsemi/android/support/v18/scanner/ScanResult;-><init>(Landroid/bluetooth/BluetoothDevice;Ldm/i;IJ)V

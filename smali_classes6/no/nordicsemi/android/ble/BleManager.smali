...
.field public static final R0:Ljava/util/UUID;

.field public static final S0:Ljava/util/UUID;

.field public static final T0:Ljava/util/UUID;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lno/nordicsemi/android/ble/BleManager;->K0:Ljava/util/UUID;
    ...
    sput-object v0, Lno/nordicsemi/android/ble/BleManager;->R0:Ljava/util/UUID;
    ...
    sput-object v0, Lno/nordicsemi/android/ble/BleManager;->S0:Ljava/util/UUID;
    ...
    sput-object v0, Lno/nordicsemi/android/ble/BleManager;->T0:Ljava/util/UUID;
    ...
    sput-object v0, Lno/nordicsemi/android/ble/BleManager;->U0:Ljava/util/UUID;

    const-string v0, "action_dismiss"

    .line 6
    sput-object v0, Lno/nordicsemi/android/ble/BleManager;->V0:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lno/nordicsemi/android/ble/BleManager;->m:Landroid/content/BroadcastReceiver;
...
.method public static synthetic g()Ljava/util/UUID;
    ...
    sget-object v0, Lno/nordicsemi/android/ble/BleManager;->K0:Ljava/util/UUID;
...
.method public static synthetic w()Ljava/util/UUID;
    ...
    sget-object v0, Lno/nordicsemi/android/ble/BleManager;->U0:Ljava/util/UUID;
...
.method public static synthetic x()Ljava/util/UUID;
    ...
    sget-object v0, Lno/nordicsemi/android/ble/BleManager;->S0:Ljava/util/UUID;
...
.method public D()V
    ...
    iget-object v1, p0, Lno/nordicsemi/android/ble/BleManager;->m:Landroid/content/BroadcastReceiver;
...
.method public E(Landroid/bluetooth/BluetoothDevice;)V
    ...
    iget-object v2, p0, Lno/nordicsemi/android/ble/BleManager;->m:Landroid/content/BroadcastReceiver;
...
.method public L(Lno/nordicsemi/android/ble/BleManager$Request;)Z
    ...
    .line 4
    invoke-virtual {p1}, Lno/nordicsemi/android/ble/BleManager$b;->l()V
...
.method public final M()Z
    ...
    .line 4
    :cond_1
    sget-object v2, Lno/nordicsemi/android/ble/BleManager;->T0:Ljava/util/UUID;
    ...
    .line 5
    :cond_2
    sget-object v2, Lno/nordicsemi/android/ble/BleManager;->U0:Ljava/util/UUID;
...
.method public final X()Z
    ...
    .line 2
    :cond_0
    sget-object v2, Lno/nordicsemi/android/ble/BleManager;->R0:Ljava/util/UUID;
    ...
    .line 3
    :cond_1
    sget-object v2, Lno/nordicsemi/android/ble/BleManager;->S0:Ljava/util/UUID;
...
.method public final c0(Z)Z
    ...
    .line 3
    :cond_1
    sget-object v3, Lno/nordicsemi/android/ble/BleManager;->S0:Ljava/util/UUID;

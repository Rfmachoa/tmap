...
.method public constructor <init>()V
    ...
    invoke-direct {p0}, Lkotlin/io/path/m;-><init>()V

    return-void
.end method

.method public static final synthetic H(Lol/q;Ljava/nio/file/Path;Ljava/nio/file/Path;Lol/q;Ljava/nio/file/Path;Ljava/nio/file/attribute/BasicFileAttributes;)Ljava/nio/file/FileVisitResult;
    .locals 0

    invoke-static/range {p0 .. p5}, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt;->M(Lol/q;Ljava/nio/file/Path;Ljava/nio/file/Path;Lol/q;Ljava/nio/file/Path;Ljava/nio/file/attribute/BasicFileAttributes;)Ljava/nio/file/FileVisitResult;
...
.method public static final synthetic I(Lol/q;Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/lang/Exception;)Ljava/nio/file/FileVisitResult;
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt;->Q(Lol/q;Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/lang/Exception;)Ljava/nio/file/FileVisitResult;
...
.method public static final J(Lkotlin/io/path/d;Lol/a;)V
    .locals 0
    ...
    .line 2
    invoke-virtual {p0, p1}, Lkotlin/io/path/d;->a(Ljava/lang/Exception;)V

    :goto_0
    return-void
.end method

.method public static final K(Ljava/nio/file/Path;Ljava/nio/file/Path;Lol/q;ZLol/q;)Ljava/nio/file/Path;
    .locals 6
    ...
    invoke-virtual {v0, p3}, Lkotlin/io/path/h;->a(Z)[Ljava/nio/file/LinkOption;
    ...
    invoke-direct {v3, p4, p0, p1, p2}, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt$copyToRecursively$5;-><init>(Lol/q;Ljava/nio/file/Path;Ljava/nio/file/Path;Lol/q;)V
    ...
    invoke-static/range {v0 .. v5}, Lkotlin/io/path/n;->B1(Ljava/nio/file/Path;IZLol/l;ILjava/lang/Object;)V
...
.method public static final L(Ljava/nio/file/Path;Ljava/nio/file/Path;Lol/q;ZZ)Ljava/nio/file/Path;
    .locals 7
    .param p0    # Ljava/nio/file/Path;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-static {p0, p1, p2, p3, p4}, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt;->K(Ljava/nio/file/Path;Ljava/nio/file/Path;Lol/q;ZLol/q;)Ljava/nio/file/Path;
    ...
    .line 2
    invoke-static/range {v0 .. v6}, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt;->N(Ljava/nio/file/Path;Ljava/nio/file/Path;Lol/q;ZLol/q;ILjava/lang/Object;)Ljava/nio/file/Path;
...
.method public static final M(Lol/q;Ljava/nio/file/Path;Ljava/nio/file/Path;Lol/q;Ljava/nio/file/Path;Ljava/nio/file/attribute/BasicFileAttributes;)Ljava/nio/file/FileVisitResult;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p0, p5, p4, v0}, Lol/q;->invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 2
    invoke-static {p3, p1, p2, p4, p0}, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt;->Q(Lol/q;Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/lang/Exception;)Ljava/nio/file/FileVisitResult;
...
.method public static synthetic N(Ljava/nio/file/Path;Ljava/nio/file/Path;Lol/q;ZLol/q;ILjava/lang/Object;)Ljava/nio/file/Path;
    .locals 0
...
.method public static synthetic O(Ljava/nio/file/Path;Ljava/nio/file/Path;Lol/q;ZZILjava/lang/Object;)Ljava/nio/file/Path;
    .locals 0
    ...
    .line 2
    :cond_0
    invoke-static {p0, p1, p2, p3, p4}, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt;->L(Ljava/nio/file/Path;Ljava/nio/file/Path;Lol/q;ZZ)Ljava/nio/file/Path;
...
.method public static final P(Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/nio/file/Path;)Ljava/nio/file/Path;
    ...
    .line 1
    invoke-static {p2, p0}, Lkotlin/io/path/n;->p1(Ljava/nio/file/Path;Ljava/nio/file/Path;)Ljava/nio/file/Path;
...
.method public static final Q(Lol/q;Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/lang/Exception;)Ljava/nio/file/FileVisitResult;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p0, p3, p1, p4}, Lol/q;->invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static final S(Ljava/nio/file/Path;)Ljava/util/List;
    ...
    invoke-direct {v0, v1, v2, v3}, Lkotlin/io/path/d;-><init>(IILkotlin/jvm/internal/u;)V
    ...
    .line 5
    iput-object v4, v0, Lkotlin/io/path/d;->d:Ljava/nio/file/Path;
    ...
    invoke-static {v2, v4, v0}, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt;->U(Ljava/nio/file/SecureDirectoryStream;Ljava/nio/file/Path;Lkotlin/io/path/d;)V
    ...
    .line 9
    invoke-static {p0, v0}, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt;->W(Ljava/nio/file/Path;Lkotlin/io/path/d;)V

    .line 10
    :cond_2
    iget-object p0, v0, Lkotlin/io/path/d;->c:Ljava/util/List;

    return-object p0
.end method

.method public static final T(Ljava/nio/file/SecureDirectoryStream;Ljava/nio/file/Path;Lkotlin/io/path/d;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0, v0, p2}, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt;->U(Ljava/nio/file/SecureDirectoryStream;Ljava/nio/file/Path;Lkotlin/io/path/d;)V
...
.method public static final U(Ljava/nio/file/SecureDirectoryStream;Ljava/nio/file/Path;Lkotlin/io/path/d;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 3
    iget v0, p2, Lkotlin/io/path/d;->b:I

    .line 4
    invoke-static {p0, p1, p2}, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt;->T(Ljava/nio/file/SecureDirectoryStream;Ljava/nio/file/Path;Lkotlin/io/path/d;)V

    .line 5
    iget v1, p2, Lkotlin/io/path/d;->b:I
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static final V(Ljava/nio/file/Path;Lkotlin/io/path/d;)V
    .locals 4
    ...
    invoke-static {v2, p1}, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt;->W(Ljava/nio/file/Path;Lkotlin/io/path/d;)V
...
.method public static final W(Ljava/nio/file/Path;Lkotlin/io/path/d;)V
    .locals 4
    ...
    .line 3
    iget v0, p1, Lkotlin/io/path/d;->b:I

    .line 4
    invoke-static {p0, p1}, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt;->V(Ljava/nio/file/Path;Lkotlin/io/path/d;)V

    .line 5
    iget v1, p1, Lkotlin/io/path/d;->b:I
...
.method public static final a0(Lol/a;)Ljava/lang/Object;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<R:",

...
.field public final s1:Ljava/util/concurrent/Callable;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/concurrent/Callable<",
            "+",
...
# direct methods
.method public constructor <init>(Loj/g0;Ljava/util/concurrent/Callable;Ljava/util/concurrent/Callable;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/k$b;->u1:Ljava/util/concurrent/atomic/AtomicReference;

    .line 3
    iput-object p2, p0, Lio/reactivex/internal/operators/observable/k$b;->r1:Ljava/util/concurrent/Callable;

    .line 4
    iput-object p3, p0, Lio/reactivex/internal/operators/observable/k$b;->s1:Ljava/util/concurrent/Callable;
...
.method public dispose()V
    ...
    .line 3
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/k$b;->t1:Lio/reactivex/disposables/b;
...
.method public bridge synthetic f(Loj/g0;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lio/reactivex/internal/operators/observable/k$b;->j(Loj/g0;Ljava/util/Collection;)V
...
.method public k()V
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/k$b;->u1:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public l()V
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/k$b;->r1:Ljava/util/concurrent/Callable;
    ...
    .line 2
    :try_start_1
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/k$b;->s1:Ljava/util/concurrent/Callable;
    ...
    .line 4
    iget-object v3, p0, Lio/reactivex/internal/operators/observable/k$b;->u1:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 6
    :try_start_2
    iget-object v3, p0, Lio/reactivex/internal/operators/observable/k$b;->v1:Ljava/util/Collection;
    ...
    .line 8
    :cond_0
    iput-object v0, p0, Lio/reactivex/internal/operators/observable/k$b;->v1:Ljava/util/Collection;
    ...
    .line 11
    invoke-virtual {p0, v3, v0, p0}, Lwj/k;->h(Ljava/lang/Object;ZLio/reactivex/disposables/b;)V
    ...
    .line 15
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/k$b;->t1:Lio/reactivex/disposables/b;
...
.method public onComplete()V
    ...
    .line 2
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/k$b;->v1:Ljava/util/Collection;
    ...
    .line 4
    iput-object v1, p0, Lio/reactivex/internal/operators/observable/k$b;->v1:Ljava/util/Collection;
...
.method public onSubscribe(Lio/reactivex/disposables/b;)V
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/k$b;->t1:Lio/reactivex/disposables/b;
    ...
    .line 4
    :try_start_0
    iget-object v2, p0, Lio/reactivex/internal/operators/observable/k$b;->r1:Ljava/util/concurrent/Callable;
    ...
    .line 5
    iput-object v2, p0, Lio/reactivex/internal/operators/observable/k$b;->v1:Ljava/util/Collection;

    .line 6
    :try_start_1
    iget-object v2, p0, Lio/reactivex/internal/operators/observable/k$b;->s1:Ljava/util/concurrent/Callable;
    ...
    .line 8
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/k$b;->u1:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 11
    invoke-interface {v2, p1}, Loj/e0;->subscribe(Loj/g0;)V
    ...
    .line 15
    invoke-static {v2, v0}, Lio/reactivex/internal/disposables/EmptyDisposable;->error(Ljava/lang/Throwable;Loj/g0;)V

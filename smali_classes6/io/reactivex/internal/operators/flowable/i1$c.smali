...
.field public final K1:Lio/reactivex/disposables/a;
...
# direct methods
.method public constructor <init>(Lum/d;Lum/c;Ltj/o;I)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/i1$c;->M1:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/i1$c;->O1:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    iput-object v0, p0, Lio/reactivex/internal/operators/flowable/i1$c;->P1:Ljava/util/concurrent/atomic/AtomicBoolean;

    .line 5
    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/i1$c;->H1:Lum/c;

    .line 6
    iput-object p3, p0, Lio/reactivex/internal/operators/flowable/i1$c;->I1:Ltj/o;

    .line 7
    iput p4, p0, Lio/reactivex/internal/operators/flowable/i1$c;->J1:I
    ...
    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/i1$c;->K1:Lio/reactivex/disposables/a;
    ...
    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/i1$c;->N1:Ljava/util/List;
...
.method public cancel()V
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/i1$c;->P1:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .line 2
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/i1$c;->M1:Ljava/util/concurrent/atomic/AtomicReference;

    invoke-static {v0}, Lio/reactivex/internal/disposables/DisposableHelper;->dispose(Ljava/util/concurrent/atomic/AtomicReference;)Z

    .line 3
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/i1$c;->O1:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    .line 4
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/i1$c;->L1:Lum/e;
...
.method public dispose()V
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/i1$c;->K1:Lio/reactivex/disposables/a;
...
.method public f(Lum/d;Ljava/lang/Object;)Z
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public m()V
    ...
    .line 3
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/i1$c;->N1:Ljava/util/List;
    ...
    .line 19
    iget-object v5, p0, Lio/reactivex/internal/operators/flowable/i1$c;->O1:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    .line 21
    :cond_6
    iget-object v5, p0, Lio/reactivex/internal/operators/flowable/i1$c;->P1:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .line 22
    :cond_7
    iget v5, p0, Lio/reactivex/internal/operators/flowable/i1$c;->J1:I
    ...
    .line 26
    invoke-virtual {p0, v7, v8}, Lxj/h;->g(J)J

    .line 27
    :cond_8
    :try_start_0
    iget-object v7, p0, Lio/reactivex/internal/operators/flowable/i1$c;->I1:Ltj/o;
    ...
    .line 29
    iget-object v5, p0, Lio/reactivex/internal/operators/flowable/i1$c;->K1:Lio/reactivex/disposables/a;
    ...
    .line 31
    invoke-interface {v6, v7}, Lum/c;->subscribe(Lum/d;)V
...
.method public onNext(Ljava/lang/Object;)V
    ...
    .line 3
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/i1$c;->N1:Ljava/util/List;
...
.method public onSubscribe(Lum/e;)V
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/i1$c;->L1:Lum/e;
    ...
    .line 6
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/i1$c;->M1:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 8
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/i1$c;->H1:Lum/c;

...
.field public final K1:Loj/h0$c;
...
# direct methods
.method public constructor <init>(Lum/d;JJLjava/util/concurrent/TimeUnit;Loj/h0$c;I)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-wide p2, p0, Lio/reactivex/internal/operators/flowable/j1$c;->H1:J

    .line 3
    iput-wide p4, p0, Lio/reactivex/internal/operators/flowable/j1$c;->I1:J

    .line 4
    iput-object p6, p0, Lio/reactivex/internal/operators/flowable/j1$c;->J1:Ljava/util/concurrent/TimeUnit;

    .line 5
    iput-object p7, p0, Lio/reactivex/internal/operators/flowable/j1$c;->K1:Loj/h0$c;

    .line 6
    iput p8, p0, Lio/reactivex/internal/operators/flowable/j1$c;->L1:I
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/j1$c;->M1:Ljava/util/List;
...
.method public dispose()V
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/j1$c;->K1:Loj/h0$c;
...
.method public m()V
    ...
    .line 3
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/j1$c;->M1:Ljava/util/List;
    ...
    :cond_0
    :goto_0
    iget-boolean v5, p0, Lio/reactivex/internal/operators/flowable/j1$c;->O1:Z

    if-eqz v5, :cond_1

    .line 5
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/j1$c;->N1:Lum/e;
    ...
    .line 20
    invoke-virtual {p0, v4}, Lxj/h;->b(I)I
    ...
    .line 25
    iget v7, p0, Lio/reactivex/internal/operators/flowable/j1$c;->L1:I
    ...
    .line 27
    invoke-interface {v1, v7}, Lum/d;->onNext(Ljava/lang/Object;)V
    ...
    .line 28
    invoke-virtual {p0, v5, v6}, Lxj/h;->g(J)J

    .line 29
    :cond_9
    iget-object v5, p0, Lio/reactivex/internal/operators/flowable/j1$c;->K1:Loj/h0$c;
    ...
    iget-wide v7, p0, Lio/reactivex/internal/operators/flowable/j1$c;->H1:J

    iget-object v9, p0, Lio/reactivex/internal/operators/flowable/j1$c;->J1:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v5, v6, v7, v8, v9}, Loj/h0$c;->c(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/reactivex/disposables/b;
    ...
    .line 34
    iput-boolean v3, p0, Lio/reactivex/internal/operators/flowable/j1$c;->O1:Z
...
.method public onNext(Ljava/lang/Object;)V
    ...
    .line 2
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/j1$c;->M1:Ljava/util/List;
...
.method public onSubscribe(Lum/e;)V
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/j1$c;->N1:Lum/e;
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/j1$c;->N1:Lum/e;
    ...
    .line 6
    iget v2, p0, Lio/reactivex/internal/operators/flowable/j1$c;->L1:I
    ...
    .line 7
    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/j1$c;->M1:Ljava/util/List;

    invoke-interface {v3, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 8
    iget-object v3, p0, Lxj/h;->C1:Lum/d;

    invoke-interface {v3, v2}, Lum/d;->onNext(Ljava/lang/Object;)V
    ...
    iget-wide v5, p0, Lio/reactivex/internal/operators/flowable/j1$c;->H1:J

    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/j1$c;->J1:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v0, v1, v5, v6, v2}, Loj/h0$c;->c(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/reactivex/disposables/b;

    .line 11
    iget-object v7, p0, Lio/reactivex/internal/operators/flowable/j1$c;->K1:Loj/h0$c;

    iget-wide v11, p0, Lio/reactivex/internal/operators/flowable/j1$c;->I1:J

    iget-object v13, p0, Lio/reactivex/internal/operators/flowable/j1$c;->J1:Ljava/util/concurrent/TimeUnit;

    move-object v8, p0

    move-wide v9, v11

    invoke-virtual/range {v7 .. v13}, Loj/h0$c;->d(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lio/reactivex/disposables/b;
...
.method public run()V
    ...
    .line 1
    iget v0, p0, Lio/reactivex/internal/operators/flowable/j1$c;->L1:I

...
.field public final I1:Ljava/util/concurrent/Callable;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/concurrent/Callable<",
            "+",
...
# direct methods
.method public constructor <init>(Lum/d;Ljava/util/concurrent/Callable;Ljava/util/concurrent/Callable;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/i$b;->K1:Ljava/util/concurrent/atomic/AtomicReference;

    .line 3
    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/i$b;->H1:Ljava/util/concurrent/Callable;

    .line 4
    iput-object p3, p0, Lio/reactivex/internal/operators/flowable/i$b;->I1:Ljava/util/concurrent/Callable;
...
.method public cancel()V
    ...
    .line 3
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/i$b;->J1:Lum/e;
...
.method public bridge synthetic f(Lum/d;Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, p1, p2}, Lio/reactivex/internal/operators/flowable/i$b;->l(Lum/d;Ljava/util/Collection;)Z
...
.method public isDisposed()Z
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/i$b;->K1:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public n()V
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/i$b;->H1:Ljava/util/concurrent/Callable;
    ...
    .line 2
    :try_start_1
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/i$b;->I1:Ljava/util/concurrent/Callable;
    ...
    .line 4
    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/i$b;->K1:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 6
    :try_start_2
    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/i$b;->L1:Ljava/util/Collection;
    ...
    .line 8
    :cond_0
    iput-object v0, p0, Lio/reactivex/internal/operators/flowable/i$b;->L1:Ljava/util/Collection;
    ...
    .line 11
    invoke-virtual {p0, v3, v0, p0}, Lxj/h;->i(Ljava/lang/Object;ZLio/reactivex/disposables/b;)V
    ...
    .line 15
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/i$b;->J1:Lum/e;
...
.method public onComplete()V
    ...
    .line 2
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/i$b;->L1:Ljava/util/Collection;
    ...
    .line 4
    iput-object v1, p0, Lio/reactivex/internal/operators/flowable/i$b;->L1:Ljava/util/Collection;
...
.method public onSubscribe(Lum/e;)V
    ...
    .line 2
    :cond_0
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/i$b;->J1:Lum/e;
    ...
    .line 4
    :try_start_0
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/i$b;->H1:Ljava/util/concurrent/Callable;
    ...
    .line 5
    iput-object v2, p0, Lio/reactivex/internal/operators/flowable/i$b;->L1:Ljava/util/Collection;

    .line 6
    :try_start_1
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/i$b;->I1:Ljava/util/concurrent/Callable;
    ...
    .line 12
    invoke-interface {v2, v1}, Lum/c;->subscribe(Lum/d;)V
    ...
    .line 16
    invoke-static {v2, v0}, Lio/reactivex/internal/subscriptions/EmptySubscription;->error(Ljava/lang/Throwable;Lum/d;)V

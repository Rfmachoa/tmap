...
# direct methods
.method public constructor <init>(Lum/d;Ltj/o;I)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->downstream:Lum/d;

    .line 3
    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->mapper:Ltj/o;
...
.method public cancel()V
    ...
    .line 3
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->upstream:Lum/e;
    ...
    .line 5
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->queue:Lvj/o;
...
.method public checkTerminated(ZZLum/d;Lvj/o;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZ",
    ...
    .line 3
    invoke-interface {p4}, Lvj/o;->clear()V
...
.method public drain()V
    ...
    .line 2
    :cond_0
    iget-object v2, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->downstream:Lum/d;

    .line 3
    iget-object v3, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->queue:Lvj/o;
    ...
    .line 7
    :try_start_0
    invoke-interface {v3}, Lvj/o;->poll()Ljava/lang/Object;
    ...
    .line 8
    :goto_2
    invoke-virtual {v1, v9, v11, v2, v3}, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->checkTerminated(ZZLum/d;Lvj/o;)Z
    ...
    .line 9
    :try_start_1
    iget-object v6, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->mapper:Ltj/o;

    invoke-interface {v6, v10}, Ltj/o;->apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 15
    iget-object v3, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->upstream:Lum/e;

    invoke-interface {v3}, Lum/e;->cancel()V
    ...
    .line 20
    iget-object v0, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->upstream:Lum/e;
    ...
    .line 24
    invoke-interface {v3}, Lvj/o;->clear()V
    ...
    invoke-virtual {v1, v15, v4, v2, v3}, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->checkTerminated(ZZLum/d;Lvj/o;)Z
    ...
    invoke-static {v15, v5}, Lio/reactivex/internal/functions/a;->g(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 29
    invoke-interface {v2, v5}, Lum/d;->onNext(Ljava/lang/Object;)V

    .line 30
    iget-boolean v5, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->done:Z

    invoke-virtual {v1, v5, v4, v2, v3}, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->checkTerminated(ZZLum/d;Lvj/o;)Z
    ...
    .line 47
    invoke-interface {v3}, Lvj/o;->isEmpty()Z
    ...
    .line 48
    :goto_6
    invoke-virtual {v1, v5, v15, v2, v3}, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->checkTerminated(ZZLum/d;Lvj/o;)Z
...
.method public onSubscribe(Lum/e;)V
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->upstream:Lum/e;
    ...
    .line 7
    iput-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->queue:Lvj/o;

    .line 8
    iput-boolean v2, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->done:Z

    .line 9
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->downstream:Lum/d;
    ...
    .line 12
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->downstream:Lum/d;
...
.method public poll()Ljava/lang/Object;
    ...
    .line 3
    :cond_0
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->mapper:Ltj/o;

    invoke-interface {v2, v0}, Ltj/o;->apply(Ljava/lang/Object;)Ljava/lang/Object;

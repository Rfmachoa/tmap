...
# direct methods
.method public constructor <init>(Loj/j;JJLjava/util/concurrent/TimeUnit;Loj/h0;Ljava/util/concurrent/Callable;IZ)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 5
    iput-object p7, p0, Lio/reactivex/internal/operators/flowable/k;->f:Loj/h0;
...
.method public g6(Lum/d;)V
    ...
    iget-object v7, p0, Lio/reactivex/internal/operators/flowable/k;->f:Loj/h0;

    move-object v1, v8

    invoke-direct/range {v1 .. v7}, Lio/reactivex/internal/operators/flowable/k$b;-><init>(Lum/d;Ljava/util/concurrent/Callable;JLjava/util/concurrent/TimeUnit;Loj/h0;)V
    ...
    .line 3
    :cond_0
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/k;->f:Loj/h0;
    ...
    invoke-direct/range {v1 .. v9}, Lio/reactivex/internal/operators/flowable/k$a;-><init>(Lum/d;Ljava/util/concurrent/Callable;JLjava/util/concurrent/TimeUnit;IZLoj/h0$c;)V

    invoke-virtual {v0, v10}, Loj/j;->f6(Loj/o;)V
    ...
    invoke-direct/range {v1 .. v9}, Lio/reactivex/internal/operators/flowable/k$c;-><init>(Lum/d;Ljava/util/concurrent/Callable;JJLjava/util/concurrent/TimeUnit;Loj/h0$c;)V

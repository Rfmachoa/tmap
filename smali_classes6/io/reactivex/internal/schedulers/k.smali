...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lio/reactivex/internal/schedulers/k;->g:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    sput-object v2, Lio/reactivex/internal/schedulers/k;->f:Lio/reactivex/internal/schedulers/RxThreadFactory;
...
.method public constructor <init>()V
    ...
    .line 1
    sget-object v0, Lio/reactivex/internal/schedulers/k;->f:Lio/reactivex/internal/schedulers/RxThreadFactory;
...
.method public constructor <init>(Ljava/util/concurrent/ThreadFactory;)V
    ...
    .line 5
    invoke-static {p1}, Lio/reactivex/internal/schedulers/k;->k(Ljava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ScheduledExecutorService;
...
.method public static k(Ljava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ScheduledExecutorService;
    .locals 0
...
.method public c()Loj/h0$c;
    ...
    iget-object v1, p0, Lio/reactivex/internal/schedulers/k;->c:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {v0, v1}, Lio/reactivex/internal/schedulers/k$a;-><init>(Ljava/util/concurrent/ScheduledExecutorService;)V
...
.method public f(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/reactivex/disposables/b;
    ...
    invoke-static {p1}, Lak/a;->b0(Ljava/lang/Runnable;)Ljava/lang/Runnable;
    ...
    .line 2
    :try_start_0
    iget-object p1, p0, Lio/reactivex/internal/schedulers/k;->c:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public g(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lio/reactivex/disposables/b;
    ...
    .line 2
    iget-object p4, p0, Lio/reactivex/internal/schedulers/k;->c:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 6
    :goto_0
    invoke-virtual {p5, p1}, Lio/reactivex/internal/schedulers/d;->b(Ljava/util/concurrent/Future;)V
    :try_end_0
    .catch Ljava/util/concurrent/RejectedExecutionException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public h()V
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/schedulers/k;->c:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 2
    sget-object v1, Lio/reactivex/internal/schedulers/k;->g:Ljava/util/concurrent/ScheduledExecutorService;
...
.method public i()V
    ...
    .line 2
    sget-object v2, Lio/reactivex/internal/schedulers/k;->g:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    .line 4
    iget-object v0, p0, Lio/reactivex/internal/schedulers/k;->b:Ljava/util/concurrent/ThreadFactory;

    invoke-static {v0}, Lio/reactivex/internal/schedulers/k;->k(Ljava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ScheduledExecutorService;

    move-result-object v0

    .line 5
    :cond_3
    iget-object v2, p0, Lio/reactivex/internal/schedulers/k;->c:Ljava/util/concurrent/atomic/AtomicReference;

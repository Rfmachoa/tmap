...
.method public static cancel(Ljava/util/concurrent/atomic/AtomicReference;)Z
    ...
    .line 4
    invoke-interface {p0}, Lum/e;->cancel()V
...
.method public static deferredRequest(Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicLong;J)V
    ...
    .line 2
    invoke-interface {v0, p2, p3}, Lum/e;->request(J)V
...
.method public static deferredSetOnce(Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicLong;Lum/e;)Z
    .locals 2
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    .line 1
    invoke-static {p0, p2}, Lio/reactivex/rxjava3/internal/subscriptions/SubscriptionHelper;->setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lum/e;)Z
    ...
    .line 3
    invoke-interface {p2, p0, p1}, Lum/e;->request(J)V
...
.method public static replace(Ljava/util/concurrent/atomic/AtomicReference;Lum/e;)Z
    .locals 2
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
...
.method public static reportMoreProduced(J)V
    ...
    invoke-static {v1, p0, p1}, Lb0/p0;->a(Ljava/lang/String;J)Ljava/lang/String;
...
.method public static set(Ljava/util/concurrent/atomic/AtomicReference;Lum/e;)Z
    .locals 2
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
...
.method public static setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lum/e;)Z
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
...
.method public static setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lum/e;J)Z
    .locals 0
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    .line 7
    invoke-interface {p1, p2, p3}, Lum/e;->request(J)V
...
.method public static validate(Lum/e;Lum/e;)Z
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-static {p0}, Lnk/a;->Y(Ljava/lang/Throwable;)V

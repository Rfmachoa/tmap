...
.field public final downstream:Lik/c;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lik/c<",
            "-TT;>;"
...
# direct methods
.method public constructor <init>(Lik/c;Lek/o0$c;ZI)V
    .locals 0
    ...
    .line 1
    invoke-direct {p0, p2, p3, p4}, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;-><init>(Lek/o0$c;ZI)V

    .line 2
    iput-object p1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->downstream:Lik/c;
...
.method public onSubscribe(Lum/e;)V
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Lum/e;
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Lum/e;
    ...
    .line 7
    iput-object v0, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->queue:Lik/q;

    .line 8
    iput-boolean v2, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->done:Z

    .line 9
    iget-object p1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->downstream:Lik/c;

    invoke-interface {p1, p0}, Lek/r;->onSubscribe(Lum/e;)V
    ...
    .line 12
    iget-object v0, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->downstream:Lik/c;

    invoke-interface {v0, p0}, Lek/r;->onSubscribe(Lum/e;)V
...
.method public poll()Ljava/lang/Object;
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->queue:Lik/q;
    ...
    .line 6
    iget-object v3, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Lum/e;

    invoke-interface {v3, v1, v2}, Lum/e;->request(J)V
...
.method public runAsync()V
    ...
    .line 2
    iget-object v1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->queue:Lik/q;
    ...
    .line 8
    :goto_1
    invoke-virtual {p0, v11, v13, v0}, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->checkTerminated(ZZLum/d;)Z
    ...
    .line 9
    :cond_4
    invoke-interface {v0, v12}, Lik/c;->tryOnNext(Ljava/lang/Object;)Z
    ...
    .line 11
    iget-object v10, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Lum/e;

    invoke-interface {v10, v4, v5}, Lum/e;->request(J)V
    ...
    .line 16
    invoke-interface {v0, v2}, Lum/d;->onError(Ljava/lang/Throwable;)V

    .line 17
    iget-object v0, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->worker:Lek/o0$c;
    ...
    invoke-virtual {p0, v8, v9, v0}, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->checkTerminated(ZZLum/d;)Z
...
.method public runBackfused()V
    ...
    .line 3
    iget-object v3, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->downstream:Lik/c;

    const/4 v4, 0x0

    invoke-interface {v3, v4}, Lum/d;->onNext(Ljava/lang/Object;)V
    ...
    .line 6
    iget-object v1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->downstream:Lik/c;
...
.method public runSync()V
    ...
    .line 10
    :cond_3
    invoke-interface {v0, v8}, Lik/c;->tryOnNext(Ljava/lang/Object;)Z
    ...
    .line 13
    iget-object v2, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Lum/e;

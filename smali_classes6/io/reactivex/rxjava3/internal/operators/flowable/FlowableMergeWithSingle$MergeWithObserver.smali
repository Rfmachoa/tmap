...
.method public constructor <init>(Lum/d;)V
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->downstream:Lum/d;
...
.method public cancel()V
    ...
    .line 6
    iput-object v0, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->queue:Lik/p;
...
.method public drainLoop()V
    ...
    .line 1
    iget-object v1, v0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->downstream:Lum/d;
    ...
    .line 8
    iput-object v13, v0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->queue:Lik/p;
    ...
    iget-object v2, v0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->downstream:Lum/d;

    invoke-virtual {v1, v2}, Lio/reactivex/rxjava3/internal/util/AtomicThrowable;->tryTerminateConsumer(Lum/d;)V
    ...
    .line 17
    invoke-interface {v1, v10}, Lum/d;->onNext(Ljava/lang/Object;)V
    ...
    .line 19
    iget-object v11, v0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->queue:Lik/p;

    if-eqz v11, :cond_3

    .line 20
    invoke-interface {v11}, Lik/p;->poll()Ljava/lang/Object;
    ...
    .line 23
    :cond_6
    invoke-interface {v1, v11}, Lum/d;->onNext(Ljava/lang/Object;)V
    ...
    invoke-interface {v4, v10, v11}, Lum/e;->request(J)V
    ...
    .line 33
    iget-object v8, v0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->queue:Lik/p;

    if-eqz v8, :cond_c

    .line 34
    invoke-interface {v8}, Lik/q;->isEmpty()Z
...
.method public getOrCreateQueue()Lik/p;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->queue:Lik/p;
...
.method public onNext(Ljava/lang/Object;)V
    ...
    .line 4
    iget-object v4, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->queue:Lik/p;

    if-eqz v4, :cond_1

    .line 5
    invoke-interface {v4}, Lik/q;->isEmpty()Z
    ...
    .line 6
    :cond_0
    invoke-interface {v4, p1}, Lik/q;->offer(Ljava/lang/Object;)Z
    ...
    .line 8
    iget-object v2, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->downstream:Lum/d;

    invoke-interface {v2, p1}, Lum/d;->onNext(Ljava/lang/Object;)V
    ...
    .line 14
    :cond_3
    invoke-virtual {p0}, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->getOrCreateQueue()Lik/p;
...
.method public onSubscribe(Lum/e;)V
    ...
    invoke-static {v0, p1, v1, v2}, Lio/reactivex/rxjava3/internal/subscriptions/SubscriptionHelper;->setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lum/e;J)Z
...
.method public otherSuccess(Ljava/lang/Object;)V
    ...
    .line 5
    iget-object v0, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->downstream:Lum/d;

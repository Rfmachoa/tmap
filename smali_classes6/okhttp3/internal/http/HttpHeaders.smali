...
.method public static final parseChallenges(Lokhttp3/Headers;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {p1, v4, v5}, Lkotlin/text/u;->L1(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-virtual {v4, v2}, Lokio/j;->G2(Ljava/lang/String;)Lokio/j;

    move-result-object v2

    .line 5
    :try_start_0
    invoke-static {v2, v0}, Lokhttp3/internal/http/HttpHeaders;->readChallengeHeader(Lokio/j;Ljava/util/List;)V
    :try_end_0
...
.method public static final promisesBody(Lokhttp3/Response;)Z
    ...
    invoke-static {v0, p0, v3}, Lkotlin/text/u;->L1(Ljava/lang/String;Ljava/lang/String;Z)Z
...
.method private static final readChallengeHeader(Lokio/j;Ljava/util/List;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-static {p0}, Lokhttp3/internal/http/HttpHeaders;->skipCommasAndWhitespace(Lokio/j;)Z

    .line 2
    invoke-static {p0}, Lokhttp3/internal/http/HttpHeaders;->readToken(Lokio/j;)Ljava/lang/String;
    ...
    .line 7
    invoke-static {p0, v4}, Lokhttp3/internal/Util;->skipAll(Lokio/j;B)I
    ...
    .line 11
    invoke-static {v4, v5}, Lkotlin/text/u;->h2(Ljava/lang/CharSequence;I)Ljava/lang/String;

    move-result-object v4

    invoke-static {v3, v4}, Lkotlin/jvm/internal/f0;->C(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
    ...
    .line 20
    invoke-static {p0, v5}, Lokhttp3/internal/http/HttpHeaders;->startsWith(Lokio/j;B)Z

    move-result v5

    if-eqz v5, :cond_a

    invoke-static {p0}, Lokhttp3/internal/http/HttpHeaders;->readQuotedString(Lokio/j;)Ljava/lang/String;
...
.method private static final readQuotedString(Lokio/j;)Ljava/lang/String;
    .locals 12
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/EOFException;
    ...
    invoke-virtual {p0, v2}, Lokio/j;->J(Lokio/ByteString;)J
    ...
    .line 5
    invoke-virtual {v0, p0, v2, v3}, Lokio/j;->write(Lokio/j;J)V
    ...
    .line 11
    invoke-virtual {v0, p0, v8, v9}, Lokio/j;->write(Lokio/j;J)V
...
.method private static final readToken(Lokio/j;)Ljava/lang/String;
    .locals 4

    .line 1
    sget-object v0, Lokhttp3/internal/http/HttpHeaders;->TOKEN_DELIMITERS:Lokio/ByteString;

    invoke-virtual {p0, v0}, Lokio/j;->J(Lokio/ByteString;)J
...
.method private static final skipCommasAndWhitespace(Lokio/j;)Z
    .locals 5
...
.method private static final startsWith(Lokio/j;B)Z
    .locals 2

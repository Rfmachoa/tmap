...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "sink",
        "<init>",
        "(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lem/o;Lem/n;)V",
        "Companion",
        "AbstractSource",
        "ChunkedSink",
        "ChunkedSource",
...
.field private final sink:Lem/n;
...
.method public constructor <init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lem/o;Lem/n;)V
    .locals 1
    ...
    iput-object p3, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->source:Lem/o;

    iput-object p4, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lem/n;

    .line 2
    new-instance p1, Lokhttp3/internal/http1/HeadersReader;

    invoke-direct {p1, p3}, Lokhttp3/internal/http1/HeadersReader;-><init>(Lem/o;)V
...
.method public static final synthetic access$detachTimeout(Lokhttp3/internal/http1/Http1ExchangeCodec;Lem/s;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->detachTimeout(Lem/s;)V
...
.method public static final synthetic access$getSink$p(Lokhttp3/internal/http1/Http1ExchangeCodec;)Lem/n;
    .locals 0

    .line 1
    iget-object p0, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lem/n;

    return-object p0
.end method

.method public static final synthetic access$getSource$p(Lokhttp3/internal/http1/Http1ExchangeCodec;)Lem/o;
    .locals 0

    .line 1
    iget-object p0, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->source:Lem/o;
...
.method private final detachTimeout(Lem/s;)V
    .locals 2

    .line 1
    invoke-virtual {p1}, Lem/s;->a()Lem/o0;

    move-result-object v0

    .line 2
    sget-object v1, Lem/o0;->NONE:Lem/o0;

    invoke-virtual {p1, v1}, Lem/s;->b(Lem/o0;)Lem/s;

    .line 3
    invoke-virtual {v0}, Lem/o0;->clearDeadline()Lem/o0;

    .line 4
    invoke-virtual {v0}, Lem/o0;->clearTimeout()Lem/o0;
...
.method private final newChunkedSink()Lem/k0;
    .locals 2
...
.method private final newChunkedSource(Lokhttp3/HttpUrl;)Lem/m0;
    .locals 2
...
.method private final newFixedLengthSource(J)Lem/m0;
    .locals 2
...
.method private final newKnownLengthSink()Lem/k0;
    .locals 2
...
.method private final newUnknownLengthSource()Lem/m0;
    .locals 2
...
.method public createRequestBody(Lokhttp3/Request;J)Lem/k0;
    .locals 2
    ...
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newChunkedSink()Lem/k0;
    ...
    .line 3
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newKnownLengthSink()Lem/k0;
...
.method public finishRequest()V
    ...
    .line 1
    iget-object v0, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lem/n;
...
.method public openResponseBodySource(Lokhttp3/Response;)Lem/m0;
    .locals 4
    ...
    invoke-direct {p0, v0, v1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newFixedLengthSource(J)Lem/m0;
    ...
    invoke-direct {p0, p1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newChunkedSource(Lokhttp3/HttpUrl;)Lem/m0;
    ...
    .line 5
    :cond_2
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newUnknownLengthSource()Lem/m0;
...
.method public final skipConnectBody(Lokhttp3/Response;)V
    ...
    invoke-static {p1, v0, v1}, Lokhttp3/internal/Util;->skipAll(Lem/m0;ILjava/util/concurrent/TimeUnit;)Z

    .line 4
    invoke-interface {p1}, Lem/m0;->close()V
...
.method public final writeRequest(Lokhttp3/Headers;Ljava/lang/String;)V
    ...
    invoke-interface {v0, p2}, Lem/n;->X(Ljava/lang/String;)Lem/n;

    move-result-object p2

    const-string v0, "\r\n"

    invoke-interface {p2, v0}, Lem/n;->X(Ljava/lang/String;)Lem/n;
    ...
    .line 4
    iget-object v3, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lem/n;

    invoke-virtual {p1, v1}, Lokhttp3/Headers;->name(I)Ljava/lang/String;

    move-result-object v4

    invoke-interface {v3, v4}, Lem/n;->X(Ljava/lang/String;)Lem/n;
    ...
    .line 7
    invoke-interface {v3, v0}, Lem/n;->X(Ljava/lang/String;)Lem/n;
    ...
    .line 8
    :cond_1
    iget-object p1, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lem/n;

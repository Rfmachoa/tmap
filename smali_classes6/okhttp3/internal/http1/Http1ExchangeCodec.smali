...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "()Z",
        "<init>",
        "(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lokio/l;Lokio/k;)V",
        "Companion",
        "AbstractSource",
        "ChunkedSink",
        "ChunkedSource",
...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/internal/http1/Http1ExchangeCodec$Companion;-><init>(Lkotlin/jvm/internal/u;)V
...
.method public constructor <init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lokio/l;Lokio/k;)V
    .locals 1
    ...
    .line 4
    iput-object p3, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->source:Lokio/l;

    .line 5
    iput-object p4, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lokio/k;

    .line 6
    new-instance p1, Lokhttp3/internal/http1/HeadersReader;

    invoke-direct {p1, p3}, Lokhttp3/internal/http1/HeadersReader;-><init>(Lokio/l;)V
...
.method public static final synthetic access$detachTimeout(Lokhttp3/internal/http1/Http1ExchangeCodec;Lokio/u;)V
    .locals 0

    invoke-direct {p0, p1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->detachTimeout(Lokio/u;)V
...
.method public static final synthetic access$getSink$p(Lokhttp3/internal/http1/Http1ExchangeCodec;)Lokio/k;
    .locals 0

    iget-object p0, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lokio/k;

    return-object p0
.end method

.method public static final synthetic access$getSource$p(Lokhttp3/internal/http1/Http1ExchangeCodec;)Lokio/l;
    .locals 0

    iget-object p0, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->source:Lokio/l;
...
.method private final detachTimeout(Lokio/u;)V
    .locals 2

    .line 1
    invoke-virtual {p1}, Lokio/u;->a()Lokio/u0;

    move-result-object v0

    .line 2
    sget-object v1, Lokio/u0;->NONE:Lokio/u0;

    invoke-virtual {p1, v1}, Lokio/u;->b(Lokio/u0;)Lokio/u;

    .line 3
    invoke-virtual {v0}, Lokio/u0;->clearDeadline()Lokio/u0;

    .line 4
    invoke-virtual {v0}, Lokio/u0;->clearTimeout()Lokio/u0;
...
.method private final isChunked(Lokhttp3/Request;)Z
    ...
    invoke-static {v0, p1, v1}, Lkotlin/text/u;->L1(Ljava/lang/String;Ljava/lang/String;Z)Z
...
.method private final newChunkedSink()Lokio/q0;
    .locals 2
...
.method private final newChunkedSource(Lokhttp3/HttpUrl;)Lokio/s0;
    .locals 2
...
.method private final newFixedLengthSource(J)Lokio/s0;
    .locals 2
...
.method private final newKnownLengthSink()Lokio/q0;
    .locals 2
...
.method private final newUnknownLengthSource()Lokio/s0;
    .locals 2
...
.method public createRequestBody(Lokhttp3/Request;J)Lokio/q0;
    .locals 2
    ...
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newChunkedSink()Lokio/q0;
    ...
    .line 3
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newKnownLengthSink()Lokio/q0;
...
.method public finishRequest()V
    ...
    iget-object v0, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lokio/k;
...
.method public openResponseBodySource(Lokhttp3/Response;)Lokio/s0;
    .locals 4
    ...
    invoke-direct {p0, v0, v1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newFixedLengthSource(J)Lokio/s0;
    ...
    invoke-direct {p0, p1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newChunkedSource(Lokhttp3/HttpUrl;)Lokio/s0;
    ...
    .line 5
    :cond_2
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newUnknownLengthSource()Lokio/s0;
...
.method public final skipConnectBody(Lokhttp3/Response;)V
    ...
    invoke-static {p1, v0, v1}, Lokhttp3/internal/Util;->skipAll(Lokio/s0;ILjava/util/concurrent/TimeUnit;)Z
...
.method public final writeRequest(Lokhttp3/Headers;Ljava/lang/String;)V
    ...
    invoke-interface {v0, p2}, Lokio/k;->a0(Ljava/lang/String;)Lokio/k;

    move-result-object p2

    const-string v0, "\r\n"

    invoke-interface {p2, v0}, Lokio/k;->a0(Ljava/lang/String;)Lokio/k;
    ...
    .line 4
    iget-object v4, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lokio/k;

    invoke-virtual {p1, v1}, Lokhttp3/Headers;->name(I)Ljava/lang/String;

    move-result-object v5

    invoke-interface {v4, v5}, Lokio/k;->a0(Ljava/lang/String;)Lokio/k;
    ...
    invoke-interface {v4, v1}, Lokio/k;->a0(Ljava/lang/String;)Lokio/k;

    move-result-object v1

    .line 7
    invoke-interface {v1, v0}, Lokio/k;->a0(Ljava/lang/String;)Lokio/k;
    ...
    .line 8
    :cond_1
    iget-object p1, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lokio/k;

    invoke-interface {p1, v0}, Lokio/k;->a0(Ljava/lang/String;)Lokio/k;

...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "sink",
        "<init>",
        "(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lim/o;Lim/n;)V",
        "Companion",
        "AbstractSource",
        "ChunkedSink",
        "ChunkedSource",
...
.method public constructor <init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lim/o;Lim/n;)V
    .locals 1
    ...
    iput-object p3, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->source:Lim/o;

    iput-object p4, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lim/n;

    .line 2
    new-instance p1, Lokhttp3/internal/http1/HeadersReader;

    invoke-direct {p1, p3}, Lokhttp3/internal/http1/HeadersReader;-><init>(Lim/o;)V
...
.method public static final synthetic access$detachTimeout(Lokhttp3/internal/http1/Http1ExchangeCodec;Lim/s;)V
    .locals 0

    invoke-direct {p0, p1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->detachTimeout(Lim/s;)V
...
.method public static final synthetic access$getSink$p(Lokhttp3/internal/http1/Http1ExchangeCodec;)Lim/n;
    .locals 0

    iget-object p0, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lim/n;

    return-object p0
.end method

.method public static final synthetic access$getSource$p(Lokhttp3/internal/http1/Http1ExchangeCodec;)Lim/o;
    .locals 0

    iget-object p0, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->source:Lim/o;
...
.method private final detachTimeout(Lim/s;)V
    .locals 2

    .line 1
    invoke-virtual {p1}, Lim/s;->a()Lim/o0;

    move-result-object v0

    .line 2
    sget-object v1, Lim/o0;->NONE:Lim/o0;

    invoke-virtual {p1, v1}, Lim/s;->b(Lim/o0;)Lim/s;
...
.method private final newChunkedSink()Lim/k0;
    .locals 2
...
.method private final newChunkedSource(Lokhttp3/HttpUrl;)Lim/m0;
    .locals 2
...
.method private final newFixedLengthSource(J)Lim/m0;
    .locals 2
...
.method private final newKnownLengthSink()Lim/k0;
    .locals 2
...
.method private final newUnknownLengthSource()Lim/m0;
    .locals 2
...
.method public createRequestBody(Lokhttp3/Request;J)Lim/k0;
    .locals 2
    ...
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newChunkedSink()Lim/k0;
    ...
    .line 3
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newKnownLengthSink()Lim/k0;
...
.method public finishRequest()V
    ...
    iget-object v0, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lim/n;
...
.method public openResponseBodySource(Lokhttp3/Response;)Lim/m0;
    .locals 4
    ...
    invoke-direct {p0, v0, v1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newFixedLengthSource(J)Lim/m0;
    ...
    invoke-direct {p0, p1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newChunkedSource(Lokhttp3/HttpUrl;)Lim/m0;
    ...
    .line 5
    :cond_2
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newUnknownLengthSource()Lim/m0;
...
.method public final skipConnectBody(Lokhttp3/Response;)V
    ...
    invoke-static {p1, v0, v1}, Lokhttp3/internal/Util;->skipAll(Lim/m0;ILjava/util/concurrent/TimeUnit;)Z

    .line 4
    invoke-interface {p1}, Lim/m0;->close()V
...
.method public final writeRequest(Lokhttp3/Headers;Ljava/lang/String;)V
    ...
    invoke-interface {v0, p2}, Lim/n;->Z(Ljava/lang/String;)Lim/n;

    move-result-object p2

    const-string v0, "\r\n"

    invoke-interface {p2, v0}, Lim/n;->Z(Ljava/lang/String;)Lim/n;
    ...
    .line 4
    iget-object v3, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lim/n;

    invoke-virtual {p1, v1}, Lokhttp3/Headers;->name(I)Ljava/lang/String;

    move-result-object v4

    invoke-interface {v3, v4}, Lim/n;->Z(Ljava/lang/String;)Lim/n;
    ...
    .line 7
    invoke-interface {v3, v0}, Lim/n;->Z(Ljava/lang/String;)Lim/n;
    ...
    .line 8
    :cond_1
    iget-object p1, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lim/n;

    invoke-interface {p1, v0}, Lim/n;->Z(Ljava/lang/String;)Lim/n;

...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "Lokio/j$a;",
        "<init>",
        "(ZLokio/l;Lokhttp3/internal/ws/WebSocketReader$FrameCallback;ZZ)V",
        "FrameCallback",
        "okhttp"
    }
    k = 0x1
...
.field private final controlFrameBuffer:Lokio/j;
...
.field private final messageFrameBuffer:Lokio/j;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field
...
# direct methods
.method public constructor <init>(ZLokio/l;Lokhttp3/internal/ws/WebSocketReader$FrameCallback;ZZ)V
    .locals 1
    .param p2    # Lokio/l;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 3
    iput-object p2, p0, Lokhttp3/internal/ws/WebSocketReader;->source:Lokio/l;
    ...
    iput-object p2, p0, Lokhttp3/internal/ws/WebSocketReader;->controlFrameBuffer:Lokio/j;
    ...
    iput-object p2, p0, Lokhttp3/internal/ws/WebSocketReader;->messageFrameBuffer:Lokio/j;
    ...
    :goto_1
    iput-object p2, p0, Lokhttp3/internal/ws/WebSocketReader;->maskCursor:Lokio/j$a;
...
.method private final readControlFrame()V
    ...
    .line 2
    iget-object v4, p0, Lokhttp3/internal/ws/WebSocketReader;->source:Lokio/l;

    iget-object v5, p0, Lokhttp3/internal/ws/WebSocketReader;->controlFrameBuffer:Lokio/j;

    invoke-interface {v4, v5, v0, v1}, Lokio/l;->F(Lokio/j;J)V
    ...
    .line 4
    iget-object v0, p0, Lokhttp3/internal/ws/WebSocketReader;->controlFrameBuffer:Lokio/j;

    iget-object v1, p0, Lokhttp3/internal/ws/WebSocketReader;->maskCursor:Lokio/j$a;

    invoke-static {v1}, Lkotlin/jvm/internal/f0;->m(Ljava/lang/Object;)V

    invoke-virtual {v0, v1}, Lokio/j;->X0(Lokio/j$a;)Lokio/j$a;

    .line 5
    iget-object v0, p0, Lokhttp3/internal/ws/WebSocketReader;->maskCursor:Lokio/j$a;

    invoke-virtual {v0, v2, v3}, Lokio/j$a;->g(J)I
    ...
    invoke-virtual {v0, v1, v4}, Lokhttp3/internal/ws/WebSocketProtocol;->toggleMask(Lokio/j$a;[B)V

    .line 7
    iget-object v0, p0, Lokhttp3/internal/ws/WebSocketReader;->maskCursor:Lokio/j$a;

    invoke-virtual {v0}, Lokio/j$a;->close()V
    ...
    iget-object v1, p0, Lokhttp3/internal/ws/WebSocketReader;->controlFrameBuffer:Lokio/j;

    invoke-virtual {v1}, Lokio/j;->B1()Lokio/ByteString;
    ...
    invoke-virtual {v0}, Lokio/j;->readShort()S
    ...
    invoke-virtual {v1}, Lokio/j;->O1()Ljava/lang/String;
...
.method private final readHeader()V
    ...
    .line 2
    iget-object v0, p0, Lokhttp3/internal/ws/WebSocketReader;->source:Lokio/l;
    ...
    .line 3
    iget-object v2, p0, Lokhttp3/internal/ws/WebSocketReader;->source:Lokio/l;

    invoke-interface {v2}, Lokio/s0;->timeout()Lokio/u0;

    move-result-object v2

    invoke-virtual {v2}, Lokio/u0;->clearTimeout()Lokio/u0;

    .line 4
    :try_start_0
    iget-object v2, p0, Lokhttp3/internal/ws/WebSocketReader;->source:Lokio/l;

    invoke-interface {v2}, Lokio/l;->readByte()B
    ...
    invoke-interface {v4}, Lokio/s0;->timeout()Lokio/u0;

    move-result-object v4

    sget-object v5, Ljava/util/concurrent/TimeUnit;->NANOSECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v4, v0, v1, v5}, Lokio/u0;->timeout(JLjava/util/concurrent/TimeUnit;)Lokio/u0;
    ...
    invoke-interface {v0}, Lokio/l;->readByte()B
    ...
    invoke-interface {v0}, Lokio/l;->readShort()S
    ...
    invoke-interface {v0}, Lokio/l;->readLong()J
    ...
    invoke-interface {v0, v1}, Lokio/l;->readFully([B)V
    ...
    .line 28
    iget-object v3, p0, Lokhttp3/internal/ws/WebSocketReader;->source:Lokio/l;

    invoke-interface {v3}, Lokio/s0;->timeout()Lokio/u0;

    move-result-object v3

    sget-object v4, Ljava/util/concurrent/TimeUnit;->NANOSECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v3, v0, v1, v4}, Lokio/u0;->timeout(JLjava/util/concurrent/TimeUnit;)Lokio/u0;
...
.method private final readMessage()V
    ...
    iget-object v3, p0, Lokhttp3/internal/ws/WebSocketReader;->messageFrameBuffer:Lokio/j;

    invoke-interface {v2, v3, v0, v1}, Lokio/l;->F(Lokio/j;J)V
    ...
    .line 5
    iget-object v0, p0, Lokhttp3/internal/ws/WebSocketReader;->messageFrameBuffer:Lokio/j;
    ...
    iget-object v1, p0, Lokhttp3/internal/ws/WebSocketReader;->messageFrameBuffer:Lokio/j;
    ...
    invoke-virtual {v0, v1, v2}, Lokio/j$a;->g(J)I
    ...
    invoke-virtual {v0, v1, v2}, Lokhttp3/internal/ws/WebSocketProtocol;->toggleMask(Lokio/j$a;[B)V
...
.method private final readMessageFrame()V
    ...
    invoke-virtual {v2, v3}, Lokhttp3/internal/ws/MessageInflater;->inflate(Lokio/j;)V
...
.method public final getSource()Lokio/l;
    .locals 1
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation

...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "()Lim/o;",
        "<init>",
        "(ZLim/o;Lokhttp3/internal/ws/WebSocketReader$FrameCallback;ZZ)V",
        "FrameCallback",
        "okhttp"
    }
    k = 0x1
...
.field private final controlFrameBuffer:Lim/m;
...
.field private final messageFrameBuffer:Lim/m;
...
# direct methods
.method public constructor <init>(ZLim/o;Lokhttp3/internal/ws/WebSocketReader$FrameCallback;ZZ)V
    .locals 1
    .param p2    # Lim/o;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    iput-object p2, p0, Lokhttp3/internal/ws/WebSocketReader;->source:Lim/o;
    ...
    invoke-direct {p2}, Lim/m;-><init>()V

    iput-object p2, p0, Lokhttp3/internal/ws/WebSocketReader;->controlFrameBuffer:Lim/m;
    ...
    iput-object p2, p0, Lokhttp3/internal/ws/WebSocketReader;->messageFrameBuffer:Lim/m;
    ...
    :goto_1
    iput-object p2, p0, Lokhttp3/internal/ws/WebSocketReader;->maskCursor:Lim/m$a;
...
.method private final readControlFrame()V
    ...
    .line 2
    iget-object v4, p0, Lokhttp3/internal/ws/WebSocketReader;->source:Lim/o;

    iget-object v5, p0, Lokhttp3/internal/ws/WebSocketReader;->controlFrameBuffer:Lim/m;

    invoke-interface {v4, v5, v0, v1}, Lim/o;->T(Lim/m;J)V
    ...
    .line 4
    iget-object v0, p0, Lokhttp3/internal/ws/WebSocketReader;->controlFrameBuffer:Lim/m;

    iget-object v1, p0, Lokhttp3/internal/ws/WebSocketReader;->maskCursor:Lim/m$a;

    invoke-static {v1}, Lkotlin/jvm/internal/f0;->m(Ljava/lang/Object;)V

    invoke-virtual {v0, v1}, Lim/m;->H1(Lim/m$a;)Lim/m$a;

    .line 5
    iget-object v0, p0, Lokhttp3/internal/ws/WebSocketReader;->maskCursor:Lim/m$a;

    invoke-virtual {v0, v2, v3}, Lim/m$a;->f(J)I
    ...
    invoke-virtual {v0, v1, v4}, Lokhttp3/internal/ws/WebSocketProtocol;->toggleMask(Lim/m$a;[B)V

    .line 7
    iget-object v0, p0, Lokhttp3/internal/ws/WebSocketReader;->maskCursor:Lim/m$a;

    invoke-virtual {v0}, Lim/m$a;->close()V
    ...
    iget-object v1, p0, Lokhttp3/internal/ws/WebSocketReader;->controlFrameBuffer:Lim/m;

    invoke-virtual {v1}, Lim/m;->A1()Lokio/ByteString;
...
.method private final readHeader()V
    ...
    .line 2
    iget-object v0, p0, Lokhttp3/internal/ws/WebSocketReader;->source:Lim/o;
    ...
    .line 3
    iget-object v2, p0, Lokhttp3/internal/ws/WebSocketReader;->source:Lim/o;

    invoke-interface {v2}, Lim/m0;->timeout()Lim/o0;

    move-result-object v2

    invoke-virtual {v2}, Lim/o0;->clearTimeout()Lim/o0;

    .line 4
    :try_start_0
    iget-object v2, p0, Lokhttp3/internal/ws/WebSocketReader;->source:Lim/o;

    invoke-interface {v2}, Lim/o;->readByte()B
    ...
    invoke-interface {v4}, Lim/m0;->timeout()Lim/o0;

    move-result-object v4

    sget-object v5, Ljava/util/concurrent/TimeUnit;->NANOSECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v4, v0, v1, v5}, Lim/o0;->timeout(JLjava/util/concurrent/TimeUnit;)Lim/o0;
    ...
    invoke-interface {v0}, Lim/o;->readByte()B
    ...
    invoke-interface {v0}, Lim/o;->readShort()S
    ...
    invoke-interface {v0}, Lim/o;->readLong()J
    ...
    invoke-interface {v0, v1}, Lim/o;->readFully([B)V
    ...
    .line 28
    iget-object v3, p0, Lokhttp3/internal/ws/WebSocketReader;->source:Lim/o;

    invoke-interface {v3}, Lim/m0;->timeout()Lim/o0;

    move-result-object v3

    sget-object v4, Ljava/util/concurrent/TimeUnit;->NANOSECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v3, v0, v1, v4}, Lim/o0;->timeout(JLjava/util/concurrent/TimeUnit;)Lim/o0;
...
.method private final readMessage()V
    ...
    iget-object v3, p0, Lokhttp3/internal/ws/WebSocketReader;->messageFrameBuffer:Lim/m;

    invoke-interface {v2, v3, v0, v1}, Lim/o;->T(Lim/m;J)V
    ...
    .line 5
    iget-object v0, p0, Lokhttp3/internal/ws/WebSocketReader;->messageFrameBuffer:Lim/m;
    ...
    iget-object v1, p0, Lokhttp3/internal/ws/WebSocketReader;->messageFrameBuffer:Lim/m;
    ...
    invoke-virtual {v0, v1, v2}, Lim/m$a;->f(J)I
    ...
    invoke-virtual {v0, v1, v2}, Lokhttp3/internal/ws/WebSocketProtocol;->toggleMask(Lim/m$a;[B)V
...
.method private final readMessageFrame()V
    ...
    invoke-virtual {v2, v3}, Lokhttp3/internal/ws/MessageInflater;->inflate(Lim/m;)V

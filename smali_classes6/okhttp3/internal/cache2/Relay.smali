...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "isClosed",
        "<init>",
        "(Ljava/io/RandomAccessFile;Lokio/s0;JLokio/ByteString;J)V",
        "Companion",
        "RelaySource",
        "okhttp"
    }
...
# instance fields
.field private final buffer:Lokio/j;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field
...
.field private upstream:Lokio/s0;
    .annotation build Lorg/jetbrains/annotations/Nullable;
    .end annotation
.end field

.field private final upstreamBuffer:Lokio/j;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field
...
.method private constructor <init>(Ljava/io/RandomAccessFile;Lokio/s0;JLokio/ByteString;J)V
    .locals 0
    ...
    .line 3
    iput-object p2, p0, Lokhttp3/internal/cache2/Relay;->upstream:Lokio/s0;
    ...
    iput-object p1, p0, Lokhttp3/internal/cache2/Relay;->upstreamBuffer:Lokio/j;

    .line 8
    iget-object p1, p0, Lokhttp3/internal/cache2/Relay;->upstream:Lokio/s0;
    ...
    iput-object p1, p0, Lokhttp3/internal/cache2/Relay;->buffer:Lokio/j;

    return-void
.end method

.method public synthetic constructor <init>(Ljava/io/RandomAccessFile;Lokio/s0;JLokio/ByteString;JLkotlin/jvm/internal/u;)V
    .locals 0

    invoke-direct/range {p0 .. p7}, Lokhttp3/internal/cache2/Relay;-><init>(Ljava/io/RandomAccessFile;Lokio/s0;JLokio/ByteString;J)V
...
.method private final writeHeader(Lokio/ByteString;JJ)V
    ...
    .line 2
    invoke-virtual {v3, p1}, Lokio/j;->n2(Lokio/ByteString;)Lokio/j;

    .line 3
    invoke-virtual {v3, p2, p3}, Lokio/j;->x2(J)Lokio/j;

    .line 4
    invoke-virtual {v3, p4, p5}, Lokio/j;->x2(J)Lokio/j;

    .line 5
    iget-wide p1, v3, Lokio/j;->b:J
    ...
    .line 7
    invoke-virtual/range {v0 .. v5}, Lokhttp3/internal/cache2/FileOperator;->write(JLokio/j;J)V
...
.method private final writeMetadata(J)V
    ...
    invoke-virtual {v3, v0}, Lokio/j;->n2(Lokio/ByteString;)Lokio/j;
...
.method public final commit(J)V
    ...
    .line 10
    iput-object p1, p0, Lokhttp3/internal/cache2/Relay;->upstream:Lokio/s0;
...
.method public final getBuffer()Lokio/j;
    .locals 1
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation

    iget-object v0, p0, Lokhttp3/internal/cache2/Relay;->buffer:Lokio/j;
...
.method public final getUpstream()Lokio/s0;
    .locals 1
    .annotation build Lorg/jetbrains/annotations/Nullable;
    .end annotation

    iget-object v0, p0, Lokhttp3/internal/cache2/Relay;->upstream:Lokio/s0;

    return-object v0
.end method

.method public final getUpstreamBuffer()Lokio/j;
    .locals 1
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation

    iget-object v0, p0, Lokhttp3/internal/cache2/Relay;->upstreamBuffer:Lokio/j;
...
.method public final newSource()Lokio/s0;
    .locals 1
    .annotation build Lorg/jetbrains/annotations/Nullable;
    .end annotation
...
.method public final setUpstream(Lokio/s0;)V
    .locals 0
    .param p1    # Lokio/s0;
        .annotation build Lorg/jetbrains/annotations/Nullable;
        .end annotation

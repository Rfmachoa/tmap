...
.method private final newSource(I)Lem/m0;
    .locals 2
    ...
    invoke-interface {v0, p1}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)Lem/m0;
    ...
    invoke-direct {v0, p0, p1, p1}, Lokhttp3/internal/cache/DiskLruCache$Entry$newSource$1;-><init>(Lokhttp3/internal/cache/DiskLruCache$Entry;Lem/m0;Lem/m0;)V
...
.method public final snapshot$okhttp()Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    .line 9
    invoke-direct {p0, v2}, Lokhttp3/internal/cache/DiskLruCache$Entry;->newSource(I)Lem/m0;
...
.method public final writeLengths$okhttp(Lem/n;)V
    .locals 6
    .param p1    # Lem/n;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 2
    invoke-interface {p1, v5}, Lem/n;->writeByte(I)Lem/n;

    move-result-object v5

    invoke-interface {v5, v3, v4}, Lem/n;->D0(J)Lem/n;

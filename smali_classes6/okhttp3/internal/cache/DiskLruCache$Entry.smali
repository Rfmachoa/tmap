...
.method private final newSource(I)Lim/m0;
    .locals 2
    ...
    invoke-interface {v0, p1}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)Lim/m0;
    ...
    invoke-direct {v0, p0, p1, p1}, Lokhttp3/internal/cache/DiskLruCache$Entry$newSource$1;-><init>(Lokhttp3/internal/cache/DiskLruCache$Entry;Lim/m0;Lim/m0;)V
...
.method public final snapshot$okhttp()Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    .line 11
    invoke-direct {p0, v2}, Lokhttp3/internal/cache/DiskLruCache$Entry;->newSource(I)Lim/m0;
...
.method public final writeLengths$okhttp(Lim/n;)V
    .locals 6
    .param p1    # Lim/n;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 2
    invoke-interface {p1, v5}, Lim/n;->writeByte(I)Lim/n;

    move-result-object v5

    invoke-interface {v5, v3, v4}, Lim/n;->G0(J)Lim/n;

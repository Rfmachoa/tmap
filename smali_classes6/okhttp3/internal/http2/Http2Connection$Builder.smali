...
.field public sink:Lokio/k;

.field public socket:Ljava/net/Socket;

.field public source:Lokio/l;
...
.method public static socket$default(Lokhttp3/internal/http2/Http2Connection$Builder;Ljava/net/Socket;Ljava/lang/String;Lokio/l;Lokio/k;ILjava/lang/Object;)Lokhttp3/internal/http2/Http2Connection$Builder;
    .locals 0
    ...
    .line 2
    invoke-static {p1}, Lokio/f0;->t(Ljava/net/Socket;)Lokio/s0;

    move-result-object p3

    .line 3
    invoke-static {p3}, Lokio/g0;->c(Lokio/s0;)Lokio/l;
    ...
    .line 4
    invoke-static {p1}, Lokio/f0;->o(Ljava/net/Socket;)Lokio/q0;
    ...
    .line 6
    :cond_2
    invoke-virtual {p0, p1, p2, p3, p4}, Lokhttp3/internal/http2/Http2Connection$Builder;->socket(Ljava/net/Socket;Ljava/lang/String;Lokio/l;Lokio/k;)Lokhttp3/internal/http2/Http2Connection$Builder;
...
.method public final getSink$okhttp()Lokio/k;
    .locals 1
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation

    iget-object v0, p0, Lokhttp3/internal/http2/Http2Connection$Builder;->sink:Lokio/k;
...
.method public final getSource$okhttp()Lokio/l;
    .locals 1
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation

    iget-object v0, p0, Lokhttp3/internal/http2/Http2Connection$Builder;->source:Lokio/l;
...
.method public final setSink$okhttp(Lokio/k;)V
    .locals 1
    .param p1    # Lokio/k;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Connection$Builder;->sink:Lokio/k;
...
.method public final setSource$okhttp(Lokio/l;)V
    .locals 1
    .param p1    # Lokio/l;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Connection$Builder;->source:Lokio/l;
...
.method public final socket(Ljava/net/Socket;)Lokhttp3/internal/http2/Http2Connection$Builder;
    ...
    invoke-static/range {v1 .. v7}, Lokhttp3/internal/http2/Http2Connection$Builder;->socket$default(Lokhttp3/internal/http2/Http2Connection$Builder;Ljava/net/Socket;Ljava/lang/String;Lokio/l;Lokio/k;ILjava/lang/Object;)Lokhttp3/internal/http2/Http2Connection$Builder;
...
.method public final socket(Ljava/net/Socket;Ljava/lang/String;Lokio/l;)Lokhttp3/internal/http2/Http2Connection$Builder;
    .locals 8
    .param p1    # Ljava/net/Socket;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
...
.method public final socket(Ljava/net/Socket;Ljava/lang/String;Lokio/l;Lokio/k;)Lokhttp3/internal/http2/Http2Connection$Builder;
    .locals 1
    .param p1    # Ljava/net/Socket;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 5
    invoke-virtual {p0, p3}, Lokhttp3/internal/http2/Http2Connection$Builder;->setSource$okhttp(Lokio/l;)V

    .line 6
    invoke-virtual {p0, p4}, Lokhttp3/internal/http2/Http2Connection$Builder;->setSink$okhttp(Lokio/k;)V

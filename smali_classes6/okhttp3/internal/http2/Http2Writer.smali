...
.field private final hpackBuffer:Lem/m;
...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/internal/http2/Http2Writer$Companion;-><init>(Lkotlin/jvm/internal/u;)V
...
.method public constructor <init>(Lem/n;Z)V
    .locals 7
    .param p1    # Lem/n;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lem/n;

    iput-boolean p2, p0, Lokhttp3/internal/http2/Http2Writer;->client:Z

    .line 2
    new-instance v4, Lem/m;

    invoke-direct {v4}, Lem/m;-><init>()V

    iput-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lem/m;
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(IZLem/m;ILkotlin/jvm/internal/u;)V
...
.method private final writeContinuationFrames(IJ)V
    ...
    .line 3
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lem/n;

    iget-object v1, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lem/m;
...
.method public final declared-synchronized applyAndAckSettings(Lokhttp3/internal/http2/Settings;)V
    ...
    .line 6
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lem/n;
...
.method public final declared-synchronized connectionPreface()V
    ...
    invoke-interface {v0, v1}, Lem/n;->O1(Lokio/ByteString;)Lem/n;
...
.method public final declared-synchronized data(ZILem/m;I)V
    .locals 1
    .param p3    # Lem/m;
    ...
    .line 2
    invoke-virtual {p0, p2, p1, p3, p4}, Lokhttp3/internal/http2/Http2Writer;->dataFrame(IILem/m;I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final dataFrame(IILem/m;I)V
    .locals 2
    .param p3    # Lem/m;
        .annotation build Lorg/jetbrains/annotations/Nullable;
        .end annotation
    ...
    invoke-interface {p1, p3, v0, v1}, Lem/k0;->write(Lem/m;J)V
...
.method public final frameHeader(IIII)V
    ...
    invoke-static {v0, p2}, Lokhttp3/internal/Util;->writeMedium(Lem/n;I)V

    .line 4
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lem/n;

    and-int/lit16 p3, p3, 0xff

    invoke-interface {p2, p3}, Lem/n;->writeByte(I)Lem/n;
    ...
    invoke-interface {p2, p1}, Lem/n;->writeInt(I)Lem/n;
...
.method public final declared-synchronized goAway(ILokhttp3/internal/http2/ErrorCode;[B)V
    ...
    invoke-interface {v0, p1}, Lem/n;->writeInt(I)Lem/n;
    ...
    invoke-interface {p1, p2}, Lem/n;->writeInt(I)Lem/n;
    ...
    invoke-interface {p1, p3}, Lem/n;->write([B)Lem/n;
...
.method public final declared-synchronized headers(ZILjava/util/List;)V
    ...
    .line 3
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lem/m;
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lem/m;

    invoke-interface {p1, v4, v2, v3}, Lem/k0;->write(Lem/m;J)V
...
.method public final declared-synchronized ping(ZII)V
    ...
    invoke-interface {p1, p3}, Lem/n;->writeInt(I)Lem/n;
...
.method public final declared-synchronized pushPromise(IILjava/util/List;)V
    ...
    .line 6
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lem/n;

    const v3, 0x7fffffff

    and-int/2addr p2, v3

    invoke-interface {v2, p2}, Lem/n;->writeInt(I)Lem/n;

    .line 7
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lem/n;

    iget-object v2, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lem/m;

    invoke-interface {p2, v2, v4, v5}, Lem/k0;->write(Lem/m;J)V
...
.method public final declared-synchronized settings(Lokhttp3/internal/http2/Settings;)V
    ...
    .line 5
    :goto_1
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lem/n;

    invoke-interface {v4, v3}, Lem/n;->writeShort(I)Lem/n;

    .line 6
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lem/n;

    invoke-virtual {p1, v2}, Lokhttp3/internal/http2/Settings;->get(I)I

    move-result v4

    invoke-interface {v3, v4}, Lem/n;->writeInt(I)Lem/n;

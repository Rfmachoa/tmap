...
.field private final hpackBuffer:Lim/m;
...
.method public constructor <init>(Lim/n;Z)V
    .locals 7
    .param p1    # Lim/n;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lim/n;
    ...
    invoke-direct {v4}, Lim/m;-><init>()V

    iput-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lim/m;
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(IZLim/m;ILkotlin/jvm/internal/u;)V
...
.method private final writeContinuationFrames(IJ)V
    ...
    .line 3
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lim/n;

    iget-object v1, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lim/m;
...
.method public final declared-synchronized applyAndAckSettings(Lokhttp3/internal/http2/Settings;)V
    ...
    .line 6
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lim/n;
...
.method public final declared-synchronized connectionPreface()V
    ...
    invoke-interface {v0, v1}, Lim/n;->M1(Lokio/ByteString;)Lim/n;
...
.method public final declared-synchronized data(ZILim/m;I)V
    .locals 1
    .param p3    # Lim/m;
    ...
    .line 2
    invoke-virtual {p0, p2, p1, p3, p4}, Lokhttp3/internal/http2/Http2Writer;->dataFrame(IILim/m;I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final dataFrame(IILim/m;I)V
    .locals 2
    .param p3    # Lim/m;
        .annotation build Lorg/jetbrains/annotations/Nullable;
        .end annotation
    ...
    invoke-interface {p1, p3, v0, v1}, Lim/k0;->write(Lim/m;J)V
...
.method public final frameHeader(IIII)V
    ...
    invoke-static {v0, p2}, Lokhttp3/internal/Util;->writeMedium(Lim/n;I)V

    .line 4
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lim/n;

    and-int/lit16 p3, p3, 0xff

    invoke-interface {p2, p3}, Lim/n;->writeByte(I)Lim/n;
    ...
    invoke-interface {p2, p1}, Lim/n;->writeInt(I)Lim/n;
...
.method public final declared-synchronized goAway(ILokhttp3/internal/http2/ErrorCode;[B)V
    ...
    invoke-interface {v0, p1}, Lim/n;->writeInt(I)Lim/n;
    ...
    invoke-interface {p1, p2}, Lim/n;->writeInt(I)Lim/n;
    ...
    invoke-interface {p1, p3}, Lim/n;->write([B)Lim/n;
...
.method public final declared-synchronized headers(ZILjava/util/List;)V
    ...
    .line 3
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lim/m;
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lim/m;

    invoke-interface {p1, v4, v2, v3}, Lim/k0;->write(Lim/m;J)V
...
.method public final declared-synchronized ping(ZII)V
    ...
    invoke-interface {p1, p3}, Lim/n;->writeInt(I)Lim/n;
...
.method public final declared-synchronized pushPromise(IILjava/util/List;)V
    ...
    .line 7
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lim/n;

    const v3, 0x7fffffff

    and-int/2addr p2, v3

    invoke-interface {v2, p2}, Lim/n;->writeInt(I)Lim/n;

    .line 8
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lim/n;

    iget-object v2, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lim/m;

    invoke-interface {p2, v2, v4, v5}, Lim/k0;->write(Lim/m;J)V
...
.method public final declared-synchronized settings(Lokhttp3/internal/http2/Settings;)V
    ...
    .line 5
    :goto_1
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lim/n;

    invoke-interface {v4, v3}, Lim/n;->writeShort(I)Lim/n;

    .line 6
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lim/n;

    invoke-virtual {p1, v2}, Lokhttp3/internal/http2/Settings;->get(I)I

    move-result v4

    invoke-interface {v3, v4}, Lim/n;->writeInt(I)Lim/n;

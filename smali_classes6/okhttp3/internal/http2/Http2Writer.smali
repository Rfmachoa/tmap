...
.field private final hpackBuffer:Lokio/j;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field
...
.method public constructor <init>(Lokio/k;Z)V
    ...
    .line 2
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lokio/k;
    ...
    invoke-direct {v4}, Lokio/j;-><init>()V

    iput-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lokio/j;
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(IZLokio/j;ILkotlin/jvm/internal/u;)V
...
.method private final writeContinuationFrames(IJ)V
    ...
    .line 3
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lokio/k;

    iget-object v1, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lokio/j;
...
.method public final declared-synchronized applyAndAckSettings(Lokhttp3/internal/http2/Settings;)V
    ...
    .line 6
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lokio/k;
...
.method public final declared-synchronized connectionPreface()V
    ...
    invoke-interface {v0, v1}, Lokio/k;->Q1(Lokio/ByteString;)Lokio/k;
...
.method public final declared-synchronized data(ZILokio/j;I)V
    .locals 1
    .param p3    # Lokio/j;
    ...
    .line 2
    invoke-virtual {p0, p2, p1, p3, p4}, Lokhttp3/internal/http2/Http2Writer;->dataFrame(IILokio/j;I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final dataFrame(IILokio/j;I)V
    .locals 2
    .param p3    # Lokio/j;
        .annotation build Lorg/jetbrains/annotations/Nullable;
        .end annotation
    ...
    invoke-interface {p1, p3, v0, v1}, Lokio/q0;->write(Lokio/j;J)V
...
.method public final frameHeader(IIII)V
    ...
    invoke-static {v0, p2}, Lokhttp3/internal/Util;->writeMedium(Lokio/k;I)V

    .line 4
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lokio/k;

    and-int/lit16 p3, p3, 0xff

    invoke-interface {p2, p3}, Lokio/k;->writeByte(I)Lokio/k;
    ...
    invoke-interface {p2, p1}, Lokio/k;->writeInt(I)Lokio/k;
...
.method public final declared-synchronized goAway(ILokhttp3/internal/http2/ErrorCode;[B)V
    ...
    invoke-interface {v0, p1}, Lokio/k;->writeInt(I)Lokio/k;
    ...
    invoke-interface {p1, p2}, Lokio/k;->writeInt(I)Lokio/k;
    ...
    invoke-interface {p1, p3}, Lokio/k;->write([B)Lokio/k;
...
.method public final declared-synchronized headers(ZILjava/util/List;)V
    ...
    .line 3
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lokio/j;
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lokio/j;

    invoke-interface {p1, v4, v2, v3}, Lokio/q0;->write(Lokio/j;J)V
...
.method public final declared-synchronized ping(ZII)V
    ...
    invoke-interface {p1, p3}, Lokio/k;->writeInt(I)Lokio/k;
...
.method public final declared-synchronized pushPromise(IILjava/util/List;)V
    ...
    .line 7
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lokio/k;

    const v3, 0x7fffffff

    and-int/2addr p2, v3

    invoke-interface {v2, p2}, Lokio/k;->writeInt(I)Lokio/k;

    .line 8
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lokio/k;

    iget-object v2, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lokio/j;

    invoke-interface {p2, v2, v4, v5}, Lokio/q0;->write(Lokio/j;J)V
...
.method public final declared-synchronized settings(Lokhttp3/internal/http2/Settings;)V
    ...
    .line 5
    :goto_1
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lokio/k;

    invoke-interface {v4, v3}, Lokio/k;->writeShort(I)Lokio/k;

    .line 6
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lokio/k;

    invoke-virtual {p1, v2}, Lokhttp3/internal/http2/Settings;->get(I)I

    move-result v2

    invoke-interface {v3, v2}, Lokio/k;->writeInt(I)Lokio/k;

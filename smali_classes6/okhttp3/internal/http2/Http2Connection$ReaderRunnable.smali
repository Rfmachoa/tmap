...
.method public final applyAndAckSettings(ZLokhttp3/internal/http2/Settings;)V
    ...
    invoke-static {v8, v9}, Lkotlin/jvm/internal/f0;->C(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
...
.method public data(ZILokio/l;I)V
    .locals 2
    .param p3    # Lokio/l;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-virtual {v0, p2, p3, p4, p1}, Lokhttp3/internal/http2/Http2Connection;->pushDataLater$okhttp(ILokio/l;IZ)V
    ...
    .line 6
    invoke-interface {p3, v0, v1}, Lokio/l;->skip(J)V

    return-void

    .line 7
    :cond_1
    invoke-virtual {v0, p3, p4}, Lokhttp3/internal/http2/Http2Stream;->receiveData(Lokio/l;I)V

...
.method public constructor <init>(Lokio/l;Z)V
    .locals 7
    .param p1    # Lokio/l;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 2
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lokio/l;
    ...
    invoke-direct {v2, p1}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;-><init>(Lokio/l;)V
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(Lokio/s0;IIILkotlin/jvm/internal/u;)V
...
.method private final readData(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 1
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lokio/l;

    invoke-interface {v1}, Lokio/l;->readByte()B
    ...
    .line 3
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lokio/l;

    invoke-interface {p1, v0, p4, p3, p2}, Lokhttp3/internal/http2/Http2Reader$Handler;->data(ZILokio/l;I)V

    .line 4
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lokio/l;

    int-to-long p2, v1

    invoke-interface {p1, p2, p3}, Lokio/l;->skip(J)V
...
.method private final readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 1
    iget-object p4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lokio/l;

    invoke-interface {p4}, Lokio/l;->readInt()I

    move-result p4

    .line 2
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lokio/l;

    invoke-interface {v0}, Lokio/l;->readInt()I
    ...
    invoke-interface {v0, v1, v2}, Lokio/l;->R0(J)Lokio/ByteString;
...
.method private final readPing(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 1
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lokio/l;

    invoke-interface {p2}, Lokio/l;->readInt()I
...
.method private final readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;I)V
    ...
    .line 13
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lokio/l;

    invoke-interface {v3}, Lokio/l;->readByte()B
...
.method private final readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 4
    invoke-static {p3, p2, p4}, Landroidx/camera/core/impl/utils/j;->a(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/String;
...
.method private final readPushPromise(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-interface {v1}, Lokio/l;->readInt()I
...
.method private final readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 5
    invoke-static {v0, p2}, Lwl/u;->W1(II)Lwl/l;

    move-result-object p2

    const/4 v1, 0x6

    invoke-static {p2, v1}, Lwl/u;->B1(Lwl/j;I)Lwl/j;

    move-result-object p2

    invoke-virtual {p2}, Lwl/j;->f()I

    move-result v1

    invoke-virtual {p2}, Lwl/j;->g()I

    move-result v2

    invoke-virtual {p2}, Lwl/j;->h()I
    ...
    .line 6
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lokio/l;

    invoke-interface {v4}, Lokio/l;->readShort()S
    ...
    .line 7
    iget-object v5, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lokio/l;

    invoke-interface {v5}, Lokio/l;->readInt()I
...
.method public final nextFrame(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-interface {v0, v1, v2}, Lokio/l;->G0(J)V
    :try_end_0
    ...
    invoke-static {v0}, Lokhttp3/internal/Util;->readMedium(Lokio/l;)I
    ...
    invoke-interface {p1, v0, v1}, Lokio/l;->skip(J)V
...
.method public final readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    invoke-interface {p1, v1, v2}, Lokio/l;->R0(J)Lokio/ByteString;

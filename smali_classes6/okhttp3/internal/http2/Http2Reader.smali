...
.method public constructor <init>(Lim/o;Z)V
    .locals 7
    .param p1    # Lim/o;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lim/o;
    ...
    invoke-direct {v2, p1}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;-><init>(Lim/o;)V
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(Lim/m0;IIILkotlin/jvm/internal/u;)V
...
.method private final readData(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 1
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lim/o;

    invoke-interface {v1}, Lim/o;->readByte()B
    ...
    .line 3
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lim/o;

    invoke-interface {p1, v0, p4, p3, p2}, Lokhttp3/internal/http2/Http2Reader$Handler;->data(ZILim/o;I)V

    .line 4
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lim/o;

    int-to-long p2, v1

    invoke-interface {p1, p2, p3}, Lim/o;->skip(J)V
...
.method private final readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 1
    iget-object p4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lim/o;

    invoke-interface {p4}, Lim/o;->readInt()I

    move-result p4

    .line 2
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lim/o;

    invoke-interface {v0}, Lim/o;->readInt()I
    ...
    invoke-interface {v0, v1, v2}, Lim/o;->P0(J)Lokio/ByteString;
...
.method private final readPing(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 1
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lim/o;

    invoke-interface {p2}, Lim/o;->readInt()I
...
.method private final readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;I)V
    ...
    .line 13
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lim/o;

    invoke-interface {v3}, Lim/o;->readByte()B
...
.method private final readPushPromise(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-interface {v1}, Lim/o;->readInt()I
...
.method private final readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 5
    invoke-static {v0, p2}, Lsl/u;->n2(II)Lsl/l;

    move-result-object p2

    const/4 v1, 0x6

    invoke-static {p2, v1}, Lsl/u;->S1(Lsl/j;I)Lsl/j;

    move-result-object p2

    invoke-virtual {p2}, Lsl/j;->e()I

    move-result v1

    invoke-virtual {p2}, Lsl/j;->f()I

    move-result v2

    invoke-virtual {p2}, Lsl/j;->g()I
    ...
    invoke-interface {v3}, Lim/o;->readShort()S
    ...
    .line 7
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lim/o;

    invoke-interface {v4}, Lim/o;->readInt()I
    ...
    .line 9
    invoke-static {p2, v4}, Landroid/support/v4/media/b;->a(Ljava/lang/String;I)Ljava/lang/String;
...
.method public final nextFrame(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-interface {v0, v1, v2}, Lim/o;->E0(J)V
    :try_end_0
    ...
    invoke-static {v0}, Lokhttp3/internal/Util;->readMedium(Lim/o;)I
    ...
    invoke-interface {p1, v0, v1}, Lim/o;->skip(J)V
...
.method public final readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    invoke-interface {p1, v2, v3}, Lim/o;->P0(J)Lokio/ByteString;

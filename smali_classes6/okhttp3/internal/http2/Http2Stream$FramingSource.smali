...
.field private final readBuffer:Lokio/j;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field

.field private final receiveBuffer:Lokio/j;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field
...
.method public constructor <init>(Lokhttp3/internal/http2/Http2Stream;JZ)V
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->receiveBuffer:Lokio/j;
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->readBuffer:Lokio/j;
...
.method public close()V
    ...
    .line 3
    invoke-virtual {p0}, Lokhttp3/internal/http2/Http2Stream$FramingSource;->getReadBuffer()Lokio/j;
...
.method public final getReadBuffer()Lokio/j;
    .locals 1
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation

    iget-object v0, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->readBuffer:Lokio/j;

    return-object v0
.end method

.method public final getReceiveBuffer()Lokio/j;
    .locals 1
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation

    iget-object v0, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->receiveBuffer:Lokio/j;
...
.method public read(Lokio/j;J)J
    ...
    invoke-virtual {v10}, Lokio/h;->enter()V
    :try_end_0
    ...
    .line 6
    invoke-virtual/range {p0 .. p0}, Lokhttp3/internal/http2/Http2Stream$FramingSource;->getReadBuffer()Lokio/j;
    ...
    invoke-virtual {v10, v0, v13, v14}, Lokio/j;->read(Lokio/j;J)J
...
.method public final receive$okhttp(Lokio/l;J)V
    .locals 9
    .param p1    # Lokio/l;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 16
    :cond_4
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->receiveBuffer:Lokio/j;

    invoke-interface {p1, v2, p2, p3}, Lokio/s0;->read(Lokio/j;J)J
    ...
    .line 19
    invoke-virtual {p0}, Lokhttp3/internal/http2/Http2Stream$FramingSource;->getReceiveBuffer()Lokio/j;
    ...
    invoke-virtual {v3, v4}, Lokio/j;->j0(Lokio/s0;)J

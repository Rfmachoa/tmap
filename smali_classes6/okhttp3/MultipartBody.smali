...
.method private final writeOrCountBytes(Lokio/k;Z)J
    .locals 13
    ...
    invoke-interface {p1, v8}, Lokio/k;->write([B)Lokio/k;

    .line 7
    iget-object v8, p0, Lokhttp3/MultipartBody;->boundaryByteString:Lokio/ByteString;

    invoke-interface {p1, v8}, Lokio/k;->Q1(Lokio/ByteString;)Lokio/k;
    ...
    invoke-interface {p1, v11}, Lokio/k;->a0(Ljava/lang/String;)Lokio/k;
    ...
    invoke-interface {v11, v12}, Lokio/k;->write([B)Lokio/k;
    ...
    invoke-interface {v11, v9}, Lokio/k;->a0(Ljava/lang/String;)Lokio/k;
    ...
    invoke-interface {v9, v11}, Lokio/k;->write([B)Lokio/k;
    ...
    .line 15
    invoke-interface {p1, v8}, Lokio/k;->a0(Ljava/lang/String;)Lokio/k;
    ...
    invoke-interface {v8, v7}, Lokio/k;->a0(Ljava/lang/String;)Lokio/k;
    ...
    invoke-interface {v7, v8}, Lokio/k;->write([B)Lokio/k;
    ...
    .line 19
    invoke-interface {p1, v9}, Lokio/k;->a0(Ljava/lang/String;)Lokio/k;

    move-result-object v9

    .line 20
    invoke-interface {v9, v7, v8}, Lokio/k;->I0(J)Lokio/k;
    ...
    invoke-interface {v9, v10}, Lokio/k;->write([B)Lokio/k;
    ...
    invoke-interface {p1, v9}, Lokio/k;->write([B)Lokio/k;
    ...
    .line 24
    :cond_5
    invoke-virtual {v5, p1}, Lokhttp3/RequestBody;->writeTo(Lokio/k;)V
    ...
    invoke-interface {p1, v1}, Lokio/k;->write([B)Lokio/k;

    .line 27
    iget-object v2, p0, Lokhttp3/MultipartBody;->boundaryByteString:Lokio/ByteString;

    invoke-interface {p1, v2}, Lokio/k;->Q1(Lokio/ByteString;)Lokio/k;
...
.method public contentLength()J
    ...
    .line 2
    invoke-direct {p0, v0, v1}, Lokhttp3/MultipartBody;->writeOrCountBytes(Lokio/k;Z)J
...
.method public writeTo(Lokio/k;)V
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/MultipartBody;->writeOrCountBytes(Lokio/k;Z)J

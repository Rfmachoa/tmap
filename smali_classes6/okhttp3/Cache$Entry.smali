...
.method public constructor <init>(Lokio/s0;)V
    ...
    .line 3
    invoke-interface {v0}, Lokio/l;->s0()Ljava/lang/String;
    ...
    invoke-virtual {v2, v0}, Lokhttp3/Cache$Companion;->readInt$okhttp(Lokio/l;)I
    ...
    .line 29
    invoke-direct {p0, v0}, Lokhttp3/Cache$Entry;->readCertificateList(Lokio/l;)Ljava/util/List;
...
.method private final readCertificateList(Lokio/l;)Ljava/util/List;
    .locals 7
    ...
    invoke-virtual {v0, p1}, Lokhttp3/Cache$Companion;->readInt$okhttp(Lokio/l;)I
    ...
    .line 5
    invoke-interface {p1}, Lokio/l;->s0()Ljava/lang/String;
    ...
    invoke-virtual {v5, v4}, Lokio/j;->n2(Lokio/ByteString;)Lokio/j;

    .line 8
    new-instance v4, Lokio/j$b;

    invoke-direct {v4, v5}, Lokio/j$b;-><init>(Lokio/j;)V
...
.method private final writeCertList(Lokio/k;Ljava/util/List;)V
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, v0, v1}, Lokio/k;->I0(J)Lokio/k;
...
.method public final writeTo(Lokhttp3/internal/cache/DiskLruCache$Editor;)V
    ...
    .line 1
    invoke-virtual {p1, v0}, Lokhttp3/internal/cache/DiskLruCache$Editor;->newSink(I)Lokio/q0;
    ...
    invoke-interface {p1, v2}, Lokio/k;->a0(Ljava/lang/String;)Lokio/k;
    ...
    invoke-interface {p1, v4, v5}, Lokio/k;->I0(J)Lokio/k;
    ...
    invoke-interface {p1, v7}, Lokio/k;->a0(Ljava/lang/String;)Lokio/k;

    move-result-object v7

    .line 8
    invoke-interface {v7, v5}, Lokio/k;->a0(Ljava/lang/String;)Lokio/k;
    ...
    invoke-interface {v5, v4}, Lokio/k;->a0(Ljava/lang/String;)Lokio/k;
    ...
    invoke-interface {p1, v6, v7}, Lokio/k;->I0(J)Lokio/k;
    ...
    invoke-interface {p1, v6}, Lokio/k;->a0(Ljava/lang/String;)Lokio/k;

    move-result-object v6

    .line 15
    invoke-interface {v6, v5}, Lokio/k;->a0(Ljava/lang/String;)Lokio/k;
    ...
    invoke-interface {v6, v0}, Lokio/k;->a0(Ljava/lang/String;)Lokio/k;
    ...
    invoke-interface {v0, v6, v7}, Lokio/k;->I0(J)Lokio/k;
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/Cache$Entry;->writeCertList(Lokio/k;Ljava/util/List;)V

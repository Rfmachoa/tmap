...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/Cache$Entry$Companion;-><init>(Lkotlin/jvm/internal/u;)V
...
.method public constructor <init>(Lim/m0;)V
    ...
    .line 3
    invoke-interface {v0}, Lim/o;->q0()Ljava/lang/String;
    ...
    invoke-virtual {v2, v0}, Lokhttp3/Cache$Companion;->readInt$okhttp(Lim/o;)I
    ...
    .line 28
    invoke-direct {p0, v0}, Lokhttp3/Cache$Entry;->readCertificateList(Lim/o;)Ljava/util/List;
    ...
    .line 30
    invoke-interface {v0}, Lim/o;->b1()Z
...
.method private final isHttps()Z
    ...
    invoke-static {v0, v1, v2, v3, v4}, Lkotlin/text/u;->u2(Ljava/lang/String;Ljava/lang/String;ZILjava/lang/Object;)Z
...
.method private final readCertificateList(Lim/o;)Ljava/util/List;
    .locals 7
    ...
    invoke-virtual {v0, p1}, Lokhttp3/Cache$Companion;->readInt$okhttp(Lim/o;)I
    ...
    .line 5
    invoke-interface {p1}, Lim/o;->q0()Ljava/lang/String;

    move-result-object v4

    .line 6
    new-instance v5, Lim/m;

    invoke-direct {v5}, Lim/m;-><init>()V
    ...
    invoke-virtual {v5, v4}, Lim/m;->n2(Lokio/ByteString;)Lim/m;

    .line 8
    new-instance v4, Lim/m$b;

    invoke-direct {v4, v5}, Lim/m$b;-><init>(Lim/m;)V
...
.method private final writeCertList(Lim/n;Ljava/util/List;)V
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, v0, v1}, Lim/n;->G0(J)Lim/n;
    ...
    invoke-static/range {v4 .. v9}, Lokio/ByteString$a;->p(Lokio/ByteString$a;[BIIILjava/lang/Object;)Lokio/ByteString;
    ...
    .line 5
    invoke-interface {p1, v3}, Lim/n;->Z(Ljava/lang/String;)Lim/n;

    move-result-object v3

    invoke-interface {v3, v1}, Lim/n;->writeByte(I)Lim/n;
    :try_end_0
...
.method public final writeTo(Lokhttp3/internal/cache/DiskLruCache$Editor;)V
    ...
    .line 1
    invoke-virtual {p1, v0}, Lokhttp3/internal/cache/DiskLruCache$Editor;->newSink(I)Lim/k0;
    ...
    invoke-interface {p1, v2}, Lim/n;->Z(Ljava/lang/String;)Lim/n;
    ...
    invoke-interface {p1, v4, v5}, Lim/n;->G0(J)Lim/n;
    ...
    invoke-interface {p1, v6}, Lim/n;->Z(Ljava/lang/String;)Lim/n;

    move-result-object v6

    .line 8
    invoke-interface {v6, v5}, Lim/n;->Z(Ljava/lang/String;)Lim/n;
    ...
    invoke-interface {v5, v6}, Lim/n;->Z(Ljava/lang/String;)Lim/n;

    move-result-object v5

    .line 10
    invoke-interface {v5, v3}, Lim/n;->writeByte(I)Lim/n;
    ...
    invoke-interface {p1, v6, v7}, Lim/n;->G0(J)Lim/n;
    ...
    invoke-interface {p1, v4}, Lim/n;->Z(Ljava/lang/String;)Lim/n;

    move-result-object v4

    .line 15
    invoke-interface {v4, v5}, Lim/n;->Z(Ljava/lang/String;)Lim/n;
    ...
    invoke-interface {v4, v6}, Lim/n;->Z(Ljava/lang/String;)Lim/n;

    move-result-object v4

    .line 17
    invoke-interface {v4, v3}, Lim/n;->writeByte(I)Lim/n;
    ...
    invoke-interface {v0, v6, v7}, Lim/n;->G0(J)Lim/n;
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/Cache$Entry;->writeCertList(Lim/n;Ljava/util/List;)V

...
.field private static final afterBoundaryOptions:Lokio/h0;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field
...
.method public static constructor <clinit>()V
    ...
    .line 1
    sget-object v0, Lokio/h0;->c:Lokio/h0$a;
    ...
    .line 6
    invoke-virtual {v0, v1}, Lokio/h0$a;->d([Lokio/ByteString;)Lokio/h0;

    move-result-object v0

    sput-object v0, Lokhttp3/MultipartReader;->afterBoundaryOptions:Lokio/h0;
...
.method public constructor <init>(Lokhttp3/ResponseBody;)V
    ...
    .line 14
    invoke-direct {p0, v0, p1}, Lokhttp3/MultipartReader;-><init>(Lokio/l;Ljava/lang/String;)V
...
.method public constructor <init>(Lokio/l;Ljava/lang/String;)V
    ...
    .line 2
    iput-object p1, p0, Lokhttp3/MultipartReader;->source:Lokio/l;
    ...
    .line 5
    invoke-virtual {p1, v0}, Lokio/j;->G2(Ljava/lang/String;)Lokio/j;

    move-result-object p1

    .line 6
    invoke-virtual {p1, p2}, Lokio/j;->G2(Ljava/lang/String;)Lokio/j;

    move-result-object p1

    .line 7
    invoke-virtual {p1}, Lokio/j;->B1()Lokio/ByteString;
...
.method public static final synthetic access$getAfterBoundaryOptions$cp()Lokio/h0;
    .locals 1

    sget-object v0, Lokhttp3/MultipartReader;->afterBoundaryOptions:Lokio/h0;
...
.method public static final synthetic access$getSource$p(Lokhttp3/MultipartReader;)Lokio/l;
    .locals 0

    iget-object p0, p0, Lokhttp3/MultipartReader;->source:Lokio/l;
...
.method private final currentPartBytesRemaining(J)J
    ...
    .line 1
    iget-object v0, p0, Lokhttp3/MultipartReader;->source:Lokio/l;
    ...
    invoke-virtual {v0, v1}, Lokio/j;->C(Lokio/ByteString;)J
...
.method public final nextPart()Lokhttp3/MultipartReader$Part;
    ...
    invoke-interface {v0, v3, v4, v5}, Lokio/l;->e0(JLokio/ByteString;)Z
    ...
    .line 7
    :goto_2
    iget-object v3, p0, Lokhttp3/MultipartReader;->source:Lokio/l;

    sget-object v4, Lokhttp3/MultipartReader;->afterBoundaryOptions:Lokio/h0;

    invoke-interface {v3, v4}, Lokio/l;->e2(Lokio/h0;)I
    ...
    iget-object v1, p0, Lokhttp3/MultipartReader;->source:Lokio/l;

    invoke-direct {v0, v1}, Lokhttp3/internal/http1/HeadersReader;-><init>(Lokio/l;)V
    ...
    .line 18
    invoke-direct {v2, v0, v1}, Lokhttp3/MultipartReader$Part;-><init>(Lokhttp3/Headers;Lokio/l;)V

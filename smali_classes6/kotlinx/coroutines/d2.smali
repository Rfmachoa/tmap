...
.method public static final B(Ljava/lang/Throwable;Lkotlinx/coroutines/y1;)Ljava/lang/Throwable;
    .locals 2
...
.method public static final synthetic b(Lkotlinx/coroutines/y1;)Lkotlinx/coroutines/y1;
    ...
    .line 1
    invoke-static {p0}, Lkotlinx/coroutines/b2;->a(Lkotlinx/coroutines/y1;)Lkotlinx/coroutines/b0;
...
.method public static synthetic d(Lkotlinx/coroutines/y1;ILjava/lang/Object;)Lkotlinx/coroutines/y1;
    ...
    .line 1
    :cond_0
    invoke-static {p0}, Lkotlinx/coroutines/b2;->b(Lkotlinx/coroutines/y1;)Lkotlinx/coroutines/y1;
...
.method public static final synthetic e(Lkotlin/coroutines/CoroutineContext;)V
    ...
    .line 1
    invoke-static {p0, v0}, Lkotlinx/coroutines/b2;->f(Lkotlin/coroutines/CoroutineContext;Ljava/util/concurrent/CancellationException;)V
...
.method public static final f(Lkotlin/coroutines/CoroutineContext;Ljava/util/concurrent/CancellationException;)V
    ...
    :cond_0
    invoke-interface {p0, p1}, Lkotlinx/coroutines/y1;->c(Ljava/util/concurrent/CancellationException;)V
...
.method public static final synthetic h(Lkotlin/coroutines/CoroutineContext;Ljava/lang/Throwable;)Z
    ...
    .line 2
    :cond_1
    invoke-static {p1, p0}, Lkotlinx/coroutines/d2;->B(Ljava/lang/Throwable;Lkotlinx/coroutines/y1;)Ljava/lang/Throwable;
...
.method public static synthetic i(Lkotlin/coroutines/CoroutineContext;Ljava/util/concurrent/CancellationException;ILjava/lang/Object;)V
    ...
    .line 1
    :cond_0
    invoke-static {p0, p1}, Lkotlinx/coroutines/b2;->f(Lkotlin/coroutines/CoroutineContext;Ljava/util/concurrent/CancellationException;)V
...
.method public static synthetic j(Lkotlinx/coroutines/y1;Ljava/lang/String;Ljava/lang/Throwable;ILjava/lang/Object;)V
    ...
    .line 1
    :cond_0
    invoke-static {p0, p1, p2}, Lkotlinx/coroutines/b2;->g(Lkotlinx/coroutines/y1;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static synthetic k(Lkotlin/coroutines/CoroutineContext;Ljava/lang/Throwable;ILjava/lang/Object;)Z
    ...
    .line 1
    :cond_0
    invoke-static {p0, p1}, Lkotlinx/coroutines/b2;->h(Lkotlin/coroutines/CoroutineContext;Ljava/lang/Throwable;)Z
...
.method public static final l(Lkotlinx/coroutines/y1;Lkotlin/coroutines/c;)Ljava/lang/Object;
    ...
    .line 2
    invoke-interface {p0, p1}, Lkotlinx/coroutines/y1;->X0(Lkotlin/coroutines/c;)Ljava/lang/Object;
...
.method public static final synthetic m(Lkotlin/coroutines/CoroutineContext;)V
    ...
    .line 1
    invoke-static {p0, v0}, Lkotlinx/coroutines/b2;->o(Lkotlin/coroutines/CoroutineContext;Ljava/util/concurrent/CancellationException;)V
...
.method public static final synthetic n(Lkotlin/coroutines/CoroutineContext;Ljava/lang/Throwable;)V
    ...
    .line 2
    :cond_0
    invoke-interface {p0}, Lkotlinx/coroutines/y1;->w()Lkotlin/sequences/m;
    ...
    invoke-virtual {v1, v2}, Lkotlinx/coroutines/JobSupport;->Z(Ljava/lang/Throwable;)V
...
.method public static final synthetic p(Lkotlinx/coroutines/y1;)V
    .locals 1
    .annotation runtime Lkotlin/Deprecated;
        level = .enum Lkotlin/DeprecationLevel;->HIDDEN:Lkotlin/DeprecationLevel;
        message = "Since 1.2.0, binary compatibility with versions <= 1.1.x"
    ...
    .line 1
    invoke-static {p0, v0}, Lkotlinx/coroutines/b2;->r(Lkotlinx/coroutines/y1;Ljava/util/concurrent/CancellationException;)V
...
.method public static synthetic s(Lkotlin/coroutines/CoroutineContext;Ljava/lang/Throwable;ILjava/lang/Object;)V
    ...
    .line 1
    :cond_0
    invoke-static {p0, p1}, Lkotlinx/coroutines/b2;->n(Lkotlin/coroutines/CoroutineContext;Ljava/lang/Throwable;)V
...
.method public static synthetic t(Lkotlin/coroutines/CoroutineContext;Ljava/util/concurrent/CancellationException;ILjava/lang/Object;)V
    ...
    .line 1
    :cond_0
    invoke-static {p0, p1}, Lkotlinx/coroutines/b2;->o(Lkotlin/coroutines/CoroutineContext;Ljava/util/concurrent/CancellationException;)V
...
.method public static synthetic u(Lkotlinx/coroutines/y1;Ljava/lang/Throwable;ILjava/lang/Object;)V
    ...
    .line 1
    :cond_0
    invoke-static {p0, p1}, Lkotlinx/coroutines/b2;->q(Lkotlinx/coroutines/y1;Ljava/lang/Throwable;)V
...
.method public static synthetic v(Lkotlinx/coroutines/y1;Ljava/util/concurrent/CancellationException;ILjava/lang/Object;)V
    ...
    .line 1
    :cond_0
    invoke-static {p0, p1}, Lkotlinx/coroutines/b2;->r(Lkotlinx/coroutines/y1;Ljava/util/concurrent/CancellationException;)V

    return-void
.end method

.method public static final w(Lkotlinx/coroutines/y1;Lkotlinx/coroutines/f1;)Lkotlinx/coroutines/f1;
    .locals 1
    .param p0    # Lkotlinx/coroutines/y1;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-direct {v0, p1}, Lkotlinx/coroutines/h1;-><init>(Lkotlinx/coroutines/f1;)V

    invoke-interface {p0, v0}, Lkotlinx/coroutines/y1;->E1(Lgl/l;)Lkotlinx/coroutines/f1;
...
.method public static final x(Lkotlin/coroutines/CoroutineContext;)V
    ...
    :cond_0
    invoke-static {p0}, Lkotlinx/coroutines/b2;->A(Lkotlinx/coroutines/y1;)V

    :goto_0
    return-void
.end method

.method public static final y(Lkotlinx/coroutines/y1;)V
    .locals 1
    .param p0    # Lkotlinx/coroutines/y1;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    :cond_0
    invoke-interface {p0}, Lkotlinx/coroutines/y1;->J()Ljava/util/concurrent/CancellationException;
...
.method public static final z(Lkotlin/coroutines/CoroutineContext;)Lkotlinx/coroutines/y1;
    .locals 2
    .param p0    # Lkotlin/coroutines/CoroutineContext;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation

.class Lorg/jdesktop/application/ResourceMap$PointStringConverter;
...
.method public parseString(Ljava/lang/String;Lorg/jdesktop/application/ResourceMap;)Ljava/lang/Object;
    ...
    const-string v0, "invalid x,y Point string"
    ...
    .line 2
    new-instance p2, Ljava/awt/Point;

    invoke-direct {p2}, Ljava/awt/Point;-><init>()V
    ...
    invoke-virtual {p2, v0, v1, v2, v3}, Ljava/awt/Point;->setLocation(DD)V

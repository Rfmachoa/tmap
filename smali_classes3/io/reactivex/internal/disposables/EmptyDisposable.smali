...
.method public static complete(Loj/d;)V
    .locals 1

    .line 5
    sget-object v0, Lio/reactivex/internal/disposables/EmptyDisposable;->INSTANCE:Lio/reactivex/internal/disposables/EmptyDisposable;

    invoke-interface {p0, v0}, Loj/d;->onSubscribe(Lio/reactivex/disposables/b;)V

    .line 6
    invoke-interface {p0}, Loj/d;->onComplete()V

    return-void
.end method

.method public static complete(Loj/g0;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p0, v0}, Loj/g0;->onSubscribe(Lio/reactivex/disposables/b;)V
...
.method public static complete(Loj/t;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p0, v0}, Loj/t;->onSubscribe(Lio/reactivex/disposables/b;)V

    .line 4
    invoke-interface {p0}, Loj/t;->onComplete()V

    return-void
.end method

.method public static error(Ljava/lang/Throwable;Loj/d;)V
    .locals 1
    ...
    .line 4
    invoke-interface {p1, p0}, Loj/d;->onError(Ljava/lang/Throwable;)V

    return-void
.end method

.method public static error(Ljava/lang/Throwable;Loj/g0;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static error(Ljava/lang/Throwable;Loj/l0;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 6
    invoke-interface {p1, p0}, Loj/l0;->onError(Ljava/lang/Throwable;)V

    return-void
.end method

.method public static error(Ljava/lang/Throwable;Loj/t;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 8
    invoke-interface {p1, p0}, Loj/t;->onError(Ljava/lang/Throwable;)V

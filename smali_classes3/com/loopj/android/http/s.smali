...
.method public b(Ldf/t;Lpg/g;)Ljava/net/URI;
    ...
    .line 8
    invoke-interface {p2, v3}, Lpg/g;->getAttribute(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-interface {v3}, Ldf/q;->getRequestLine()Ldf/a0;

    move-result-object v3

    invoke-interface {v3}, Ldf/a0;->getUri()Ljava/lang/String;
    ...
    .line 10
    invoke-static {v4, v0, v2}, Lnf/i;->j(Ljava/net/URI;Lcz/msebera/android/httpclient/HttpHost;Z)Ljava/net/URI;
    ...
    .line 24
    invoke-static {v1, p1, v2}, Lnf/i;->j(Ljava/net/URI;Lcz/msebera/android/httpclient/HttpHost;Z)Ljava/net/URI;

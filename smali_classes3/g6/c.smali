...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lg6/c;->f:Ljava/util/logging/Logger;
...
.method public constructor <init>(I)V
    ...
    iput-object v0, p0, Lg6/c;->d:Lf6/d;

    .line 4
    new-instance v0, Lf6/f;

    invoke-direct {v0, p1}, Lf6/f;-><init>(I)V

    .line 5
    iget-object p1, p0, Lg6/c;->d:Lf6/d;

    invoke-virtual {p1, v0}, Lf6/d;->C(Lf6/c;)V

    .line 6
    new-instance p1, Lg6/b;

    invoke-direct {p1, v0}, Lg6/b;-><init>(Lf6/c;)V
...
.method public a(Le6/c;)V
    ...
    .line 2
    iget-object v1, v0, Lg6/c;->b:Ljava/io/File;
    ...
    .line 4
    invoke-virtual {v1, v2}, Lf6/b;->a(Le6/c;)Lcom/coremedia/iso/IsoFile;
    ...
    iget-object v4, v0, Lg6/c;->b:Ljava/io/File;
    ...
    .line 9
    :goto_0
    invoke-virtual/range {p0 .. p1}, Lg6/c;->c(Le6/c;)Le6/c;

    move-result-object v1

    .line 10
    invoke-virtual {v0, v1}, Lg6/c;->b(Le6/c;)Le6/c;

    move-result-object v1

    .line 11
    iget-boolean v2, v0, Lg6/c;->c:Z
    ...
    .line 13
    invoke-virtual {v2, v1}, Lf6/b;->a(Le6/c;)Lcom/coremedia/iso/IsoFile;
    ...
    .line 18
    :cond_1
    iget-object v2, v0, Lg6/c;->d:Lf6/d;

    invoke-virtual {v2, v1}, Lf6/d;->a(Le6/c;)Lcom/coremedia/iso/IsoFile;

    move-result-object v2

    .line 19
    iget-boolean v3, v0, Lg6/c;->c:Z
    ...
    .line 24
    :cond_2
    invoke-virtual {v1}, Le6/c;->f()Ljava/util/List;
    ...
    .line 26
    iget-object v3, v0, Lg6/c;->e:Lg6/d;

    invoke-interface {v3, v1}, Lg6/d;->a(Le6/c;)Ljava/lang/String;
    ...
    .line 29
    iget-object v5, v0, Lg6/c;->e:Lg6/d;

    invoke-interface {v5, v4}, Lg6/d;->b(Le6/e;)J
    ...
    .line 30
    invoke-interface {v4}, Le6/e;->i()Le6/f;
    ...
    .line 31
    invoke-virtual {v2}, Ld6/b;->getBoxes()Ljava/util/List;
    ...
    .line 32
    invoke-interface {v4}, Le6/e;->f()Lcom/coremedia/iso/boxes/AbstractMediaHeaderBox;
    ...
    iget-object v10, v0, Lg6/c;->b:Ljava/io/File;
    ...
    .line 38
    sget-object v5, Lg6/c;->f:Ljava/util/logging/Logger;
    ...
    invoke-interface {v5, v4, v1}, Lg6/d;->c(Le6/e;Le6/c;)[J
    ...
    invoke-interface {v4}, Le6/e;->getHandler()Ljava/lang/String;
...
.method public b(Le6/c;)Le6/c;
    ...
    iget-wide v4, p0, Lg6/c;->a:J

    iget-object v6, p0, Lg6/c;->d:Lf6/d;

    invoke-virtual {v6}, Lf6/d;->z()Lf6/c;

    move-result-object v6

    invoke-interface {v6, v2, p1}, Lf6/c;->a(Le6/e;Le6/c;)[J

    move-result-object v6

    invoke-direct {v3, v2, v4, v5, v6}, Lcom/googlecode/mp4parser/authoring/tracks/d;-><init>(Le6/e;J[J)V

    invoke-virtual {v0, v3}, Le6/c;->a(Le6/e;)V
...
.method public final c(Le6/c;)Le6/c;
    ...
    .line 3
    invoke-interface {v1}, Le6/e;->getHandler()Ljava/lang/String;
    ...
    .line 4
    :cond_1
    sget-object v2, Lg6/c;->f:Ljava/util/logging/Logger;
    ...
    :cond_2
    :goto_1
    invoke-virtual {v0, v1}, Le6/c;->a(Le6/e;)V
...
.method public e(Lf6/d;)V
    .locals 1

    .line 1
    iput-object p1, p0, Lg6/c;->d:Lf6/d;

    .line 2
    new-instance v0, Lg6/b;

    invoke-virtual {p1}, Lf6/d;->z()Lf6/c;

    move-result-object p1

    invoke-direct {v0, p1}, Lg6/b;-><init>(Lf6/c;)V

    iput-object v0, p0, Lg6/c;->e:Lg6/d;

    return-void
.end method

.method public f(Lg6/d;)V
    .locals 0
...
.method public g(Ljava/io/File;)V
    ...
    .line 1
    iput-object p1, p0, Lg6/c;->b:Ljava/io/File;

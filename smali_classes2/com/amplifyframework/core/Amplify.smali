...
.method public static addPlugin(Lcom/amplifyframework/core/plugin/Plugin;)V
    .locals 1
    .param p0    # Lcom/amplifyframework/core/plugin/Plugin;
...
.method private static beginInitialization(Lcom/amplifyframework/core/category/Category;Landroid/content/Context;)V
    .locals 2
    .param p0    # Lcom/amplifyframework/core/category/Category;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    ...
    new-instance v1, Lcom/amplifyframework/core/a;

    invoke-direct {v1, p0, p1}, Lcom/amplifyframework/core/a;-><init>(Lcom/amplifyframework/core/category/Category;Landroid/content/Context;)V
...
.method public static configure(Lcom/amplifyframework/core/AmplifyConfiguration;Landroid/content/Context;)V
    .locals 4
    .param p0    # Lcom/amplifyframework/core/AmplifyConfiguration;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    .param p1    # Landroid/content/Context;
    ...
    invoke-direct {p0, p1}, Lcom/amplifyframework/core/Amplify$AlreadyConfiguredException;-><init>(Lcom/amplifyframework/core/Amplify$1;)V
...
.method private static updatePluginRegistry(Lcom/amplifyframework/core/plugin/Plugin;Lcom/amplifyframework/core/Amplify$RegistryUpdateType;)V
    ...
    .line 7
    invoke-virtual {v1, p0}, Lcom/amplifyframework/core/category/Category;->removePlugin(Lcom/amplifyframework/core/plugin/Plugin;)V

    goto :goto_1

    .line 8
    :cond_0
    invoke-virtual {v1, p0}, Lcom/amplifyframework/core/category/Category;->addPlugin(Lcom/amplifyframework/core/plugin/Plugin;)V
    ...
    const-string v2, "The client tried to "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v1, p0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string p0, " a plugin after calling configure()."
    ...
    const-string v1, "Plugins may not be added or removed after configure(...) is called."

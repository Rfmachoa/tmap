...
.method public static synthetic b(Lcom/fingram/mi/scanner/CardView;)La7/b;
    .locals 0

    iget-object p0, p0, Lcom/fingram/mi/scanner/CardView;->g:La7/b;
...
.method private setGuideFrame(Landroid/view/SurfaceView;)V
    ...
    .line 1
    iget-object v0, p0, Lcom/fingram/mi/scanner/CardView;->d:Lz6/b;
...
.method public c(FFFLcom/fingram/mi/bankcard/BankCardScanner$CardOrientation;)I
    ...
    .line 2
    iget-object p2, p0, Lcom/fingram/mi/scanner/CardView;->a:Lz6/c;

    invoke-virtual {p2}, Lz6/c;->getSurfaceView()Landroid/view/SurfaceView;
...
.method public f(Landroid/content/Context;Lz6/b;)V
    .locals 2

    .line 1
    iput-object p2, p0, Lcom/fingram/mi/scanner/CardView;->d:Lz6/b;
    ...
    invoke-direct {v0, p1, p2}, Lcom/fingram/mi/scanner/CardScanner;-><init>(Landroid/content/Context;Lz6/b;)V

    iput-object v0, p0, Lcom/fingram/mi/scanner/CardView;->c:Lcom/fingram/mi/scanner/CardScanner;

    .line 4
    invoke-virtual {v0, p2}, Lcom/fingram/mi/scanner/CardScanner;->t(Lz6/b;)Z
    ...
    .line 6
    iget-object v0, p0, Lcom/fingram/mi/scanner/CardView;->a:Lz6/c;
    ...
    invoke-direct {v0, p1, v1, p2}, Lcom/fingram/mi/scanner/a;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;Lz6/b;)V
    ...
    invoke-virtual {p1, p2}, Lcom/fingram/mi/scanner/CardScanner;->n(La7/a;)V
...
.method public h(Landroid/content/Context;I)V
    ...
    iget-object v1, p0, Lcom/fingram/mi/scanner/CardView;->d:Lz6/b;
    ...
    invoke-direct/range {v1 .. v6}, Lz6/c;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;III)V

    iput-object v0, p0, Lcom/fingram/mi/scanner/CardView;->a:Lz6/c;
...
.method public i()Z
    ...
    invoke-virtual {v0, v1}, Lz6/c;->setOrientationInfo(I)V
    ...
    .line 3
    invoke-virtual {v0, v1}, Lcom/fingram/mi/scanner/a;->setResultInfo(Lz6/e;)V
    ...
    iget-object v1, p0, Lcom/fingram/mi/scanner/CardView;->a:Lz6/c;

    invoke-virtual {v1}, Lz6/c;->getSurfaceHolder()Landroid/view/SurfaceHolder;
...
.method public setCardViewListener(La7/b;)V
    .locals 0

    iput-object p1, p0, Lcom/fingram/mi/scanner/CardView;->g:La7/b;

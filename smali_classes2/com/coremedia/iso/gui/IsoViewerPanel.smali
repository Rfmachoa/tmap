...
.method private showSamples(Ljava/lang/Object;)V
    ...
    invoke-virtual {p1, v0}, Lw7/b;->getBoxes(Ljava/lang/Class;)Ljava/util/List;
    ...
    invoke-virtual {v0}, Le8/a;->a()Lcom/coremedia/iso/boxes/h264/AvcConfigurationBox$AVCDecoderConfigurationRecord;
...
.method public open(Ljava/io/File;)V
    ...
    invoke-static {v1}, Lr8/d;->a(Lcom/coremedia/iso/boxes/Box;)Ljava/lang/String;

    move-result-object v1

    .line 21
    invoke-static {v0, v1}, Lr8/d;->c(Lcom/coremedia/iso/boxes/Box;Ljava/lang/String;)Lcom/coremedia/iso/boxes/Box;
...
.method public showDetails(Ljava/lang/Object;)V
    ...
    invoke-static {v1, v2}, Lr8/b;->a(J)I
    ...
    invoke-direct {v2, v1}, Lr8/a;-><init>(Ljava/nio/ByteBuffer;)V

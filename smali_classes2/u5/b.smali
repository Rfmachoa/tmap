...
# static fields
.field public static final d:Lpk/c;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lu5/b;->e:Ljava/nio/charset/Charset;
    ...
    sput-object v0, Lu5/b;->f:Ljava/util/UUID;
    ...
    sput-object v0, Lu5/b;->g:Ljava/util/UUID;
    ...
    sput-object v0, Lu5/b;->h:Ljava/util/UUID;
    ...
    sput-object v0, Lu5/b;->i:Ljava/util/UUID;
...
.method public constructor <init>(Ljava/util/UUID;Ljava/security/MessageDigest;Lcom/fasterxml/uuid/UUIDType;)V
    ...
    .line 2
    iput-object p1, p0, Lu5/b;->a:Ljava/util/UUID;
    ...
    .line 9
    sget-object v0, Lu5/b;->d:Lpk/c;

    const-string v1, "Could not determine type of Digester from \'{}\'; assuming \'SHA-1\' type"

    invoke-interface {v0, v1, p1}, Lpk/c;->warn(Ljava/lang/String;Ljava/lang/Object;)V

    .line 10
    :cond_2
    :goto_0
    iput-object p2, p0, Lu5/b;->b:Ljava/security/MessageDigest;

    .line 11
    iput-object p3, p0, Lu5/b;->c:Lcom/fasterxml/uuid/UUIDType;
...
.method public a()Lcom/fasterxml/uuid/UUIDType;
    ...
    .line 1
    iget-object v0, p0, Lu5/b;->c:Lcom/fasterxml/uuid/UUIDType;
...
.method public b(Ljava/lang/String;)Ljava/util/UUID;
    ...
    .line 1
    sget-object v0, Lu5/b;->e:Ljava/nio/charset/Charset;

    invoke-virtual {p1, v0}, Ljava/lang/String;->getBytes(Ljava/nio/charset/Charset;)[B

    move-result-object p1

    invoke-virtual {p0, p1}, Lu5/b;->c([B)Ljava/util/UUID;
...
.method public c([B)Ljava/util/UUID;
    ...
    .line 1
    iget-object v0, p0, Lu5/b;->b:Ljava/security/MessageDigest;

    monitor-enter v0

    .line 2
    :try_start_0
    iget-object v1, p0, Lu5/b;->b:Ljava/security/MessageDigest;

    invoke-virtual {v1}, Ljava/security/MessageDigest;->reset()V

    .line 3
    iget-object v1, p0, Lu5/b;->a:Ljava/util/UUID;

    if-eqz v1, :cond_0

    .line 4
    iget-object v2, p0, Lu5/b;->b:Ljava/security/MessageDigest;

    invoke-static {v1}, Lu5/e;->d(Ljava/util/UUID;)[B
    ...
    .line 6
    iget-object p1, p0, Lu5/b;->b:Ljava/security/MessageDigest;
    ...
    invoke-static {v0, p1}, Lu5/e;->f(Lcom/fasterxml/uuid/UUIDType;[B)Ljava/util/UUID;
...
.method public d()Ljava/util/UUID;
    ...
    .line 1
    iget-object v0, p0, Lu5/b;->a:Ljava/util/UUID;

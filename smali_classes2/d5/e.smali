...
.method public bridge synthetic a(Ljava/lang/Object;IILu4/e;)Lcom/bumptech/glide/load/engine/s;
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Ld5/e;->c(Landroid/net/Uri;IILu4/e;)Lcom/bumptech/glide/load/engine/s;
...
.method public bridge synthetic b(Ljava/lang/Object;Lu4/e;)Z
    ...
    invoke-virtual {p0, p1, p2}, Ld5/e;->h(Landroid/net/Uri;Lu4/e;)Z
...
.method public c(Landroid/net/Uri;IILu4/e;)Lcom/bumptech/glide/load/engine/s;
    ...
    .line 2
    invoke-virtual {p0, p1, p2}, Ld5/e;->d(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Context;

    move-result-object p2

    .line 3
    invoke-virtual {p0, p2, p1}, Ld5/e;->g(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    invoke-static {p3, p2, p1}, Ld5/a;->b(Landroid/content/Context;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object p1

    .line 5
    invoke-static {p1}, Ld5/d;->d(Landroid/graphics/drawable/Drawable;)Lcom/bumptech/glide/load/engine/s;
...
.method public final d(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Context;
    ...
    .line 2
    iget-object p1, p0, Ld5/e;->a:Landroid/content/Context;
...
.method public final e(Landroid/net/Uri;)I
    ...
    invoke-static {v2, p1}, Landroidx/appcompat/widget/b0;->a(Ljava/lang/String;Landroid/net/Uri;)Ljava/lang/String;
...
.method public final f(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    invoke-static {v0, p2}, Landroidx/appcompat/widget/b0;->a(Ljava/lang/String;Landroid/net/Uri;)Ljava/lang/String;
...
.method public final g(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    .line 3
    invoke-virtual {p0, p1, p2}, Ld5/e;->f(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    .line 5
    invoke-virtual {p0, p2}, Ld5/e;->e(Landroid/net/Uri;)I
...
.method public h(Landroid/net/Uri;Lu4/e;)Z
    .locals 0
    .param p1    # Landroid/net/Uri;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation

...
.method public bridge synthetic a(Ljava/lang/Object;IILr6/e;)Lcom/bumptech/glide/load/engine/s;
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, La7/f;->c(Landroid/net/Uri;IILr6/e;)Lcom/bumptech/glide/load/engine/s;
...
.method public bridge synthetic b(Ljava/lang/Object;Lr6/e;)Z
    ...
    invoke-virtual {p0, p1, p2}, La7/f;->h(Landroid/net/Uri;Lr6/e;)Z
...
.method public c(Landroid/net/Uri;IILr6/e;)Lcom/bumptech/glide/load/engine/s;
    .locals 0
    ...
    .line 2
    invoke-virtual {p0, p1, p2}, La7/f;->d(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Context;

    move-result-object p2

    .line 3
    invoke-virtual {p0, p2, p1}, La7/f;->g(Landroid/content/Context;Landroid/net/Uri;)I

    move-result p1

    .line 4
    iget-object p3, p0, La7/f;->a:Landroid/content/Context;

    invoke-static {p3, p2, p1}, La7/b;->b(Landroid/content/Context;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object p1

    .line 5
    invoke-static {p1}, La7/e;->d(Landroid/graphics/drawable/Drawable;)Lcom/bumptech/glide/load/engine/s;
...
.method public final d(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Context;
    ...
    .line 1
    iget-object v0, p0, La7/f;->a:Landroid/content/Context;
    ...
    .line 2
    iget-object p1, p0, La7/f;->a:Landroid/content/Context;
...
.method public final g(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    .line 3
    invoke-virtual {p0, p1, p2}, La7/f;->f(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    .line 5
    invoke-virtual {p0, p2}, La7/f;->e(Landroid/net/Uri;)I
...
.method public h(Landroid/net/Uri;Lr6/e;)Z
    .locals 0
    .param p1    # Landroid/net/Uri;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation

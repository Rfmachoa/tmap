...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;Lz4/d;Landroid/os/Bundle;)V
    .locals 0
    ...
    invoke-direct/range {p0 .. p6}, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;-><init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;Lz4/d;Landroid/os/Bundle;)V
...
.method public N(Landroid/app/PendingIntent;Landroid/content/ComponentName;)V
    ...
    .line 3
    :cond_0
    invoke-super {p0, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->N(Landroid/app/PendingIntent;Landroid/content/ComponentName;)V
...
.method public c(Landroid/support/v4/media/session/MediaSessionCompat$b;Landroid/os/Handler;)V
    ...
    .line 1
    invoke-super {p0, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->c(Landroid/support/v4/media/session/MediaSessionCompat$b;Landroid/os/Handler;)V
...
.method public x(J)I
    ...
    invoke-super {p0, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->x(J)I
...
.method public z(Landroid/app/PendingIntent;Landroid/content/ComponentName;)V
    ...
    .line 6
    invoke-super {p0, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->z(Landroid/app/PendingIntent;Landroid/content/ComponentName;)V

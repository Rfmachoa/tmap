...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;Landroid/os/Bundle;)V
    ...
    .line 3
    invoke-direct/range {v0 .. v6}, Landroid/support/v4/media/session/MediaSessionCompat;-><init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;Landroid/os/Bundle;Lz4/d;)V

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;Landroid/os/Bundle;Lz4/d;)V
    .locals 2
    .param p1    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-direct {p3, p1, p2, p6, p5}, Landroid/support/v4/media/session/MediaSessionCompat$h;-><init>(Landroid/content/Context;Ljava/lang/String;Lz4/d;Landroid/os/Bundle;)V
    ...
    invoke-direct {p3, p1, p2, p6, p5}, Landroid/support/v4/media/session/MediaSessionCompat$g;-><init>(Landroid/content/Context;Ljava/lang/String;Lz4/d;Landroid/os/Bundle;)V
    ...
    invoke-direct {p3, p1, p2, p6, p5}, Landroid/support/v4/media/session/MediaSessionCompat$f;-><init>(Landroid/content/Context;Ljava/lang/String;Lz4/d;Landroid/os/Bundle;)V
    ...
    invoke-interface {p2, p4}, Landroid/support/v4/media/session/MediaSessionCompat$c;->m(Landroid/app/PendingIntent;)V
...
.method public A(Ljava/lang/CharSequence;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$c;->d(Ljava/lang/CharSequence;)V
...
.method public d()Ljava/lang/String;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaSessionCompat$c;->i()Ljava/lang/String;
...
.method public final f()Landroidx/media/e$b;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaSessionCompat$c;->s()Landroidx/media/e$b;
...
.method public h()Ljava/lang/Object;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaSessionCompat$c;->n()Ljava/lang/Object;
...
.method public n(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$c;->b(Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public o(Z)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$c;->o(Z)V
...
.method public q(Landroid/support/v4/media/session/MediaSessionCompat$b;Landroid/os/Handler;)V
    ...
    invoke-interface {p1, p2, p2}, Landroid/support/v4/media/session/MediaSessionCompat$c;->c(Landroid/support/v4/media/session/MediaSessionCompat$b;Landroid/os/Handler;)V
    ...
    :goto_0
    invoke-interface {v0, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$c;->c(Landroid/support/v4/media/session/MediaSessionCompat$b;Landroid/os/Handler;)V
...
.method public v(Landroid/support/v4/media/MediaMetadataCompat;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$c;->e(Landroid/support/v4/media/MediaMetadataCompat;)V
...
.method public x(I)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$c;->k(I)V
...
.method public y(Landroidx/media/VolumeProviderCompat;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$c;->r(Landroidx/media/VolumeProviderCompat;)V
...
.method public z(Ljava/util/List;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$c;->g(Ljava/util/List;)V

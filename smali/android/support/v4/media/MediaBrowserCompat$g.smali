...
.method public constructor <init>(Landroid/content/Context;Landroid/content/ComponentName;Landroid/support/v4/media/MediaBrowserCompat$c;Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Landroid/support/v4/media/MediaBrowserCompat$g;->e:Landroidx/collection/b;
...
.method public b(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/MediaBrowserCompat$d;)V
    ...
    invoke-virtual {v2, p1, p2, v0, v3}, Landroid/support/v4/media/MediaBrowserCompat$m;->h(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/os/ResultReceiver;Landroid/os/Messenger;)V
    :try_end_0
...
.method public c(Landroid/os/Messenger;Ljava/lang/String;Ljava/util/List;Landroid/os/Bundle;Landroid/os/Bundle;)V
    ...
    .line 2
    :cond_0
    iget-object p1, p0, Landroid/support/v4/media/MediaBrowserCompat$g;->e:Landroidx/collection/b;
...
.method public e(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/MediaBrowserCompat$l;)V
    ...
    invoke-virtual {v2, p1, p2, v0, v3}, Landroid/support/v4/media/MediaBrowserCompat$m;->g(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/os/ResultReceiver;Landroid/os/Messenger;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public j(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/MediaBrowserCompat$o;)V
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v4/media/MediaBrowserCompat$g;->e:Landroidx/collection/b;
    ...
    .line 3
    iget-object v1, p0, Landroid/support/v4/media/MediaBrowserCompat$g;->e:Landroidx/collection/b;
...
.method public l(Ljava/lang/String;Landroid/support/v4/media/MediaBrowserCompat$o;)V
    ...
    .line 22
    :cond_8
    iget-object p2, p0, Landroid/support/v4/media/MediaBrowserCompat$g;->e:Landroidx/collection/b;
...
.method public onConnected()V
    ...
    .line 3
    invoke-static {v1, v2}, Landroidx/core/app/k$a;->a(Landroid/os/Bundle;Ljava/lang/String;)Landroid/os/IBinder;
    ...
    .line 9
    invoke-static {v1, v0}, Landroidx/core/app/k$a;->a(Landroid/os/Bundle;Ljava/lang/String;)Landroid/os/IBinder;

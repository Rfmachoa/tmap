...
.method public constructor <init>(Landroidx/camera/video/internal/AudioSource$f;Ljava/util/concurrent/Executor;Landroid/content/Context;)V
    ...
    .line 12
    invoke-static {p2}, Landroidx/camera/core/impl/utils/executor/a;->h(Ljava/util/concurrent/Executor;)Ljava/util/concurrent/Executor;
    ...
    .line 20
    invoke-static {}, Ln0/a;->b()Landroid/media/AudioRecord$Builder;
    ...
    .line 21
    invoke-static {v4, p3}, Ln0/f;->c(Landroid/media/AudioRecord$Builder;Landroid/content/Context;)V
    ...
    invoke-static {v4, p1}, Ln0/a;->d(Landroid/media/AudioRecord$Builder;I)V

    .line 23
    invoke-static {v4, v2}, Ln0/a;->c(Landroid/media/AudioRecord$Builder;Landroid/media/AudioFormat;)V

    .line 24
    invoke-static {v4, v0}, Ln0/a;->e(Landroid/media/AudioRecord$Builder;I)V

    .line 25
    invoke-static {v4}, Ln0/a;->a(Landroid/media/AudioRecord$Builder;)Landroid/media/AudioRecord;
    ...
    .line 27
    new-instance p3, Landroidx/camera/video/internal/AudioSource$d;

    invoke-direct {p3, p0}, Landroidx/camera/video/internal/AudioSource$d;-><init>(Landroidx/camera/video/internal/AudioSource;)V

    iput-object p3, p0, Landroidx/camera/video/internal/AudioSource;->b:Landroid/media/AudioManager$AudioRecordingCallback;

    .line 28
    invoke-static {p1, p2, p3}, Ln0/e;->b(Landroid/media/AudioRecord;Ljava/util/concurrent/Executor;Landroid/media/AudioManager$AudioRecordingCallback;)V
...
.method private synthetic m()V
    ...
    invoke-static {v0, v1}, Ln0/e;->c(Landroid/media/AudioRecord;Landroid/media/AudioManager$AudioRecordingCallback;)V
...
.method public i()J
    ...
    invoke-static {v1, v0, v2}, Ln0/b;->b(Landroid/media/AudioRecord;Landroid/media/AudioTimestamp;I)I
...
.method public final t(Landroidx/camera/video/internal/BufferProvider;)V
    ...
    .line 2
    iget-object v1, p0, Landroidx/camera/video/internal/AudioSource;->m:Lb0/j1$a;
    ...
    .line 4
    iput-object v0, p0, Landroidx/camera/video/internal/AudioSource;->m:Lb0/j1$a;
    ...
    invoke-interface {p1, v0, v1}, Lb0/j1;->c(Ljava/util/concurrent/Executor;Lb0/j1$a;)V

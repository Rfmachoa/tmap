...
.method public constructor <init>(Ln0/a;)V
    ...
    iput-object p1, p0, Landroidx/camera/video/f1;->r:Lc0/j1$a;

    return-void
.end method

.method public static synthetic N(Landroidx/camera/video/f1;Ljava/lang/String;Ln0/a;Landroid/util/Size;Landroidx/camera/core/impl/SessionConfig;Landroidx/camera/core/impl/SessionConfig$SessionError;)V
    .locals 0

    invoke-static {p0}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;)Ljava/lang/Object;

    invoke-virtual {p0, p1, p2, p3}, Landroidx/camera/video/f1;->g0(Ljava/lang/String;Ln0/a;Landroid/util/Size;)V
...
.method public static synthetic P(Ljava/util/concurrent/atomic/AtomicBoolean;Landroidx/camera/core/impl/SessionConfig$b;Lc0/m;)V
    .locals 0

    invoke-static {p0, p1, p2}, Landroidx/camera/video/f1;->e0(Ljava/util/concurrent/atomic/AtomicBoolean;Landroidx/camera/core/impl/SessionConfig$b;Lc0/m;)V
...
.method public static Y(Lc0/j1;Ljava/lang/Object;)Ljava/lang/Object;
    .locals 1
    .param p0    # Lc0/j1;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 1
    invoke-interface {p0}, Lc0/j1;->c()Lcom/google/common/util/concurrent/ListenableFuture;
...
.method private synthetic d0(Ljava/lang/String;Ln0/a;Landroid/util/Size;Landroidx/camera/core/impl/SessionConfig;Landroidx/camera/core/impl/SessionConfig$SessionError;)V
    .locals 0
...
.method public static synthetic e0(Ljava/util/concurrent/atomic/AtomicBoolean;Landroidx/camera/core/impl/SessionConfig$b;Lc0/m;)V
    .locals 2
    ...
    .line 3
    invoke-virtual {p1, p2}, Landroidx/camera/core/impl/SessionConfig$b;->r(Lc0/m;)Z

    return-void
.end method

.method private f0(Landroidx/camera/core/impl/SessionConfig$b;Landroidx/concurrent/futures/CallbackToFutureAdapter$a;)Ljava/lang/Object;
    .locals 5
    ...
    invoke-direct {v4, v0, p1, v3}, Landroidx/camera/video/e1;-><init>(Ljava/util/concurrent/atomic/AtomicBoolean;Landroidx/camera/core/impl/SessionConfig$b;Lc0/m;)V
    ...
    .line 7
    invoke-virtual {p1, v3}, Landroidx/camera/core/impl/SessionConfig$b;->j(Lc0/m;)V
...
.method public D(Lc0/y;Landroidx/camera/core/impl/q$a;)Landroidx/camera/core/impl/q;
    ...
    .line 1
    invoke-virtual {p0, p1, p2}, Landroidx/camera/video/f1;->l0(Lc0/y;Landroidx/camera/core/impl/q$a;)V
...
.method public E()V
    ...
    invoke-interface {v0}, Landroidx/camera/video/VideoOutput;->c()Lc0/j1;
    ...
    .line 4
    iget-object v2, p0, Landroidx/camera/video/f1;->r:Lc0/j1$a;

    invoke-interface {v0, v1, v2}, Lc0/j1;->b(Ljava/util/concurrent/Executor;Lc0/j1$a;)V
...
.method public F()V
    ...
    iget-object v1, p0, Landroidx/camera/video/f1;->r:Lc0/j1$a;
...
.method public G(Landroid/util/Size;)Landroid/util/Size;
    ...
    .line 3
    iget-object v2, p0, Landroidx/camera/core/UseCase;->f:Landroidx/camera/core/impl/q;
    ...
    invoke-interface {v1}, Landroidx/camera/video/VideoOutput;->c()Lc0/j1;

    move-result-object v1

    sget-object v3, Landroidx/camera/video/StreamInfo;->c:Landroidx/camera/video/StreamInfo;

    invoke-static {v1, v3}, Landroidx/camera/video/f1;->Y(Lc0/j1;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 15
    invoke-virtual {p0, v0, v2, p1}, Landroidx/camera/video/f1;->X(Ljava/lang/String;Ln0/a;Landroid/util/Size;)Landroidx/camera/core/impl/SessionConfig$b;
...
.method public final X(Ljava/lang/String;Ln0/a;Landroid/util/Size;)Landroidx/camera/core/impl/SessionConfig$b;
    .locals 3
    ...
    .line 5
    invoke-virtual {p2}, Ln0/a;->g0()Landroidx/camera/video/VideoOutput;
    ...
    invoke-direct {v1, p0, p1, p2, p3}, Landroidx/camera/video/c1;-><init>(Landroidx/camera/video/f1;Ljava/lang/String;Ln0/a;Landroid/util/Size;)V
...
.method public final a0()Landroidx/camera/video/MediaSpec;
    ...
    invoke-interface {v0}, Landroidx/camera/video/VideoOutput;->b()Lc0/j1;

    move-result-object v0

    const/4 v1, 0x0

    invoke-static {v0, v1}, Landroidx/camera/video/f1;->Y(Lc0/j1;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public b0()Landroidx/camera/video/VideoOutput;
    ...
    invoke-virtual {v0}, Ln0/a;->g0()Landroidx/camera/video/VideoOutput;
...
.method public g0(Ljava/lang/String;Ln0/a;Landroid/util/Size;)V
    .locals 1
    .param p1    # Ljava/lang/String;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 3
    invoke-virtual {p0, p1, p2, p3}, Landroidx/camera/video/f1;->X(Ljava/lang/String;Ln0/a;Landroid/util/Size;)Landroidx/camera/core/impl/SessionConfig$b;
...
.method public h(ZLandroidx/camera/core/impl/UseCaseConfigFactory;)Landroidx/camera/core/impl/q;
    ...
    .line 3
    sget-object p1, Landroidx/camera/video/f1$e;->c:Ln0/a;
    ...
    .line 5
    :cond_1
    invoke-static {p2}, Landroidx/camera/video/f1$d;->u(Landroidx/camera/core/impl/Config;)Landroidx/camera/video/f1$d;
    ...
    .line 7
    invoke-virtual {p1}, Landroidx/camera/video/f1$d;->w()Ln0/a;
...
.method public final h0(Landroid/util/Size;)V
    ...
    invoke-direct {v3, p1, v0, v2}, Landroidx/camera/core/k;-><init>(Landroid/graphics/Rect;II)V

    .line 6
    invoke-virtual {v1, v3}, Landroidx/camera/core/SurfaceRequest;->y(Landroidx/camera/core/SurfaceRequest$e;)V
...
.method public final l0(Lc0/y;Landroidx/camera/core/impl/q$a;)V
    .locals 6
    .param p1    # Lc0/y;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 17
    invoke-interface {p1, p2, v0}, Landroidx/camera/core/impl/k;->u(Landroidx/camera/core/impl/Config$a;Ljava/lang/Object;)V

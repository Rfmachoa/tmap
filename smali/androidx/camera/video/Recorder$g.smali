...
.method public static A(Landroidx/camera/video/t;J)Landroidx/camera/video/Recorder$g;
    .locals 8
...
.method private synthetic H0(Landroidx/camera/video/VideoRecordEvent;)V
    ...
    invoke-virtual {p0}, Landroidx/camera/video/Recorder$g;->N()Landroidx/core/util/d;
...
.method public static synthetic a(Landroidx/camera/video/q;Landroid/net/Uri;)V
    ...
    invoke-static {p0, p1}, Landroidx/camera/video/Recorder$g;->p0(Landroidx/camera/video/q;Landroid/net/Uri;)V
...
.method public static synthetic b(Landroidx/camera/video/q;Landroid/content/Context;Landroid/net/Uri;)V
    ...
    invoke-static {p0, p1, p2}, Landroidx/camera/video/Recorder$g;->t0(Landroidx/camera/video/q;Landroid/content/Context;Landroid/net/Uri;)V
...
.method public static synthetic c(Landroid/os/ParcelFileDescriptor;Landroid/net/Uri;)V
    ...
    invoke-static {p0, p1}, Landroidx/camera/video/Recorder$g;->v0(Landroid/os/ParcelFileDescriptor;Landroid/net/Uri;)V

    return-void
.end method

.method public static synthetic e(Landroidx/camera/video/r;Landroid/os/ParcelFileDescriptor;ILandroidx/core/util/d;)Landroid/media/MediaMuxer;
    .locals 0

    invoke-static {p0, p1, p2, p3}, Landroidx/camera/video/Recorder$g;->l0(Landroidx/camera/video/r;Landroid/os/ParcelFileDescriptor;ILandroidx/core/util/d;)Landroid/media/MediaMuxer;
...
.method public static synthetic g(Ljava/lang/String;Landroid/net/Uri;)V
    ...
    invoke-static {p0, p1}, Landroidx/camera/video/Recorder$g;->r0(Ljava/lang/String;Landroid/net/Uri;)V

    return-void
.end method

.method public static synthetic h(Landroidx/camera/video/Recorder$g;Landroidx/camera/video/VideoRecordEvent;)V
    .locals 0

    invoke-direct {p0, p1}, Landroidx/camera/video/Recorder$g;->H0(Landroidx/camera/video/VideoRecordEvent;)V
...
.method public static synthetic l0(Landroidx/camera/video/r;Landroid/os/ParcelFileDescriptor;ILandroidx/core/util/d;)Landroid/media/MediaMuxer;
    .locals 2
    ...
    const-string p1, "Failed to create folder for "
    ...
    .line 26
    invoke-static {p1, p2}, Lo0/c;->a(Ljava/io/FileDescriptor;I)Landroid/media/MediaMuxer;
...
.method public static synthetic p0(Landroidx/camera/video/q;Landroid/net/Uri;)V
    .locals 3
...
.method public static synthetic r0(Ljava/lang/String;Landroid/net/Uri;)V
    .locals 4
...
.method public static synthetic t0(Landroidx/camera/video/q;Landroid/content/Context;Landroid/net/Uri;)V
    .locals 1
...
.method public static synthetic v0(Landroid/os/ParcelFileDescriptor;Landroid/net/Uri;)V
    .locals 1
...
.method public static synthetic y0(Landroid/net/Uri;)V
    .locals 0
...
.method public abstract N()Landroidx/core/util/d;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
...
.method public V0(Landroidx/camera/video/internal/AudioSource$f;Ljava/util/concurrent/Executor;)Landroidx/camera/video/internal/AudioSource;
    .locals 2
    ...
    .line 1
    invoke-virtual {p0}, Landroidx/camera/video/Recorder$g;->b0()Z
...
.method public X0(ILandroidx/core/util/d;)Landroid/media/MediaMuxer;
    .locals 2
...
.method public abstract Y()Landroidx/camera/video/r;
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
.end method
...
.method public c1(Landroidx/camera/video/VideoRecordEvent;)V
    .locals 4
    ...
    invoke-virtual {p0}, Landroidx/camera/video/Recorder$g;->Y()Landroidx/camera/video/r;
    ...
    .line 12
    invoke-virtual {p0}, Landroidx/camera/video/Recorder$g;->M()Ljava/util/concurrent/Executor;
...
.method public close()V
    ...
    invoke-virtual {p0, v0}, Landroidx/camera/video/Recorder$g;->u(Landroid/net/Uri;)V
...
.method public finalize()V
    ...
    invoke-virtual {p0, v0, v1}, Landroidx/camera/video/Recorder$g;->v(Landroidx/core/util/d;Landroid/net/Uri;)V
    :try_end_0
...
.method public u(Landroid/net/Uri;)V
    ...
    invoke-virtual {p0, v0, p1}, Landroidx/camera/video/Recorder$g;->v(Landroidx/core/util/d;Landroid/net/Uri;)V

    return-void
.end method

.method public final v(Landroidx/core/util/d;Landroid/net/Uri;)V
    .locals 1

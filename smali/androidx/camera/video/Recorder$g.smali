...
.method public static J(Landroidx/camera/video/t;J)Landroidx/camera/video/Recorder$g;
    .locals 8
    ...
    .line 3
    invoke-virtual {p0}, Landroidx/camera/video/t;->c()Ljava/util/concurrent/Executor;

    move-result-object v2

    .line 4
    invoke-virtual {p0}, Landroidx/camera/video/t;->b()Landroidx/core/util/d;

    move-result-object v3

    .line 5
    invoke-virtual {p0}, Landroidx/camera/video/t;->f()Z
...
.method public static synthetic V0(Landroidx/camera/video/q;Landroid/content/Context;Landroid/net/Uri;)V
    ...
    .line 3
    invoke-static {p0, p2, v0}, Lq0/a;->b(Landroid/content/ContentResolver;Landroid/net/Uri;Ljava/lang/String;)Ljava/lang/String;
...
.method public static synthetic a(Landroidx/camera/video/q;Landroid/net/Uri;)V
    ...
    invoke-static {p0, p1}, Landroidx/camera/video/Recorder$g;->q0(Landroidx/camera/video/q;Landroid/net/Uri;)V
...
.method public static synthetic d(Landroidx/camera/video/r;Landroid/os/ParcelFileDescriptor;ILandroidx/core/util/d;)Landroid/media/MediaMuxer;
    .locals 0

    invoke-static {p0, p1, p2, p3}, Landroidx/camera/video/Recorder$g;->o0(Landroidx/camera/video/r;Landroid/os/ParcelFileDescriptor;ILandroidx/core/util/d;)Landroid/media/MediaMuxer;
...
.method public static synthetic g(Ljava/lang/String;Landroid/net/Uri;)V
    ...
    invoke-static {p0, p1}, Landroidx/camera/video/Recorder$g;->v0(Ljava/lang/String;Landroid/net/Uri;)V

    return-void
.end method

.method public static synthetic k(Landroidx/camera/video/Recorder$g;Landroidx/camera/video/VideoRecordEvent;)V
    .locals 0
...
.method public static synthetic o0(Landroidx/camera/video/r;Landroid/os/ParcelFileDescriptor;ILandroidx/core/util/d;)Landroid/media/MediaMuxer;
    .locals 6
    ...
    .line 5
    invoke-static {p0}, Lq0/a;->a(Ljava/io/File;)Z
    ...
    .line 14
    invoke-static {p0, p2}, Ln0/c;->a(Ljava/io/FileDescriptor;I)Landroid/media/MediaMuxer;
    ...
    .line 26
    invoke-static {p0, p1, v0}, Lq0/a;->b(Landroid/content/ContentResolver;Landroid/net/Uri;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0}, Lq0/a;->a(Ljava/io/File;)Z
    ...
    .line 34
    invoke-static {v0, p2}, Ln0/c;->a(Ljava/io/FileDescriptor;I)Landroid/media/MediaMuxer;
...
.method public static synthetic q0(Landroidx/camera/video/q;Landroid/net/Uri;)V
    .locals 3
...
.method private synthetic r1(Landroidx/camera/video/VideoRecordEvent;)V
    ...
    .line 1
    invoke-virtual {p0}, Landroidx/camera/video/Recorder$g;->U()Landroidx/core/util/d;
...
.method public static synthetic s(Landroid/net/Uri;)V
    ...
    invoke-static {p0}, Landroidx/camera/video/Recorder$g;->e1(Landroid/net/Uri;)V

    return-void
.end method

.method public static synthetic v0(Ljava/lang/String;Landroid/net/Uri;)V
    .locals 4
...
# virtual methods
.method public E1(Landroidx/camera/video/internal/AudioSource$f;Ljava/util/concurrent/Executor;)Landroidx/camera/video/internal/AudioSource;
    .locals 2
    ...
    .line 1
    invoke-virtual {p0}, Landroidx/camera/video/Recorder$g;->h0()Z
...
.method public F1(ILandroidx/core/util/d;)Landroid/media/MediaMuxer;
    .locals 2
...
.method public H1(Landroidx/camera/video/VideoRecordEvent;)V
    .locals 4
    ...
    invoke-virtual {p0}, Landroidx/camera/video/Recorder$g;->V()Landroidx/camera/video/r;
    ...
    .line 7
    invoke-virtual {v1}, Landroidx/camera/video/VideoRecordEvent$Finalize;->k()I
    ...
    .line 11
    invoke-virtual {p0}, Landroidx/camera/video/Recorder$g;->T()Ljava/util/concurrent/Executor;
...
.method public abstract U()Landroidx/core/util/d;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
...
.method public abstract V()Landroidx/camera/video/r;
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
.end method
...
.method public close()V
    ...
    invoke-virtual {p0, v0}, Landroidx/camera/video/Recorder$g;->w(Landroid/net/Uri;)V
...
.method public finalize()V
    ...
    invoke-virtual {p0, v0, v1}, Landroidx/camera/video/Recorder$g;->x(Landroidx/core/util/d;Landroid/net/Uri;)V
    :try_end_0
...
.method public w(Landroid/net/Uri;)V
    ...
    invoke-virtual {p0, v0, p1}, Landroidx/camera/video/Recorder$g;->x(Landroidx/core/util/d;Landroid/net/Uri;)V

    return-void
.end method

.method public final x(Landroidx/core/util/d;Landroid/net/Uri;)V
    .locals 1

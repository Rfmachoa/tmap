...
.method public static synthetic a(Li0/p;Landroid/content/Context;Landroidx/camera/core/p;Landroidx/concurrent/futures/CallbackToFutureAdapter$a;)Ljava/lang/Object;
    .locals 0

    invoke-static {p0, p1, p2, p3}, Landroidx/camera/extensions/ExtensionsManager;->j(Li0/p;Landroid/content/Context;Landroidx/camera/core/p;Landroidx/concurrent/futures/CallbackToFutureAdapter$a;)Ljava/lang/Object;
...
.method public static f(Landroid/content/Context;Landroidx/camera/core/p;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    invoke-static {p0, p1, v0}, Landroidx/camera/extensions/ExtensionsManager;->g(Landroid/content/Context;Landroidx/camera/core/p;Li0/p;)Lcom/google/common/util/concurrent/ListenableFuture;
...
.method public static g(Landroid/content/Context;Landroidx/camera/core/p;Li0/p;)Lcom/google/common/util/concurrent/ListenableFuture;
    .locals 3
    .param p0    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    sget-object v2, Li0/o;->b:Li0/o;

    invoke-virtual {v1, v2}, Li0/o;->c(Li0/o;)I
    ...
    invoke-direct {v1, p2, p0, p1}, Landroidx/camera/extensions/f;-><init>(Li0/p;Landroid/content/Context;Landroidx/camera/core/p;)V
...
.method public static synthetic j(Li0/p;Landroid/content/Context;Landroidx/camera/core/p;Landroidx/concurrent/futures/CallbackToFutureAdapter$a;)Ljava/lang/Object;
    .locals 3
    ...
    .line 1
    :try_start_0
    invoke-virtual {p0}, Li0/p;->c()Ljava/lang/String;

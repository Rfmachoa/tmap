...
.method public constructor <init>(Landroid/content/Context;Landroidx/camera/camera2/internal/e;Ljava/lang/Object;Ljava/util/Set;)V
    ...
    .line 5
    iput-object p2, p0, Landroidx/camera/camera2/internal/j1;->b:Landroidx/camera/camera2/internal/e;

    .line 6
    instance-of p2, p3, Lw/i0;
    ...
    .line 8
    :cond_0
    invoke-static {p1}, Lw/i0;->a(Landroid/content/Context;)Lw/i0;

    move-result-object p3

    .line 9
    :goto_0
    invoke-virtual {p0, p1, p3, p4}, Landroidx/camera/camera2/internal/j1;->d(Landroid/content/Context;Lw/i0;Ljava/util/Set;)V
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/Object;Ljava/util/Set;)V
    ...
    invoke-direct {p0, p1, v0, p2, p3}, Landroidx/camera/camera2/internal/j1;-><init>(Landroid/content/Context;Landroidx/camera/camera2/internal/e;Ljava/lang/Object;Ljava/util/Set;)V
...
.method public a(Ljava/lang/String;ILandroid/util/Size;)Landroidx/camera/core/impl/SurfaceConfig;
    ...
    check-cast p1, Landroidx/camera/camera2/internal/e3;

    if-eqz p1, :cond_0

    .line 3
    invoke-virtual {p1, p2, p3}, Landroidx/camera/camera2/internal/e3;->P(ILandroid/util/Size;)Landroidx/camera/core/impl/SurfaceConfig;
...
.method public b(Ljava/lang/String;Ljava/util/List;)Z
    ...
    .line 4
    invoke-virtual {p1, p2}, Landroidx/camera/camera2/internal/e3;->b(Ljava/util/List;)Z
...
.method public c(Ljava/lang/String;Ljava/util/List;Ljava/util/List;)Ljava/util/Map;
    ...
    .line 4
    invoke-virtual {v0, p2, p3}, Landroidx/camera/camera2/internal/e3;->z(Ljava/util/List;Ljava/util/List;)Ljava/util/Map;
...
.method public final d(Landroid/content/Context;Lw/i0;Ljava/util/Set;)V
    .locals 4
    .param p1    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    iget-object v3, p0, Landroidx/camera/camera2/internal/j1;->b:Landroidx/camera/camera2/internal/e;

    invoke-direct {v2, p1, v0, p2, v3}, Landroidx/camera/camera2/internal/e3;-><init>(Landroid/content/Context;Ljava/lang/String;Lw/i0;Landroidx/camera/camera2/internal/e;)V

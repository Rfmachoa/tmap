...
.field public e:Landroidx/camera/camera2/internal/q3;
    .annotation build Landroidx/annotation/GuardedBy;
        value = "mSessionLock"
    .end annotation
...
.field public f:Landroidx/camera/camera2/internal/e3;
    .annotation build Landroidx/annotation/GuardedBy;
        value = "mSessionLock"
    .end annotation
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/camera/camera2/internal/CaptureSession;->i:Lw/d;
    ...
    iput-object v0, p0, Landroidx/camera/camera2/internal/CaptureSession;->o:La0/o;
...
.method public static u(Ljava/util/List;)Landroidx/camera/core/impl/Config;
    ...
    .line 4
    iget-object v1, v1, Landroidx/camera/core/impl/e;->b:Landroidx/camera/core/impl/Config;
    ...
    .line 8
    :try_start_0
    invoke-virtual {v0, v3}, Landroidx/camera/core/impl/m;->c(Landroidx/camera/core/impl/Config$a;)Ljava/lang/Object;
    ...
    .line 13
    :cond_2
    invoke-virtual {v0, v3, v5}, Landroidx/camera/core/impl/l;->u(Landroidx/camera/core/impl/Config$a;Ljava/lang/Object;)V
...
.method public close()V
    ...
    .line 4
    iget-object v1, p0, Landroidx/camera/camera2/internal/CaptureSession;->i:Lw/d;

    .line 5
    invoke-virtual {v1}, Lw/d;->d()Lw/d$a;

    move-result-object v1

    invoke-virtual {v1}, Lw/d$a;->b()Ljava/util/List;
    ...
    :cond_1
    :goto_0
    iget-object v1, p0, Landroidx/camera/camera2/internal/CaptureSession;->e:Landroidx/camera/camera2/internal/q3;
    ...
    invoke-virtual {v1}, Landroidx/camera/camera2/internal/q3;->e()Z
...
.method public e()V
    ...
    .line 8
    iget-object v1, v1, Landroidx/camera/core/impl/e;->d:Ljava/util/List;
...
.method public f(Z)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 3
    :pswitch_0
    iget-object v1, p0, Landroidx/camera/camera2/internal/CaptureSession;->f:Landroidx/camera/camera2/internal/e3;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 4
    :try_start_1
    invoke-interface {v1}, Landroidx/camera/camera2/internal/e3;->b()V
    :try_end_1
    ...
    :cond_0
    :goto_0
    iget-object p1, p0, Landroidx/camera/camera2/internal/CaptureSession;->f:Landroidx/camera/camera2/internal/e3;

    invoke-interface {p1}, Landroidx/camera/camera2/internal/e3;->close()V
    ...
    .line 8
    iget-object p1, p0, Landroidx/camera/camera2/internal/CaptureSession;->e:Landroidx/camera/camera2/internal/q3;
    ...
    invoke-virtual {p1}, Landroidx/camera/camera2/internal/q3;->e()Z
    ...
    invoke-direct {p1, p0}, Landroidx/camera/camera2/internal/y1;-><init>(Landroidx/camera/camera2/internal/CaptureSession;)V
...
.method public i(Landroidx/camera/core/impl/SessionConfig;Landroid/hardware/camera2/CameraDevice;Landroidx/camera/camera2/internal/q3;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 8
    iput-object p3, p0, Landroidx/camera/camera2/internal/CaptureSession;->e:Landroidx/camera/camera2/internal/q3;

    const-wide/16 v3, 0x1388

    .line 9
    invoke-virtual {p3, v2, v3, v4}, Landroidx/camera/camera2/internal/q3;->d(Ljava/util/List;J)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    invoke-direct {v1, p0, p1, p2}, Landroidx/camera/camera2/internal/x1;-><init>(Landroidx/camera/camera2/internal/CaptureSession;Landroidx/camera/core/impl/SessionConfig;Landroid/hardware/camera2/CameraDevice;)V

    iget-object p1, p0, Landroidx/camera/camera2/internal/CaptureSession;->e:Landroidx/camera/camera2/internal/q3;

    .line 11
    invoke-virtual {p1}, Landroidx/camera/camera2/internal/q3;->b()Ljava/util/concurrent/Executor;
    ...
    iget-object p3, p0, Landroidx/camera/camera2/internal/CaptureSession;->e:Landroidx/camera/camera2/internal/q3;

    .line 14
    invoke-virtual {p3}, Landroidx/camera/camera2/internal/q3;->b()Ljava/util/concurrent/Executor;
...
.method public final varargs l(Ljava/util/List;[Landroid/hardware/camera2/CameraCaptureSession$CaptureCallback;)Landroid/hardware/camera2/CameraCaptureSession$CaptureCallback;
    ...
    .line 4
    invoke-static {v1}, Landroidx/camera/camera2/internal/v1;->a(Lc0/m;)Landroid/hardware/camera2/CameraCaptureSession$CaptureCallback;
    ...
    invoke-direct {p1, v0}, Landroidx/camera/camera2/internal/s0$a;-><init>(Ljava/util/List;)V
...
.method public m()V
    ...
    .line 4
    iput-object v0, p0, Landroidx/camera/camera2/internal/CaptureSession;->f:Landroidx/camera/camera2/internal/e3;
...
.method public o(Ljava/util/List;)I
    ...
    invoke-direct {v1}, Landroidx/camera/camera2/internal/m1;-><init>()V
    ...
    .line 13
    :cond_4
    iget v7, v6, Landroidx/camera/core/impl/e;->c:I
    ...
    .line 14
    :cond_5
    new-instance v7, Landroidx/camera/core/impl/e$a;

    invoke-direct {v7, v6}, Landroidx/camera/core/impl/e$a;-><init>(Landroidx/camera/core/impl/e;)V

    .line 15
    iget v8, v6, Landroidx/camera/core/impl/e;->c:I
    ...
    .line 16
    iget-object v8, v6, Landroidx/camera/core/impl/e;->g:Landroidx/camera/core/impl/c;

    if-eqz v8, :cond_6

    .line 17
    iput-object v8, v7, Landroidx/camera/core/impl/e$a;->g:Landroidx/camera/core/impl/c;
    ...
    .line 20
    iget-object v8, v8, Landroidx/camera/core/impl/SessionConfig;->f:Landroidx/camera/core/impl/e;

    .line 21
    invoke-static {v8}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;)Ljava/lang/Object;

    .line 22
    iget-object v8, v8, Landroidx/camera/core/impl/e;->b:Landroidx/camera/core/impl/Config;
    ...
    .line 25
    iget-object v8, v6, Landroidx/camera/core/impl/e;->b:Landroidx/camera/core/impl/Config;
    ...
    iget-object v8, p0, Landroidx/camera/camera2/internal/CaptureSession;->f:Landroidx/camera/camera2/internal/e3;

    invoke-interface {v8}, Landroidx/camera/camera2/internal/e3;->k()Landroid/hardware/camera2/CameraDevice;
    ...
    .line 28
    invoke-static {v7, v8, v9}, Landroidx/camera/camera2/internal/h1;->b(Landroidx/camera/core/impl/e;Landroid/hardware/camera2/CameraDevice;Ljava/util/Map;)Landroid/hardware/camera2/CaptureRequest;
    ...
    .line 32
    iget-object v6, v6, Landroidx/camera/core/impl/e;->d:Ljava/util/List;
    ...
    .line 34
    invoke-static {v9, v8}, Landroidx/camera/camera2/internal/v1;->b(Lc0/m;Ljava/util/List;)V

    goto :goto_2

    .line 35
    :cond_9
    invoke-virtual {v1, v7, v8}, Landroidx/camera/camera2/internal/m1;->a(Landroid/hardware/camera2/CaptureRequest;Ljava/util/List;)V
    ...
    .line 38
    iget-object p1, p0, Landroidx/camera/camera2/internal/CaptureSession;->o:La0/o;

    .line 39
    invoke-virtual {p1, v3, v5}, La0/o;->a(Ljava/util/List;Z)Z
    ...
    invoke-interface {p1}, Landroidx/camera/camera2/internal/e3;->a()V
    ...
    .line 42
    iput-object p1, v1, Landroidx/camera/camera2/internal/m1;->b:Landroidx/camera/camera2/internal/m1$a;

    .line 43
    :cond_b
    iget-object p1, p0, Landroidx/camera/camera2/internal/CaptureSession;->f:Landroidx/camera/camera2/internal/e3;

    invoke-interface {p1, v3, v1}, Landroidx/camera/camera2/internal/e3;->r(Ljava/util/List;Landroid/hardware/camera2/CameraCaptureSession$CaptureCallback;)I
...
.method public q(Landroidx/camera/core/impl/SessionConfig;)I
    ...
    .line 4
    :cond_0
    iget-object p1, p1, Landroidx/camera/core/impl/SessionConfig;->f:Landroidx/camera/core/impl/e;
    ...
    invoke-direct {v2, p1}, Landroidx/camera/core/impl/e$a;-><init>(Landroidx/camera/core/impl/e;)V

    .line 13
    iget-object v3, p0, Landroidx/camera/camera2/internal/CaptureSession;->i:Lw/d;

    .line 14
    invoke-virtual {v3}, Lw/d;->d()Lw/d$a;

    move-result-object v3

    invoke-virtual {v3}, Lw/d$a;->e()Ljava/util/List;
    ...
    iget-object v3, p0, Landroidx/camera/camera2/internal/CaptureSession;->f:Landroidx/camera/camera2/internal/e3;

    invoke-interface {v3}, Landroidx/camera/camera2/internal/e3;->k()Landroid/hardware/camera2/CameraDevice;
    ...
    .line 18
    invoke-static {v2, v3, v4}, Landroidx/camera/camera2/internal/h1;->b(Landroidx/camera/core/impl/e;Landroid/hardware/camera2/CameraDevice;Ljava/util/Map;)Landroid/hardware/camera2/CaptureRequest;
    ...
    invoke-interface {v3, v2, p1}, Landroidx/camera/camera2/internal/e3;->l(Landroid/hardware/camera2/CaptureRequest;Landroid/hardware/camera2/CameraCaptureSession$CaptureCallback;)I
...
.method public final v(Ljava/util/List;Landroidx/camera/core/impl/SessionConfig;Landroid/hardware/camera2/CameraDevice;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    new-array p1, v3, [Landroidx/camera/camera2/internal/e3$a;
    ...
    .line 14
    iget-object v5, p2, Landroidx/camera/core/impl/SessionConfig;->c:Ljava/util/List;

    .line 15
    invoke-direct {v3, v5}, Landroidx/camera/camera2/internal/r3$a;-><init>(Ljava/util/List;)V

    aput-object v3, p1, v2

    .line 16
    invoke-static {p1}, Landroidx/camera/camera2/internal/r3;->C([Landroidx/camera/camera2/internal/e3$a;)Landroidx/camera/camera2/internal/e3$a;
    ...
    invoke-direct {v2, v3}, Lw/b;-><init>(Landroidx/camera/core/impl/Config;)V
    ...
    invoke-virtual {v2, v3}, Lw/b;->j0(Lw/d;)Lw/d;

    move-result-object v3

    iput-object v3, p0, Landroidx/camera/camera2/internal/CaptureSession;->i:Lw/d;
    ...
    invoke-virtual {v3}, Lw/d$a;->d()Ljava/util/List;
    ...
    .line 22
    new-instance v5, Landroidx/camera/core/impl/e$a;

    invoke-direct {v5, p2}, Landroidx/camera/core/impl/e$a;-><init>(Landroidx/camera/core/impl/e;)V
    ...
    .line 25
    iget-object v3, v3, Landroidx/camera/core/impl/e;->b:Landroidx/camera/core/impl/Config;

    .line 26
    invoke-virtual {v5, v3}, Landroidx/camera/core/impl/e$a;->e(Landroidx/camera/core/impl/Config;)V
    ...
    invoke-direct {v6, v4}, Ly/b;-><init>(Landroid/view/Surface;)V

    const/4 v4, 0x0

    .line 30
    invoke-virtual {v2, v4}, Lw/b;->o0(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    .line 31
    invoke-virtual {v6, v4}, Ly/b;->i(Ljava/lang/String;)V
    ...
    .line 33
    :cond_3
    iget-object v2, p0, Landroidx/camera/camera2/internal/CaptureSession;->e:Landroidx/camera/camera2/internal/q3;

    .line 34
    invoke-virtual {v2, v1, p2, p1}, Landroidx/camera/camera2/internal/q3;->a(ILjava/util/List;Landroidx/camera/camera2/internal/e3$a;)Landroidx/camera/camera2/internal/compat/params/SessionConfigurationCompat;
    ...
    .line 35
    :try_start_1
    invoke-virtual {v5}, Landroidx/camera/core/impl/e$a;->h()Landroidx/camera/core/impl/e;

    move-result-object p2

    .line 36
    invoke-static {p2, p3}, Landroidx/camera/camera2/internal/h1;->c(Landroidx/camera/core/impl/e;Landroid/hardware/camera2/CameraDevice;)Landroid/hardware/camera2/CaptureRequest;
    ...
    :cond_4
    :try_start_2
    iget-object p2, p0, Landroidx/camera/camera2/internal/CaptureSession;->e:Landroidx/camera/camera2/internal/q3;

    iget-object v1, p0, Landroidx/camera/camera2/internal/CaptureSession;->k:Ljava/util/List;

    invoke-virtual {p2, p3, p1, v1}, Landroidx/camera/camera2/internal/q3;->c(Landroid/hardware/camera2/CameraDevice;Landroidx/camera/camera2/internal/compat/params/SessionConfigurationCompat;Ljava/util/List;)Lcom/google/common/util/concurrent/ListenableFuture;
...
.method public w(Ljava/util/List;)Ljava/util/List;
    ...
    .line 6
    iget-object v1, v1, Landroidx/camera/core/impl/SessionConfig;->f:Landroidx/camera/core/impl/e;
    ...
    .line 8
    invoke-virtual {v2, v3}, Landroidx/camera/core/impl/e$a;->f(Landroidx/camera/core/impl/DeferrableSurface;)V
...
.method public x()V
    ...
    invoke-interface {v1}, Landroidx/camera/camera2/internal/e3;->a()V
    :try_end_1
    .catch Landroid/hardware/camera2/CameraAccessException; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

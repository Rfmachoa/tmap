...
.method public constructor <init>(Landroidx/camera/camera2/internal/CaptureSession;Ljava/util/List;)V
    ...
    .line 4
    iput-object p1, p0, Landroidx/camera/camera2/internal/k1;->a:Landroidx/camera/camera2/internal/CaptureSession;
...
.method public a()V
    ...
    .line 1
    iget-boolean v0, p0, Landroidx/camera/camera2/internal/k1;->c:Z
    ...
    .line 2
    :cond_0
    iget-object v0, p0, Landroidx/camera/camera2/internal/k1;->a:Landroidx/camera/camera2/internal/CaptureSession;
...
.method public c(Ljava/util/List;Lb0/o1$a;)I
    .locals 5
    ...
    invoke-virtual {p0, p1}, Landroidx/camera/camera2/internal/k1;->f(Ljava/util/List;)Z
    ...
    .line 5
    invoke-interface {v2}, Lb0/o1$b;->a()I

    move-result v4

    invoke-virtual {v3, v4}, Landroidx/camera/core/impl/e$a;->u(I)V

    .line 6
    invoke-interface {v2}, Lb0/o1$b;->getParameters()Landroidx/camera/core/impl/Config;
    ...
    .line 7
    new-instance v4, Landroidx/camera/camera2/internal/k1$a;

    invoke-direct {v4, p0, v2, p2, v1}, Landroidx/camera/camera2/internal/k1$a;-><init>(Landroidx/camera/camera2/internal/k1;Lb0/o1$b;Lb0/o1$a;Z)V

    .line 8
    invoke-static {v4}, Landroidx/camera/camera2/internal/v1;->d(Landroid/hardware/camera2/CameraCaptureSession$CaptureCallback;)Landroidx/camera/camera2/internal/v1;

    move-result-object v1

    .line 9
    invoke-virtual {v3, v1}, Landroidx/camera/core/impl/e$a;->c(Lb0/m;)V

    const/4 v1, 0x0

    .line 10
    invoke-interface {v2}, Lb0/o1$b;->b()Ljava/util/List;
    ...
    invoke-virtual {p0, v4}, Landroidx/camera/camera2/internal/k1;->i(I)Landroidx/camera/core/impl/DeferrableSurface;
    ...
    .line 13
    :cond_2
    iget-object p1, p0, Landroidx/camera/camera2/internal/k1;->a:Landroidx/camera/camera2/internal/CaptureSession;
...
.method public d(Lb0/o1$b;Lb0/o1$a;)I
    .locals 2
    .param p1    # Lb0/o1$b;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/camera/camera2/internal/k1;->c(Ljava/util/List;Lb0/o1$a;)I
...
.method public e(Lb0/o1$b;Lb0/o1$a;)I
    .locals 4
    .param p1    # Lb0/o1$b;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-virtual {p0, p1}, Landroidx/camera/camera2/internal/k1;->j(Lb0/o1$b;)Z
    ...
    .line 3
    invoke-interface {p1}, Lb0/o1$b;->a()I
    ...
    .line 4
    invoke-interface {p1}, Lb0/o1$b;->getParameters()Landroidx/camera/core/impl/Config;
    ...
    .line 5
    new-instance v1, Landroidx/camera/camera2/internal/k1$a;

    const/4 v2, 0x1

    invoke-direct {v1, p0, p1, p2, v2}, Landroidx/camera/camera2/internal/k1$a;-><init>(Landroidx/camera/camera2/internal/k1;Lb0/o1$b;Lb0/o1$a;Z)V

    invoke-static {v1}, Landroidx/camera/camera2/internal/v1;->d(Landroid/hardware/camera2/CameraCaptureSession$CaptureCallback;)Landroidx/camera/camera2/internal/v1;

    move-result-object p2

    invoke-virtual {v0, p2}, Landroidx/camera/core/impl/SessionConfig$b;->e(Lb0/m;)V

    .line 6
    iget-object p2, p0, Landroidx/camera/camera2/internal/k1;->d:Landroidx/camera/core/impl/SessionConfig;
    ...
    .line 8
    invoke-virtual {v0, v1}, Landroidx/camera/core/impl/SessionConfig$b;->e(Lb0/m;)V
    ...
    invoke-virtual {p2}, Landroidx/camera/core/impl/e;->f()Lb0/v1;

    move-result-object p2

    .line 10
    invoke-virtual {p2}, Lb0/v1;->e()Ljava/util/Set;
    ...
    .line 11
    invoke-virtual {p2, v2}, Lb0/v1;->d(Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 12
    :cond_2
    invoke-interface {p1}, Lb0/o1$b;->b()Ljava/util/List;
    ...
    invoke-virtual {p0, p2}, Landroidx/camera/camera2/internal/k1;->i(I)Landroidx/camera/core/impl/DeferrableSurface;
...
.method public final f(Ljava/util/List;)Z
    ...
    check-cast v0, Lb0/o1$b;

    .line 2
    invoke-virtual {p0, v0}, Landroidx/camera/camera2/internal/k1;->j(Lb0/o1$b;)Z
...
.method public h(Landroid/view/Surface;)I
    ...
    .line 1
    iget-object v0, p0, Landroidx/camera/camera2/internal/k1;->b:Ljava/util/List;
...
.method public final j(Lb0/o1$b;)Z
    .locals 4
    .param p1    # Lb0/o1$b;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-virtual {p0, v3}, Landroidx/camera/camera2/internal/k1;->i(I)Landroidx/camera/core/impl/DeferrableSurface;
...
.method public k(Landroidx/camera/core/impl/SessionConfig;)V
    ...
    .line 1
    iput-object p1, p0, Landroidx/camera/camera2/internal/k1;->d:Landroidx/camera/core/impl/SessionConfig;

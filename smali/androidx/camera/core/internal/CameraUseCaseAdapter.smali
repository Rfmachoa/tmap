...
# static fields
.field public static final p:Ljava/lang/String; = "CameraUseCaseAdapter"
...
# direct methods
.method public constructor <init>(Ljava/util/LinkedHashSet;Lb0/s;Landroidx/camera/core/impl/UseCaseConfigFactory;)V
    .locals 1
    ...
    .line 11
    iput-object p2, p0, Landroidx/camera/core/internal/CameraUseCaseAdapter;->c:Lb0/s;
...
.method public static synthetic J(Landroidx/camera/core/SurfaceRequest;)V
    .locals 4
    ...
    .line 2
    invoke-virtual {p0}, Landroidx/camera/core/SurfaceRequest;->m()Landroid/util/Size;
    ...
    invoke-direct {v3, v1, v0}, Ld0/d;-><init>(Landroid/view/Surface;Landroid/graphics/SurfaceTexture;)V
...
.method public final C()Z
    ...
    invoke-interface {v1}, Landroidx/camera/core/impl/CameraConfig;->A()I
...
.method public D(Landroidx/camera/core/internal/CameraUseCaseAdapter;)Z
    ...
    invoke-virtual {p1}, Landroidx/camera/core/internal/CameraUseCaseAdapter;->z()Landroidx/camera/core/internal/CameraUseCaseAdapter$a;
...
.method public final E(Ljava/util/List;)Z
    ...
    .line 2
    invoke-virtual {p0, v3}, Landroidx/camera/core/internal/CameraUseCaseAdapter;->H(Landroidx/camera/core/UseCase;)Z
    ...
    .line 3
    :cond_1
    invoke-virtual {p0, v3}, Landroidx/camera/core/internal/CameraUseCaseAdapter;->G(Landroidx/camera/core/UseCase;)Z
...
.method public final N(Ljava/util/Map;Ljava/util/Collection;)V
    ...
    invoke-interface {v1}, Landroidx/camera/core/impl/CameraInternal;->m()Lb0/y;

    move-result-object v1

    invoke-interface {v1}, Lb0/y;->h()Ljava/lang/Integer;
    ...
    .line 12
    invoke-static/range {v2 .. v8}, Ld0/j;->a(Landroid/graphics/Rect;ZLandroid/util/Rational;IIILjava/util/Map;)Ljava/util/Map;
...
.method public d(Landroidx/camera/core/impl/CameraConfig;)V
    ...
    invoke-interface {v1}, Landroidx/camera/core/impl/CameraConfig;->b0()Lb0/s0;

    move-result-object v1

    .line 4
    invoke-interface {p1}, Landroidx/camera/core/impl/CameraConfig;->b0()Lb0/s0;
...
.method public n(Ljava/util/Collection;)V
    ...
    .line 25
    invoke-interface {v6}, Landroidx/camera/core/impl/CameraInternal;->m()Lb0/y;

    move-result-object v6

    invoke-virtual {p0, v6, v1, v5, v2}, Landroidx/camera/core/internal/CameraUseCaseAdapter;->t(Lb0/y;Ljava/util/List;Ljava/util/List;Ljava/util/Map;)Ljava/util/Map;
...
.method public varargs o([Landroidx/camera/core/UseCase;)Z
    ...
    invoke-interface {v2}, Landroidx/camera/core/impl/CameraInternal;->m()Lb0/y;
    ...
    .line 7
    invoke-virtual {p0, v2, p1, v3, v1}, Landroidx/camera/core/internal/CameraUseCaseAdapter;->t(Lb0/y;Ljava/util/List;Ljava/util/List;Ljava/util/Map;)Ljava/util/Map;
    :try_end_0
...
.method public final r(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    .line 5
    invoke-virtual {p0, v4}, Landroidx/camera/core/internal/CameraUseCaseAdapter;->H(Landroidx/camera/core/UseCase;)Z
    ...
    .line 6
    :cond_1
    invoke-virtual {p0, v4}, Landroidx/camera/core/internal/CameraUseCaseAdapter;->G(Landroidx/camera/core/UseCase;)Z
...
.method public final t(Lb0/y;Ljava/util/List;Ljava/util/List;Ljava/util/Map;)Ljava/util/Map;
    .locals 7
    .param p1    # Lb0/y;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 2
    invoke-interface {p1}, Lb0/y;->c()Ljava/lang/String;
    ...
    .line 5
    iget-object v4, p0, Landroidx/camera/core/internal/CameraUseCaseAdapter;->c:Lb0/s;
    ...
    .line 8
    invoke-interface {v4, v1, v5, v6}, Lb0/s;->a(Ljava/lang/String;ILandroid/util/Size;)Landroidx/camera/core/impl/SurfaceConfig;
    ...
    .line 16
    invoke-virtual {v3, p1, v5, v4}, Landroidx/camera/core/UseCase;->s(Lb0/y;Landroidx/camera/core/impl/q;Landroidx/camera/core/impl/q;)Landroidx/camera/core/impl/q;
    ...
    .line 18
    :cond_1
    iget-object p1, p0, Landroidx/camera/core/internal/CameraUseCaseAdapter;->c:Lb0/s;
    ...
    .line 20
    invoke-interface {p1, v1, v0, p2}, Lb0/s;->c(Ljava/lang/String;Ljava/util/List;Ljava/util/List;)Ljava/util/Map;

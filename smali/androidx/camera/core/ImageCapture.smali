...
.field public static final d0:Lh0/a;
...
.field public u:Lc0/e0;

.field public v:I

.field public w:Lc0/f0;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/camera/core/ImageCapture;->d0:Lh0/a;
...
.method public constructor <init>(Landroidx/camera/core/impl/i;)V
    ...
    iput-object p1, p0, Landroidx/camera/core/ImageCapture;->l:Lc0/w0$a;
    ...
    .line 17
    invoke-virtual {v0, p1}, Landroidx/camera/core/impl/i;->P(Ljava/util/concurrent/Executor;)Ljava/util/concurrent/Executor;
    ...
    .line 21
    iput-object v0, p0, Landroidx/camera/core/ImageCapture;->G:Ljava/util/concurrent/Executor;
...
.method private B0(Landroidx/camera/core/ImageCapture$k;Landroidx/concurrent/futures/CallbackToFutureAdapter$a;)Ljava/lang/Object;
    .locals 3
    ...
    .line 3
    invoke-virtual {v0, v1, v2}, Landroidx/camera/core/s2;->g(Lc0/w0$a;Ljava/util/concurrent/Executor;)V
...
.method public static synthetic T(Landroidx/concurrent/futures/CallbackToFutureAdapter$a;Lc0/w0;)V
    .locals 0

    invoke-static {p0, p1}, Landroidx/camera/core/ImageCapture;->z0(Landroidx/concurrent/futures/CallbackToFutureAdapter$a;Lc0/w0;)V
...
.method public static synthetic X(Lc0/w0;)V
    .locals 0

    invoke-static {p0}, Landroidx/camera/core/ImageCapture;->t0(Lc0/w0;)V
...
.method public static e0(Landroidx/camera/core/impl/k;)Z
    ...
    .line 4
    invoke-static {v5, v2}, Landroidx/camera/core/u1;->p(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 6
    invoke-interface {p0, v0, v1}, Landroidx/camera/core/impl/k;->u(Landroidx/camera/core/impl/Config$a;Ljava/lang/Object;)V
...
.method public static synthetic t0(Lc0/w0;)V
    .locals 3
    ...
    .line 1
    :try_start_0
    invoke-interface {p0}, Lc0/w0;->e()Landroidx/camera/core/m1;
...
.method public static synthetic z0(Landroidx/concurrent/futures/CallbackToFutureAdapter$a;Lc0/w0;)V
    .locals 1
...
.method public D(Lc0/y;Landroidx/camera/core/impl/q$a;)Landroidx/camera/core/impl/q;
    ...
    invoke-interface {p1, v0, v3}, Landroidx/camera/core/impl/k;->u(Landroidx/camera/core/impl/Config$a;Ljava/lang/Object;)V

    goto :goto_0

    .line 4
    :cond_0
    invoke-interface {p1}, Lc0/y;->l()Lc0/n1;
    ...
    invoke-interface {p1, v0, v4}, Landroidx/camera/core/impl/k;->u(Landroidx/camera/core/impl/Config$a;Ljava/lang/Object;)V
    ...
    .line 17
    invoke-interface {v1, v2, p1}, Landroidx/camera/core/impl/k;->u(Landroidx/camera/core/impl/Config$a;Ljava/lang/Object;)V
    ...
    invoke-interface {p1, v1, v0}, Landroidx/camera/core/impl/k;->u(Landroidx/camera/core/impl/Config$a;Ljava/lang/Object;)V
...
.method public final D0(Ljava/util/concurrent/Executor;Landroidx/camera/core/ImageCapture$n;Z)V
    ...
    .line 8
    iget-object v6, p0, Landroidx/camera/core/UseCase;->i:Landroid/graphics/Rect;
...
.method public d0(Ljava/lang/String;Landroidx/camera/core/impl/i;Landroid/util/Size;)Landroidx/camera/core/impl/SessionConfig$b;
    ...
    .line 3
    iget v3, v0, Landroidx/camera/core/ImageCapture;->n:I
    ...
    .line 4
    invoke-virtual/range {p0 .. p0}, Landroidx/camera/core/UseCase;->e()Landroidx/camera/core/impl/CameraControlInternal;

    move-result-object v3

    invoke-interface {v3, v1, v2}, Landroidx/camera/core/impl/CameraControlInternal;->b(Landroid/util/Size;Landroidx/camera/core/impl/SessionConfig$b;)V
    ...
    invoke-virtual/range {p0 .. p0}, Landroidx/camera/core/UseCase;->i()I
    ...
    .line 9
    invoke-interface/range {v6 .. v12}, Landroidx/camera/core/o1;->a(IIIIJ)Lc0/w0;

    move-result-object v6

    invoke-direct {v3, v6}, Landroidx/camera/core/s2;-><init>(Lc0/w0;)V
    ...
    invoke-direct {v3, v0}, Landroidx/camera/core/ImageCapture$a;-><init>(Landroidx/camera/core/ImageCapture;)V

    iput-object v3, v0, Landroidx/camera/core/ImageCapture;->D:Lc0/m;

    goto/16 :goto_1

    .line 11
    :cond_1
    iget-boolean v3, v0, Landroidx/camera/core/ImageCapture;->y:Z
    ...
    invoke-direct {v3, v6}, Landroidx/camera/core/d;-><init>(Landroid/media/ImageReader;)V
    ...
    .line 19
    invoke-virtual/range {p0 .. p0}, Landroidx/camera/core/ImageCapture;->l0()I

    move-result v8

    invoke-direct {v3, v8, v4}, Le0/l;-><init>(II)V

    .line 20
    new-instance v8, Landroidx/camera/core/a2;
    ...
    .line 23
    invoke-static {v9, v10, v7, v4}, Landroid/media/ImageReader;->newInstance(IIII)Landroid/media/ImageReader;

    move-result-object v7

    invoke-direct {v8, v7}, Landroidx/camera/core/a2;-><init>(Landroid/media/ImageReader;)V

    .line 24
    invoke-static {}, Landroidx/camera/core/y;->c()Lc0/e0;
    ...
    invoke-direct {v9, v8, v7, v3}, Landroidx/camera/core/i2$e;-><init>(Lc0/w0;Lc0/e0;Lc0/f0;)V

    iget-object v10, v0, Landroidx/camera/core/ImageCapture;->s:Ljava/util/concurrent/ExecutorService;

    .line 26
    iput-object v10, v9, Landroidx/camera/core/i2$e;->e:Ljava/util/concurrent/Executor;

    .line 27
    iput v6, v9, Landroidx/camera/core/i2$e;->d:I

    .line 28
    new-instance v6, Landroidx/camera/core/i2;

    invoke-direct {v6, v9}, Landroidx/camera/core/i2;-><init>(Landroidx/camera/core/i2$e;)V
    ...
    .line 30
    iget-object v10, v6, Landroidx/camera/core/i2;->p:Ljava/lang/String;

    .line 31
    invoke-interface {v7}, Lc0/e0;->c()Ljava/util/List;
    ...
    .line 32
    invoke-virtual {v9, v10, v7}, Lc0/i1;->i(Ljava/lang/String;Ljava/lang/Object;)V

    .line 33
    iput-object v9, v8, Landroidx/camera/core/a2;->c:Lc0/v1;
    ...
    invoke-direct {v7, v0}, Landroidx/camera/core/ImageCapture$b;-><init>(Landroidx/camera/core/ImageCapture;)V

    iput-object v7, v0, Landroidx/camera/core/ImageCapture;->D:Lc0/m;

    .line 35
    new-instance v7, Landroidx/camera/core/s2;

    invoke-direct {v7, v3}, Landroidx/camera/core/s2;-><init>(Lc0/w0;)V
    ...
    .line 39
    :cond_4
    iget-object v3, v0, Landroidx/camera/core/ImageCapture;->w:Lc0/f0;

    if-nez v3, :cond_6

    iget-boolean v7, v0, Landroidx/camera/core/ImageCapture;->x:Z
    ...
    invoke-direct {v3, v6, v7, v8, v4}, Landroidx/camera/core/x1;-><init>(IIII)V

    .line 42
    iget-object v6, v3, Landroidx/camera/core/x1;->b:Lc0/m;

    .line 43
    iput-object v6, v0, Landroidx/camera/core/ImageCapture;->D:Lc0/m;

    .line 44
    new-instance v6, Landroidx/camera/core/s2;

    invoke-direct {v6, v3}, Landroidx/camera/core/s2;-><init>(Lc0/w0;)V

    iput-object v6, v0, Landroidx/camera/core/ImageCapture;->A:Landroidx/camera/core/s2;
    ...
    .line 47
    iget-boolean v8, v0, Landroidx/camera/core/ImageCapture;->x:Z
    ...
    .line 48
    invoke-static {v3, v7}, Landroidx/camera/core/u1;->f(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget v8, v0, Landroidx/camera/core/ImageCapture;->v:I

    invoke-direct {v3, v7, v8}, Le0/l;-><init>(II)V

    .line 51
    new-instance v7, Landroidx/camera/core/e0;

    iget-object v8, v0, Landroidx/camera/core/ImageCapture;->w:Lc0/f0;
    ...
    invoke-direct {v7, v8, v9, v3, v11}, Landroidx/camera/core/e0;-><init>(Lc0/f0;ILc0/f0;Ljava/util/concurrent/Executor;)V
    ...
    invoke-virtual {v0, v7}, Landroidx/camera/core/ImageCapture;->f0(Lc0/e0;)Lc0/e0;

    move-result-object v12

    move-object v7, v14

    invoke-direct/range {v7 .. v13}, Landroidx/camera/core/i2$e;-><init>(IIIILc0/e0;Lc0/f0;)V

    iget-object v7, v0, Landroidx/camera/core/ImageCapture;->s:Ljava/util/concurrent/ExecutorService;

    .line 58
    iput-object v7, v14, Landroidx/camera/core/i2$e;->e:Ljava/util/concurrent/Executor;

    .line 59
    iput v6, v14, Landroidx/camera/core/i2$e;->d:I

    .line 60
    new-instance v6, Landroidx/camera/core/i2;

    invoke-direct {v6, v14}, Landroidx/camera/core/i2;-><init>(Landroidx/camera/core/i2$e;)V

    .line 61
    iput-object v6, v0, Landroidx/camera/core/ImageCapture;->B:Landroidx/camera/core/i2;

    .line 62
    invoke-virtual {v6}, Landroidx/camera/core/i2;->m()Lc0/m;
    ...
    invoke-direct {v6, v7}, Landroidx/camera/core/s2;-><init>(Lc0/w0;)V
    ...
    invoke-direct {v7, v0}, Landroidx/camera/core/u0;-><init>(Landroidx/camera/core/ImageCapture;)V
    ...
    invoke-direct {v8, v0, v6}, Landroidx/camera/core/ImageCapture$c;-><init>(Landroidx/camera/core/ImageCapture;Le0/l;)V

    :goto_6
    invoke-direct {v3, v4, v7, v8}, Landroidx/camera/core/ImageCapture$l;-><init>(ILandroidx/camera/core/ImageCapture$l$b;Landroidx/camera/core/ImageCapture$l$c;)V
    ...
    iget-object v4, v0, Landroidx/camera/core/ImageCapture;->l:Lc0/w0$a;
    ...
    .line 70
    invoke-virtual {v3, v4, v6}, Landroidx/camera/core/s2;->g(Lc0/w0$a;Ljava/util/concurrent/Executor;)V
    ...
    invoke-direct {v3, v4, v6, v7}, Lc0/x0;-><init>(Landroid/view/Surface;Landroid/util/Size;I)V
    ...
    .line 77
    :cond_c
    invoke-static {v5}, Landroidx/camera/core/impl/utils/futures/f;->h(Ljava/lang/Object;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    new-instance v5, Landroidx/camera/camera2/internal/e4;

    invoke-direct {v5, v4}, Landroidx/camera/camera2/internal/e4;-><init>(Landroidx/camera/core/s2;)V
    ...
    invoke-direct {v3, v0, v4, v5, v1}, Landroidx/camera/core/z0;-><init>(Landroidx/camera/core/ImageCapture;Ljava/lang/String;Landroidx/camera/core/impl/i;Landroid/util/Size;)V
...
.method public final f0(Lc0/e0;)Lc0/e0;
    .locals 2

    .line 1
    iget-object v0, p0, Landroidx/camera/core/ImageCapture;->u:Lc0/e0;

    invoke-interface {v0}, Lc0/e0;->c()Ljava/util/List;
    ...
    .line 3
    :cond_0
    new-instance p1, Landroidx/camera/core/y$a;

    invoke-direct {p1, v0}, Landroidx/camera/core/y$a;-><init>(Ljava/util/List;)V
...
.method public h(ZLandroidx/camera/core/impl/UseCaseConfigFactory;)Landroidx/camera/core/impl/q;
    ...
    .line 5
    sget-object p1, Landroidx/camera/core/ImageCapture$j;->c:Landroidx/camera/core/impl/i;
    ...
    .line 7
    :cond_1
    invoke-static {p2}, Landroidx/camera/core/ImageCapture$i;->t(Landroidx/camera/core/impl/Config;)Landroidx/camera/core/ImageCapture$i;
    ...
    .line 9
    invoke-virtual {p1}, Landroidx/camera/core/ImageCapture$i;->v()Landroidx/camera/core/impl/i;
...
.method public final k0(Landroidx/camera/core/impl/CameraInternal;Z)I
    ...
    .line 2
    iget-object p2, p0, Landroidx/camera/core/UseCase;->g:Landroid/util/Size;
...
.method public l()Landroidx/camera/core/p2;
    ...
    invoke-virtual {p0}, Landroidx/camera/core/ImageCapture;->m()Landroidx/camera/core/p2;
...
.method public m()Landroidx/camera/core/p2;
    ...
    .line 3
    :cond_0
    iget-object v2, p0, Landroidx/camera/core/UseCase;->i:Landroid/graphics/Rect;
...
.method public o0(Landroidx/camera/core/ImageCapture$k;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    invoke-virtual {p0, v1}, Landroidx/camera/core/ImageCapture;->f0(Lc0/e0;)Lc0/e0;
    ...
    .line 6
    :cond_0
    iget-object v3, p0, Landroidx/camera/core/ImageCapture;->w:Lc0/f0;
    ...
    invoke-virtual {v2, v1}, Landroidx/camera/core/i2;->t(Lc0/e0;)V
    ...
    .line 22
    iget v5, v5, Landroidx/camera/core/impl/e;->c:I

    .line 23
    iput v5, v4, Landroidx/camera/core/impl/e$a;->c:I
    ...
    .line 25
    iget-object v5, v5, Landroidx/camera/core/impl/e;->b:Landroidx/camera/core/impl/Config;
    ...
    .line 32
    sget-object v5, Landroidx/camera/core/ImageCapture;->d0:Lh0/a;

    invoke-virtual {v5}, Lh0/a;->a()Z
    ...
    .line 43
    :cond_7
    iget-object v3, p0, Landroidx/camera/core/ImageCapture;->D:Lc0/m;

    invoke-virtual {v4, v3}, Landroidx/camera/core/impl/e$a;->c(Lc0/m;)V
    ...
    .line 47
    invoke-static {p1, v0, v1}, Landroidx/camera/core/impl/utils/futures/f;->o(Lcom/google/common/util/concurrent/ListenableFuture;Lq/a;Ljava/util/concurrent/Executor;)Lcom/google/common/util/concurrent/ListenableFuture;
...
.method public z()V
    ...
    .line 5
    invoke-virtual {v0, v1}, Landroidx/camera/core/impl/i;->m0(Lc0/f0;)Lc0/f0;

    move-result-object v1

    iput-object v1, p0, Landroidx/camera/core/ImageCapture;->w:Lc0/f0;
    ...
    .line 8
    invoke-virtual {v0, v1}, Landroidx/camera/core/impl/i;->j0(Lc0/e0;)Lc0/e0;

    move-result-object v1

    iput-object v1, p0, Landroidx/camera/core/ImageCapture;->u:Lc0/e0;
    ...
    invoke-direct {v1, p0}, Landroidx/camera/core/ImageCapture$g;-><init>(Landroidx/camera/core/ImageCapture;)V

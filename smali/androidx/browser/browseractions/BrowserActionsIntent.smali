...
.method public static g(Landroid/content/Context;Landroid/net/Uri;)V
    ...
    invoke-direct {v0, p0, p1}, Landroidx/browser/browseractions/BrowserActionsIntent$b;-><init>(Landroid/content/Context;Landroid/net/Uri;)V

    invoke-virtual {v0}, Landroidx/browser/browseractions/BrowserActionsIntent$b;->a()Landroidx/browser/browseractions/BrowserActionsIntent;
...
.method public static h(Landroid/content/Context;Landroid/net/Uri;ILjava/util/ArrayList;Landroid/app/PendingIntent;)V
    ...
    .line 2
    iput p2, v0, Landroidx/browser/browseractions/BrowserActionsIntent$b;->d:I

    .line 3
    invoke-virtual {v0, p3}, Landroidx/browser/browseractions/BrowserActionsIntent$b;->c(Ljava/util/ArrayList;)Landroidx/browser/browseractions/BrowserActionsIntent$b;
    ...
    .line 5
    iput-object p4, p1, Landroidx/browser/browseractions/BrowserActionsIntent$b;->f:Landroid/app/PendingIntent;

    .line 6
    invoke-virtual {p1}, Landroidx/browser/browseractions/BrowserActionsIntent$b;->a()Landroidx/browser/browseractions/BrowserActionsIntent;
...
.method public static j(Landroid/content/Context;Landroid/net/Uri;Ljava/util/List;)V
    ...
    invoke-direct {v0, p0, p1, p2}, Ls/d;-><init>(Landroid/content/Context;Landroid/net/Uri;Ljava/util/List;)V
...
.method public static k(Ljava/util/ArrayList;)Ljava/util/List;
    ...
    invoke-direct {v2, v3, v4, v5}, Ls/a;-><init>(Ljava/lang/String;Landroid/app/PendingIntent;I)V
    ...
    invoke-direct {v5, v3, v4, v2}, Ls/a;-><init>(Ljava/lang/String;Landroid/app/PendingIntent;Landroid/net/Uri;)V

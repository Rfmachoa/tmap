...
# static fields
.field public static final e:Ljava/lang/String; = "CustomTabsSession"
...
.method public constructor <init>(Landroid/support/customtabs/ICustomTabsService;Landroid/support/customtabs/ICustomTabsCallback;Landroid/content/ComponentName;)V
    ...
    iput-object v0, p0, Landroidx/browser/customtabs/d;->a:Ljava/lang/Object;

    .line 3
    iput-object p1, p0, Landroidx/browser/customtabs/d;->b:Landroid/support/customtabs/ICustomTabsService;

    .line 4
    iput-object p2, p0, Landroidx/browser/customtabs/d;->c:Landroid/support/customtabs/ICustomTabsCallback;

    .line 5
    iput-object p3, p0, Landroidx/browser/customtabs/d;->d:Landroid/content/ComponentName;

    return-void
.end method

.method public static a(Landroid/content/ComponentName;)Landroidx/browser/customtabs/d;
    .locals 3
    ...
    invoke-direct {v0, v2, v1, p0}, Landroidx/browser/customtabs/d;-><init>(Landroid/support/customtabs/ICustomTabsService;Landroid/support/customtabs/ICustomTabsCallback;Landroid/content/ComponentName;)V
...
.method public b()Landroid/os/IBinder;
    ...
    .line 1
    iget-object v0, p0, Landroidx/browser/customtabs/d;->c:Landroid/support/customtabs/ICustomTabsCallback;
...
.method public c()Landroid/content/ComponentName;
    ...
    .line 1
    iget-object v0, p0, Landroidx/browser/customtabs/d;->d:Landroid/content/ComponentName;
...
.method public d(Landroid/net/Uri;Landroid/os/Bundle;Ljava/util/List;)Z
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Landroidx/browser/customtabs/d;->b:Landroid/support/customtabs/ICustomTabsService;

    iget-object v1, p0, Landroidx/browser/customtabs/d;->c:Landroid/support/customtabs/ICustomTabsCallback;
...
.method public e(Ljava/lang/String;Landroid/os/Bundle;)I
    ...
    .line 1
    iget-object v0, p0, Landroidx/browser/customtabs/d;->a:Ljava/lang/Object;

    monitor-enter v0

    .line 2
    :try_start_0
    iget-object v1, p0, Landroidx/browser/customtabs/d;->b:Landroid/support/customtabs/ICustomTabsService;

    iget-object v2, p0, Landroidx/browser/customtabs/d;->c:Landroid/support/customtabs/ICustomTabsCallback;
...
.method public g(Landroid/graphics/Bitmap;Ljava/lang/String;)Z
    ...
    .line 6
    :try_start_0
    iget-object p2, p0, Landroidx/browser/customtabs/d;->b:Landroid/support/customtabs/ICustomTabsService;
...
.method public h(Landroid/widget/RemoteViews;[ILandroid/app/PendingIntent;)Z
    ...
    .line 5
    :try_start_0
    iget-object p1, p0, Landroidx/browser/customtabs/d;->b:Landroid/support/customtabs/ICustomTabsService;

    iget-object p2, p0, Landroidx/browser/customtabs/d;->c:Landroid/support/customtabs/ICustomTabsCallback;
...
.method public i(ILandroid/graphics/Bitmap;Ljava/lang/String;)Z
    ...
    iget-object p3, p0, Landroidx/browser/customtabs/d;->c:Landroid/support/customtabs/ICustomTabsCallback;

...
.method public static b(Landroid/content/Context;Landroidx/browser/customtabs/CustomTabsIntent;Landroid/net/Uri;)V
    ...
    .line 3
    invoke-static {v0, v1}, Landroidx/core/app/k$a;->a(Landroid/os/Bundle;Ljava/lang/String;)Landroid/os/IBinder;
    ...
    .line 5
    invoke-virtual {p1, p0, p2}, Landroidx/browser/customtabs/CustomTabsIntent;->c(Landroid/content/Context;Landroid/net/Uri;)V
...
.method public static c(Landroid/content/Context;Landroidx/browser/customtabs/CustomTabsSession;Landroid/net/Uri;)V
    .locals 3
    .param p0    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 8
    invoke-static {p2, v2, v1}, Landroidx/core/app/k$a;->b(Landroid/os/Bundle;Ljava/lang/String;Landroid/os/IBinder;)V
...
.method public static d(Landroid/content/Context;Ljava/io/File;Ljava/lang/String;Ljava/lang/String;Landroidx/browser/customtabs/CustomTabsSession;)Z
    .locals 0
    .param p0    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 1
    invoke-static {p0, p2, p1}, Landroidx/core/content/FileProvider;->f(Landroid/content/Context;Ljava/lang/String;Ljava/io/File;)Landroid/net/Uri;
    ...
    .line 3
    invoke-virtual {p4, p1, p2, p0}, Landroidx/browser/customtabs/CustomTabsSession;->i(Landroid/net/Uri;ILandroid/os/Bundle;)Z

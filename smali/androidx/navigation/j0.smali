...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "navigatorProvider",
        "<init>",
        "(Landroid/content/Context;Landroidx/navigation/r0;)V",
...
# static fields
.field public static final c:Landroidx/navigation/j0$a;
...
.field public final b:Landroidx/navigation/r0;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field
...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Landroidx/navigation/j0$a;-><init>(Lkotlin/jvm/internal/u;)V

    sput-object v0, Landroidx/navigation/j0;->c:Landroidx/navigation/j0$a;
    ...
    sput-object v0, Landroidx/navigation/j0;->i:Ljava/lang/ThreadLocal;

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Landroidx/navigation/r0;)V
    .locals 1
    ...
    .line 2
    iput-object p1, p0, Landroidx/navigation/j0;->a:Landroid/content/Context;

    .line 3
    iput-object p2, p0, Landroidx/navigation/j0;->b:Landroidx/navigation/r0;
...
.method public final a(Landroid/content/res/Resources;Landroid/content/res/XmlResourceParser;Landroid/util/AttributeSet;I)Landroidx/navigation/NavDestination;
    ...
    .line 1
    iget-object v0, p0, Landroidx/navigation/j0;->b:Landroidx/navigation/r0;
    ...
    .line 3
    iget-object v1, p0, Landroidx/navigation/j0;->a:Landroid/content/Context;

    invoke-virtual {v0, v1, p3}, Landroidx/navigation/NavDestination;->x(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 9
    invoke-virtual {p0, p1, v0, p3, p4}, Landroidx/navigation/j0;->f(Landroid/content/res/Resources;Landroidx/navigation/NavDestination;Landroid/util/AttributeSet;I)V
    ...
    .line 11
    invoke-virtual {p0, p1, v0, p3}, Landroidx/navigation/j0;->g(Landroid/content/res/Resources;Landroidx/navigation/NavDestination;Landroid/util/AttributeSet;)V
    ...
    .line 13
    invoke-virtual/range {v1 .. v6}, Landroidx/navigation/j0;->c(Landroid/content/res/Resources;Landroidx/navigation/NavDestination;Landroid/util/AttributeSet;Landroid/content/res/XmlResourceParser;I)V
    ...
    invoke-virtual {p0, v2}, Landroidx/navigation/j0;->b(I)Landroidx/navigation/NavGraph;

    move-result-object v2

    invoke-virtual {v3, v2}, Landroidx/navigation/NavGraph;->K(Landroidx/navigation/NavDestination;)V
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Landroidx/navigation/j0;->a(Landroid/content/res/Resources;Landroid/content/res/XmlResourceParser;Landroid/util/AttributeSet;I)Landroidx/navigation/NavDestination;

    move-result-object v2

    invoke-virtual {v1, v2}, Landroidx/navigation/NavGraph;->K(Landroidx/navigation/NavDestination;)V
...
.method public final b(I)Landroidx/navigation/NavGraph;
    ...
    .line 1
    iget-object v0, p0, Landroidx/navigation/j0;->a:Landroid/content/Context;
    ...
    invoke-virtual {p0, v0, v1, v2, p1}, Landroidx/navigation/j0;->a(Landroid/content/res/Resources;Landroid/content/res/XmlResourceParser;Landroid/util/AttributeSet;I)Landroidx/navigation/NavDestination;
...
.method public final c(Landroid/content/res/Resources;Landroidx/navigation/NavDestination;Landroid/util/AttributeSet;Landroid/content/res/XmlResourceParser;I)V
    ...
    invoke-direct/range {v4 .. v9}, Landroidx/navigation/j;-><init>(ILandroidx/navigation/k0;Landroid/os/Bundle;ILkotlin/jvm/internal/u;)V

    .line 6
    new-instance v4, Landroidx/navigation/k0$a;

    invoke-direct {v4}, Landroidx/navigation/k0$a;-><init>()V
    ...
    invoke-virtual {v4, v5}, Landroidx/navigation/k0$a;->d(Z)Landroidx/navigation/k0$a;
    ...
    invoke-virtual {v4, v5}, Landroidx/navigation/k0$a;->m(Z)Landroidx/navigation/k0$a;
    ...
    .line 12
    invoke-virtual {v4, v5, v7, v2}, Landroidx/navigation/k0$a;->h(IZZ)Landroidx/navigation/k0$a;
    ...
    invoke-virtual {v4, v2}, Landroidx/navigation/k0$a;->b(I)Landroidx/navigation/k0$a;
    ...
    invoke-virtual {v4, v2}, Landroidx/navigation/k0$a;->c(I)Landroidx/navigation/k0$a;
    ...
    invoke-virtual {v4, v2}, Landroidx/navigation/k0$a;->e(I)Landroidx/navigation/k0$a;
    ...
    invoke-virtual {v4, v2}, Landroidx/navigation/k0$a;->f(I)Landroidx/navigation/k0$a;

    .line 17
    invoke-virtual {v4}, Landroidx/navigation/k0$a;->a()Landroidx/navigation/k0;

    move-result-object v2

    invoke-virtual {v3, v2}, Landroidx/navigation/j;->e(Landroidx/navigation/k0;)V
    ...
    .line 24
    invoke-virtual {p0, p1, v2, p3, p5}, Landroidx/navigation/j0;->e(Landroid/content/res/Resources;Landroid/os/Bundle;Landroid/util/AttributeSet;I)V
    ...
    .line 26
    invoke-virtual {v3, v2}, Landroidx/navigation/j;->d(Landroid/os/Bundle;)V

    .line 27
    :cond_5
    invoke-virtual {p2, v1, v3}, Landroidx/navigation/NavDestination;->B(ILandroidx/navigation/j;)V
...
.method public final d(Landroid/content/res/TypedArray;Landroid/content/res/Resources;I)Landroidx/navigation/o;
    .locals 10
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/xmlpull/v1/XmlPullParserException;
    ...
    invoke-virtual {v0, v1}, Landroidx/navigation/o$a;->c(Z)Landroidx/navigation/o$a;

    .line 3
    sget-object v1, Landroidx/navigation/j0;->i:Ljava/lang/ThreadLocal;
    ...
    .line 7
    sget-object v4, Landroidx/navigation/n0;->c:Landroidx/navigation/n0$l;

    invoke-virtual {p2, p3}, Landroid/content/res/Resources;->getResourcePackageName(I)Ljava/lang/String;

    move-result-object p3

    invoke-virtual {v4, v8, p3}, Landroidx/navigation/n0$l;->a(Ljava/lang/String;Ljava/lang/String;)Landroidx/navigation/n0;
    ...
    .line 9
    sget-object v1, Landroidx/navigation/n0;->e:Landroidx/navigation/n0;
    ...
    invoke-virtual {v6}, Landroidx/navigation/n0;->c()Ljava/lang/String;
    ...
    .line 22
    :cond_6
    sget-object v1, Landroidx/navigation/n0;->m:Landroidx/navigation/n0;
    ...
    .line 25
    sget-object v7, Landroidx/navigation/n0;->i:Landroidx/navigation/n0;

    if-ne v6, v7, :cond_8

    .line 26
    sget-object v4, Landroidx/navigation/j0;->c:Landroidx/navigation/j0$a;

    const-string v9, "float"

    move-object v5, v3

    invoke-virtual/range {v4 .. v9}, Landroidx/navigation/j0$a;->a(Landroid/util/TypedValue;Landroidx/navigation/n0;Landroidx/navigation/n0;Ljava/lang/String;Ljava/lang/String;)Landroidx/navigation/n0;
    ...
    .line 29
    sget-object v7, Landroidx/navigation/n0;->d:Landroidx/navigation/n0;
    ...
    sget-object v7, Landroidx/navigation/n0;->k:Landroidx/navigation/n0;
    ...
    .line 42
    sget-object p2, Landroidx/navigation/n0;->c:Landroidx/navigation/n0$l;

    invoke-virtual {p2, p1}, Landroidx/navigation/n0$l;->b(Ljava/lang/String;)Landroidx/navigation/n0;

    move-result-object v6

    .line 43
    :cond_f
    invoke-virtual {v6, p1}, Landroidx/navigation/n0;->h(Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 44
    invoke-virtual {v0, v1}, Landroidx/navigation/o$a;->b(Ljava/lang/Object;)Landroidx/navigation/o$a;

    :cond_11
    if-eqz v6, :cond_12

    .line 45
    invoke-virtual {v0, v6}, Landroidx/navigation/o$a;->d(Landroidx/navigation/n0;)Landroidx/navigation/o$a;
...
.method public final e(Landroid/content/res/Resources;Landroid/os/Bundle;Landroid/util/AttributeSet;I)V
    ...
    .line 3
    invoke-virtual {p0, p3, p1, p4}, Landroidx/navigation/j0;->d(Landroid/content/res/TypedArray;Landroid/content/res/Resources;I)Landroidx/navigation/o;
    ...
    .line 5
    invoke-virtual {p1, v0, p2}, Landroidx/navigation/o;->e(Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public final f(Landroid/content/res/Resources;Landroidx/navigation/NavDestination;Landroid/util/AttributeSet;I)V
    ...
    .line 4
    invoke-virtual {p2, v0, p1}, Landroidx/navigation/NavDestination;->c(Ljava/lang/String;Landroidx/navigation/o;)V
...
.method public final g(Landroid/content/res/Resources;Landroidx/navigation/NavDestination;Landroid/util/AttributeSet;)V
    ...
    :cond_7
    :goto_6
    new-instance v9, Landroidx/navigation/NavDeepLink$a;

    invoke-direct {v9}, Landroidx/navigation/NavDeepLink$a;-><init>()V
    ...
    invoke-virtual {v9, v0}, Landroidx/navigation/NavDeepLink$a;->g(Ljava/lang/String;)Landroidx/navigation/NavDeepLink$a;
    ...
    invoke-virtual {v9, p3}, Landroidx/navigation/NavDeepLink$a;->e(Ljava/lang/String;)Landroidx/navigation/NavDeepLink$a;

    :cond_b
    if-eqz v7, :cond_c

    .line 11
    iget-object p3, p0, Landroidx/navigation/j0;->a:Landroid/content/Context;
    ...
    .line 13
    invoke-virtual {v9, p3}, Landroidx/navigation/NavDeepLink$a;->f(Ljava/lang/String;)Landroidx/navigation/NavDeepLink$a;

    .line 14
    :cond_c
    invoke-virtual {v9}, Landroidx/navigation/NavDeepLink$a;->a()Landroidx/navigation/NavDeepLink;

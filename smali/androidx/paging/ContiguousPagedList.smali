...
# interfaces
.implements Landroidx/paging/f0$a;
...
# static fields
.field public static final W0:Landroidx/paging/ContiguousPagedList$a;
...
.field public final V0:Landroidx/paging/LegacyPageFetcher;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroidx/paging/LegacyPageFetcher<",
            "TK;TV;>;"
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/paging/ContiguousPagedList;->W0:Landroidx/paging/ContiguousPagedList$a;
...
.method public constructor <init>(Landroidx/paging/PagingSource;Lkotlinx/coroutines/p0;Lkotlinx/coroutines/CoroutineDispatcher;Lkotlinx/coroutines/CoroutineDispatcher;Landroidx/paging/PagedList$a;Landroidx/paging/PagedList$d;Landroidx/paging/PagingSource$b$c;Ljava/lang/Object;)V
    ...
    .line 1
    new-instance v4, Landroidx/paging/f0;

    invoke-direct {v4}, Landroidx/paging/f0;-><init>()V
    ...
    .line 2
    invoke-direct/range {v0 .. v5}, Landroidx/paging/PagedList;-><init>(Landroidx/paging/PagingSource;Lkotlinx/coroutines/p0;Lkotlinx/coroutines/CoroutineDispatcher;Landroidx/paging/f0;Landroidx/paging/PagedList$d;)V
    ...
    .line 5
    iput-object v0, v8, Landroidx/paging/ContiguousPagedList;->m:Ljava/lang/Object;

    const v0, 0x7fffffff

    .line 6
    iput v0, v8, Landroidx/paging/ContiguousPagedList;->R0:I

    const/high16 v13, -0x80000000

    .line 7
    iput v13, v8, Landroidx/paging/ContiguousPagedList;->S0:I
    ...
    :goto_0
    iput-boolean v0, v8, Landroidx/paging/ContiguousPagedList;->U0:Z

    .line 9
    new-instance v5, Landroidx/paging/LegacyPageFetcher;

    .line 10
    invoke-virtual/range {p0 .. p0}, Landroidx/paging/PagedList;->E()Landroidx/paging/f0;
    ...
    iput-object v11, v8, Landroidx/paging/ContiguousPagedList;->V0:Landroidx/paging/LegacyPageFetcher;
    ...
    .line 15
    iget v1, v10, Landroidx/paging/PagingSource$b$c;->d:I
    ...
    .line 16
    :goto_1
    iget v3, v10, Landroidx/paging/PagingSource$b$c;->e:I
    ...
    .line 17
    invoke-virtual/range {v0 .. v6}, Landroidx/paging/f0;->r(ILandroidx/paging/PagingSource$b$c;IILandroidx/paging/f0$a;Z)V
    ...
    .line 20
    iget v2, v10, Landroidx/paging/PagingSource$b$c;->d:I
    ...
    .line 23
    iget-object v1, v10, Landroidx/paging/PagingSource$b$c;->a:Ljava/util/List;

    .line 24
    invoke-virtual {v8, v0, v1}, Landroidx/paging/ContiguousPagedList;->e0(Landroidx/paging/LoadType;Ljava/util/List;)V

    return-void
.end method

.method public static final synthetic V(Landroidx/paging/ContiguousPagedList;ZZ)V
    .locals 0

    invoke-virtual {p0, p1, p2}, Landroidx/paging/ContiguousPagedList;->a0(ZZ)V
...
.method public static final synthetic X(Landroidx/paging/ContiguousPagedList;Z)V
    .locals 0
...
.method public static final synthetic Y(Landroidx/paging/ContiguousPagedList;Z)V
    .locals 0

    invoke-virtual {p0, p1}, Landroidx/paging/ContiguousPagedList;->f0(Z)V
...
.method public F()Z
    ...
    iget-object v0, p0, Landroidx/paging/ContiguousPagedList;->V0:Landroidx/paging/LegacyPageFetcher;
...
.method public J(I)V
    ...
    .line 1
    sget-object v0, Landroidx/paging/ContiguousPagedList;->W0:Landroidx/paging/ContiguousPagedList$a;

    invoke-virtual {p0}, Landroidx/paging/PagedList;->r()Landroidx/paging/PagedList$d;

    move-result-object v1

    iget v1, v1, Landroidx/paging/PagedList$d;->b:I

    invoke-virtual {p0}, Landroidx/paging/PagedList;->E()Landroidx/paging/f0;
    ...
    .line 2
    iget v2, v2, Landroidx/paging/f0;->b:I
    ...
    .line 6
    iget v3, v3, Landroidx/paging/f0;->b:I
    ...
    .line 8
    iget v4, v4, Landroidx/paging/f0;->f:I
    ...
    .line 10
    iget v3, p0, Landroidx/paging/ContiguousPagedList;->p:I
    ...
    .line 11
    iget-object v1, p0, Landroidx/paging/ContiguousPagedList;->V0:Landroidx/paging/LegacyPageFetcher;

    invoke-virtual {v1}, Landroidx/paging/LegacyPageFetcher;->u()V

    .line 12
    :cond_0
    iget v1, p0, Landroidx/paging/ContiguousPagedList;->u:I
    ...
    invoke-virtual {v1}, Landroidx/paging/LegacyPageFetcher;->t()V

    .line 14
    :cond_1
    iget v1, p0, Landroidx/paging/ContiguousPagedList;->R0:I

    invoke-static {v1, p1}, Ljava/lang/Math;->min(II)I

    move-result v1

    iput v1, p0, Landroidx/paging/ContiguousPagedList;->R0:I

    .line 15
    iget v1, p0, Landroidx/paging/ContiguousPagedList;->S0:I

    invoke-static {v1, p1}, Ljava/lang/Math;->max(II)I

    move-result p1

    iput p1, p0, Landroidx/paging/ContiguousPagedList;->S0:I

    .line 16
    invoke-virtual {p0, v0}, Landroidx/paging/ContiguousPagedList;->f0(Z)V
...
.method public Q()V
    ...
    .line 3
    iget-object v0, v0, Landroidx/paging/LegacyPageFetcher;->i:Landroidx/paging/PagedList$e;
    ...
    .line 6
    invoke-virtual {p0}, Landroidx/paging/PagedList;->B()Ljava/lang/Runnable;
...
.method public final Z(ZZZ)V
    ...
    .line 2
    iget v0, p0, Landroidx/paging/ContiguousPagedList;->R0:I
    ...
    .line 5
    iput v0, p0, Landroidx/paging/ContiguousPagedList;->R0:I

    .line 6
    :cond_0
    iget v0, p0, Landroidx/paging/ContiguousPagedList;->S0:I
    ...
    .line 7
    iput v0, p0, Landroidx/paging/ContiguousPagedList;->S0:I
    ...
    .line 8
    :cond_2
    invoke-virtual {p0}, Landroidx/paging/PagedList;->s()Lkotlinx/coroutines/p0;

    move-result-object v1

    invoke-virtual {p0}, Landroidx/paging/PagedList;->x()Lkotlinx/coroutines/CoroutineDispatcher;
...
.method public final a0(ZZ)V
    ...
    invoke-virtual {v0}, Landroidx/paging/f0;->k()Ljava/lang/Object;
    ...
    invoke-virtual {p2}, Landroidx/paging/f0;->n()Ljava/lang/Object;
...
.method public final b0()Landroidx/paging/PagedList$a;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public c(II)V
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/paging/PagedList;->M(II)V
...
.method public d(III)V
    ...
    .line 2
    invoke-virtual {p0, p1, p3}, Landroidx/paging/PagedList;->L(II)V
...
.method public e(III)V
    ...
    .line 3
    iget p1, p0, Landroidx/paging/ContiguousPagedList;->R0:I

    add-int/2addr p1, p3

    iput p1, p0, Landroidx/paging/ContiguousPagedList;->R0:I

    .line 4
    iget p1, p0, Landroidx/paging/ContiguousPagedList;->S0:I
...
.method public final e0(Landroidx/paging/LoadType;Ljava/util/List;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 6
    :goto_2
    invoke-virtual {p0, v0, v3, v1}, Landroidx/paging/ContiguousPagedList;->Z(ZZZ)V

    :cond_3
    return-void
.end method

.method public f(Landroidx/paging/LoadType;Landroidx/paging/PagingSource$b$c;)Z
    .locals 8
    .param p1    # Landroidx/paging/LoadType;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 2
    iget-object v0, p2, Landroidx/paging/PagingSource$b$c;->a:Ljava/util/List;

    .line 3
    invoke-virtual {p0}, Landroidx/paging/PagedList;->H()I
    ...
    invoke-virtual {v2}, Landroidx/paging/f0;->o()I
    ...
    .line 4
    :goto_0
    iget-boolean v2, p0, Landroidx/paging/ContiguousPagedList;->U0:Z
    ...
    .line 6
    invoke-virtual {p0}, Landroidx/paging/PagedList;->C()I
    ...
    .line 8
    invoke-virtual {v2, v5, v6, v7}, Landroidx/paging/f0;->B(III)Z
    ...
    invoke-virtual {v2, p2, p0}, Landroidx/paging/f0;->i(Landroidx/paging/PagingSource$b$c;Landroidx/paging/f0$a;)V
    ...
    .line 15
    iput v3, p0, Landroidx/paging/ContiguousPagedList;->p:I
    ...
    invoke-virtual {v2, p2, p0}, Landroidx/paging/f0;->x(Landroidx/paging/PagingSource$b$c;Landroidx/paging/f0$a;)V
    ...
    :cond_5
    :goto_3
    iget-boolean p2, p0, Landroidx/paging/ContiguousPagedList;->U0:Z
    ...
    .line 20
    iget-object p2, p0, Landroidx/paging/ContiguousPagedList;->V0:Landroidx/paging/LegacyPageFetcher;

    invoke-static {p2}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;)Ljava/lang/Object;

    .line 21
    iget-object p2, p2, Landroidx/paging/LegacyPageFetcher;->i:Landroidx/paging/PagedList$e;
    ...
    .line 24
    iget-boolean v1, p0, Landroidx/paging/ContiguousPagedList;->T0:Z
    ...
    .line 27
    invoke-virtual {p2, v1, v2, v4, p0}, Landroidx/paging/f0;->F(ZIILandroidx/paging/f0$a;)Z
    ...
    .line 40
    invoke-virtual {p2, v1, v2, v4, p0}, Landroidx/paging/f0;->E(ZIILandroidx/paging/f0$a;)Z
    ...
    :cond_7
    :goto_4
    invoke-virtual {p0, p1, v0}, Landroidx/paging/ContiguousPagedList;->e0(Landroidx/paging/LoadType;Ljava/util/List;)V
...
.method public final f0(Z)V
    ...
    .line 3
    :goto_0
    iget-boolean v3, p0, Landroidx/paging/ContiguousPagedList;->K0:Z

    if-eqz v3, :cond_1

    .line 4
    iget v3, p0, Landroidx/paging/ContiguousPagedList;->S0:I
    ...
    .line 9
    :cond_5
    invoke-virtual {p0, v0, v1}, Landroidx/paging/ContiguousPagedList;->a0(ZZ)V
...
.method public g(I)V
    ...
    .line 1
    invoke-virtual {p0, v0, p1}, Landroidx/paging/PagedList;->L(II)V
    ...
    .line 3
    iget p1, p1, Landroidx/paging/f0;->b:I
    ...
    .line 5
    iget p1, p1, Landroidx/paging/f0;->c:I
    ...
    .line 6
    :cond_1
    iput-boolean v0, p0, Landroidx/paging/ContiguousPagedList;->T0:Z

    return-void
.end method

.method public h(Landroidx/paging/LoadType;Landroidx/paging/p;)V
    .locals 1
    .param p1    # Landroidx/paging/LoadType;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/paging/PagedList;->q(Landroidx/paging/LoadType;Landroidx/paging/p;)V
...
.method public v()Ljava/lang/Object;
    ...
    invoke-virtual {v0, v1}, Landroidx/paging/f0;->q(Landroidx/paging/PagedList$d;)Landroidx/paging/k0;
    ...
    .line 2
    :cond_0
    invoke-virtual {p0}, Landroidx/paging/ContiguousPagedList;->z()Landroidx/paging/PagingSource;

    move-result-object v1

    invoke-virtual {v1, v0}, Landroidx/paging/PagingSource;->e(Landroidx/paging/k0;)Ljava/lang/Object;
    ...
    .line 3
    iget-object v0, p0, Landroidx/paging/ContiguousPagedList;->m:Ljava/lang/Object;

    :cond_1
    return-object v0
.end method

.method public final z()Landroidx/paging/PagingSource;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",

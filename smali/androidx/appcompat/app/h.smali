...
.method public static constructor <clinit>()V
    ...
    .line 3
    sput-object v0, Landroidx/appcompat/app/h;->sAccessibilityHeading:[I
    ...
    .line 4
    sput-object v0, Landroidx/appcompat/app/h;->sAccessibilityPaneTitle:[I
    ...
    .line 5
    sput-object v0, Landroidx/appcompat/app/h;->sScreenReaderFocusable:[I
    ...
    sput-object v0, Landroidx/appcompat/app/h;->sConstructorMap:Landroidx/collection/m;
...
.method private backportAccessibilityAttributes(Landroid/content/Context;Landroid/view/View;Landroid/util/AttributeSet;)V
    ...
    .line 2
    :cond_0
    sget-object v0, Landroidx/appcompat/app/h;->sAccessibilityHeading:[I
    ...
    invoke-static {p2, v2}, Landroidx/core/view/ViewCompat;->C1(Landroid/view/View;Z)V
    ...
    .line 6
    sget-object v0, Landroidx/appcompat/app/h;->sAccessibilityPaneTitle:[I
    ...
    invoke-static {p2, v2}, Landroidx/core/view/ViewCompat;->E1(Landroid/view/View;Ljava/lang/CharSequence;)V
    ...
    .line 10
    sget-object v0, Landroidx/appcompat/app/h;->sScreenReaderFocusable:[I
    ...
    invoke-static {p2, p3}, Landroidx/core/view/ViewCompat;->n2(Landroid/view/View;Z)V
...
.method private createViewByPrefix(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    .line 1
    sget-object v0, Landroidx/appcompat/app/h;->sConstructorMap:Landroidx/collection/m;
...
.method public final createView(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;ZZZZ)Landroid/view/View;
    ...
    .line 6
    :pswitch_0
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/h;->createButton(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatButton;
    ...
    .line 10
    :pswitch_2
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/h;->createCheckBox(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatCheckBox;
    ...
    .line 12
    :pswitch_3
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/h;->createAutoCompleteTextView(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatAutoCompleteTextView;
    ...
    .line 16
    :pswitch_5
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/h;->createToggleButton(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatToggleButton;
    ...
    .line 18
    :pswitch_6
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/h;->createRadioButton(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatRadioButton;
    ...
    .line 20
    :pswitch_7
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/h;->createSpinner(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatSpinner;
    ...
    .line 22
    :pswitch_8
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/h;->createSeekBar(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatSeekBar;
    ...
    .line 24
    :pswitch_9
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/h;->createImageButton(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatImageButton;
    ...
    .line 28
    :pswitch_b
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/h;->createMultiAutoCompleteTextView(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatMultiAutoCompleteTextView;
    ...
    .line 30
    :pswitch_c
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/h;->createCheckedTextView(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatCheckedTextView;
    ...
    .line 32
    :pswitch_d
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/h;->createRatingBar(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatRatingBar;
    ...
    .line 36
    invoke-direct {p0, p1, p5, p4}, Landroidx/appcompat/app/h;->backportAccessibilityAttributes(Landroid/content/Context;Landroid/view/View;Landroid/util/AttributeSet;)V

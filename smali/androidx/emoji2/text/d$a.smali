...
# virtual methods
.method public final a(Landroid/content/Context;Lr2/d;)Landroidx/emoji2/text/EmojiCompat$c;
    .locals 1
    ...
    invoke-direct {v0, p1, p2}, Landroidx/emoji2/text/j;-><init>(Landroid/content/Context;Lr2/d;)V
...
.method public c(Landroid/content/Context;)Landroidx/emoji2/text/EmojiCompat$c;
    ...
    invoke-virtual {p0, p1}, Landroidx/emoji2/text/d$a;->h(Landroid/content/Context;)Lr2/d;

    move-result-object v0

    invoke-virtual {p0, p1, v0}, Landroidx/emoji2/text/d$a;->a(Landroid/content/Context;Lr2/d;)Landroidx/emoji2/text/EmojiCompat$c;
...
.method public final d(Landroid/content/pm/ProviderInfo;Landroid/content/pm/PackageManager;)Lr2/d;
    .locals 3
    ...
    invoke-direct {v1, v0, p1, v2, p2}, Lr2/d;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)V
...
.method public h(Landroid/content/Context;)Lr2/d;
    .locals 2
    .param p1    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    :cond_0
    :try_start_0
    invoke-virtual {p0, v0, p1}, Landroidx/emoji2/text/d$a;->d(Landroid/content/pm/ProviderInfo;Landroid/content/pm/PackageManager;)Lr2/d;

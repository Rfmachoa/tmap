...
.method public c(Landroid/app/Activity;)Landroidx/window/layout/s;
    ...
    .line 3
    invoke-virtual {p0, p1}, Landroidx/window/layout/t;->h(Landroid/app/Activity;)Landroid/graphics/Rect;
    ...
    .line 4
    invoke-virtual {p0, p1}, Landroidx/window/layout/t;->g(Landroid/app/Activity;)Landroid/graphics/Rect;
    ...
    .line 5
    :cond_2
    invoke-virtual {p0, p1}, Landroidx/window/layout/t;->f(Landroid/app/Activity;)Landroid/graphics/Rect;
    ...
    invoke-direct {v0, p1}, Landroidx/window/layout/s;-><init>(Landroid/graphics/Rect;)V

    return-object v0
.end method

.method public d(Landroid/app/Activity;)Landroidx/window/layout/s;
    .locals 3
    .param p1    # Landroid/app/Activity;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-virtual {p0, p1}, Landroidx/window/layout/t;->k(Landroid/view/Display;)Landroid/graphics/Point;
...
.method public final f(Landroid/app/Activity;)Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, v1}, Landroidx/window/layout/t;->k(Landroid/view/Display;)Landroid/graphics/Point;

    move-result-object v1

    .line 6
    invoke-virtual {p0, p1}, Landroidx/window/layout/t;->j(Landroid/content/Context;)I
...
.method public final g(Landroid/app/Activity;)Landroid/graphics/Rect;
    ...
    .line 13
    invoke-virtual {p0, p1, v0}, Landroidx/window/layout/t;->l(Landroid/app/Activity;Landroid/graphics/Rect;)V
    ...
    .line 34
    invoke-virtual {p0, v1}, Landroidx/window/layout/t;->i(Landroid/view/Display;)Landroid/view/DisplayCutout;
...
.method public final i(Landroid/view/Display;)Landroid/view/DisplayCutout;
    ...
    .line 15
    sget-object v0, Landroidx/window/layout/t;->c:Ljava/lang/String;

...
.method public constructor <init>(Lh2/i;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Lh2/i;)V
    .locals 0
    .param p1    # Lh2/i;
    ...
    .line 2
    invoke-static/range {p1 .. p6}, Landroidx/core/view/f;->a(Lh2/i;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Lh2/i;)Landroid/view/DisplayCutout;
...
.method public static a(Lh2/i;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Lh2/i;)Landroid/view/DisplayCutout;
    .locals 8
    .param p0    # Lh2/i;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 2
    invoke-virtual {p0}, Lh2/i;->h()Landroid/graphics/Insets;

    move-result-object v2

    .line 3
    invoke-virtual {p5}, Lh2/i;->h()Landroid/graphics/Insets;

...
.method public static c(Landroid/view/MenuItem;)Landroidx/core/view/b;
    ...
    invoke-interface {p0}, La2/b;->a()Landroidx/core/view/b;
...
.method public static e(Landroid/view/MenuItem;)I
    ...
    invoke-interface {p0}, La2/b;->getAlphabeticModifiers()I
...
.method public static f(Landroid/view/MenuItem;)Ljava/lang/CharSequence;
    ...
    invoke-interface {p0}, La2/b;->getContentDescription()Ljava/lang/CharSequence;
...
.method public static g(Landroid/view/MenuItem;)Landroid/content/res/ColorStateList;
    ...
    invoke-interface {p0}, La2/b;->getIconTintList()Landroid/content/res/ColorStateList;
...
.method public static h(Landroid/view/MenuItem;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-interface {p0}, La2/b;->getIconTintMode()Landroid/graphics/PorterDuff$Mode;
...
.method public static i(Landroid/view/MenuItem;)I
    ...
    invoke-interface {p0}, La2/b;->getNumericModifiers()I
...
.method public static j(Landroid/view/MenuItem;)Ljava/lang/CharSequence;
    ...
    invoke-interface {p0}, La2/b;->getTooltipText()Ljava/lang/CharSequence;
...
.method public static l(Landroid/view/MenuItem;Landroidx/core/view/b;)Landroid/view/MenuItem;
    ...
    invoke-interface {p0, p1}, La2/b;->c(Landroidx/core/view/b;)La2/b;
...
.method public static o(Landroid/view/MenuItem;CI)V
    ...
    invoke-interface {p0, p1, p2}, La2/b;->setAlphabeticShortcut(CI)Landroid/view/MenuItem;
...
.method public static q(Landroid/view/MenuItem;Landroid/content/res/ColorStateList;)V
    ...
    invoke-interface {p0, p1}, La2/b;->setIconTintList(Landroid/content/res/ColorStateList;)Landroid/view/MenuItem;
...
.method public static r(Landroid/view/MenuItem;Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-interface {p0, p1}, La2/b;->setIconTintMode(Landroid/graphics/PorterDuff$Mode;)Landroid/view/MenuItem;
...
.method public static s(Landroid/view/MenuItem;CI)V
    ...
    invoke-interface {p0, p1, p2}, La2/b;->setNumericShortcut(CI)Landroid/view/MenuItem;
...
.method public static u(Landroid/view/MenuItem;CCII)V
    ...
    invoke-interface {p0, p1, p2, p3, p4}, La2/b;->setShortcut(CCII)Landroid/view/MenuItem;

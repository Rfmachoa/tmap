...
.method public static b(Landroid/location/LocationManager;Landroid/os/Handler;Ljava/util/concurrent/Executor;Landroidx/core/location/GnssStatusCompat$a;)Z
    ...
    .line 2
    sget-object v2, Landroidx/core/location/a$g;->a:Landroidx/collection/m;
    ...
    .line 4
    new-instance v3, Landroidx/core/location/a$m;

    invoke-direct {v3, p3}, Landroidx/core/location/a$m;-><init>(Landroidx/core/location/GnssStatusCompat$a;)V

    goto :goto_1

    .line 5
    :cond_1
    invoke-virtual {v3}, Landroidx/core/location/a$m;->j()V

    .line 6
    :goto_1
    invoke-virtual {v3, p2}, Landroidx/core/location/a$m;->i(Ljava/util/concurrent/Executor;)V
...
.method public static d(Landroid/location/LocationManager;Ljava/lang/Object;)V
    ...
    .line 1
    instance-of v0, p1, Landroidx/core/location/a$m;
    ...
    check-cast v0, Landroidx/core/location/a$m;

    invoke-virtual {v0}, Landroidx/core/location/a$m;->j()V

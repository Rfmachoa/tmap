...
.field public static final e:Ljava/lang/String; = "ACTION_FORCE_STOP_RESCHEDULE"
...
.method public constructor <init>(Landroid/content/Context;Lg5/i;)V
    ...
    .line 3
    iput-object p2, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Lg5/i;
...
.method public a()Z
    ...
    iget-object v1, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Lg5/i;

    invoke-static {v0, v1}, Lj5/b;->i(Landroid/content/Context;Lg5/i;)Z
    ...
    invoke-virtual {v1}, Lg5/i;->M()Landroidx/work/impl/WorkDatabase;
    ...
    .line 6
    :try_start_0
    invoke-interface {v2}, Ln5/s;->w()Ljava/util/List;
    ...
    iget-object v11, v8, Ln5/r;->a:Ljava/lang/String;

    aput-object v11, v10, v6

    invoke-interface {v2, v9, v10}, Ln5/s;->b(Landroidx/work/WorkInfo$State;[Ljava/lang/String;)I

    .line 10
    iget-object v8, v8, Ln5/r;->a:Ljava/lang/String;

    const-wide/16 v9, -0x1

    invoke-interface {v2, v8, v9, v10}, Ln5/s;->q(Ljava/lang/String;J)I

    goto :goto_1

    .line 11
    :cond_1
    invoke-interface {v3}, Ln5/p;->c()V
...
.method public b()V
    ...
    .line 4
    iget-object v0, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Lg5/i;

    invoke-virtual {v0}, Lg5/i;->R()V

    .line 5
    iget-object v0, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Lg5/i;

    invoke-virtual {v0}, Lg5/i;->I()Lo5/f;

    move-result-object v0

    invoke-virtual {v0, v2}, Lo5/f;->f(Z)V
    ...
    iget-object v2, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Lg5/i;

    .line 13
    invoke-virtual {v2}, Lg5/i;->L()Ljava/util/List;
...
.method public e()Z
    ...
    invoke-virtual {v3, v4, v0, v5}, Lf5/i;->h(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
...
.method public f()Z
    ...
    .line 3
    iget-object v1, v0, Landroidx/work/a;->g:Ljava/lang/String;
    ...
    invoke-virtual {v1, v4, v2, v3}, Lf5/i;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
...
.method public run()V
    ...
    invoke-static {v0}, Lg5/h;->e(Landroid/content/Context;)V
    ...
    invoke-virtual {v4, v5, v1, v6}, Lf5/i;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
    ...
    .line 11
    iget-object v0, v0, Landroidx/work/a;->f:Lf5/f;
    ...
    invoke-virtual {v1, v5, v6, v2}, Lf5/i;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V

    .line 13
    invoke-interface {v0, v4}, Lf5/f;->a(Ljava/lang/Throwable;)V
    :try_end_3
    ...
    invoke-virtual {v1, v8, v4, v2}, Lf5/i;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V

...
.method public constructor <init>(Landroid/content/Context;Ly4/i;)V
    ...
    .line 3
    iput-object p2, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Ly4/i;
...
.method public a()Z
    ...
    iget-object v1, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Ly4/i;

    invoke-static {v0, v1}, Lb5/b;->i(Landroid/content/Context;Ly4/i;)Z
    ...
    invoke-virtual {v1}, Ly4/i;->M()Landroidx/work/impl/WorkDatabase;

    move-result-object v1

    .line 3
    invoke-virtual {v1}, Landroidx/work/impl/WorkDatabase;->W()Lf5/s;
    ...
    .line 6
    :try_start_0
    invoke-interface {v2}, Lf5/s;->v()Ljava/util/List;
    ...
    iget-object v11, v8, Lf5/r;->a:Ljava/lang/String;

    aput-object v11, v10, v6

    invoke-interface {v2, v9, v10}, Lf5/s;->b(Landroidx/work/WorkInfo$State;[Ljava/lang/String;)I

    .line 10
    iget-object v8, v8, Lf5/r;->a:Ljava/lang/String;

    const-wide/16 v9, -0x1

    invoke-interface {v2, v8, v9, v10}, Lf5/s;->p(Ljava/lang/String;J)I

    goto :goto_1

    .line 11
    :cond_1
    invoke-interface {v3}, Lf5/p;->c()V
...
.method public b()V
    ...
    .line 4
    iget-object v0, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Ly4/i;

    invoke-virtual {v0}, Ly4/i;->R()V

    .line 5
    iget-object v0, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Ly4/i;

    invoke-virtual {v0}, Ly4/i;->I()Lg5/f;

    move-result-object v0

    invoke-virtual {v0, v2}, Lg5/f;->f(Z)V
    ...
    iget-object v2, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Ly4/i;

    .line 13
    invoke-virtual {v2}, Ly4/i;->L()Ljava/util/List;
...
.method public e()Z
    ...
    invoke-virtual {v3, v4, v0, v5}, Lx4/i;->h(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
...
.method public f()Z
    ...
    invoke-virtual {v1, v4, v2, v3}, Lx4/i;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
...
.method public run()V
    ...
    invoke-static {v0}, Ly4/h;->e(Landroid/content/Context;)V
    ...
    invoke-virtual {v4, v5, v1, v6}, Lx4/i;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
    ...
    .line 11
    iget-object v0, v0, Landroidx/work/a;->f:Lx4/f;
    ...
    invoke-virtual {v1, v5, v6, v2}, Lx4/i;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V

    .line 13
    invoke-interface {v0, v4}, Lx4/f;->a(Ljava/lang/Throwable;)V
    :try_end_3
    ...
    invoke-virtual {v1, v8, v4, v2}, Lx4/i;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V

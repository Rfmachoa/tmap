...
# instance fields
.field public final a:Landroidx/recyclerview/widget/x$a;


# direct methods
.method public constructor <init>(Landroidx/recyclerview/widget/x$a;)V
    .locals 0
    ...
    .line 2
    iput-object p1, p0, Landroidx/recyclerview/widget/x;->a:Landroidx/recyclerview/widget/x$a;
...
.method public b(Ljava/util/List;)V
    ...
    .line 1
    :goto_0
    invoke-virtual {p0, p1}, Landroidx/recyclerview/widget/x;->a(Ljava/util/List;)I
    ...
    .line 2
    invoke-virtual {p0, p1, v0, v1}, Landroidx/recyclerview/widget/x;->d(Ljava/util/List;II)V
...
.method public final d(Ljava/util/List;II)V
    ...
    .line 4
    invoke-virtual/range {v1 .. v6}, Landroidx/recyclerview/widget/x;->f(Ljava/util/List;ILandroidx/recyclerview/widget/a$b;ILandroidx/recyclerview/widget/a$b;)V
    ...
    .line 5
    invoke-virtual/range {v1 .. v6}, Landroidx/recyclerview/widget/x;->e(Ljava/util/List;ILandroidx/recyclerview/widget/a$b;ILandroidx/recyclerview/widget/a$b;)V
    ...
    .line 6
    invoke-virtual/range {v1 .. v6}, Landroidx/recyclerview/widget/x;->c(Ljava/util/List;ILandroidx/recyclerview/widget/a$b;ILandroidx/recyclerview/widget/a$b;)V
...
.method public e(Ljava/util/List;ILandroidx/recyclerview/widget/a$b;ILandroidx/recyclerview/widget/a$b;)V
    ...
    .line 12
    iget-object p1, p0, Landroidx/recyclerview/widget/x;->a:Landroidx/recyclerview/widget/x$a;

    invoke-interface {p1, p5}, Landroidx/recyclerview/widget/x$a;->b(Landroidx/recyclerview/widget/a$b;)V
    ...
    .line 16
    iget-object v7, p0, Landroidx/recyclerview/widget/x;->a:Landroidx/recyclerview/widget/x$a;

    add-int/2addr v1, v3

    invoke-interface {v7, v5, v1, v4, v6}, Landroidx/recyclerview/widget/x$a;->a(IIILjava/lang/Object;)Landroidx/recyclerview/widget/a$b;
    ...
    invoke-interface {p1, p3}, Landroidx/recyclerview/widget/x$a;->b(Landroidx/recyclerview/widget/a$b;)V
...
.method public f(Ljava/util/List;ILandroidx/recyclerview/widget/a$b;ILandroidx/recyclerview/widget/a$b;)V
    ...
    .line 5
    iget-object v0, p0, Landroidx/recyclerview/widget/x;->a:Landroidx/recyclerview/widget/x$a;

    iget v1, p3, Landroidx/recyclerview/widget/a$b;->b:I

    iget-object v5, p5, Landroidx/recyclerview/widget/a$b;->c:Ljava/lang/Object;

    invoke-interface {v0, v2, v1, v4, v5}, Landroidx/recyclerview/widget/x$a;->a(IIILjava/lang/Object;)Landroidx/recyclerview/widget/a$b;
    ...
    .line 9
    iget-object v3, p0, Landroidx/recyclerview/widget/x;->a:Landroidx/recyclerview/widget/x$a;

    add-int/2addr v1, v4

    iget-object v4, p5, Landroidx/recyclerview/widget/a$b;->c:Ljava/lang/Object;

    invoke-interface {v3, v2, v1, v5, v4}, Landroidx/recyclerview/widget/x$a;->a(IIILjava/lang/Object;)Landroidx/recyclerview/widget/a$b;
    ...
    .line 15
    iget-object p3, p0, Landroidx/recyclerview/widget/x;->a:Landroidx/recyclerview/widget/x$a;

    invoke-interface {p3, p5}, Landroidx/recyclerview/widget/x$a;->b(Landroidx/recyclerview/widget/a$b;)V

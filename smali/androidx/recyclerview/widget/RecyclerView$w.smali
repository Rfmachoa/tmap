...
.method public onAnimation(II)V
    ...
    .line 12
    invoke-virtual {p0, v1}, Landroidx/recyclerview/widget/RecyclerView$w;->getChildPosition(Landroid/view/View;)I

    move-result v1

    iget v3, p0, Landroidx/recyclerview/widget/RecyclerView$w;->mTargetPosition:I
    ...
    invoke-virtual {p0, v1, v2, v3}, Landroidx/recyclerview/widget/RecyclerView$w;->onTargetFound(Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView$x;Landroidx/recyclerview/widget/RecyclerView$w$a;)V

    .line 14
    iget-object v1, p0, Landroidx/recyclerview/widget/RecyclerView$w;->mRecyclingAction:Landroidx/recyclerview/widget/RecyclerView$w$a;

    invoke-virtual {v1, v0}, Landroidx/recyclerview/widget/RecyclerView$w$a;->g(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    :cond_5
    :goto_0
    iget-boolean v1, p0, Landroidx/recyclerview/widget/RecyclerView$w;->mRunning:Z
    ...
    invoke-virtual {p0, p1, p2, v1, v2}, Landroidx/recyclerview/widget/RecyclerView$w;->onSeekTargetStep(IILandroidx/recyclerview/widget/RecyclerView$x;Landroidx/recyclerview/widget/RecyclerView$w$a;)V
    ...
    invoke-virtual {p1}, Landroidx/recyclerview/widget/RecyclerView$w$a;->e()Z

    move-result p1

    .line 21
    iget-object p2, p0, Landroidx/recyclerview/widget/RecyclerView$w;->mRecyclingAction:Landroidx/recyclerview/widget/RecyclerView$w$a;

    invoke-virtual {p2, v0}, Landroidx/recyclerview/widget/RecyclerView$w$a;->g(Landroidx/recyclerview/widget/RecyclerView;)V

...
# virtual methods
.method public final a(Ll2/c;Landroid/view/ViewGroup;)V
    .locals 4
    ...
    .line 4
    invoke-virtual {p1, v2}, Ll2/c;->c(Landroid/view/View;)V
...
.method public final b(Ll2/c;Ll2/c;)V
    .locals 1
    ...
    .line 2
    invoke-virtual {p2, v0}, Ll2/c;->t(Landroid/graphics/Rect;)V

    .line 3
    invoke-virtual {p1, v0}, Ll2/c;->V0(Landroid/graphics/Rect;)V

    .line 4
    invoke-virtual {p2}, Ll2/c;->E0()Z

    move-result v0

    invoke-virtual {p1, v0}, Ll2/c;->a2(Z)V

    .line 5
    invoke-virtual {p2}, Ll2/c;->O()Ljava/lang/CharSequence;

    move-result-object v0

    invoke-virtual {p1, v0}, Ll2/c;->A1(Ljava/lang/CharSequence;)V

    .line 6
    invoke-virtual {p2}, Ll2/c;->w()Ljava/lang/CharSequence;

    move-result-object v0

    invoke-virtual {p1, v0}, Ll2/c;->Z0(Ljava/lang/CharSequence;)V

    .line 7
    invoke-virtual {p2}, Ll2/c;->A()Ljava/lang/CharSequence;

    move-result-object v0

    invoke-virtual {p1, v0}, Ll2/c;->d1(Ljava/lang/CharSequence;)V

    .line 8
    invoke-virtual {p2}, Ll2/c;->q0()Z

    move-result v0

    invoke-virtual {p1, v0}, Ll2/c;->j1(Z)V

    .line 9
    invoke-virtual {p2}, Ll2/c;->s0()Z

    move-result v0

    invoke-virtual {p1, v0}, Ll2/c;->m1(Z)V

    .line 10
    invoke-virtual {p2}, Ll2/c;->i0()Z

    move-result v0

    invoke-virtual {p1, v0}, Ll2/c;->R0(Z)V

    .line 11
    invoke-virtual {p2}, Ll2/c;->A0()Z
    ...
    .line 12
    invoke-virtual {p2}, Ll2/c;->p()I

    move-result p2

    invoke-virtual {p1, p2}, Ll2/c;->a(I)V
...
.method public onInitializeAccessibilityNodeInfo(Landroid/view/View;Ll2/c;)V
    ...
    .line 3
    :cond_0
    invoke-static {p2}, Ll2/c;->I0(Ll2/c;)Ll2/c;

    move-result-object v0

    .line 4
    invoke-super {p0, p1, v0}, Landroidx/core/view/a;->onInitializeAccessibilityNodeInfo(Landroid/view/View;Ll2/c;)V

    .line 5
    invoke-virtual {p2, p1}, Ll2/c;->L1(Landroid/view/View;)V
    ...
    invoke-virtual {p2, v1}, Ll2/c;->C1(Landroid/view/View;)V

    .line 9
    :cond_1
    invoke-virtual {p0, p2, v0}, Landroidx/drawerlayout/widget/DrawerLayout$c;->b(Ll2/c;Ll2/c;)V

    .line 10
    invoke-virtual {v0}, Ll2/c;->L0()V

    .line 11
    check-cast p1, Landroid/view/ViewGroup;

    invoke-virtual {p0, p2, p1}, Landroidx/drawerlayout/widget/DrawerLayout$c;->a(Ll2/c;Landroid/view/ViewGroup;)V

    :goto_0
    const-string p1, "androidx.drawerlayout.widget.DrawerLayout"

    .line 12
    invoke-virtual {p2, p1}, Ll2/c;->Z0(Ljava/lang/CharSequence;)V

    const/4 p1, 0x0

    .line 13
    invoke-virtual {p2, p1}, Ll2/c;->l1(Z)V

    .line 14
    invoke-virtual {p2, p1}, Ll2/c;->m1(Z)V

    .line 15
    sget-object p1, Ll2/c$a;->f:Ll2/c$a;

    invoke-virtual {p2, p1}, Ll2/c;->N0(Ll2/c$a;)Z

    .line 16
    sget-object p1, Ll2/c$a;->g:Ll2/c$a;

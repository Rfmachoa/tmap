...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/constraintlayout/motion/widget/k$a;->m:Landroid/util/SparseIntArray;
    ...
    .line 3
    sget-object v0, Landroidx/constraintlayout/motion/widget/k$a;->m:Landroid/util/SparseIntArray;
...
.method public static synthetic a(Landroidx/constraintlayout/motion/widget/k;Landroid/content/res/TypedArray;)V
    .locals 0

    .line 1
    invoke-static {p0, p1}, Landroidx/constraintlayout/motion/widget/k$a;->b(Landroidx/constraintlayout/motion/widget/k;Landroid/content/res/TypedArray;)V

    return-void
.end method

.method public static b(Landroidx/constraintlayout/motion/widget/k;Landroid/content/res/TypedArray;)V
    .locals 8
    ...
    .line 3
    sget-object v6, Landroidx/constraintlayout/motion/widget/k$a;->m:Landroid/util/SparseIntArray;
    ...
    .line 5
    :pswitch_0
    iget v3, p0, Landroidx/constraintlayout/motion/widget/k;->E:F

    invoke-virtual {p1, v5, v3}, Landroid/content/res/TypedArray;->getFloat(IF)F

    move-result v3

    iput v3, p0, Landroidx/constraintlayout/motion/widget/k;->E:F

    goto/16 :goto_1

    .line 6
    :pswitch_1
    iget v3, p0, Landroidx/constraintlayout/motion/widget/k;->D:F

    invoke-virtual {p1, v5, v3}, Landroid/content/res/TypedArray;->getFloat(IF)F

    move-result v3

    iput v3, p0, Landroidx/constraintlayout/motion/widget/k;->D:F
    ...
    iput v3, p0, Landroidx/constraintlayout/motion/widget/k;->B:I

    goto/16 :goto_1

    .line 8
    :pswitch_3
    iget v3, p0, Landroidx/constraintlayout/motion/widget/k;->J:I

    invoke-virtual {p1, v5, v3}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v3

    iput v3, p0, Landroidx/constraintlayout/motion/widget/k;->J:I
    ...
    .line 10
    :pswitch_5
    iget v3, p0, Landroidx/constraintlayout/motion/widget/k;->G:F

    invoke-virtual {p1, v5, v3}, Landroid/content/res/TypedArray;->getFloat(IF)F

    move-result v3

    iput v3, p0, Landroidx/constraintlayout/motion/widget/k;->G:F

    goto/16 :goto_1

    .line 11
    :pswitch_6
    iget v3, p0, Landroidx/constraintlayout/motion/widget/k;->F:F

    invoke-virtual {p1, v5, v3}, Landroid/content/res/TypedArray;->getFloat(IF)F

    move-result v3

    iput v3, p0, Landroidx/constraintlayout/motion/widget/k;->F:F
    ...
    .line 13
    :pswitch_8
    iget v3, p0, Landroidx/constraintlayout/motion/widget/l;->y:I

    invoke-virtual {p1, v5, v3}, Landroid/content/res/TypedArray;->getInteger(II)I

    move-result v3

    iput v3, p0, Landroidx/constraintlayout/motion/widget/l;->y:I
    ...
    iput-object v3, p0, Landroidx/constraintlayout/motion/widget/k;->A:Ljava/lang/String;

    goto :goto_1

    .line 16
    :cond_0
    sget-object v3, Ls0/d;->k:[Ljava/lang/String;
    ...
    iput-object v3, p0, Landroidx/constraintlayout/motion/widget/e;->c:Ljava/lang/String;
    ...
    .line 24
    :cond_4
    iget p0, p0, Landroidx/constraintlayout/motion/widget/e;->a:I

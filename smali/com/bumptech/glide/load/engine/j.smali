...
# static fields
.field public static final a1:Lcom/bumptech/glide/load/engine/j$c;


# instance fields
.field public K0:Lcom/bumptech/glide/load/engine/s;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field public S0:Lcom/bumptech/glide/load/DataSource;

.field public T0:Z

.field public U0:Lcom/bumptech/glide/load/engine/GlideException;

.field public V0:Z

.field public W0:Lcom/bumptech/glide/load/engine/n;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field public X0:Lcom/bumptech/glide/load/engine/DecodeJob;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcom/bumptech/glide/load/engine/j;->a1:Lcom/bumptech/glide/load/engine/j$c;

    return-void
.end method

.method public constructor <init>(Ld6/a;Ld6/a;Ld6/a;Ld6/a;Lcom/bumptech/glide/load/engine/k;Lcom/bumptech/glide/load/engine/n$a;Landroidx/core/util/o$a;)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    sget-object v8, Lcom/bumptech/glide/load/engine/j;->a1:Lcom/bumptech/glide/load/engine/j$c;
    ...
    invoke-direct/range {v0 .. v8}, Lcom/bumptech/glide/load/engine/j;-><init>(Ld6/a;Ld6/a;Ld6/a;Ld6/a;Lcom/bumptech/glide/load/engine/k;Lcom/bumptech/glide/load/engine/n$a;Landroidx/core/util/o$a;Lcom/bumptech/glide/load/engine/j$c;)V

    return-void
.end method

.method public constructor <init>(Ld6/a;Ld6/a;Ld6/a;Ld6/a;Lcom/bumptech/glide/load/engine/k;Lcom/bumptech/glide/load/engine/n$a;Landroidx/core/util/o$a;Lcom/bumptech/glide/load/engine/j$c;)V
    .locals 1
    ...
    .line 5
    iput-object v0, p0, Lcom/bumptech/glide/load/engine/j;->b:Lt6/c;
    ...
    .line 7
    iput-object p1, p0, Lcom/bumptech/glide/load/engine/j;->g:Ld6/a;

    .line 8
    iput-object p2, p0, Lcom/bumptech/glide/load/engine/j;->h:Ld6/a;

    .line 9
    iput-object p3, p0, Lcom/bumptech/glide/load/engine/j;->i:Ld6/a;

    .line 10
    iput-object p4, p0, Lcom/bumptech/glide/load/engine/j;->j:Ld6/a;
    ...
    .line 13
    iput-object p7, p0, Lcom/bumptech/glide/load/engine/j;->d:Landroidx/core/util/o$a;
...
.method public declared-synchronized a(Lcom/bumptech/glide/request/i;Ljava/util/concurrent/Executor;)V
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/j;->b:Lt6/c;
    ...
    .line 3
    iget-boolean v0, p0, Lcom/bumptech/glide/load/engine/j;->T0:Z
    ...
    .line 6
    :cond_0
    iget-boolean v0, p0, Lcom/bumptech/glide/load/engine/j;->V0:Z
    ...
    .line 9
    :cond_1
    iget-boolean p1, p0, Lcom/bumptech/glide/load/engine/j;->Y0:Z
    ...
    invoke-static {v1, p1}, Ls6/m;->a(ZLjava/lang/String;)V
    :try_end_0
...
.method public b(Lcom/bumptech/glide/load/engine/s;Lcom/bumptech/glide/load/DataSource;Z)V
    ...
    .line 2
    :try_start_0
    iput-object p1, p0, Lcom/bumptech/glide/load/engine/j;->K0:Lcom/bumptech/glide/load/engine/s;

    .line 3
    iput-object p2, p0, Lcom/bumptech/glide/load/engine/j;->S0:Lcom/bumptech/glide/load/DataSource;

    .line 4
    iput-boolean p3, p0, Lcom/bumptech/glide/load/engine/j;->Z0:Z
...
.method public c(Lcom/bumptech/glide/load/engine/GlideException;)V
    ...
    .line 2
    :try_start_0
    iput-object p1, p0, Lcom/bumptech/glide/load/engine/j;->U0:Lcom/bumptech/glide/load/engine/GlideException;
...
.method public e(Lcom/bumptech/glide/load/engine/DecodeJob;)V
    ...
    invoke-virtual {p0}, Lcom/bumptech/glide/load/engine/j;->j()Ld6/a;

    move-result-object v0

    invoke-virtual {v0, p1}, Ld6/a;->execute(Ljava/lang/Runnable;)V
...
.method public f(Lcom/bumptech/glide/request/i;)V
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/j;->U0:Lcom/bumptech/glide/load/engine/GlideException;
...
.method public g(Lcom/bumptech/glide/request/i;)V
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/j;->W0:Lcom/bumptech/glide/load/engine/n;

    iget-object v1, p0, Lcom/bumptech/glide/load/engine/j;->S0:Lcom/bumptech/glide/load/DataSource;

    iget-boolean v2, p0, Lcom/bumptech/glide/load/engine/j;->Z0:Z
...
.method public h()V
    ...
    .line 2
    iput-boolean v0, p0, Lcom/bumptech/glide/load/engine/j;->Y0:Z

    .line 3
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/j;->X0:Lcom/bumptech/glide/load/engine/DecodeJob;
    ...
    iget-object v1, p0, Lcom/bumptech/glide/load/engine/j;->l:La6/b;

    invoke-interface {v0, p0, v1}, Lcom/bumptech/glide/load/engine/k;->b(Lcom/bumptech/glide/load/engine/j;La6/b;)V
...
.method public i()V
    ...
    .line 5
    invoke-static {v1, v2}, Ls6/m;->a(ZLjava/lang/String;)V
...
.method public final j()Ld6/a;
    ...
    .line 2
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/j;->i:Ld6/a;
    ...
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/j;->j:Ld6/a;

    goto :goto_0

    :cond_1
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/j;->h:Ld6/a;
...
.method public declared-synchronized k(I)V
    ...
    iget-object p1, p0, Lcom/bumptech/glide/load/engine/j;->W0:Lcom/bumptech/glide/load/engine/n;
...
.method public declared-synchronized l(La6/b;ZZZZ)Lcom/bumptech/glide/load/engine/j;
    .locals 0
    .annotation build Landroidx/annotation/VisibleForTesting;
    .end annotation
    ...
    .line 1
    :try_start_0
    iput-object p1, p0, Lcom/bumptech/glide/load/engine/j;->l:La6/b;
    ...
    .line 4
    iput-boolean p4, p0, Lcom/bumptech/glide/load/engine/j;->u:Z
...
.method public declared-synchronized m()Z
    ...
    :try_start_0
    iget-boolean v0, p0, Lcom/bumptech/glide/load/engine/j;->Y0:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public o()V
    ...
    .line 8
    iput-boolean v0, p0, Lcom/bumptech/glide/load/engine/j;->V0:Z
    ...
    invoke-interface {v0, p0, v1, v3}, Lcom/bumptech/glide/load/engine/k;->c(Lcom/bumptech/glide/load/engine/j;La6/b;Lcom/bumptech/glide/load/engine/n;)V
...
.method public p()V
    ...
    .line 4
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/j;->K0:Lcom/bumptech/glide/load/engine/s;
    ...
    iget-object v1, p0, Lcom/bumptech/glide/load/engine/j;->K0:Lcom/bumptech/glide/load/engine/s;

    iget-boolean v2, p0, Lcom/bumptech/glide/load/engine/j;->m:Z

    iget-object v3, p0, Lcom/bumptech/glide/load/engine/j;->l:La6/b;

    iget-object v4, p0, Lcom/bumptech/glide/load/engine/j;->c:Lcom/bumptech/glide/load/engine/n$a;

    invoke-virtual {v0, v1, v2, v3, v4}, Lcom/bumptech/glide/load/engine/j$c;->a(Lcom/bumptech/glide/load/engine/s;ZLa6/b;Lcom/bumptech/glide/load/engine/n$a;)Lcom/bumptech/glide/load/engine/n;

    move-result-object v0

    iput-object v0, p0, Lcom/bumptech/glide/load/engine/j;->W0:Lcom/bumptech/glide/load/engine/n;

    const/4 v0, 0x1

    .line 10
    iput-boolean v0, p0, Lcom/bumptech/glide/load/engine/j;->T0:Z
    ...
    .line 13
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/j;->l:La6/b;

    .line 14
    iget-object v2, p0, Lcom/bumptech/glide/load/engine/j;->W0:Lcom/bumptech/glide/load/engine/n;
    ...
    invoke-interface {v3, p0, v0, v2}, Lcom/bumptech/glide/load/engine/k;->c(Lcom/bumptech/glide/load/engine/j;La6/b;Lcom/bumptech/glide/load/engine/n;)V
...
.method public final declared-synchronized r()V
    ...
    .line 3
    iput-object v0, p0, Lcom/bumptech/glide/load/engine/j;->l:La6/b;

    .line 4
    iput-object v0, p0, Lcom/bumptech/glide/load/engine/j;->W0:Lcom/bumptech/glide/load/engine/n;

    .line 5
    iput-object v0, p0, Lcom/bumptech/glide/load/engine/j;->K0:Lcom/bumptech/glide/load/engine/s;

    const/4 v1, 0x0

    .line 6
    iput-boolean v1, p0, Lcom/bumptech/glide/load/engine/j;->V0:Z

    .line 7
    iput-boolean v1, p0, Lcom/bumptech/glide/load/engine/j;->Y0:Z

    .line 8
    iput-boolean v1, p0, Lcom/bumptech/glide/load/engine/j;->T0:Z

    .line 9
    iput-boolean v1, p0, Lcom/bumptech/glide/load/engine/j;->Z0:Z

    .line 10
    iget-object v2, p0, Lcom/bumptech/glide/load/engine/j;->X0:Lcom/bumptech/glide/load/engine/DecodeJob;

    invoke-virtual {v2, v1}, Lcom/bumptech/glide/load/engine/DecodeJob;->w(Z)V

    .line 11
    iput-object v0, p0, Lcom/bumptech/glide/load/engine/j;->X0:Lcom/bumptech/glide/load/engine/DecodeJob;

    .line 12
    iput-object v0, p0, Lcom/bumptech/glide/load/engine/j;->U0:Lcom/bumptech/glide/load/engine/GlideException;

    .line 13
    iput-object v0, p0, Lcom/bumptech/glide/load/engine/j;->S0:Lcom/bumptech/glide/load/DataSource;

    .line 14
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/j;->d:Landroidx/core/util/o$a;
...
.method public declared-synchronized s(Lcom/bumptech/glide/request/i;)V
    ...
    .line 5
    iget-boolean p1, p0, Lcom/bumptech/glide/load/engine/j;->T0:Z

    if-nez p1, :cond_1

    iget-boolean p1, p0, Lcom/bumptech/glide/load/engine/j;->V0:Z
...
.method public declared-synchronized t(Lcom/bumptech/glide/load/engine/DecodeJob;)V
    ...
    .line 1
    :try_start_0
    iput-object p1, p0, Lcom/bumptech/glide/load/engine/j;->X0:Lcom/bumptech/glide/load/engine/DecodeJob;
    ...
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/j;->g:Ld6/a;

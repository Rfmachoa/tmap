...
.field public mdatEndCache:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap<",
...
.field public mdatStartCache:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap<",
            "Lcom/coremedia/iso/boxes/mdat/MediaDataBox;",
...
.field public mdats:[Lcom/coremedia/iso/boxes/mdat/MediaDataBox;
...
.method public constructor <init>(Lcom/coremedia/iso/boxes/TrackBox;)V
    ...
    .line 4
    invoke-virtual {p1}, Lh7/a;->getIsoFile()Lcom/coremedia/iso/IsoFile;
    ...
    :cond_4
    :goto_4
    invoke-virtual {p1}, Lh7/a;->getParent()Lcom/coremedia/iso/boxes/ContainerBox;
    ...
    invoke-virtual {v0, v2}, Lh7/b;->getBoxes(Ljava/lang/Class;)Ljava/util/List;
    ...
    invoke-virtual {v4, v5}, Lh7/b;->getBoxes(Ljava/lang/Class;)Ljava/util/List;
...
.method private initIsoFile(Lcom/coremedia/iso/IsoFile;)V
    ...
    invoke-virtual {v0}, Lh7/b;->getBoxes()Ljava/util/List;
...
.method public get(I)Ljava/nio/ByteBuffer;
    ...
    invoke-static {v3, v4}, Lc8/b;->a(J)I
...
.method public getOffsets(Lcom/coremedia/iso/boxes/fragment/MovieFragmentBox;JLcom/coremedia/iso/boxes/fragment/TrackExtendsBox;)Ljava/util/Map;
    .locals 19
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v2, v1}, Lh7/b;->getBoxes(Ljava/lang/Class;)Ljava/util/List;
    ...
    .line 10
    invoke-virtual {v6}, Lh7/a;->getParent()Lcom/coremedia/iso/boxes/ContainerBox;

...
.method public static constructor <clinit>()V
    ...
    .line 1
    sput-boolean v0, Lx2/a;->i:Z

    .line 2
    sput-boolean v0, Lx2/a;->j:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 2
    iput-object v0, p0, Lx2/a;->b:Landroid/graphics/BitmapFactory$Options;
...
.method public i(Landroid/net/Uri;)Landroid/graphics/Bitmap;
    ...
    .line 4
    invoke-virtual {p0, p1, v0}, Lx2/a;->h(Landroid/net/Uri;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    iput-object v2, p0, Lx2/a;->b:Landroid/graphics/BitmapFactory$Options;
    ...
    .line 14
    :try_start_1
    invoke-virtual {p0, p1, v2}, Lx2/a;->h(Landroid/net/Uri;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    .line 16
    :try_start_2
    iput-object v3, p0, Lx2/a;->b:Landroid/graphics/BitmapFactory$Options;
...
.method public j(Ljava/lang/String;Landroid/graphics/Bitmap;)V
    ...
    .line 1
    invoke-virtual {p0, p1, p2, v0}, Lx2/a;->k(Ljava/lang/String;Landroid/graphics/Bitmap;Lx2/a$b;)V

    return-void
.end method

.method public k(Ljava/lang/String;Landroid/graphics/Bitmap;Lx2/a$b;)V
    .locals 9
    .param p1    # Ljava/lang/String;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 3
    invoke-static {p2}, Lx2/a;->g(Landroid/graphics/Bitmap;)Z
    ...
    invoke-direct/range {v2 .. v7}, Lx2/a$c;-><init>(Lx2/a;Ljava/lang/String;ILandroid/graphics/Bitmap;Lx2/a$b;)V
...
.method public l(Ljava/lang/String;Landroid/net/Uri;)V
    ...
    .line 1
    invoke-virtual {p0, p1, p2, v0}, Lx2/a;->m(Ljava/lang/String;Landroid/net/Uri;Lx2/a$b;)V

    return-void
.end method

.method public m(Ljava/lang/String;Landroid/net/Uri;Lx2/a$b;)V
    .locals 7
    .param p1    # Ljava/lang/String;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-direct/range {v0 .. v5}, Lx2/a$d;-><init>(Lx2/a;Ljava/lang/String;Landroid/net/Uri;Lx2/a$b;I)V

    .line 2
    iget-object p2, p0, Lx2/a;->a:Landroid/content/Context;
...
.method public r(Landroid/print/PrintAttributes;ILandroid/graphics/Bitmap;Landroid/os/ParcelFileDescriptor;Landroid/os/CancellationSignal;Landroid/print/PrintDocumentAdapter$WriteResultCallback;)V
    ...
    .line 2
    :cond_0
    invoke-static {p1}, Lx2/a;->b(Landroid/print/PrintAttributes;)Landroid/print/PrintAttributes$Builder;
    ...
    invoke-direct/range {v2 .. v10}, Lx2/a$a;-><init>(Lx2/a;Landroid/os/CancellationSignal;Landroid/print/PrintAttributes;Landroid/graphics/Bitmap;Landroid/print/PrintAttributes;ILandroid/os/ParcelFileDescriptor;Landroid/print/PrintDocumentAdapter$WriteResultCallback;)V

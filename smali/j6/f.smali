...
.method public bridge synthetic a(Ljava/lang/Object;IILa6/e;)Lcom/bumptech/glide/load/engine/s;
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lj6/f;->c(Landroid/net/Uri;IILa6/e;)Lcom/bumptech/glide/load/engine/s;
...
.method public bridge synthetic b(Ljava/lang/Object;La6/e;)Z
    ...
    invoke-virtual {p0, p1, p2}, Lj6/f;->h(Landroid/net/Uri;La6/e;)Z
...
.method public c(Landroid/net/Uri;IILa6/e;)Lcom/bumptech/glide/load/engine/s;
    .locals 0
    ...
    .line 2
    invoke-virtual {p0, p1, p2}, Lj6/f;->d(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Context;

    move-result-object p2

    .line 3
    invoke-virtual {p0, p2, p1}, Lj6/f;->g(Landroid/content/Context;Landroid/net/Uri;)I

    move-result p1

    .line 4
    iget-object p3, p0, Lj6/f;->a:Landroid/content/Context;

    invoke-static {p3, p2, p1}, Lj6/b;->b(Landroid/content/Context;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method public final d(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Context;
    ...
    .line 2
    iget-object p1, p0, Lj6/f;->a:Landroid/content/Context;
    ...
    .line 4
    iget-object v1, p0, Lj6/f;->a:Landroid/content/Context;
...
.method public final g(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    .line 3
    invoke-virtual {p0, p1, p2}, Lj6/f;->f(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    .line 5
    invoke-virtual {p0, p2}, Lj6/f;->e(Landroid/net/Uri;)I
...
.method public h(Landroid/net/Uri;La6/e;)Z
    .locals 0
    .param p1    # Landroid/net/Uri;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation

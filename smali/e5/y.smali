...
.method public final a(Ljava/lang/String;Ljava/lang/CharSequence;)Landroid/content/ComponentName;
    ...
    .line 5
    invoke-static/range {v3 .. v8}, Lkotlin/text/StringsKt__StringsKt;->r3(Ljava/lang/CharSequence;CIZILjava/lang/Object;)I
...
.method public final b(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Le5/a;
    .locals 3
    ...
    invoke-virtual {p0, p1, v0}, Le5/y;->a(Ljava/lang/String;Ljava/lang/CharSequence;)Landroid/content/ComponentName;

    move-result-object p1

    .line 9
    invoke-direct {v1, p1, p2}, Le5/a;-><init>(Landroid/content/ComponentName;Ljava/lang/String;)V

    return-object v1
.end method

.method public final c(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Le5/b;
    .locals 2
    ...
    .line 7
    invoke-direct {p2, v0, p1}, Le5/b;-><init>(Ljava/util/Set;Z)V

    return-object p2
.end method

.method public final d(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Le5/u;
    .locals 3
    ...
    .line 11
    invoke-virtual {p0, p1, v1}, Le5/y;->a(Ljava/lang/String;Ljava/lang/CharSequence;)Landroid/content/ComponentName;
    ...
    invoke-direct {v1, v0, p1, p2}, Le5/u;-><init>(Landroid/content/ComponentName;Landroid/content/ComponentName;Ljava/lang/String;)V

    return-object v1
.end method

.method public final e(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Le5/w;
    .locals 11
    ...
    .line 14
    invoke-direct/range {v2 .. v10}, Le5/w;-><init>(Ljava/util/Set;ZZZIIFI)V

    return-object p1
.end method

.method public final f(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Le5/x;
    .locals 10
    ...
    .line 18
    invoke-direct/range {v3 .. v9}, Le5/x;-><init>(Ljava/util/Set;Landroid/content/Intent;IIFI)V
...
.method public final g(Landroid/content/Context;I)Ljava/util/Set;
    ...
    invoke-virtual {p0, p1, p2}, Le5/y;->h(Landroid/content/Context;I)Ljava/util/Set;
...
.method public final h(Landroid/content/Context;I)Ljava/util/Set;
    ...
    .line 9
    :cond_2
    invoke-virtual {p0, p1, p2}, Le5/y;->f(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Le5/x;
    ...
    .line 12
    :cond_3
    invoke-virtual {p0, p1, p2}, Le5/y;->c(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Le5/b;
    ...
    .line 15
    invoke-virtual {p0, p1, p2}, Le5/y;->d(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Le5/u;
    ...
    .line 17
    invoke-virtual {v5, v3}, Le5/w;->j(Le5/u;)Le5/w;
    ...
    .line 21
    :cond_6
    invoke-virtual {p0, p1, p2}, Le5/y;->e(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Le5/w;
    ...
    :cond_9
    :goto_4
    invoke-virtual {p0, p1, p2}, Le5/y;->b(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Le5/a;
    ...
    .line 27
    invoke-virtual {v4, v3}, Le5/b;->c(Le5/a;)Le5/b;
    ...
    .line 30
    invoke-virtual {v6, v3}, Le5/x;->h(Le5/a;)Le5/x;

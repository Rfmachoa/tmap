...
.method public static a(Landroid/graphics/Rect;ZLandroid/util/Rational;IIILjava/util/Map;)Ljava/util/Map;
    ...
    .line 15
    :cond_1
    invoke-static {p3, p2}, Landroidx/camera/core/internal/utils/ImageUtil;->c(ILandroid/util/Rational;)Landroid/util/Rational;
    ...
    .line 16
    invoke-static/range {v2 .. v7}, Lz/i;->g(Landroid/graphics/RectF;Landroid/util/Rational;IZII)Landroid/graphics/RectF;
...
.method public static b(ZILandroid/graphics/RectF;Landroid/graphics/RectF;)Landroid/graphics/RectF;
    ...
    invoke-static {p3, p0}, Lz/i;->d(Landroid/graphics/RectF;F)Landroid/graphics/RectF;
    ...
    .line 4
    invoke-static {p0, p1}, Lz/i;->c(Landroid/graphics/RectF;F)Landroid/graphics/RectF;
    ...
    invoke-static {p3, p0}, Lz/i;->c(Landroid/graphics/RectF;F)Landroid/graphics/RectF;
...
.method public static c(Landroid/graphics/RectF;F)Landroid/graphics/RectF;
    ...
    .line 2
    invoke-static {v1, p1}, Lz/i;->e(FF)F
    ...
    .line 3
    invoke-static {v3, p1}, Lz/i;->e(FF)F
...
.method public static d(Landroid/graphics/RectF;F)Landroid/graphics/RectF;
    ...
    .line 2
    invoke-static {v2, p1}, Lz/i;->f(FF)F
    ...
    .line 3
    invoke-static {p0, p1}, Lz/i;->f(FF)F
...
.method public static g(Landroid/graphics/RectF;Landroid/util/Rational;IZII)Landroid/graphics/RectF;
    ...
    .line 10
    invoke-static {p3, p4}, Lz/i;->h(ZI)Z

    move-result p2

    .line 11
    invoke-static {p2, p5, p0, p1}, Lz/i;->b(ZILandroid/graphics/RectF;Landroid/graphics/RectF;)Landroid/graphics/RectF;

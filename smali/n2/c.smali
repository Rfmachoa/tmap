...
.method public static synthetic a(Landroid/view/View;Ln2/d;ILandroid/os/Bundle;)Z
    .locals 0

    invoke-static {p0, p1, p2, p3}, Ln2/c;->g(Landroid/view/View;Ln2/d;ILandroid/os/Bundle;)Z
...
.method public static b(Landroid/view/inputmethod/InputConnection;Landroid/view/inputmethod/EditorInfo;Ln2/d;ILandroid/os/Bundle;)Z
    .locals 3
    ...
    .line 2
    invoke-virtual {p2}, Ln2/d;->f()Ljava/lang/Object;
    ...
    .line 3
    invoke-static {p0, p1, p3, p4}, Ln2/c$c;->a(Landroid/view/inputmethod/InputConnection;Landroid/view/inputmethod/InputContentInfo;ILandroid/os/Bundle;)Z
    ...
    .line 4
    :cond_0
    invoke-static {p1}, Ln2/a;->e(Landroid/view/inputmethod/EditorInfo;)I
    ...
    .line 6
    :goto_0
    invoke-virtual {p2}, Ln2/d;->a()Landroid/net/Uri;
    ...
    .line 8
    :goto_1
    invoke-virtual {p2}, Ln2/d;->b()Landroid/content/ClipDescription;
    ...
    .line 10
    :goto_2
    invoke-virtual {p2}, Ln2/d;->c()Landroid/net/Uri;
...
.method public static c(Landroid/view/View;)Ln2/c$d;
    .locals 1
    ...
    invoke-direct {v0, p0}, Ln2/b;-><init>(Landroid/view/View;)V
...
.method public static d(Landroid/view/View;Landroid/view/inputmethod/InputConnection;Landroid/view/inputmethod/EditorInfo;)Landroid/view/inputmethod/InputConnection;
    ...
    .line 1
    invoke-static {p0}, Ln2/c;->c(Landroid/view/View;)Ln2/c$d;

    move-result-object p0

    .line 2
    invoke-static {p1, p2, p0}, Ln2/c;->e(Landroid/view/inputmethod/InputConnection;Landroid/view/inputmethod/EditorInfo;Ln2/c$d;)Landroid/view/inputmethod/InputConnection;
...
.method public static e(Landroid/view/inputmethod/InputConnection;Landroid/view/inputmethod/EditorInfo;Ln2/c$d;)Landroid/view/inputmethod/InputConnection;
    .locals 3
    .param p0    # Landroid/view/inputmethod/InputConnection;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-direct {p1, p0, v2, p2}, Ln2/c$a;-><init>(Landroid/view/inputmethod/InputConnection;ZLn2/c$d;)V

    return-object p1

    .line 6
    :cond_0
    invoke-static {p1}, Ln2/a;->a(Landroid/view/inputmethod/EditorInfo;)[Ljava/lang/String;
    ...
    invoke-direct {p1, p0, v2, p2}, Ln2/c$b;-><init>(Landroid/view/inputmethod/InputConnection;ZLn2/c$d;)V

    return-object p1
.end method

.method public static f(Ljava/lang/String;Landroid/os/Bundle;Ln2/c$d;)Z
    .locals 7
    ...
    invoke-direct {p1, v3, v4, v5}, Ln2/d;-><init>(Landroid/net/Uri;Landroid/content/ClipDescription;Landroid/net/Uri;)V

    .line 10
    invoke-interface {p2, p1, v6, p0}, Ln2/c$d;->a(Ln2/d;ILandroid/os/Bundle;)Z
...
.method public static g(Landroid/view/View;Ln2/d;ILandroid/os/Bundle;)Z
    .locals 5
    ...
    .line 2
    :try_start_0
    invoke-virtual {p1}, Ln2/d;->e()V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    .line 3
    invoke-virtual {p1}, Ln2/d;->f()Ljava/lang/Object;
    ...
    invoke-virtual {p1}, Ln2/d;->b()Landroid/content/ClipDescription;
    ...
    .line 8
    invoke-virtual {p1}, Ln2/d;->a()Landroid/net/Uri;
    ...
    .line 10
    invoke-virtual {p1}, Ln2/d;->c()Landroid/net/Uri;

    move-result-object p1

    .line 11
    iget-object p2, v0, Landroidx/core/view/ContentInfoCompat$b;->a:Landroidx/core/view/ContentInfoCompat$d;

    invoke-interface {p2, p1}, Landroidx/core/view/ContentInfoCompat$d;->b(Landroid/net/Uri;)V

    .line 12
    iget-object p1, v0, Landroidx/core/view/ContentInfoCompat$b;->a:Landroidx/core/view/ContentInfoCompat$d;

    invoke-interface {p1, p3}, Landroidx/core/view/ContentInfoCompat$d;->setExtras(Landroid/os/Bundle;)V
    ...
    .line 14
    invoke-static {p0, p1}, Landroidx/core/view/ViewCompat;->m1(Landroid/view/View;Landroidx/core/view/ContentInfoCompat;)Landroidx/core/view/ContentInfoCompat;

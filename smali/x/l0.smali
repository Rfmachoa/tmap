...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/Object;)V
    ...
    iput-object p1, p0, Lx/l0;->a:Landroid/hardware/camera2/CameraManager;

    .line 3
    iput-object p2, p0, Lx/l0;->b:Ljava/lang/Object;

    return-void
.end method

.method public static h(Landroid/content/Context;Landroid/os/Handler;)Lx/l0;
    .locals 2
    ...
    new-instance v1, Lx/l0$a;

    invoke-direct {v1, p1}, Lx/l0$a;-><init>(Landroid/os/Handler;)V

    invoke-direct {v0, p0, v1}, Lx/l0;-><init>(Landroid/content/Context;Ljava/lang/Object;)V
...
.method public a()Landroid/hardware/camera2/CameraManager;
    ...
    iget-object v0, p0, Lx/l0;->a:Landroid/hardware/camera2/CameraManager;
...
.method public b(Ljava/util/concurrent/Executor;Landroid/hardware/camera2/CameraManager$AvailabilityCallback;)V
    ...
    .line 1
    iget-object v1, p0, Lx/l0;->b:Ljava/lang/Object;

    check-cast v1, Lx/l0$a;

    if-eqz p2, :cond_1

    .line 2
    iget-object v2, v1, Lx/l0$a;->a:Ljava/util/Map;

    monitor-enter v2

    .line 3
    :try_start_0
    iget-object v0, v1, Lx/l0$a;->a:Ljava/util/Map;

    invoke-interface {v0, p2}, Ljava/util/Map;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lx/i0$a;
    ...
    invoke-direct {v0, p1, p2}, Lx/i0$a;-><init>(Ljava/util/concurrent/Executor;Landroid/hardware/camera2/CameraManager$AvailabilityCallback;)V

    .line 5
    iget-object p1, v1, Lx/l0$a;->a:Ljava/util/Map;
    ...
    :cond_1
    :goto_0
    iget-object p1, p0, Lx/l0;->a:Landroid/hardware/camera2/CameraManager;

    iget-object p2, v1, Lx/l0$a;->b:Landroid/os/Handler;
...
.method public d(Ljava/lang/String;Ljava/util/concurrent/Executor;Landroid/hardware/camera2/CameraDevice$StateCallback;)V
    ...
    invoke-direct {v0, p2, p3}, Lx/v$b;-><init>(Ljava/util/concurrent/Executor;Landroid/hardware/camera2/CameraDevice$StateCallback;)V

    .line 4
    iget-object p2, p0, Lx/l0;->b:Ljava/lang/Object;

    check-cast p2, Lx/l0$a;

    .line 5
    :try_start_0
    iget-object p3, p0, Lx/l0;->a:Landroid/hardware/camera2/CameraManager;

    iget-object p2, p2, Lx/l0$a;->b:Landroid/os/Handler;
...
.method public f(Landroid/hardware/camera2/CameraManager$AvailabilityCallback;)V
    ...
    .line 1
    iget-object v0, p0, Lx/l0;->b:Ljava/lang/Object;

    check-cast v0, Lx/l0$a;

    .line 2
    iget-object v1, v0, Lx/l0$a;->a:Ljava/util/Map;

    monitor-enter v1

    .line 3
    :try_start_0
    iget-object v0, v0, Lx/l0$a;->a:Ljava/util/Map;

    invoke-interface {v0, p1}, Ljava/util/Map;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Lx/i0$a;

...
.method public static b(Lc5/i;)Landroid/webkit/WebMessage;
    .locals 2
    .param p0    # Lc5/i;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-virtual {p0}, Lc5/i;->a()Ljava/lang/String;

    move-result-object v1

    .line 2
    invoke-virtual {p0}, Lc5/i;->b()[Lc5/j;

    move-result-object p0

    invoke-static {p0}, Ld5/y;->h([Lc5/j;)[Landroid/webkit/WebMessagePort;
...
.method public static d(Landroid/webkit/WebMessage;)Lc5/i;
    .locals 2
    ...
    invoke-direct {v0, v1, p0}, Lc5/i;-><init>(Ljava/lang/String;[Lc5/j;)V
...
.method public static i(Landroid/webkit/WebView;JLc5/m$a;)V
    .locals 1
    .param p0    # Landroid/webkit/WebView;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    new-instance v0, Ld5/c$c;

    invoke-direct {v0, p3}, Ld5/c$c;-><init>(Lc5/m$a;)V
...
.method public static l(Landroid/webkit/WebMessagePort;Lc5/j$a;)V
    .locals 1
    .param p0    # Landroid/webkit/WebMessagePort;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-direct {v0, p1}, Ld5/c$a;-><init>(Lc5/j$a;)V
...
.method public static m(Landroid/webkit/WebMessagePort;Lc5/j$a;Landroid/os/Handler;)V
    .locals 1
    .param p0    # Landroid/webkit/WebMessagePort;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-direct {v0, p1}, Ld5/c$b;-><init>(Lc5/j$a;)V

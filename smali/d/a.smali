...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Ld/a;->c:Ljava/util/concurrent/ExecutorService;
    ...
    sput-object v0, Ld/a;->d:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    sput-object v0, Ld/a;->e:Ljava/lang/Object;
    ...
    sput-object v0, Ld/a;->f:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public static a()V
    ...
    .line 1
    sget-object v0, Ld/a;->f:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public static b(Landroid/content/Context;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    invoke-direct {v0, p0}, Ld/a$a;-><init>(Landroid/content/Context;)V
...
.method public static c(Landroid/content/Context;)Ld/a$e;
    .locals 4
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
    ...
    .line 2
    sget-object v1, Ld/a;->e:Ljava/lang/Object;
    ...
    .line 5
    sget-object p0, Ld/a;->f:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 6
    invoke-static {v0, v2, v3}, Ld/a$e;->c(Lf/a;J)Ld/a$e;
...
.method public static d(Lf/a;)Ld/b;
    .locals 3
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
    ...
    .line 1
    invoke-virtual {p0}, Lf/a;->c()Landroidx/ads/identifier/provider/IAdvertisingIdService;
    ...
    .line 4
    invoke-static {}, Ld/b;->a()Ld/b$a;

    move-result-object v2

    .line 5
    invoke-virtual {v2, v1}, Ld/b$a;->b(Ljava/lang/String;)Ld/b$a;

    move-result-object v1

    .line 6
    invoke-virtual {p0}, Lf/a;->e()Ljava/lang/String;

    move-result-object p0

    invoke-virtual {v1, p0}, Ld/b$a;->d(Ljava/lang/String;)Ld/b$a;
    ...
    invoke-virtual {p0, v0}, Ld/b$a;->c(Z)Ld/b$a;

    move-result-object p0

    .line 8
    invoke-virtual {p0}, Ld/b$a;->a()Ld/b;
...
.method public static e(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Ld/c;->a(Landroid/content/pm/PackageManager;)Ljava/util/List;
...
.method public static g(Ld/a$e;)V
    .locals 4

    .line 1
    sget-object v0, Ld/a;->d:Ljava/util/concurrent/ScheduledExecutorService;

    new-instance v1, Ld/a$d;

    invoke-direct {v1, p0}, Ld/a$d;-><init>(Ld/a$e;)V
...
.method public static h(Ljava/util/concurrent/Future;Landroidx/concurrent/futures/CallbackToFutureAdapter$a;)V
    ...
    invoke-direct {v1, p0, p1}, Ld/a$c;-><init>(Ljava/util/concurrent/Future;Landroidx/concurrent/futures/CallbackToFutureAdapter$a;)V
...
.method public static i(Landroid/content/Context;Landroidx/concurrent/futures/CallbackToFutureAdapter$a;)V
    ...
    .line 1
    sget-object v0, Ld/a;->c:Ljava/util/concurrent/ExecutorService;

    new-instance v1, Ld/a$b;

    invoke-direct {v1, p0, p1}, Ld/a$b;-><init>(Landroid/content/Context;Landroidx/concurrent/futures/CallbackToFutureAdapter$a;)V
    ...
    .line 2
    invoke-static {p0, p1}, Ld/a;->h(Ljava/util/concurrent/Future;Landroidx/concurrent/futures/CallbackToFutureAdapter$a;)V

    return-void
.end method

.method public static j()Ld/a$e;
    .locals 5
    ...
    .line 3
    invoke-static {v0, v1, v2}, Ld/a$e;->c(Lf/a;J)Ld/a$e;

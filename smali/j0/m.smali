...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lj0/m;->e:Landroidx/camera/core/impl/Config$a;
...
.method public constructor <init>(ILj0/n;Landroid/content/Context;)V
    ...
    .line 3
    iput-object p2, p0, Lj0/m;->a:Lj0/n;

    .line 4
    iput-object p3, p0, Lj0/m;->b:Landroid/content/Context;
...
.method public bridge synthetic a()Landroidx/camera/core/impl/Config;
    ...
    invoke-virtual {p0}, Lj0/m;->b()Landroidx/camera/core/impl/n;
...
.method public b()Landroidx/camera/core/impl/n;
    ...
    iget-object v2, p0, Lj0/m;->a:Lj0/n;

    iget-object v3, p0, Lj0/m;->b:Landroid/content/Context;

    invoke-virtual {p0, v0, v1, v2, v3}, Lj0/m;->c(Landroidx/camera/core/e2$b;ILj0/n;Landroid/content/Context;)V
...
.method public c(Landroidx/camera/core/e2$b;ILj0/n;Landroid/content/Context;)V
    .locals 4
    ...
    .line 3
    invoke-virtual {v0}, Lj0/g;->k()Landroidx/camera/extensions/impl/PreviewExtenderImpl;
    ...
    .line 5
    new-instance v2, Lj0/m$b;

    const/4 v3, 0x0

    invoke-direct {v2, v0, p4, v3}, Lj0/m$b;-><init>(Landroidx/camera/extensions/impl/PreviewExtenderImpl;Landroid/content/Context;Lj0/i;)V
    ...
    invoke-direct {v2, v3}, Lj0/c;-><init>(Landroidx/camera/extensions/impl/PreviewImageProcessorImpl;)V

    .line 8
    invoke-virtual {p1, v2}, Landroidx/camera/core/e2$b;->z(Lc0/f0;)Landroidx/camera/core/e2$b;

    .line 9
    invoke-virtual {p1, v1}, Landroidx/camera/core/e2$b;->E(Z)Landroidx/camera/core/e2$b;

    .line 10
    new-instance v3, Lj0/m$b;

    invoke-direct {v3, v0, p4, v2}, Lj0/m$b;-><init>(Landroidx/camera/extensions/impl/PreviewExtenderImpl;Landroid/content/Context;Lj0/i;)V
    ...
    invoke-direct {v2, v0}, Lj0/d;-><init>(Landroidx/camera/extensions/impl/PreviewExtenderImpl;)V

    .line 12
    invoke-virtual {p1, v2}, Landroidx/camera/core/e2$b;->D(Lc0/u0;)Landroidx/camera/core/e2$b;
    ...
    .line 19
    iget-object p4, p1, Landroidx/camera/core/e2$b;->a:Landroidx/camera/core/impl/l;

    .line 20
    sget-object v0, Lj0/m;->e:Landroidx/camera/core/impl/Config$a;
    ...
    .line 21
    invoke-interface {p3}, Lj0/n;->b()Ljava/util/List;

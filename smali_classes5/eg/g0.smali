...
# direct methods
.method public constructor <init>(Ltf/j;Ljava/net/ProxySelector;)V
    .locals 1
    ...
    .line 3
    iput-object p1, p0, Leg/g0;->a:Ltf/j;

    .line 4
    iput-object p2, p0, Leg/g0;->b:Ljava/net/ProxySelector;
...
.method public a(Lcz/msebera/android/httpclient/HttpHost;Ldf/q;Lpg/g;)Lcz/msebera/android/httpclient/conn/routing/a;
    ...
    invoke-static {v0}, Lrf/j;->b(Lng/i;)Lcz/msebera/android/httpclient/conn/routing/a;
    ...
    invoke-static {v0}, Lrf/j;->c(Lng/i;)Ljava/net/InetAddress;

    move-result-object v0

    .line 5
    invoke-virtual {p0, p1, p2, p3}, Leg/g0;->c(Lcz/msebera/android/httpclient/HttpHost;Ldf/q;Lpg/g;)Lcz/msebera/android/httpclient/HttpHost;

    move-result-object p2

    .line 6
    iget-object p3, p0, Leg/g0;->a:Ltf/j;
    ...
    invoke-virtual {p3, v1}, Ltf/j;->c(Ljava/lang/String;)Ltf/f;

    move-result-object p3

    .line 8
    invoke-virtual {p3}, Ltf/f;->e()Z
...
.method public b(Ljava/util/List;Lcz/msebera/android/httpclient/HttpHost;Ldf/q;Lpg/g;)Ljava/net/Proxy;
    .locals 2
    ...
    .line 1
    invoke-static {p1, p2}, Lqg/a;->e(Ljava/util/Collection;Ljava/lang/String;)Ljava/util/Collection;
...
.method public c(Lcz/msebera/android/httpclient/HttpHost;Ldf/q;Lpg/g;)Lcz/msebera/android/httpclient/HttpHost;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcz/msebera/android/httpclient/HttpException;
    ...
    .line 1
    iget-object v0, p0, Leg/g0;->b:Ljava/net/ProxySelector;
    ...
    .line 5
    invoke-virtual {p0, v0, p1, p2, p3}, Leg/g0;->b(Ljava/util/List;Lcz/msebera/android/httpclient/HttpHost;Ldf/q;Lpg/g;)Ljava/net/Proxy;
    ...
    invoke-virtual {p0, p1}, Leg/g0;->d(Ljava/net/InetSocketAddress;)Ljava/lang/String;
...
.method public f(Ljava/net/ProxySelector;)V
    ...
    .line 1
    iput-object p1, p0, Leg/g0;->b:Ljava/net/ProxySelector;

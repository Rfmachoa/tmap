...
.method public constructor <init>(Llg/h;Lmg/q;Ldf/u;Lng/i;)V
    ...
    iput-object p1, p0, Leg/p;->i:Lcz/msebera/android/httpclient/extras/b;
    ...
    .line 4
    iput-object p3, p0, Leg/p;->j:Ldf/u;
    ...
    iput-object p1, p0, Leg/p;->k:Lcz/msebera/android/httpclient/util/CharArrayBuffer;

    .line 6
    invoke-virtual {p0, p4}, Leg/p;->d(Lng/i;)I

    move-result p1

    iput p1, p0, Leg/p;->l:I
...
.method public a(Llg/h;)Ldf/p;
    ...
    .line 1
    :goto_0
    iget-object v2, p0, Leg/p;->k:Lcz/msebera/android/httpclient/util/CharArrayBuffer;
    ...
    iget-object v5, p0, Leg/p;->k:Lcz/msebera/android/httpclient/util/CharArrayBuffer;
    ...
    iget-object v6, p0, Leg/p;->k:Lcz/msebera/android/httpclient/util/CharArrayBuffer;
    ...
    iget-object v0, p0, Leg/p;->k:Lcz/msebera/android/httpclient/util/CharArrayBuffer;
    ...
    .line 7
    iget-object v0, p0, Leg/p;->j:Ldf/u;
    ...
    .line 8
    iget v2, p0, Leg/p;->l:I

    if-ge v1, v2, :cond_4

    .line 9
    iget-object v2, p0, Leg/p;->i:Lcz/msebera/android/httpclient/extras/b;
    ...
    iget-object v4, p0, Leg/p;->k:Lcz/msebera/android/httpclient/util/CharArrayBuffer;
...
.method public d(Lng/i;)I
    ...
    .line 1
    invoke-interface {p1, v0, v1}, Lng/i;->getIntParameter(Ljava/lang/String;I)I

...
.method public static o(BLlg/j$a;)I
    .locals 2

    .line 1
    iget v0, p1, Llg/j$a;->e:I

    const/4 v1, 0x1

    invoke-static {p0, v0, v1}, Llg/j;->p(BII)I

    move-result p0

    .line 2
    iget-object v0, p1, Llg/j$a;->d:[Lcom/tmapmobility/tmap/exoplayer2/extractor/e0$c;
    ...
    .line 3
    iget-object p0, p1, Llg/j$a;->a:Lcom/tmapmobility/tmap/exoplayer2/extractor/e0$d;
...
.method public e(J)V
    ...
    .line 2
    :goto_0
    iput-boolean p1, p0, Llg/j;->t:Z

    .line 3
    iget-object p1, p0, Llg/j;->u:Lcom/tmapmobility/tmap/exoplayer2/extractor/e0$d;
...
.method public f(Lcom/tmapmobility/tmap/exoplayer2/util/b0;)J
    ...
    iget-object v2, p0, Llg/j;->r:Llg/j$a;

    invoke-static {v2}, Lcom/tmapmobility/tmap/exoplayer2/util/a;->k(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Llg/j$a;

    invoke-static {v0, v2}, Llg/j;->o(BLlg/j$a;)I

    move-result v0

    .line 5
    iget-boolean v2, p0, Llg/j;->t:Z

    if-eqz v2, :cond_1

    iget v1, p0, Llg/j;->s:I
    ...
    .line 6
    invoke-static {p1, v1, v2}, Llg/j;->n(Lcom/tmapmobility/tmap/exoplayer2/util/b0;J)V

    .line 7
    iput-boolean v3, p0, Llg/j;->t:Z

    .line 8
    iput v0, p0, Llg/j;->s:I
...
.method public i(Lcom/tmapmobility/tmap/exoplayer2/util/b0;JLlg/i$b;)Z
    ...
    .line 1
    iget-object p2, p0, Llg/j;->r:Llg/j$a;
    ...
    .line 4
    :cond_0
    invoke-virtual {p0, p1}, Llg/j;->q(Lcom/tmapmobility/tmap/exoplayer2/util/b0;)Llg/j$a;

    move-result-object p1

    iput-object p1, p0, Llg/j;->r:Llg/j$a;
    ...
    .line 5
    :cond_1
    iget-object p3, p1, Llg/j$a;->a:Lcom/tmapmobility/tmap/exoplayer2/extractor/e0$d;
    ...
    .line 8
    iget-object v1, p1, Llg/j$a;->c:[B

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 9
    iget-object p1, p1, Llg/j$a;->b:Lcom/tmapmobility/tmap/exoplayer2/extractor/e0$b;
...
.method public l(Z)V
    ...
    .line 3
    iput-object p1, p0, Llg/j;->u:Lcom/tmapmobility/tmap/exoplayer2/extractor/e0$d;

    .line 4
    iput-object p1, p0, Llg/j;->v:Lcom/tmapmobility/tmap/exoplayer2/extractor/e0$b;

    :cond_0
    const/4 p1, 0x0

    .line 5
    iput p1, p0, Llg/j;->s:I
...
.method public q(Lcom/tmapmobility/tmap/exoplayer2/util/b0;)Llg/j$a;
    .locals 7
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
    ...
    .line 1
    iget-object v1, p0, Llg/j;->u:Lcom/tmapmobility/tmap/exoplayer2/extractor/e0$d;
    ...
    .line 3
    :cond_0
    iget-object v2, p0, Llg/j;->v:Lcom/tmapmobility/tmap/exoplayer2/extractor/e0$b;
    ...
    invoke-direct/range {v0 .. v5}, Llg/j$a;-><init>(Lcom/tmapmobility/tmap/exoplayer2/extractor/e0$d;Lcom/tmapmobility/tmap/exoplayer2/extractor/e0$b;[B[Lcom/tmapmobility/tmap/exoplayer2/extractor/e0$c;I)V

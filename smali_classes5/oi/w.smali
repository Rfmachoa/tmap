...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Loi/w;->d:Lcz/msebera/android/httpclient/cookie/CookiePathComparator;
    ...
    sput-object v0, Loi/w;->e:[Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    .line 12
    invoke-direct {p0, v0, v1}, Loi/w;-><init>([Ljava/lang/String;Z)V
...
.method public constructor <init>([Ljava/lang/String;Z)V
    ...
    iput-object p1, p0, Loi/w;->b:[Ljava/lang/String;

    goto :goto_0

    .line 3
    :cond_0
    sget-object p1, Loi/w;->e:[Ljava/lang/String;

    iput-object p1, p0, Loi/w;->b:[Ljava/lang/String;

    .line 4
    :goto_0
    iput-boolean p2, p0, Loi/w;->c:Z

    .line 5
    new-instance p1, Loi/y;

    invoke-direct {p1}, Loi/y;-><init>()V

    const-string p2, "version"

    invoke-virtual {p0, p2, p1}, Loi/b;->g(Ljava/lang/String;Lfi/c;)V
    ...
    iget-object p2, p0, Loi/w;->b:[Ljava/lang/String;

    invoke-direct {p1, p2}, Loi/e;-><init>([Ljava/lang/String;)V
...
.method public a(Lfi/b;Lfi/d;)V
    ...
    .line 5
    invoke-super {p0, p1, p2}, Loi/l;->a(Lfi/b;Lfi/d;)V
...
.method public formatCookies(Ljava/util/List;)Ljava/util/List;
    ...
    .line 4
    sget-object p1, Loi/w;->d:Lcz/msebera/android/httpclient/cookie/CookiePathComparator;
    ...
    .line 5
    :cond_0
    iget-boolean v0, p0, Loi/w;->c:Z

    if-eqz v0, :cond_1

    .line 6
    invoke-virtual {p0, p1}, Loi/w;->l(Ljava/util/List;)Ljava/util/List;
    ...
    .line 7
    :cond_1
    invoke-virtual {p0, p1}, Loi/w;->k(Ljava/util/List;)Ljava/util/List;
...
.method public final k(Ljava/util/List;)Ljava/util/List;
    ...
    .line 3
    invoke-interface {v1}, Lfi/b;->getVersion()I
    ...
    .line 9
    invoke-virtual {p0, v3, v1, v2}, Loi/w;->m(Lcz/msebera/android/httpclient/util/CharArrayBuffer;Lfi/b;I)V
...
.method public final l(Ljava/util/List;)Ljava/util/List;
    ...
    .line 2
    invoke-interface {v2}, Lfi/b;->getVersion()I
    ...
    .line 11
    invoke-virtual {p0, v0, v2, v1}, Loi/w;->m(Lcz/msebera/android/httpclient/util/CharArrayBuffer;Lfi/b;I)V
...
.method public m(Lcz/msebera/android/httpclient/util/CharArrayBuffer;Lfi/b;I)V
    .locals 3

    .line 1
    invoke-interface {p2}, Lfi/b;->getName()Ljava/lang/String;

    move-result-object v0

    invoke-interface {p2}, Lfi/b;->getValue()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p0, p1, v0, v1, p3}, Loi/w;->n(Lcz/msebera/android/httpclient/util/CharArrayBuffer;Ljava/lang/String;Ljava/lang/String;I)V

    .line 2
    invoke-interface {p2}, Lfi/b;->getPath()Ljava/lang/String;
    ...
    .line 4
    invoke-interface {v0, v2}, Lfi/a;->containsAttribute(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, p1, v2, v0, p3}, Loi/w;->n(Lcz/msebera/android/httpclient/util/CharArrayBuffer;Ljava/lang/String;Ljava/lang/String;I)V

    .line 7
    :cond_0
    invoke-interface {p2}, Lfi/b;->getDomain()Ljava/lang/String;
    ...
    invoke-virtual {p0, p1, v0, p2, p3}, Loi/w;->n(Lcz/msebera/android/httpclient/util/CharArrayBuffer;Ljava/lang/String;Ljava/lang/String;I)V

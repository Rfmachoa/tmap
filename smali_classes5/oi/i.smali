...
.method public a(Lph/t;Lbj/g;)Z
    ...
    .line 6
    :cond_0
    invoke-virtual {p0, p1}, Loi/i;->b(Lph/t;)Z
    ...
    .line 15
    :try_start_1
    invoke-virtual {p0, v0}, Loi/i;->c(Lph/g;)Lph/c0;
    ...
    :cond_4
    :goto_0
    invoke-interface {p1}, Lph/c0;->hasNext()Z
    ...
    .line 17
    invoke-interface {p1}, Lph/c0;->nextToken()Ljava/lang/String;
...
.method public c(Lph/g;)Lph/c0;
    .locals 1

    new-instance v0, Lyi/m;

    invoke-direct {v0, p1}, Lyi/m;-><init>(Lph/g;)V

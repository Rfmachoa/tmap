...
.method public constructor <init>(Ljava/io/OutputStream;ILjava/nio/charset/Charset;ILjava/nio/charset/CodingErrorAction;Ljava/nio/charset/CodingErrorAction;)V
    ...
    .line 4
    iput-object p1, p0, Lvi/d;->a:Ljava/io/OutputStream;
    ...
    iput-object p1, p0, Lvi/d;->b:Lcz/msebera/android/httpclient/util/ByteArrayBuffer;
    ...
    .line 6
    :cond_0
    sget-object p3, Lph/b;->f:Ljava/nio/charset/Charset;

    :goto_0
    iput-object p3, p0, Lvi/d;->c:Ljava/nio/charset/Charset;
    ...
    iput-boolean p1, p0, Lvi/d;->d:Z

    const/4 p1, 0x0

    .line 8
    iput-object p1, p0, Lvi/d;->i:Ljava/nio/charset/CharsetEncoder;
    ...
    .line 9
    :goto_1
    iput p4, p0, Lvi/d;->e:I

    .line 10
    invoke-virtual {p0}, Lvi/d;->c()Lvi/u;

    move-result-object p1

    iput-object p1, p0, Lvi/d;->f:Lvi/u;
    ...
    :goto_2
    iput-object p5, p0, Lvi/d;->g:Ljava/nio/charset/CodingErrorAction;
    ...
    :goto_3
    iput-object p6, p0, Lvi/d;->h:Ljava/nio/charset/CodingErrorAction;
...
.method public a(Lcz/msebera/android/httpclient/util/CharArrayBuffer;)V
    ...
    .line 3
    iget-object v2, p0, Lvi/d;->b:Lcz/msebera/android/httpclient/util/ByteArrayBuffer;

    invoke-virtual {v2}, Lcz/msebera/android/httpclient/util/ByteArrayBuffer;->capacity()I

    move-result v2

    iget-object v3, p0, Lvi/d;->b:Lcz/msebera/android/httpclient/util/ByteArrayBuffer;
    ...
    .line 9
    invoke-virtual {p0, p1}, Lvi/d;->g(Ljava/nio/CharBuffer;)V

    .line 10
    :cond_4
    sget-object p1, Lvi/d;->k:[B

    invoke-virtual {p0, p1}, Lvi/d;->write([B)V
...
.method public available()I
    ...
    invoke-virtual {p0}, Lvi/d;->b()I

    move-result v0

    invoke-virtual {p0}, Lvi/d;->length()I
...
.method public b()I
    ...
    iget-object v0, p0, Lvi/d;->b:Lcz/msebera/android/httpclient/util/ByteArrayBuffer;
...
.method public d()V
    ...
    .line 2
    iget-object v1, p0, Lvi/d;->a:Ljava/io/OutputStream;
    ...
    .line 3
    iget-object v1, p0, Lvi/d;->b:Lcz/msebera/android/httpclient/util/ByteArrayBuffer;

    invoke-virtual {v1}, Lcz/msebera/android/httpclient/util/ByteArrayBuffer;->clear()V

    .line 4
    iget-object v1, p0, Lvi/d;->f:Lvi/u;

    int-to-long v2, v0

    invoke-virtual {v1, v2, v3}, Lvi/u;->a(J)V
...
.method public final e(Ljava/nio/charset/CoderResult;)V
    ...
    .line 3
    :cond_0
    iget-object p1, p0, Lvi/d;->j:Ljava/nio/ByteBuffer;
    ...
    invoke-virtual {p0, p1}, Lvi/d;->write(I)V
...
.method public f(Ljava/io/OutputStream;ILzi/i;)V
    .locals 1
    ...
    :goto_0
    iput-object p1, p0, Lvi/d;->c:Ljava/nio/charset/Charset;
    ...
    :goto_1
    iput-object p1, p0, Lvi/d;->g:Ljava/nio/charset/CodingErrorAction;
    ...
    :goto_2
    iput-object p1, p0, Lvi/d;->h:Ljava/nio/charset/CodingErrorAction;
...
.method public flush()V
    ...
    .line 2
    iget-object v0, p0, Lvi/d;->a:Ljava/io/OutputStream;
...
.method public final g(Ljava/nio/CharBuffer;)V
    ...
    .line 2
    :cond_0
    iget-object v0, p0, Lvi/d;->i:Ljava/nio/charset/CharsetEncoder;

    if-nez v0, :cond_1

    .line 3
    iget-object v0, p0, Lvi/d;->c:Ljava/nio/charset/Charset;

    invoke-virtual {v0}, Ljava/nio/charset/Charset;->newEncoder()Ljava/nio/charset/CharsetEncoder;

    move-result-object v0

    iput-object v0, p0, Lvi/d;->i:Ljava/nio/charset/CharsetEncoder;

    .line 4
    iget-object v1, p0, Lvi/d;->g:Ljava/nio/charset/CodingErrorAction;
    ...
    iget-object v1, p0, Lvi/d;->h:Ljava/nio/charset/CodingErrorAction;

    invoke-virtual {v0, v1}, Ljava/nio/charset/CharsetEncoder;->onUnmappableCharacter(Ljava/nio/charset/CodingErrorAction;)Ljava/nio/charset/CharsetEncoder;

    .line 6
    :cond_1
    iget-object v0, p0, Lvi/d;->j:Ljava/nio/ByteBuffer;
    ...
    iput-object v0, p0, Lvi/d;->j:Ljava/nio/ByteBuffer;
    ...
    iget-object v1, p0, Lvi/d;->j:Ljava/nio/ByteBuffer;
    ...
    .line 11
    invoke-virtual {p0, v0}, Lvi/d;->e(Ljava/nio/charset/CoderResult;)V

    goto :goto_0

    .line 12
    :cond_3
    iget-object p1, p0, Lvi/d;->i:Ljava/nio/charset/CharsetEncoder;
    ...
    .line 13
    invoke-virtual {p0, p1}, Lvi/d;->e(Ljava/nio/charset/CoderResult;)V
...
.method public getMetrics()Lxi/g;
    ...
    iget-object v0, p0, Lvi/d;->f:Lvi/u;
...
.method public write([B)V
    ...
    invoke-virtual {p0, p1, v0, v1}, Lvi/d;->write([BII)V
...
.method public write([BII)V
    ...
    .line 7
    iget-object p1, p0, Lvi/d;->f:Lvi/u;

    int-to-long p2, p3

    invoke-virtual {p1, p2, p3}, Lvi/u;->a(J)V
...
.method public writeLine(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v1}, Lvi/d;->write(I)V

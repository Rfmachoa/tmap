...
.field public static final c:Ldg/v;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Ldg/v;->d:[Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Ldg/v;->a:Lcz/msebera/android/httpclient/extras/b;
...
.method public a(Ldf/q;Ldf/t;Lpg/g;)Z
    ...
    .line 6
    :pswitch_1
    invoke-virtual {p0, p1}, Ldg/v;->e(Ljava/lang/String;)Z
...
.method public b(Ldf/q;Ldf/t;Lpg/g;)Lkf/q;
    ...
    .line 1
    invoke-virtual {p0, p1, p2, p3}, Ldg/v;->d(Ldf/q;Ldf/t;Lpg/g;)Ljava/net/URI;
    ...
    invoke-direct {p1, p3}, Lkf/i;-><init>(Ljava/net/URI;)V
    ...
    invoke-direct {p1, p3}, Lkf/h;-><init>(Ljava/net/URI;)V
    ...
    .line 8
    invoke-static {p1}, Lkf/r;->g(Ldf/q;)Lkf/r;

    move-result-object p1

    invoke-virtual {p1, p3}, Lkf/r;->F(Ljava/net/URI;)Lkf/r;

    move-result-object p1

    invoke-virtual {p1}, Lkf/r;->f()Lkf/q;
...
.method public c(Ljava/lang/String;)Ljava/net/URI;
    ...
    invoke-direct {v0, v1}, Lnf/h;-><init>(Ljava/net/URI;)V

    .line 2
    invoke-virtual {v0}, Lnf/h;->l()Ljava/lang/String;
    ...
    invoke-virtual {v0, v1}, Lnf/h;->y(Ljava/lang/String;)Lnf/h;

    .line 4
    :cond_0
    invoke-virtual {v0}, Lnf/h;->m()Ljava/lang/String;

    move-result-object v1

    .line 5
    invoke-static {v1}, Lqg/i;->b(Ljava/lang/CharSequence;)Z
    ...
    .line 6
    invoke-virtual {v0, v1}, Lnf/h;->C(Ljava/lang/String;)Lnf/h;

    .line 7
    :cond_1
    invoke-virtual {v0}, Lnf/h;->c()Ljava/net/URI;
...
.method public d(Ldf/q;Ldf/t;Lpg/g;)Ljava/net/URI;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcz/msebera/android/httpclient/ProtocolException;
    ...
    .line 7
    iget-object v1, p0, Ldg/v;->a:Lcz/msebera/android/httpclient/extras/b;
    ...
    .line 10
    invoke-virtual {p0, p2}, Ldg/v;->c(Ljava/lang/String;)Ljava/net/URI;
    ...
    .line 14
    invoke-static {v3, v4}, Lqg/b;->e(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    .line 16
    invoke-static {v4, v3, p1}, Lnf/i;->j(Ljava/net/URI;Lcz/msebera/android/httpclient/HttpHost;Z)Ljava/net/URI;

    move-result-object p1

    .line 17
    invoke-static {p1, p2}, Lnf/i;->f(Ljava/net/URI;Ljava/net/URI;)Ljava/net/URI;
    ...
    .line 19
    invoke-virtual {v0, p1}, Lpg/h;->getAttribute(Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 21
    invoke-interface {p3, p1, v0}, Lpg/g;->setAttribute(Ljava/lang/String;Ljava/lang/Object;)V

    .line 22
    :cond_3
    invoke-virtual {v1}, Lif/c;->n()Z
    ...
    .line 23
    invoke-virtual {v0, p2}, Ldg/q0;->b(Ljava/net/URI;)Z
    ...
    :cond_5
    :goto_1
    invoke-virtual {v0, p2}, Ldg/q0;->a(Ljava/net/URI;)V
...
.method public e(Ljava/lang/String;)Z
    ...
    .line 1
    sget-object v0, Ldg/v;->d:[Ljava/lang/String;

...
.method public a(Lcz/msebera/android/httpclient/util/CharArrayBuffer;)I
    ...
    .line 3
    iget-object v0, p0, Lri/c;->c:Lcz/msebera/android/httpclient/util/ByteArrayBuffer;
    ...
    .line 4
    invoke-virtual {p0, p1, v4}, Lri/c;->j(Lcz/msebera/android/httpclient/util/CharArrayBuffer;I)I
    ...
    .line 6
    iget-object v5, p0, Lri/c;->c:Lcz/msebera/android/httpclient/util/ByteArrayBuffer;

    iget-object v6, p0, Lri/c;->b:[B

    invoke-virtual {v5, v6, v0, v3}, Lcz/msebera/android/httpclient/util/ByteArrayBuffer;->append([BII)V

    .line 7
    iput v4, p0, Lri/c;->k:I
    ...
    .line 9
    iget v2, p0, Lri/c;->l:I

    iget v4, p0, Lri/c;->k:I
    ...
    :cond_4
    :goto_2
    iget v3, p0, Lri/c;->f:I

    if-lez v3, :cond_0

    iget-object v3, p0, Lri/c;->c:Lcz/msebera/android/httpclient/util/ByteArrayBuffer;

    invoke-virtual {v3}, Lcz/msebera/android/httpclient/util/ByteArrayBuffer;->length()I

    move-result v3

    iget v4, p0, Lri/c;->f:I
    ...
    .line 16
    :cond_7
    invoke-virtual {p0, p1}, Lri/c;->i(Lcz/msebera/android/httpclient/util/CharArrayBuffer;)I
...
.method public available()I
    ...
    invoke-virtual {p0}, Lri/c;->b()I

    move-result v0

    invoke-virtual {p0}, Lri/c;->length()I
...
.method public final c(Lcz/msebera/android/httpclient/util/CharArrayBuffer;Ljava/nio/ByteBuffer;)I
    ...
    .line 2
    :cond_0
    iget-object v0, p0, Lri/c;->m:Ljava/nio/charset/CharsetDecoder;

    if-nez v0, :cond_1

    .line 3
    iget-object v0, p0, Lri/c;->d:Ljava/nio/charset/Charset;

    invoke-virtual {v0}, Ljava/nio/charset/Charset;->newDecoder()Ljava/nio/charset/CharsetDecoder;

    move-result-object v0

    iput-object v0, p0, Lri/c;->m:Ljava/nio/charset/CharsetDecoder;

    .line 4
    iget-object v2, p0, Lri/c;->i:Ljava/nio/charset/CodingErrorAction;
    ...
    iget-object v2, p0, Lri/c;->j:Ljava/nio/charset/CodingErrorAction;
    ...
    .line 6
    :cond_1
    iget-object v0, p0, Lri/c;->n:Ljava/nio/CharBuffer;
    ...
    iput-object v0, p0, Lri/c;->n:Ljava/nio/CharBuffer;
    ...
    iget-object v2, p0, Lri/c;->n:Ljava/nio/CharBuffer;
    ...
    .line 11
    invoke-virtual {p0, v0, p1, p2}, Lri/c;->f(Ljava/nio/charset/CoderResult;Lcz/msebera/android/httpclient/util/CharArrayBuffer;Ljava/nio/ByteBuffer;)I
    ...
    .line 14
    iget-object p2, p0, Lri/c;->n:Ljava/nio/CharBuffer;
...
.method public e()I
    ...
    .line 8
    iget-object v3, p0, Lri/c;->a:Ljava/io/InputStream;
    ...
    .line 9
    iput v0, p0, Lri/c;->l:I

    .line 10
    iget-object v0, p0, Lri/c;->h:Lri/u;

    int-to-long v2, v1

    invoke-virtual {v0, v2, v3}, Lri/u;->a(J)V
...
.method public final f(Ljava/nio/charset/CoderResult;Lcz/msebera/android/httpclient/util/CharArrayBuffer;Ljava/nio/ByteBuffer;)I
    ...
    .line 3
    :cond_0
    iget-object p1, p0, Lri/c;->n:Ljava/nio/CharBuffer;
    ...
    .line 5
    :goto_0
    iget-object p3, p0, Lri/c;->n:Ljava/nio/CharBuffer;
...
.method public h(Ljava/io/InputStream;ILvi/i;)V
    .locals 1
    ...
    .line 4
    iput-object p1, p0, Lri/c;->a:Ljava/io/InputStream;

    .line 5
    new-array p1, p2, [B

    iput-object p1, p0, Lri/c;->b:[B
    ...
    iput-object p1, p0, Lri/c;->c:Lcz/msebera/android/httpclient/util/ByteArrayBuffer;

    const-string p1, "http.protocol.element-charset"

    .line 9
    invoke-interface {p3, p1}, Lvi/i;->getParameter(Ljava/lang/String;)Ljava/lang/Object;
    ...
    :goto_0
    iput-object p1, p0, Lri/c;->d:Ljava/nio/charset/Charset;

    .line 11
    sget-object p2, Llh/b;->f:Ljava/nio/charset/Charset;
    ...
    .line 12
    iput-object p1, p0, Lri/c;->m:Ljava/nio/charset/CharsetDecoder;
    ...
    .line 13
    invoke-interface {p3, p2, p1}, Lvi/i;->getIntParameter(Ljava/lang/String;I)I

    move-result p1

    iput p1, p0, Lri/c;->f:I
    ...
    iput p1, p0, Lri/c;->g:I

    .line 15
    invoke-virtual {p0}, Lri/c;->d()Lri/u;

    move-result-object p1

    iput-object p1, p0, Lri/c;->h:Lri/u;
    ...
    :goto_1
    iput-object p1, p0, Lri/c;->i:Ljava/nio/charset/CodingErrorAction;
    ...
    :goto_2
    iput-object p1, p0, Lri/c;->j:Ljava/nio/charset/CodingErrorAction;
...
.method public final i(Lcz/msebera/android/httpclient/util/CharArrayBuffer;)I
    ...
    .line 2
    iget-object v1, p0, Lri/c;->c:Lcz/msebera/android/httpclient/util/ByteArrayBuffer;
    ...
    .line 7
    invoke-virtual {p0, p1, v0}, Lri/c;->c(Lcz/msebera/android/httpclient/util/CharArrayBuffer;Ljava/nio/ByteBuffer;)I

    move-result v0

    .line 8
    :goto_0
    iget-object p1, p0, Lri/c;->c:Lcz/msebera/android/httpclient/util/ByteArrayBuffer;
...
.method public final j(Lcz/msebera/android/httpclient/util/CharArrayBuffer;I)I
    ...
    .line 7
    invoke-virtual {p0, p1, p2}, Lri/c;->c(Lcz/msebera/android/httpclient/util/CharArrayBuffer;Ljava/nio/ByteBuffer;)I
...
.method public read([B)I
    ...
    invoke-virtual {p0, p1, v0, v1}, Lri/c;->read([BII)I
...
.method public read([BII)I
    ...
    .line 8
    :cond_1
    iget v0, p0, Lri/c;->g:I

    if-le p3, v0, :cond_3

    .line 9
    iget-object v0, p0, Lri/c;->a:Ljava/io/InputStream;
    ...
    .line 10
    iget-object p2, p0, Lri/c;->h:Lri/u;

    int-to-long v0, p1

    invoke-virtual {p2, v0, v1}, Lri/u;->a(J)V
...
.method public readLine()Ljava/lang/String;
    ...
    .line 2
    invoke-virtual {p0, v0}, Lri/c;->a(Lcz/msebera/android/httpclient/util/CharArrayBuffer;)I

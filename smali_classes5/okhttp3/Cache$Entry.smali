...
.method public constructor <init>(Lzj/m0;)V
    ...
    .line 3
    invoke-interface {v0}, Lzj/o;->Z()Ljava/lang/String;
    ...
    invoke-virtual {v2, v0}, Lokhttp3/Cache$Companion;->readInt$okhttp(Lzj/o;)I
    ...
    .line 28
    invoke-direct {p0, v0}, Lokhttp3/Cache$Entry;->readCertificateList(Lzj/o;)Ljava/util/List;
...
.method private final readCertificateList(Lzj/o;)Ljava/util/List;
    .locals 7
    ...
    invoke-virtual {v0, p1}, Lokhttp3/Cache$Companion;->readInt$okhttp(Lzj/o;)I
    ...
    .line 5
    invoke-interface {p1}, Lzj/o;->Z()Ljava/lang/String;

    move-result-object v4

    .line 6
    new-instance v5, Lzj/m;

    invoke-direct {v5}, Lzj/m;-><init>()V
    ...
    invoke-virtual {v5, v4}, Lzj/m;->U1(Lokio/ByteString;)Lzj/m;

    .line 8
    invoke-virtual {v5}, Lzj/m;->F1()Ljava/io/InputStream;
...
.method private final writeCertList(Lzj/n;Ljava/util/List;)V
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, v0, v1}, Lzj/n;->m0(J)Lzj/n;
    ...
    .line 5
    invoke-interface {p1, v3}, Lzj/n;->P(Ljava/lang/String;)Lzj/n;

    move-result-object v3

    invoke-interface {v3, v1}, Lzj/n;->writeByte(I)Lzj/n;
    :try_end_0
...
.method public final writeTo(Lokhttp3/internal/cache/DiskLruCache$Editor;)V
    ...
    .line 1
    invoke-virtual {p1, v0}, Lokhttp3/internal/cache/DiskLruCache$Editor;->newSink(I)Lzj/k0;
    ...
    invoke-interface {p1, v3, v4}, Lzj/n;->m0(J)Lzj/n;
    ...
    invoke-interface {p1, v5}, Lzj/n;->P(Ljava/lang/String;)Lzj/n;

    move-result-object v5

    .line 7
    invoke-interface {v5, v4}, Lzj/n;->P(Ljava/lang/String;)Lzj/n;
    ...
    invoke-interface {v4, v5}, Lzj/n;->P(Ljava/lang/String;)Lzj/n;

    move-result-object v4

    .line 9
    invoke-interface {v4, v2}, Lzj/n;->writeByte(I)Lzj/n;
    ...
    invoke-interface {p1, v5, v6}, Lzj/n;->m0(J)Lzj/n;
    ...
    invoke-interface {v3, v5}, Lzj/n;->P(Ljava/lang/String;)Lzj/n;

    move-result-object v3

    .line 16
    invoke-interface {v3, v2}, Lzj/n;->writeByte(I)Lzj/n;
    ...
    invoke-interface {v0, v5, v6}, Lzj/n;->m0(J)Lzj/n;
    ...
    invoke-interface {v0, v3, v4}, Lzj/n;->m0(J)Lzj/n;
    ...
    .line 26
    invoke-interface {p1, v2}, Lzj/n;->writeByte(I)Lzj/n;
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/Cache$Entry;->writeCertList(Lzj/n;Ljava/util/List;)V

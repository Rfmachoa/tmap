...
.field private final hpackBuffer:Lzj/m;
...
.method public constructor <init>(Lzj/n;Z)V
    .locals 7
    .param p1    # Lzj/n;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lzj/n;

    iput-boolean p2, p0, Lokhttp3/internal/http2/Http2Writer;->client:Z

    .line 2
    new-instance v4, Lzj/m;

    invoke-direct {v4}, Lzj/m;-><init>()V

    iput-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lzj/m;
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(IZLzj/m;ILkotlin/jvm/internal/u;)V
...
.method private final writeContinuationFrames(IJ)V
    ...
    .line 3
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lzj/n;

    iget-object v1, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lzj/m;
...
.method public final declared-synchronized applyAndAckSettings(Lokhttp3/internal/http2/Settings;)V
    ...
    .line 6
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lzj/n;
...
.method public final declared-synchronized connectionPreface()V
    ...
    invoke-interface {v0, v1}, Lzj/n;->s1(Lokio/ByteString;)Lzj/n;
...
.method public final declared-synchronized data(ZILzj/m;I)V
    .locals 1
    .param p3    # Lzj/m;
    ...
    .line 2
    invoke-virtual {p0, p2, p1, p3, p4}, Lokhttp3/internal/http2/Http2Writer;->dataFrame(IILzj/m;I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final dataFrame(IILzj/m;I)V
    .locals 2
    .param p3    # Lzj/m;
        .annotation build Lorg/jetbrains/annotations/Nullable;
        .end annotation
    ...
    invoke-interface {p1, p3, v0, v1}, Lzj/k0;->write(Lzj/m;J)V
...
.method public final frameHeader(IIII)V
    ...
    invoke-static {v0, p2}, Lokhttp3/internal/Util;->writeMedium(Lzj/n;I)V

    .line 4
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lzj/n;

    and-int/lit16 p3, p3, 0xff

    invoke-interface {p2, p3}, Lzj/n;->writeByte(I)Lzj/n;
    ...
    invoke-interface {p2, p1}, Lzj/n;->writeInt(I)Lzj/n;
...
.method public final declared-synchronized goAway(ILokhttp3/internal/http2/ErrorCode;[B)V
    ...
    invoke-interface {v0, p1}, Lzj/n;->writeInt(I)Lzj/n;
    ...
    invoke-interface {p1, p2}, Lzj/n;->writeInt(I)Lzj/n;
    ...
    invoke-interface {p1, p3}, Lzj/n;->write([B)Lzj/n;
...
.method public final declared-synchronized headers(ZILjava/util/List;)V
    ...
    .line 3
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lzj/m;
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lzj/m;

    invoke-interface {p1, v4, v2, v3}, Lzj/k0;->write(Lzj/m;J)V
...
.method public final declared-synchronized ping(ZII)V
    ...
    invoke-interface {p1, p3}, Lzj/n;->writeInt(I)Lzj/n;
...
.method public final declared-synchronized pushPromise(IILjava/util/List;)V
    ...
    .line 6
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lzj/n;

    const v3, 0x7fffffff

    and-int/2addr p2, v3

    invoke-interface {v2, p2}, Lzj/n;->writeInt(I)Lzj/n;

    .line 7
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lzj/n;

    iget-object v2, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lzj/m;

    invoke-interface {p2, v2, v4, v5}, Lzj/k0;->write(Lzj/m;J)V
...
.method public final declared-synchronized settings(Lokhttp3/internal/http2/Settings;)V
    ...
    .line 5
    :goto_1
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lzj/n;

    invoke-interface {v4, v3}, Lzj/n;->writeShort(I)Lzj/n;

    .line 6
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lzj/n;

    invoke-virtual {p1, v2}, Lokhttp3/internal/http2/Settings;->get(I)I

    move-result v4

    invoke-interface {v3, v4}, Lzj/n;->writeInt(I)Lzj/n;

...
.method public data(ZILzj/o;I)V
    .locals 2
    .param p3    # Lzj/o;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-virtual {v0, p2, p3, p4, p1}, Lokhttp3/internal/http2/Http2Connection;->pushDataLater$okhttp(ILzj/o;IZ)V
    ...
    .line 6
    invoke-interface {p3, v0, v1}, Lzj/o;->skip(J)V

    return-void

    .line 7
    :cond_1
    invoke-virtual {v0, p3, p4}, Lokhttp3/internal/http2/Http2Stream;->receiveData(Lzj/o;I)V

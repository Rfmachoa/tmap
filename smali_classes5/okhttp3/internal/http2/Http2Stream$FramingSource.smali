...
.field private final readBuffer:Lzj/m;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field

.field private final receiveBuffer:Lzj/m;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field
...
.method public constructor <init>(Lokhttp3/internal/http2/Http2Stream;JZ)V
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->receiveBuffer:Lzj/m;
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->readBuffer:Lzj/m;
...
.method public close()V
    ...
    .line 3
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->readBuffer:Lzj/m;
    ...
    .line 4
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->readBuffer:Lzj/m;

    invoke-virtual {v3}, Lzj/m;->c()V
...
.method public final getReadBuffer()Lzj/m;
    .locals 1
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation

    .line 1
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->readBuffer:Lzj/m;

    return-object v0
.end method

.method public final getReceiveBuffer()Lzj/m;
    .locals 1
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation

    .line 1
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->receiveBuffer:Lzj/m;
...
.method public read(Lzj/m;J)J
    ...
    invoke-virtual {v4}, Lzj/k;->enter()V
    :try_end_0
    ...
    .line 6
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->readBuffer:Lzj/m;
    ...
    invoke-virtual {v0, p1, v6, v7}, Lzj/m;->read(Lzj/m;J)J
...
.method public final receive$okhttp(Lzj/o;J)V
    .locals 9
    .param p1    # Lzj/o;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 12
    :cond_4
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->receiveBuffer:Lzj/m;

    invoke-interface {p1, v2, p2, p3}, Lzj/m0;->read(Lzj/m;J)J
    ...
    .line 15
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->receiveBuffer:Lzj/m;

    invoke-virtual {v3}, Lzj/m;->size()J

    move-result-wide v3

    .line 16
    iget-object v5, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->receiveBuffer:Lzj/m;

    invoke-virtual {v5}, Lzj/m;->c()V
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->receiveBuffer:Lzj/m;

    invoke-virtual {v3, v4}, Lzj/m;->A1(Lzj/m0;)J

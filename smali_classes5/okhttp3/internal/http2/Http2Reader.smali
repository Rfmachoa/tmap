...
.method public constructor <init>(Lzj/o;Z)V
    .locals 7
    .param p1    # Lzj/o;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lzj/o;
    ...
    invoke-direct {v2, p1}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;-><init>(Lzj/o;)V
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(Lzj/m0;IIILkotlin/jvm/internal/u;)V
...
.method private final readData(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 1
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lzj/o;

    invoke-interface {v1}, Lzj/o;->readByte()B
    ...
    .line 3
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lzj/o;

    invoke-interface {p1, v0, p4, p3, p2}, Lokhttp3/internal/http2/Http2Reader$Handler;->data(ZILzj/o;I)V

    .line 4
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lzj/o;

    int-to-long p2, v1

    invoke-interface {p1, p2, p3}, Lzj/o;->skip(J)V
...
.method private final readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 1
    iget-object p4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lzj/o;

    invoke-interface {p4}, Lzj/o;->readInt()I

    move-result p4

    .line 2
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lzj/o;

    invoke-interface {v0}, Lzj/o;->readInt()I
    ...
    invoke-interface {v0, v1, v2}, Lzj/o;->v0(J)Lokio/ByteString;
...
.method private final readPing(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 1
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lzj/o;

    invoke-interface {p2}, Lzj/o;->readInt()I
...
.method private final readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;I)V
    ...
    .line 5
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lzj/o;

    invoke-interface {v3}, Lzj/o;->readByte()B
...
.method private final readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-static {p3, p2, p4}, Landroidx/camera/core/impl/utils/f;->a(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/String;
...
.method private final readPushPromise(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-interface {v1}, Lzj/o;->readInt()I
...
.method private final readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 5
    invoke-static {v0, p2}, Lkj/q;->n1(II)Lkj/k;

    move-result-object p2

    const/4 v1, 0x6

    invoke-static {p2, v1}, Lkj/q;->S0(Lkj/i;I)Lkj/i;

    move-result-object p2

    invoke-virtual {p2}, Lkj/i;->e()I

    move-result v1

    invoke-virtual {p2}, Lkj/i;->f()I

    move-result v2

    invoke-virtual {p2}, Lkj/i;->g()I
    ...
    invoke-interface {v3}, Lzj/o;->readShort()S
    ...
    .line 7
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lzj/o;

    invoke-interface {v4}, Lzj/o;->readInt()I
...
.method public final nextFrame(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-interface {v0, v1, v2}, Lzj/o;->l0(J)V
    :try_end_0
    ...
    invoke-static {v0}, Lokhttp3/internal/Util;->readMedium(Lzj/o;)I
    ...
    invoke-interface {p1, v0, v1}, Lzj/o;->skip(J)V
...
.method public final readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    invoke-interface {p1, v2, v3}, Lzj/o;->v0(J)Lokio/ByteString;

...
.method private final newSource(I)Lzj/m0;
    .locals 2
    ...
    invoke-interface {v0, p1}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)Lzj/m0;
    ...
    invoke-direct {v0, p0, p1, p1}, Lokhttp3/internal/cache/DiskLruCache$Entry$newSource$1;-><init>(Lokhttp3/internal/cache/DiskLruCache$Entry;Lzj/m0;Lzj/m0;)V
...
.method public final snapshot$okhttp()Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    .line 9
    invoke-direct {p0, v2}, Lokhttp3/internal/cache/DiskLruCache$Entry;->newSource(I)Lzj/m0;
...
.method public final writeLengths$okhttp(Lzj/n;)V
    .locals 6
    .param p1    # Lzj/n;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 2
    invoke-interface {p1, v5}, Lzj/n;->writeByte(I)Lzj/n;

    move-result-object v5

    invoke-interface {v5, v3, v4}, Lzj/n;->m0(J)Lzj/n;

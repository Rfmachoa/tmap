...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "()Lzj/o;",
        "<init>",
        "(ZLzj/o;Lokhttp3/internal/ws/WebSocketReader$FrameCallback;ZZ)V",
        "FrameCallback",
        "okhttp"
    }
    k = 0x1
...
.field private final controlFrameBuffer:Lzj/m;
...
.field private final maskCursor:Lzj/m$a;

.field private final maskKey:[B

.field private final messageFrameBuffer:Lzj/m;
...
# direct methods
.method public constructor <init>(ZLzj/o;Lokhttp3/internal/ws/WebSocketReader$FrameCallback;ZZ)V
    .locals 1
    .param p2    # Lzj/o;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    iput-object p2, p0, Lokhttp3/internal/ws/WebSocketReader;->source:Lzj/o;
    ...
    iput-object p2, p0, Lokhttp3/internal/ws/WebSocketReader;->controlFrameBuffer:Lzj/m;
    ...
    iput-object p2, p0, Lokhttp3/internal/ws/WebSocketReader;->messageFrameBuffer:Lzj/m;
    ...
    .line 5
    :cond_1
    new-instance p2, Lzj/m$a;

    invoke-direct {p2}, Lzj/m$a;-><init>()V

    :goto_1
    iput-object p2, p0, Lokhttp3/internal/ws/WebSocketReader;->maskCursor:Lzj/m$a;
...
.method private final readControlFrame()V
    ...
    .line 2
    iget-object v4, p0, Lokhttp3/internal/ws/WebSocketReader;->source:Lzj/o;

    iget-object v5, p0, Lokhttp3/internal/ws/WebSocketReader;->controlFrameBuffer:Lzj/m;

    invoke-interface {v4, v5, v0, v1}, Lzj/o;->i1(Lzj/m;J)V
    ...
    .line 4
    iget-object v0, p0, Lokhttp3/internal/ws/WebSocketReader;->controlFrameBuffer:Lzj/m;

    iget-object v1, p0, Lokhttp3/internal/ws/WebSocketReader;->maskCursor:Lzj/m$a;

    invoke-static {v1}, Lkotlin/jvm/internal/f0;->m(Ljava/lang/Object;)V

    invoke-virtual {v0, v1}, Lzj/m;->B1(Lzj/m$a;)Lzj/m$a;

    .line 5
    iget-object v0, p0, Lokhttp3/internal/ws/WebSocketReader;->maskCursor:Lzj/m$a;

    invoke-virtual {v0, v2, v3}, Lzj/m$a;->d(J)I
    ...
    invoke-virtual {v0, v1, v4}, Lokhttp3/internal/ws/WebSocketProtocol;->toggleMask(Lzj/m$a;[B)V

    .line 7
    iget-object v0, p0, Lokhttp3/internal/ws/WebSocketReader;->maskCursor:Lzj/m$a;

    invoke-virtual {v0}, Lzj/m$a;->close()V
    ...
    iget-object v1, p0, Lokhttp3/internal/ws/WebSocketReader;->controlFrameBuffer:Lzj/m;
...
.method private final readHeader()V
    ...
    .line 2
    iget-object v0, p0, Lokhttp3/internal/ws/WebSocketReader;->source:Lzj/o;
    ...
    .line 3
    iget-object v2, p0, Lokhttp3/internal/ws/WebSocketReader;->source:Lzj/o;

    invoke-interface {v2}, Lzj/m0;->timeout()Lzj/o0;

    move-result-object v2

    invoke-virtual {v2}, Lzj/o0;->clearTimeout()Lzj/o0;

    .line 4
    :try_start_0
    iget-object v2, p0, Lokhttp3/internal/ws/WebSocketReader;->source:Lzj/o;

    invoke-interface {v2}, Lzj/o;->readByte()B
    ...
    invoke-interface {v4}, Lzj/m0;->timeout()Lzj/o0;

    move-result-object v4

    sget-object v5, Ljava/util/concurrent/TimeUnit;->NANOSECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v4, v0, v1, v5}, Lzj/o0;->timeout(JLjava/util/concurrent/TimeUnit;)Lzj/o0;
    ...
    invoke-interface {v0}, Lzj/o;->readByte()B
    ...
    invoke-interface {v0}, Lzj/o;->readShort()S
    ...
    invoke-interface {v0}, Lzj/o;->readLong()J
    ...
    invoke-interface {v0, v1}, Lzj/o;->readFully([B)V
    ...
    .line 27
    iget-object v3, p0, Lokhttp3/internal/ws/WebSocketReader;->source:Lzj/o;

    invoke-interface {v3}, Lzj/m0;->timeout()Lzj/o0;

    move-result-object v3

    sget-object v4, Ljava/util/concurrent/TimeUnit;->NANOSECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v3, v0, v1, v4}, Lzj/o0;->timeout(JLjava/util/concurrent/TimeUnit;)Lzj/o0;
...
.method private final readMessage()V
    ...
    iget-object v3, p0, Lokhttp3/internal/ws/WebSocketReader;->messageFrameBuffer:Lzj/m;

    invoke-interface {v2, v3, v0, v1}, Lzj/o;->i1(Lzj/m;J)V
    ...
    .line 5
    iget-object v0, p0, Lokhttp3/internal/ws/WebSocketReader;->messageFrameBuffer:Lzj/m;
    ...
    iget-object v1, p0, Lokhttp3/internal/ws/WebSocketReader;->messageFrameBuffer:Lzj/m;
    ...
    invoke-virtual {v0, v1, v2}, Lzj/m$a;->d(J)I
    ...
    invoke-virtual {v0, v1, v2}, Lokhttp3/internal/ws/WebSocketProtocol;->toggleMask(Lzj/m$a;[B)V
...
.method private final readMessageFrame()V
    ...
    invoke-virtual {v2, v3}, Lokhttp3/internal/ws/MessageInflater;->inflate(Lzj/m;)V
...
.method public final getSource()Lzj/o;
    .locals 1
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation

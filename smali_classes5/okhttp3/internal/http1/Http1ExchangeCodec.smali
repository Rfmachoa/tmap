...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "sink",
        "<init>",
        "(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lzj/o;Lzj/n;)V",
        "Companion",
        "AbstractSource",
        "ChunkedSink",
        "ChunkedSource",
...
.field private final sink:Lzj/n;
...
.method public constructor <init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lzj/o;Lzj/n;)V
    .locals 1
    ...
    iput-object p3, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->source:Lzj/o;

    iput-object p4, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lzj/n;

    .line 2
    new-instance p1, Lokhttp3/internal/http1/HeadersReader;

    invoke-direct {p1, p3}, Lokhttp3/internal/http1/HeadersReader;-><init>(Lzj/o;)V
...
.method public static final synthetic access$detachTimeout(Lokhttp3/internal/http1/Http1ExchangeCodec;Lzj/s;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->detachTimeout(Lzj/s;)V
...
.method public static final synthetic access$getSink$p(Lokhttp3/internal/http1/Http1ExchangeCodec;)Lzj/n;
    .locals 0

    .line 1
    iget-object p0, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lzj/n;

    return-object p0
.end method

.method public static final synthetic access$getSource$p(Lokhttp3/internal/http1/Http1ExchangeCodec;)Lzj/o;
    .locals 0

    .line 1
    iget-object p0, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->source:Lzj/o;
...
.method private final detachTimeout(Lzj/s;)V
    .locals 2

    .line 1
    invoke-virtual {p1}, Lzj/s;->a()Lzj/o0;

    move-result-object v0

    .line 2
    sget-object v1, Lzj/o0;->NONE:Lzj/o0;

    invoke-virtual {p1, v1}, Lzj/s;->b(Lzj/o0;)Lzj/s;
...
.method private final newChunkedSink()Lzj/k0;
    .locals 2
...
.method private final newChunkedSource(Lokhttp3/HttpUrl;)Lzj/m0;
    .locals 2
...
.method private final newFixedLengthSource(J)Lzj/m0;
    .locals 2
...
.method private final newKnownLengthSink()Lzj/k0;
    .locals 2
...
.method private final newUnknownLengthSource()Lzj/m0;
    .locals 2
...
.method public createRequestBody(Lokhttp3/Request;J)Lzj/k0;
    .locals 2
    ...
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newChunkedSink()Lzj/k0;
    ...
    .line 3
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newKnownLengthSink()Lzj/k0;
...
.method public finishRequest()V
    ...
    .line 1
    iget-object v0, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lzj/n;
...
.method public openResponseBodySource(Lokhttp3/Response;)Lzj/m0;
    .locals 4
    ...
    invoke-direct {p0, v0, v1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newFixedLengthSource(J)Lzj/m0;
    ...
    invoke-direct {p0, p1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newChunkedSource(Lokhttp3/HttpUrl;)Lzj/m0;
    ...
    .line 5
    :cond_2
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newUnknownLengthSource()Lzj/m0;
...
.method public final skipConnectBody(Lokhttp3/Response;)V
    ...
    invoke-static {p1, v0, v1}, Lokhttp3/internal/Util;->skipAll(Lzj/m0;ILjava/util/concurrent/TimeUnit;)Z

    .line 4
    invoke-interface {p1}, Lzj/m0;->close()V
...
.method public final writeRequest(Lokhttp3/Headers;Ljava/lang/String;)V
    ...
    invoke-interface {v0, p2}, Lzj/n;->P(Ljava/lang/String;)Lzj/n;

    move-result-object p2

    const-string v0, "\r\n"

    invoke-interface {p2, v0}, Lzj/n;->P(Ljava/lang/String;)Lzj/n;
    ...
    .line 4
    iget-object v3, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lzj/n;

    invoke-virtual {p1, v1}, Lokhttp3/Headers;->name(I)Ljava/lang/String;

    move-result-object v4

    invoke-interface {v3, v4}, Lzj/n;->P(Ljava/lang/String;)Lzj/n;
    ...
    .line 7
    invoke-interface {v3, v0}, Lzj/n;->P(Ljava/lang/String;)Lzj/n;
    ...
    .line 8
    :cond_1
    iget-object p1, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lzj/n;

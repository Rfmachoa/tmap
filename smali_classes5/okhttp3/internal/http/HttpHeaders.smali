...
.method public static final parseChallenges(Lokhttp3/Headers;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {v3, v4}, Lzj/m;->n2(Ljava/lang/String;)Lzj/m;

    move-result-object v3

    .line 5
    :try_start_0
    invoke-static {v3, v0}, Lokhttp3/internal/http/HttpHeaders;->readChallengeHeader(Lzj/m;Ljava/util/List;)V
    :try_end_0
...
.method private static final readChallengeHeader(Lzj/m;Ljava/util/List;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-static {p0}, Lokhttp3/internal/http/HttpHeaders;->skipCommasAndWhitespace(Lzj/m;)Z

    .line 2
    invoke-static {p0}, Lokhttp3/internal/http/HttpHeaders;->readToken(Lzj/m;)Ljava/lang/String;
    ...
    .line 7
    invoke-static {p0, v4}, Lokhttp3/internal/Util;->skipAll(Lzj/m;B)I
    ...
    .line 20
    invoke-static {p0, v5}, Lokhttp3/internal/http/HttpHeaders;->startsWith(Lzj/m;B)Z

    move-result v5

    if-eqz v5, :cond_a

    invoke-static {p0}, Lokhttp3/internal/http/HttpHeaders;->readQuotedString(Lzj/m;)Ljava/lang/String;
...
.method private static final readQuotedString(Lzj/m;)Ljava/lang/String;
    .locals 12
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/EOFException;
    ...
    invoke-virtual {p0, v2}, Lzj/m;->D(Lokio/ByteString;)J
    ...
    .line 5
    invoke-virtual {v0, p0, v2, v3}, Lzj/m;->write(Lzj/m;J)V
    ...
    .line 11
    invoke-virtual {v0, p0, v8, v9}, Lzj/m;->write(Lzj/m;J)V
...
.method private static final readToken(Lzj/m;)Ljava/lang/String;
    .locals 4

    .line 1
    sget-object v0, Lokhttp3/internal/http/HttpHeaders;->TOKEN_DELIMITERS:Lokio/ByteString;

    invoke-virtual {p0, v0}, Lzj/m;->D(Lokio/ByteString;)J
...
.method private static final skipCommasAndWhitespace(Lzj/m;)Z
    .locals 3
...
.method private static final startsWith(Lzj/m;B)Z
    .locals 2

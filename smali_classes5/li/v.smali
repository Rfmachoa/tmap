...
.field public static final c:Lli/v;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lli/v;->d:[Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lli/v;->a:Lcz/msebera/android/httpclient/extras/b;
...
.method public a(Llh/q;Llh/t;Lxi/g;)Z
    ...
    .line 6
    :pswitch_1
    invoke-virtual {p0, p1}, Lli/v;->e(Ljava/lang/String;)Z
...
.method public b(Llh/q;Llh/t;Lxi/g;)Lsh/q;
    ...
    .line 1
    invoke-virtual {p0, p1, p2, p3}, Lli/v;->d(Llh/q;Llh/t;Lxi/g;)Ljava/net/URI;
    ...
    invoke-direct {p1, p3}, Lsh/i;-><init>(Ljava/net/URI;)V
    ...
    invoke-direct {p1, p3}, Lsh/h;-><init>(Ljava/net/URI;)V
    ...
    .line 8
    invoke-static {p1}, Lsh/r;->g(Llh/q;)Lsh/r;

    move-result-object p1

    invoke-virtual {p1, p3}, Lsh/r;->F(Ljava/net/URI;)Lsh/r;

    move-result-object p1

    invoke-virtual {p1}, Lsh/r;->f()Lsh/q;
...
.method public c(Ljava/lang/String;)Ljava/net/URI;
    ...
    invoke-direct {v0, v1}, Lvh/h;-><init>(Ljava/net/URI;)V

    .line 2
    iget-object v1, v0, Lvh/h;->f:Ljava/lang/String;
    ...
    invoke-virtual {v0, v1}, Lvh/h;->y(Ljava/lang/String;)Lvh/h;

    .line 4
    :cond_0
    iget-object v1, v0, Lvh/h;->h:Ljava/lang/String;

    .line 5
    invoke-static {v1}, Lyi/i;->b(Ljava/lang/CharSequence;)Z
    ...
    .line 6
    invoke-virtual {v0, v1}, Lvh/h;->C(Ljava/lang/String;)Lvh/h;

    .line 7
    :cond_1
    invoke-virtual {v0}, Lvh/h;->c()Ljava/net/URI;
...
.method public d(Llh/q;Llh/t;Lxi/g;)Ljava/net/URI;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcz/msebera/android/httpclient/ProtocolException;
    ...
    .line 5
    invoke-interface {p2, v1}, Llh/p;->getFirstHeader(Ljava/lang/String;)Llh/d;
    ...
    .line 7
    iget-object v1, p0, Lli/v;->a:Lcz/msebera/android/httpclient/extras/b;
    ...
    .line 9
    :cond_0
    invoke-virtual {v0}, Luh/c;->x()Lqh/c;

    move-result-object v1

    .line 10
    invoke-virtual {p0, p2}, Lli/v;->c(Ljava/lang/String;)Ljava/net/URI;
    ...
    .line 13
    invoke-virtual {v0}, Lxi/h;->h()Lcz/msebera/android/httpclient/HttpHost;
    ...
    .line 14
    invoke-static {v3, v4}, Lyi/b;->e(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    .line 16
    invoke-static {v4, v3, p1}, Lvh/i;->j(Ljava/net/URI;Lcz/msebera/android/httpclient/HttpHost;Z)Ljava/net/URI;

    move-result-object p1

    .line 17
    invoke-static {p1, p2}, Lvh/i;->f(Ljava/net/URI;Ljava/net/URI;)Ljava/net/URI;
    ...
    .line 19
    invoke-virtual {v0, p1}, Lxi/h;->getAttribute(Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 21
    invoke-interface {p3, p1, v0}, Lxi/g;->setAttribute(Ljava/lang/String;Ljava/lang/Object;)V

    .line 22
    :cond_3
    invoke-virtual {v1}, Lqh/c;->n()Z
    ...
    .line 23
    invoke-virtual {v0, p2}, Lli/q0;->b(Ljava/net/URI;)Z
    ...
    :cond_5
    :goto_1
    invoke-virtual {v0, p2}, Lli/q0;->a(Ljava/net/URI;)V
...
.method public e(Ljava/lang/String;)Z
    ...
    .line 1
    sget-object v0, Lli/v;->d:[Ljava/lang/String;

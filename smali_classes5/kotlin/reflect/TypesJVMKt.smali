...
.method public static final c(Lkotlin/reflect/r;Z)Ljava/lang/reflect/Type;
    ...
    new-instance p0, Lkotlin/reflect/x;

    check-cast v0, Lkotlin/reflect/s;

    invoke-direct {p0, v0}, Lkotlin/reflect/x;-><init>(Lkotlin/reflect/s;)V
    ...
    invoke-static {v0}, Ldj/a;->e(Lkotlin/reflect/d;)Ljava/lang/Class;
    ...
    .line 5
    :goto_0
    invoke-interface {p0}, Lkotlin/reflect/r;->d()Ljava/util/List;
    ...
    .line 10
    invoke-virtual {v0}, Lkotlin/reflect/t;->a()Lkotlin/reflect/KVariance;

    move-result-object p0

    .line 11
    invoke-virtual {v0}, Lkotlin/reflect/t;->b()Lkotlin/reflect/r;
    ...
    .line 12
    :cond_4
    sget-object v1, Lkotlin/reflect/y;->a:[I
...
.method public static final e(Ljava/lang/Class;Ljava/util/List;)Ljava/lang/reflect/Type;
    ...
    invoke-static {p1, v1}, Lkotlin/collections/x;->Y(Ljava/lang/Iterable;I)I
...
.method public static final g(Lkotlin/reflect/t;)Ljava/lang/reflect/Type;
    ...
    .line 1
    invoke-virtual {p0}, Lkotlin/reflect/t;->h()Lkotlin/reflect/KVariance;
    ...
    .line 2
    invoke-virtual {p0}, Lkotlin/reflect/t;->g()Lkotlin/reflect/r;
    ...
    .line 3
    sget-object v1, Lkotlin/reflect/y;->b:[I
    ...
    invoke-static {p0, v1}, Lkotlin/reflect/TypesJVMKt;->c(Lkotlin/reflect/r;Z)Ljava/lang/reflect/Type;

    move-result-object p0

    invoke-direct {v0, p0, v3}, Lkotlin/reflect/z;-><init>(Ljava/lang/reflect/Type;Ljava/lang/reflect/Type;)V
    ...
    invoke-direct {v0, v3, p0}, Lkotlin/reflect/z;-><init>(Ljava/lang/reflect/Type;Ljava/lang/reflect/Type;)V
    ...
    .line 7
    :cond_3
    sget-object p0, Lkotlin/reflect/z;->d:Lkotlin/reflect/z$a;

    invoke-virtual {p0}, Lkotlin/reflect/z$a;->a()Lkotlin/reflect/z;
...
.method public static final j(Ljava/lang/reflect/Type;)Ljava/lang/String;
    ...
    invoke-static {p0, v0}, Lkotlin/sequences/SequencesKt__SequencesKt;->q(Ljava/lang/Object;Lej/l;)Lkotlin/sequences/m;
    ...
    invoke-static {p0}, Lkotlin/sequences/SequencesKt___SequencesKt;->Y0(Lkotlin/sequences/m;)Ljava/lang/Object;

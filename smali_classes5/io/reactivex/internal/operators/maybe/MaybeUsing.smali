...
.method public constructor <init>(Ljava/util/concurrent/Callable;Lph/o;Lph/g;Z)V
    ...
    .line 3
    iput-object p2, p0, Lio/reactivex/internal/operators/maybe/MaybeUsing;->b:Lph/o;

    .line 4
    iput-object p3, p0, Lio/reactivex/internal/operators/maybe/MaybeUsing;->c:Lph/g;
...
.method public p1(Lkh/t;)V
    ...
    .line 2
    :try_start_1
    iget-object v1, p0, Lio/reactivex/internal/operators/maybe/MaybeUsing;->b:Lph/o;
    ...
    iget-object v3, p0, Lio/reactivex/internal/operators/maybe/MaybeUsing;->c:Lph/g;

    iget-boolean v4, p0, Lio/reactivex/internal/operators/maybe/MaybeUsing;->d:Z

    invoke-direct {v2, p1, v0, v3, v4}, Lio/reactivex/internal/operators/maybe/MaybeUsing$UsingObserver;-><init>(Lkh/t;Ljava/lang/Object;Lph/g;Z)V

    invoke-interface {v1, v2}, Lkh/w;->b(Lkh/t;)V
    ...
    .line 6
    :try_start_2
    iget-object v2, p0, Lio/reactivex/internal/operators/maybe/MaybeUsing;->c:Lph/g;
    ...
    invoke-static {v2, p1}, Lio/reactivex/internal/disposables/EmptyDisposable;->error(Ljava/lang/Throwable;Lkh/t;)V
    ...
    :cond_0
    :goto_0
    invoke-static {v1, p1}, Lio/reactivex/internal/disposables/EmptyDisposable;->error(Ljava/lang/Throwable;Lkh/t;)V
    ...
    .line 11
    :try_start_3
    iget-object p1, p0, Lio/reactivex/internal/operators/maybe/MaybeUsing;->c:Lph/g;

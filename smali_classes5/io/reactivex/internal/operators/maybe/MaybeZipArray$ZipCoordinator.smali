...
# direct methods
.method public constructor <init>(Lwj/t;ILbk/o;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/maybe/MaybeZipArray$ZipCoordinator;->downstream:Lwj/t;

    .line 3
    iput-object p3, p0, Lio/reactivex/internal/operators/maybe/MaybeZipArray$ZipCoordinator;->zipper:Lbk/o;
...
.method public innerComplete(I)V
    ...
    .line 3
    iget-object p1, p0, Lio/reactivex/internal/operators/maybe/MaybeZipArray$ZipCoordinator;->downstream:Lwj/t;

    invoke-interface {p1}, Lwj/t;->onComplete()V
...
.method public innerError(Ljava/lang/Throwable;I)V
    ...
    .line 3
    iget-object p2, p0, Lio/reactivex/internal/operators/maybe/MaybeZipArray$ZipCoordinator;->downstream:Lwj/t;

    invoke-interface {p2, p1}, Lwj/t;->onError(Ljava/lang/Throwable;)V
...
.method public innerSuccess(Ljava/lang/Object;I)V
    ...
    .line 3
    :try_start_0
    iget-object p1, p0, Lio/reactivex/internal/operators/maybe/MaybeZipArray$ZipCoordinator;->zipper:Lbk/o;

    iget-object p2, p0, Lio/reactivex/internal/operators/maybe/MaybeZipArray$ZipCoordinator;->values:[Ljava/lang/Object;

    invoke-interface {p1, p2}, Lbk/o;->apply(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p1

    const-string p2, "The zipper returned a null value"

    invoke-static {p1, p2}, Lio/reactivex/internal/functions/a;->g(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-interface {p2, p1}, Lwj/t;->onSuccess(Ljava/lang/Object;)V

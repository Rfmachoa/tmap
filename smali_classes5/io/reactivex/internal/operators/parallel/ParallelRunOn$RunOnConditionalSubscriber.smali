...
# direct methods
.method public constructor <init>(Ldk/a;ILio/reactivex/internal/queue/SpscArrayQueue;Lwj/h0$c;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-direct {p0, p2, p3, p4}, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;-><init>(ILio/reactivex/internal/queue/SpscArrayQueue;Lwj/h0$c;)V

    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$RunOnConditionalSubscriber;->downstream:Ldk/a;
...
.method public onSubscribe(Lan/e;)V
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->upstream:Lan/e;
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->upstream:Lan/e;

    .line 3
    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$RunOnConditionalSubscriber;->downstream:Ldk/a;
...
.method public run()V
    ...
    .line 3
    iget-object v3, v0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$RunOnConditionalSubscriber;->downstream:Ldk/a;
    ...
    .line 11
    invoke-interface {v3, v15}, Lan/d;->onError(Ljava/lang/Throwable;)V

    .line 12
    iget-object v1, v0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->worker:Lwj/h0$c;
    ...
    .line 16
    :cond_6
    invoke-interface {v3, v15}, Ldk/a;->tryOnNext(Ljava/lang/Object;)Z
    ...
    .line 17
    iget-object v13, v0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->upstream:Lan/e;

    int-to-long v14, v1

    invoke-interface {v13, v14, v15}, Lan/e;->request(J)V

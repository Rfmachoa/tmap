...
.field public final D1:Lwj/h0$c;
...
# direct methods
.method public constructor <init>(Lan/d;JJLjava/util/concurrent/TimeUnit;Lwj/h0$c;I)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-wide p2, p0, Lio/reactivex/internal/operators/flowable/j1$c;->A1:J

    .line 3
    iput-wide p4, p0, Lio/reactivex/internal/operators/flowable/j1$c;->B1:J

    .line 4
    iput-object p6, p0, Lio/reactivex/internal/operators/flowable/j1$c;->C1:Ljava/util/concurrent/TimeUnit;

    .line 5
    iput-object p7, p0, Lio/reactivex/internal/operators/flowable/j1$c;->D1:Lwj/h0$c;

    .line 6
    iput p8, p0, Lio/reactivex/internal/operators/flowable/j1$c;->E1:I
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/j1$c;->F1:Ljava/util/List;
...
.method public dispose()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/j1$c;->D1:Lwj/h0$c;
...
.method public m()V
    ...
    .line 3
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/j1$c;->F1:Ljava/util/List;
    ...
    :cond_0
    :goto_0
    iget-boolean v5, p0, Lio/reactivex/internal/operators/flowable/j1$c;->H1:Z

    if-eqz v5, :cond_1

    .line 5
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/j1$c;->G1:Lan/e;
    ...
    .line 20
    invoke-virtual {p0, v4}, Lfk/h;->b(I)I
    ...
    .line 25
    iget v7, p0, Lio/reactivex/internal/operators/flowable/j1$c;->E1:I
    ...
    .line 27
    invoke-interface {v1, v7}, Lan/d;->onNext(Ljava/lang/Object;)V
    ...
    .line 29
    :cond_9
    iget-object v5, p0, Lio/reactivex/internal/operators/flowable/j1$c;->D1:Lwj/h0$c;
    ...
    iget-wide v7, p0, Lio/reactivex/internal/operators/flowable/j1$c;->A1:J

    iget-object v9, p0, Lio/reactivex/internal/operators/flowable/j1$c;->C1:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v5, v6, v7, v8, v9}, Lwj/h0$c;->c(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/reactivex/disposables/b;
    ...
    .line 34
    iput-boolean v3, p0, Lio/reactivex/internal/operators/flowable/j1$c;->H1:Z
...
.method public onNext(Ljava/lang/Object;)V
    ...
    .line 2
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/j1$c;->F1:Ljava/util/List;
...
.method public onSubscribe(Lan/e;)V
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/j1$c;->G1:Lan/e;
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/j1$c;->G1:Lan/e;
    ...
    .line 6
    iget v2, p0, Lio/reactivex/internal/operators/flowable/j1$c;->E1:I
    ...
    .line 7
    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/j1$c;->F1:Ljava/util/List;

    invoke-interface {v3, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 8
    iget-object v3, p0, Lfk/h;->v1:Lan/d;
    ...
    iget-wide v5, p0, Lio/reactivex/internal/operators/flowable/j1$c;->A1:J

    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/j1$c;->C1:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v0, v1, v5, v6, v2}, Lwj/h0$c;->c(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/reactivex/disposables/b;

    .line 11
    iget-object v7, p0, Lio/reactivex/internal/operators/flowable/j1$c;->D1:Lwj/h0$c;

    iget-wide v11, p0, Lio/reactivex/internal/operators/flowable/j1$c;->B1:J

    iget-object v13, p0, Lio/reactivex/internal/operators/flowable/j1$c;->C1:Ljava/util/concurrent/TimeUnit;

    move-object v8, p0

    move-wide v9, v11

    invoke-virtual/range {v7 .. v13}, Lwj/h0$c;->d(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lio/reactivex/disposables/b;
...
.method public run()V
    ...
    .line 1
    iget v0, p0, Lio/reactivex/internal/operators/flowable/j1$c;->E1:I

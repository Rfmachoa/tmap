...
.field public final downstream:Lzj/a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lzj/a<",
            "-TT;>;"
...
# direct methods
.method public constructor <init>(Lzj/a;Lsj/h0$c;ZI)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-direct {p0, p2, p3, p4}, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;-><init>(Lsj/h0$c;ZI)V

    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->downstream:Lzj/a;
...
.method public onSubscribe(Lym/e;)V
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Lym/e;
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Lym/e;
    ...
    .line 7
    iput-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->queue:Lzj/o;

    .line 8
    iput-boolean v2, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->done:Z

    .line 9
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->downstream:Lzj/a;
    ...
    .line 12
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->downstream:Lzj/a;

    invoke-interface {v0, p0}, Lsj/o;->onSubscribe(Lym/e;)V
...
.method public poll()Ljava/lang/Object;
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->queue:Lzj/o;
    ...
    .line 6
    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Lym/e;

    invoke-interface {v3, v1, v2}, Lym/e;->request(J)V
...
.method public runAsync()V
    ...
    .line 2
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->queue:Lzj/o;
    ...
    .line 7
    :try_start_0
    invoke-interface {v1}, Lzj/o;->poll()Ljava/lang/Object;
    ...
    .line 8
    :goto_2
    invoke-virtual {p0, v11, v13, v0}, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->checkTerminated(ZZLym/d;)Z
    ...
    .line 9
    :cond_4
    invoke-interface {v0, v12}, Lzj/a;->tryOnNext(Ljava/lang/Object;)Z
    ...
    .line 11
    iget-object v10, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Lym/e;

    invoke-interface {v10, v4, v5}, Lym/e;->request(J)V
    ...
    .line 16
    invoke-interface {v0, v2}, Lym/d;->onError(Ljava/lang/Throwable;)V

    .line 17
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->worker:Lsj/h0$c;
    ...
    invoke-virtual {p0, v8, v9, v0}, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->checkTerminated(ZZLym/d;)Z
...
.method public runBackfused()V
    ...
    .line 3
    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->downstream:Lzj/a;

    const/4 v4, 0x0

    invoke-interface {v3, v4}, Lym/d;->onNext(Ljava/lang/Object;)V
    ...
    .line 6
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->downstream:Lzj/a;
...
.method public runSync()V
    ...
    .line 10
    :cond_3
    invoke-interface {v0, v8}, Lzj/a;->tryOnNext(Ljava/lang/Object;)Z
    ...
    .line 13
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Lym/e;

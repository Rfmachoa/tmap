...
.field public static final p:[Lio/reactivex/internal/operators/flowable/FlowableCache$CacheSubscription;
...
.field public final g:Lio/reactivex/internal/operators/flowable/FlowableCache$a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lio/reactivex/internal/operators/flowable/FlowableCache$a<",
            "TT;>;"
...
.field public h:Lio/reactivex/internal/operators/flowable/FlowableCache$a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lio/reactivex/internal/operators/flowable/FlowableCache$a<",
            "TT;>;"
...
.method public static constructor <clinit>()V
    ...
    .line 1
    sput-object v1, Lio/reactivex/internal/operators/flowable/FlowableCache;->l:[Lio/reactivex/internal/operators/flowable/FlowableCache$CacheSubscription;

    new-array v0, v0, [Lio/reactivex/internal/operators/flowable/FlowableCache$CacheSubscription;

    .line 2
    sput-object v0, Lio/reactivex/internal/operators/flowable/FlowableCache;->p:[Lio/reactivex/internal/operators/flowable/FlowableCache$CacheSubscription;
...
.method public constructor <init>(Lkh/j;I)V
    ...
    .line 2
    iput p2, p0, Lio/reactivex/internal/operators/flowable/FlowableCache;->d:I
    ...
    sget-object p2, Lio/reactivex/internal/operators/flowable/FlowableCache;->l:[Lio/reactivex/internal/operators/flowable/FlowableCache$CacheSubscription;

    invoke-direct {p1, p2}, Ljava/util/concurrent/atomic/AtomicReference;-><init>(Ljava/lang/Object;)V

    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableCache;->e:Ljava/util/concurrent/atomic/AtomicReference;
...
# virtual methods
.method public I8(Lio/reactivex/internal/operators/flowable/FlowableCache$CacheSubscription;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    sget-object v1, Lio/reactivex/internal/operators/flowable/FlowableCache;->p:[Lio/reactivex/internal/operators/flowable/FlowableCache$CacheSubscription;
...
.method public J8()J
    ...
    .line 1
    iget-wide v0, p0, Lio/reactivex/internal/operators/flowable/FlowableCache;->f:J
...
.method public L8()Z
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableCache;->c:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public M8(Lio/reactivex/internal/operators/flowable/FlowableCache$CacheSubscription;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public N8(Lio/reactivex/internal/operators/flowable/FlowableCache$CacheSubscription;)V
    .locals 17
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 6
    iget-object v7, v1, Lio/reactivex/internal/operators/flowable/FlowableCache$CacheSubscription;->downstream:Lok/d;
    ...
    :cond_1
    :goto_0
    iget-boolean v11, v0, Lio/reactivex/internal/operators/flowable/FlowableCache;->k:Z

    .line 9
    iget-wide v12, v0, Lio/reactivex/internal/operators/flowable/FlowableCache;->f:J
    ...
    .line 11
    iget-object v1, v0, Lio/reactivex/internal/operators/flowable/FlowableCache;->j:Ljava/lang/Throwable;

    if-eqz v1, :cond_3

    .line 12
    invoke-interface {v7, v1}, Lok/d;->onError(Ljava/lang/Throwable;)V

    goto :goto_2

    .line 13
    :cond_3
    invoke-interface {v7}, Lok/d;->onComplete()V
    ...
    invoke-interface {v7, v11}, Lok/d;->onNext(Ljava/lang/Object;)V
...
.method public g6(Lok/d;)V
    ...
    invoke-direct {v0, p1, p0}, Lio/reactivex/internal/operators/flowable/FlowableCache$CacheSubscription;-><init>(Lok/d;Lio/reactivex/internal/operators/flowable/FlowableCache;)V

    .line 2
    invoke-interface {p1, v0}, Lok/d;->onSubscribe(Lok/e;)V

    .line 3
    invoke-virtual {p0, v0}, Lio/reactivex/internal/operators/flowable/FlowableCache;->I8(Lio/reactivex/internal/operators/flowable/FlowableCache$CacheSubscription;)V
    ...
    invoke-virtual {p1, p0}, Lkh/j;->f6(Lkh/o;)V

    goto :goto_0

    .line 6
    :cond_0
    invoke-virtual {p0, v0}, Lio/reactivex/internal/operators/flowable/FlowableCache;->N8(Lio/reactivex/internal/operators/flowable/FlowableCache$CacheSubscription;)V
...
.method public onComplete()V
    ...
    .line 1
    iput-boolean v0, p0, Lio/reactivex/internal/operators/flowable/FlowableCache;->k:Z
    ...
    .line 3
    invoke-virtual {p0, v3}, Lio/reactivex/internal/operators/flowable/FlowableCache;->N8(Lio/reactivex/internal/operators/flowable/FlowableCache$CacheSubscription;)V
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    .line 1
    iget-boolean v0, p0, Lio/reactivex/internal/operators/flowable/FlowableCache;->k:Z
    ...
    .line 3
    :cond_0
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableCache;->j:Ljava/lang/Throwable;

    const/4 p1, 0x1

    .line 4
    iput-boolean p1, p0, Lio/reactivex/internal/operators/flowable/FlowableCache;->k:Z

    .line 5
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableCache;->e:Ljava/util/concurrent/atomic/AtomicReference;

    sget-object v0, Lio/reactivex/internal/operators/flowable/FlowableCache;->p:[Lio/reactivex/internal/operators/flowable/FlowableCache$CacheSubscription;
    ...
    .line 6
    invoke-virtual {p0, v2}, Lio/reactivex/internal/operators/flowable/FlowableCache;->N8(Lio/reactivex/internal/operators/flowable/FlowableCache$CacheSubscription;)V
...
.method public onNext(Ljava/lang/Object;)V
    ...
    .line 1
    iget v0, p0, Lio/reactivex/internal/operators/flowable/FlowableCache;->i:I
    ...
    .line 5
    iput v3, p0, Lio/reactivex/internal/operators/flowable/FlowableCache;->i:I

    .line 6
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableCache;->h:Lio/reactivex/internal/operators/flowable/FlowableCache$a;
    ...
    .line 7
    iput-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableCache;->h:Lio/reactivex/internal/operators/flowable/FlowableCache$a;

    goto :goto_0

    .line 8
    :cond_0
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableCache;->h:Lio/reactivex/internal/operators/flowable/FlowableCache$a;
    ...
    .line 9
    iput v0, p0, Lio/reactivex/internal/operators/flowable/FlowableCache;->i:I
    ...
    iput-wide v0, p0, Lio/reactivex/internal/operators/flowable/FlowableCache;->f:J
    ...
    .line 12
    invoke-virtual {p0, v1}, Lio/reactivex/internal/operators/flowable/FlowableCache;->N8(Lio/reactivex/internal/operators/flowable/FlowableCache$CacheSubscription;)V

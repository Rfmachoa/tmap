...
.field public final n1:Lwj/h0$c;
...
.field public q1:Lio/reactivex/disposables/b;

.field public volatile r1:Z


# direct methods
.method public constructor <init>(Lwj/g0;JJLjava/util/concurrent/TimeUnit;Lwj/h0$c;I)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-wide p2, p0, Lio/reactivex/internal/operators/observable/x1$c;->k1:J

    .line 3
    iput-wide p4, p0, Lio/reactivex/internal/operators/observable/x1$c;->l1:J

    .line 4
    iput-object p6, p0, Lio/reactivex/internal/operators/observable/x1$c;->m1:Ljava/util/concurrent/TimeUnit;

    .line 5
    iput-object p7, p0, Lio/reactivex/internal/operators/observable/x1$c;->n1:Lwj/h0$c;

    .line 6
    iput p8, p0, Lio/reactivex/internal/operators/observable/x1$c;->o1:I
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/x1$c;->p1:Ljava/util/List;
...
.method public k()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/x1$c;->n1:Lwj/h0$c;
...
.method public l()V
    ...
    .line 3
    iget-object v2, p0, Lio/reactivex/internal/operators/observable/x1$c;->p1:Ljava/util/List;
    ...
    :cond_0
    :goto_0
    iget-boolean v5, p0, Lio/reactivex/internal/operators/observable/x1$c;->r1:Z

    if-eqz v5, :cond_1

    .line 5
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/x1$c;->q1:Lio/reactivex/disposables/b;
    ...
    .line 24
    :cond_8
    iget v5, p0, Lio/reactivex/internal/operators/observable/x1$c;->o1:I
    ...
    .line 27
    iget-object v6, p0, Lio/reactivex/internal/operators/observable/x1$c;->n1:Lwj/h0$c;
    ...
    iget-wide v8, p0, Lio/reactivex/internal/operators/observable/x1$c;->k1:J

    iget-object v5, p0, Lio/reactivex/internal/operators/observable/x1$c;->m1:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v6, v7, v8, v9, v5}, Lwj/h0$c;->c(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/reactivex/disposables/b;
    ...
    .line 31
    iput-boolean v3, p0, Lio/reactivex/internal/operators/observable/x1$c;->r1:Z
...
.method public onNext(Ljava/lang/Object;)V
    ...
    .line 2
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/x1$c;->p1:Ljava/util/List;
...
.method public onSubscribe(Lio/reactivex/disposables/b;)V
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/x1$c;->q1:Lio/reactivex/disposables/b;
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/x1$c;->q1:Lio/reactivex/disposables/b;
    ...
    .line 5
    :cond_0
    iget p1, p0, Lio/reactivex/internal/operators/observable/x1$c;->o1:I
    ...
    iget-wide v2, p0, Lio/reactivex/internal/operators/observable/x1$c;->k1:J

    iget-object p1, p0, Lio/reactivex/internal/operators/observable/x1$c;->m1:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v0, v1, v2, v3, p1}, Lwj/h0$c;->c(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/reactivex/disposables/b;

    .line 9
    iget-object v4, p0, Lio/reactivex/internal/operators/observable/x1$c;->n1:Lwj/h0$c;

    iget-wide v8, p0, Lio/reactivex/internal/operators/observable/x1$c;->l1:J

    iget-object v10, p0, Lio/reactivex/internal/operators/observable/x1$c;->m1:Ljava/util/concurrent/TimeUnit;
...
.method public run()V
    ...
    .line 1
    iget v0, p0, Lio/reactivex/internal/operators/observable/x1$c;->o1:I

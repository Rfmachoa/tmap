...
.method public constructor <init>(Lsj/g0;Ljava/util/concurrent/Callable;Ljava/util/concurrent/Callable;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/k$b;->o1:Ljava/util/concurrent/atomic/AtomicReference;

    .line 3
    iput-object p2, p0, Lio/reactivex/internal/operators/observable/k$b;->l1:Ljava/util/concurrent/Callable;

    .line 4
    iput-object p3, p0, Lio/reactivex/internal/operators/observable/k$b;->m1:Ljava/util/concurrent/Callable;
...
.method public dispose()V
    ...
    .line 3
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/k$b;->n1:Lio/reactivex/disposables/b;
...
.method public bridge synthetic f(Lsj/g0;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lio/reactivex/internal/operators/observable/k$b;->j(Lsj/g0;Ljava/util/Collection;)V
...
.method public k()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/k$b;->o1:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public l()V
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/k$b;->l1:Ljava/util/concurrent/Callable;
    ...
    .line 2
    :try_start_1
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/k$b;->m1:Ljava/util/concurrent/Callable;
    ...
    .line 6
    iget-object v3, p0, Lio/reactivex/internal/operators/observable/k$b;->o1:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 8
    :try_start_2
    iget-object v3, p0, Lio/reactivex/internal/operators/observable/k$b;->p1:Ljava/util/Collection;
    ...
    .line 10
    :cond_0
    iput-object v0, p0, Lio/reactivex/internal/operators/observable/k$b;->p1:Ljava/util/Collection;
    ...
    .line 13
    invoke-virtual {p0, v3, v0, p0}, Lak/k;->h(Ljava/lang/Object;ZLio/reactivex/disposables/b;)V
    ...
    .line 17
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/k$b;->n1:Lio/reactivex/disposables/b;
...
.method public onComplete()V
    ...
    .line 2
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/k$b;->p1:Ljava/util/Collection;
    ...
    .line 4
    iput-object v1, p0, Lio/reactivex/internal/operators/observable/k$b;->p1:Ljava/util/Collection;
...
.method public onSubscribe(Lio/reactivex/disposables/b;)V
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/k$b;->n1:Lio/reactivex/disposables/b;
    ...
    .line 5
    iput-object v2, p0, Lio/reactivex/internal/operators/observable/k$b;->p1:Ljava/util/Collection;

    .line 6
    :try_start_1
    iget-object v2, p0, Lio/reactivex/internal/operators/observable/k$b;->m1:Ljava/util/concurrent/Callable;
    ...
    .line 10
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/k$b;->o1:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 13
    invoke-interface {v2, p1}, Lsj/e0;->subscribe(Lsj/g0;)V
    ...
    .line 17
    invoke-static {v2, v0}, Lio/reactivex/internal/disposables/EmptyDisposable;->error(Ljava/lang/Throwable;Lsj/g0;)V

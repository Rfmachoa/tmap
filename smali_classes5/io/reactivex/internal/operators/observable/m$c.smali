...
.field public final p1:Lsj/h0$c;
...
# direct methods
.method public constructor <init>(Lsj/g0;Ljava/util/concurrent/Callable;JJLjava/util/concurrent/TimeUnit;Lsj/h0$c;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p2, p0, Lio/reactivex/internal/operators/observable/m$c;->l1:Ljava/util/concurrent/Callable;

    .line 3
    iput-wide p3, p0, Lio/reactivex/internal/operators/observable/m$c;->m1:J

    .line 4
    iput-wide p5, p0, Lio/reactivex/internal/operators/observable/m$c;->n1:J

    .line 5
    iput-object p7, p0, Lio/reactivex/internal/operators/observable/m$c;->o1:Ljava/util/concurrent/TimeUnit;

    .line 6
    iput-object p8, p0, Lio/reactivex/internal/operators/observable/m$c;->p1:Lsj/h0$c;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/m$c;->q1:Ljava/util/List;
...
.method public static synthetic k(Lio/reactivex/internal/operators/observable/m$c;Ljava/lang/Object;ZLio/reactivex/disposables/b;)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Lak/k;->i(Ljava/lang/Object;ZLio/reactivex/disposables/b;)V
...
.method public dispose()V
    ...
    .line 4
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/m$c;->r1:Lio/reactivex/disposables/b;

    invoke-interface {v0}, Lio/reactivex/disposables/b;->dispose()V

    .line 5
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/m$c;->p1:Lsj/h0$c;
...
.method public m()V
    ...
    .line 2
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/m$c;->q1:Ljava/util/List;
...
.method public onComplete()V
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/m$c;->q1:Ljava/util/List;
    ...
    iget-object v3, p0, Lio/reactivex/internal/operators/observable/m$c;->p1:Lsj/h0$c;

    invoke-static {v0, v1, v2, v3, p0}, Lio/reactivex/internal/util/n;->d(Lzj/n;Lsj/g0;ZLio/reactivex/disposables/b;Lio/reactivex/internal/util/j;)V
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    .line 4
    iget-object p1, p0, Lio/reactivex/internal/operators/observable/m$c;->p1:Lsj/h0$c;
...
.method public onSubscribe(Lio/reactivex/disposables/b;)V
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/m$c;->r1:Lio/reactivex/disposables/b;

    .line 3
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/m$c;->l1:Ljava/util/concurrent/Callable;
    ...
    .line 4
    iget-object p1, p0, Lio/reactivex/internal/operators/observable/m$c;->q1:Ljava/util/List;
    ...
    .line 6
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/m$c;->p1:Lsj/h0$c;

    iget-wide v5, p0, Lio/reactivex/internal/operators/observable/m$c;->n1:J

    iget-object v7, p0, Lio/reactivex/internal/operators/observable/m$c;->o1:Ljava/util/concurrent/TimeUnit;
    ...
    iget-wide v2, p0, Lio/reactivex/internal/operators/observable/m$c;->m1:J

    iget-object v0, p0, Lio/reactivex/internal/operators/observable/m$c;->o1:Ljava/util/concurrent/TimeUnit;
...
.method public run()V
    ...
    iget-wide v3, p0, Lio/reactivex/internal/operators/observable/m$c;->m1:J

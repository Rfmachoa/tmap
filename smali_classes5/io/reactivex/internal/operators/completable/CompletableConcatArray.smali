...
.method public constructor <init>([Lwj/g;)V
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/completable/CompletableConcatArray;->a:[Lwj/g;
...
.method public I0(Lwj/d;)V
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/completable/CompletableConcatArray;->a:[Lwj/g;

    invoke-direct {v0, p1, v1}, Lio/reactivex/internal/operators/completable/CompletableConcatArray$ConcatInnerObserver;-><init>(Lwj/d;[Lwj/g;)V
    ...
    invoke-interface {p1, v1}, Lwj/d;->onSubscribe(Lio/reactivex/disposables/b;)V

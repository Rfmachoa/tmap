...
.method public e(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;Lck/a;)Lio/reactivex/internal/schedulers/ScheduledRunnable;
    .locals 3
    .param p4    # Ljava/util/concurrent/TimeUnit;
        .annotation build Lio/reactivex/annotations/NonNull;
        .end annotation
    ...
    invoke-direct {v0, p1, p5}, Lio/reactivex/internal/schedulers/ScheduledRunnable;-><init>(Ljava/lang/Runnable;Lck/a;)V

    if-eqz p5, :cond_0

    .line 3
    invoke-interface {p5, v0}, Lck/a;->b(Lio/reactivex/disposables/b;)Z
    ...
    .line 7
    invoke-interface {p5, v0}, Lck/a;->a(Lio/reactivex/disposables/b;)Z

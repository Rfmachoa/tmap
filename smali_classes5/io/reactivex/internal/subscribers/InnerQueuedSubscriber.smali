...
.field public final parent:Lfk/g;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lfk/g<",
            "TT;>;"
...
.field public volatile queue:Ldk/o;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ldk/o<",
            "TT;>;"
...
# direct methods
.method public constructor <init>(Lfk/g;I)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;->parent:Lfk/g;
...
.method public onComplete()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;->parent:Lfk/g;

    invoke-interface {v0, p0}, Lfk/g;->innerComplete(Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;)V
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    invoke-interface {v0, p0, p1}, Lfk/g;->innerError(Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;Ljava/lang/Throwable;)V
...
.method public onNext(Ljava/lang/Object;)V
    ...
    invoke-interface {v0, p0, p1}, Lfk/g;->innerNext(Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;Ljava/lang/Object;)V

    goto :goto_0

    .line 3
    :cond_0
    iget-object p1, p0, Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;->parent:Lfk/g;

    invoke-interface {p1}, Lfk/g;->drain()V
...
.method public onSubscribe(Lan/e;)V
    ...
    .line 1
    invoke-static {p0, p1}, Lio/reactivex/internal/subscriptions/SubscriptionHelper;->setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lan/e;)Z
    ...
    .line 6
    iput-object v0, p0, Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;->queue:Ldk/o;
    ...
    invoke-interface {p1, p0}, Lfk/g;->innerComplete(Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;)V
...
.method public queue()Ldk/o;
    ...
    iget-object v0, p0, Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;->queue:Ldk/o;
...
.method public requestOne()V
    ...
    invoke-interface {v2, v0, v1}, Lan/e;->request(J)V

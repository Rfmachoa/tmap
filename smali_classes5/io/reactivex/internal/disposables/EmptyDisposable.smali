...
.method public static complete(Lwj/d;)V
    .locals 1

    .line 5
    sget-object v0, Lio/reactivex/internal/disposables/EmptyDisposable;->INSTANCE:Lio/reactivex/internal/disposables/EmptyDisposable;

    invoke-interface {p0, v0}, Lwj/d;->onSubscribe(Lio/reactivex/disposables/b;)V

    .line 6
    invoke-interface {p0}, Lwj/d;->onComplete()V

    return-void
.end method

.method public static complete(Lwj/g0;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p0, v0}, Lwj/g0;->onSubscribe(Lio/reactivex/disposables/b;)V
...
.method public static complete(Lwj/t;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p0, v0}, Lwj/t;->onSubscribe(Lio/reactivex/disposables/b;)V

    .line 4
    invoke-interface {p0}, Lwj/t;->onComplete()V

    return-void
.end method

.method public static error(Ljava/lang/Throwable;Lwj/d;)V
    .locals 1
    ...
    .line 4
    invoke-interface {p1, p0}, Lwj/d;->onError(Ljava/lang/Throwable;)V

    return-void
.end method

.method public static error(Ljava/lang/Throwable;Lwj/g0;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static error(Ljava/lang/Throwable;Lwj/l0;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 6
    invoke-interface {p1, p0}, Lwj/l0;->onError(Ljava/lang/Throwable;)V

    return-void
.end method

.method public static error(Ljava/lang/Throwable;Lwj/t;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 8
    invoke-interface {p1, p0}, Lwj/t;->onError(Ljava/lang/Throwable;)V

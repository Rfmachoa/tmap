...
.method public static complete(Lsj/d;)V
    .locals 1

    .line 5
    sget-object v0, Lio/reactivex/internal/disposables/EmptyDisposable;->INSTANCE:Lio/reactivex/internal/disposables/EmptyDisposable;

    invoke-interface {p0, v0}, Lsj/d;->onSubscribe(Lio/reactivex/disposables/b;)V

    .line 6
    invoke-interface {p0}, Lsj/d;->onComplete()V

    return-void
.end method

.method public static complete(Lsj/g0;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p0, v0}, Lsj/g0;->onSubscribe(Lio/reactivex/disposables/b;)V
...
.method public static complete(Lsj/t;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p0, v0}, Lsj/t;->onSubscribe(Lio/reactivex/disposables/b;)V

    .line 4
    invoke-interface {p0}, Lsj/t;->onComplete()V

    return-void
.end method

.method public static error(Ljava/lang/Throwable;Lsj/d;)V
    .locals 1
    ...
    .line 4
    invoke-interface {p1, p0}, Lsj/d;->onError(Ljava/lang/Throwable;)V

    return-void
.end method

.method public static error(Ljava/lang/Throwable;Lsj/g0;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    invoke-interface {p1, p0}, Lsj/g0;->onError(Ljava/lang/Throwable;)V

    return-void
.end method

.method public static error(Ljava/lang/Throwable;Lsj/l0;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 6
    invoke-interface {p1, p0}, Lsj/l0;->onError(Ljava/lang/Throwable;)V

    return-void
.end method

.method public static error(Ljava/lang/Throwable;Lsj/t;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 8
    invoke-interface {p1, p0}, Lsj/t;->onError(Ljava/lang/Throwable;)V

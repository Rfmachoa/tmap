...
# static fields
.field public static final k0:[Lio/reactivex/processors/MulticastProcessor$MulticastSubscription;

.field public static final u:[Lio/reactivex/processors/MulticastProcessor$MulticastSubscription;
...
.method public static constructor <clinit>()V
    ...
    .line 1
    sput-object v1, Lio/reactivex/processors/MulticastProcessor;->u:[Lio/reactivex/processors/MulticastProcessor$MulticastSubscription;

    new-array v0, v0, [Lio/reactivex/processors/MulticastProcessor$MulticastSubscription;

    .line 2
    sput-object v0, Lio/reactivex/processors/MulticastProcessor;->k0:[Lio/reactivex/processors/MulticastProcessor$MulticastSubscription;
...
.method public constructor <init>(IZ)V
    ...
    sget-object v0, Lio/reactivex/processors/MulticastProcessor;->u:[Lio/reactivex/processors/MulticastProcessor$MulticastSubscription;
...
.method public static O8()Lio/reactivex/processors/MulticastProcessor;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static P8(I)Lio/reactivex/processors/MulticastProcessor;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static Q8(IZ)Lio/reactivex/processors/MulticastProcessor;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static R8(Z)Lio/reactivex/processors/MulticastProcessor;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public N8(Lio/reactivex/processors/MulticastProcessor$MulticastSubscription;)Z
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    sget-object v1, Lio/reactivex/processors/MulticastProcessor;->k0:[Lio/reactivex/processors/MulticastProcessor$MulticastSubscription;
...
.method public S8()V
    ...
    :cond_1
    :goto_0
    iget-object v7, v1, Lio/reactivex/processors/MulticastProcessor;->i:Lrh/o;
    ...
    .line 14
    sget-object v11, Lio/reactivex/processors/MulticastProcessor;->k0:[Lio/reactivex/processors/MulticastProcessor$MulticastSubscription;

    if-ne v0, v11, :cond_6

    .line 15
    invoke-interface {v7}, Lrh/o;->clear()V
    ...
    .line 17
    :try_start_0
    invoke-interface {v7}, Lrh/o;->poll()Ljava/lang/Object;
    ...
    .line 23
    sget-object v3, Lio/reactivex/processors/MulticastProcessor;->k0:[Lio/reactivex/processors/MulticastProcessor$MulticastSubscription;
    ...
    .line 25
    :cond_9
    sget-object v0, Lio/reactivex/processors/MulticastProcessor;->k0:[Lio/reactivex/processors/MulticastProcessor$MulticastSubscription;
    ...
    invoke-interface {v0, v9, v10}, Lok/e;->request(J)V
    ...
    .line 31
    sget-object v10, Lio/reactivex/processors/MulticastProcessor;->k0:[Lio/reactivex/processors/MulticastProcessor$MulticastSubscription;
...
.method public T8(Ljava/lang/Object;)Z
    ...
    .line 4
    iget-object v0, p0, Lio/reactivex/processors/MulticastProcessor;->i:Lrh/o;
    ...
    .line 5
    invoke-virtual {p0}, Lio/reactivex/processors/MulticastProcessor;->S8()V
...
.method public U8(Lio/reactivex/processors/MulticastProcessor$MulticastSubscription;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    sget-object v2, Lio/reactivex/processors/MulticastProcessor;->k0:[Lio/reactivex/processors/MulticastProcessor$MulticastSubscription;
    ...
    sget-object v2, Lio/reactivex/processors/MulticastProcessor;->u:[Lio/reactivex/processors/MulticastProcessor$MulticastSubscription;
...
.method public V8()V
    ...
    invoke-static {v0, v1}, Lio/reactivex/internal/subscriptions/SubscriptionHelper;->setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lok/e;)Z
    ...
    iput-object v0, p0, Lio/reactivex/processors/MulticastProcessor;->i:Lrh/o;
...
.method public g6(Lok/d;)V
    ...
    invoke-direct {v0, p1, p0}, Lio/reactivex/processors/MulticastProcessor$MulticastSubscription;-><init>(Lok/d;Lio/reactivex/processors/MulticastProcessor;)V

    .line 2
    invoke-interface {p1, v0}, Lok/d;->onSubscribe(Lok/e;)V

    .line 3
    invoke-virtual {p0, v0}, Lio/reactivex/processors/MulticastProcessor;->N8(Lio/reactivex/processors/MulticastProcessor$MulticastSubscription;)Z
    ...
    .line 5
    invoke-virtual {p0, v0}, Lio/reactivex/processors/MulticastProcessor;->U8(Lio/reactivex/processors/MulticastProcessor$MulticastSubscription;)V

...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lpi/u;->a:Lcz/msebera/android/httpclient/extras/b;
...
# virtual methods
.method public a(Lph/t;Lbj/g;)Ljava/net/URI;
    .locals 6
    ...
    .line 4
    iget-object v1, p0, Lpi/u;->a:Lcz/msebera/android/httpclient/extras/b;
    ...
    .line 9
    invoke-interface {p1, v0}, Lzi/i;->isParameterTrue(Ljava/lang/String;)Z
    ...
    .line 11
    invoke-static {v0, v4}, Lcj/b;->e(Ljava/lang/Object;Ljava/lang/String;)V

    const-string v4, "http.request"

    .line 12
    invoke-interface {p2, v4}, Lbj/g;->getAttribute(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-interface {v4}, Lph/q;->getRequestLine()Lph/a0;

    move-result-object v4

    invoke-interface {v4}, Lph/a0;->getUri()Ljava/lang/String;
    ...
    .line 14
    invoke-static {v5, v0, v3}, Lzh/i;->j(Ljava/net/URI;Lcz/msebera/android/httpclient/HttpHost;Z)Ljava/net/URI;

    move-result-object v0

    .line 15
    invoke-static {v0, v1}, Lzh/i;->f(Ljava/net/URI;Ljava/net/URI;)Ljava/net/URI;
    ...
    .line 18
    invoke-interface {p1, v0}, Lzi/i;->isParameterFalse(Ljava/lang/String;)Z
    ...
    .line 27
    invoke-static {v1, p1, v3}, Lzh/i;->j(Ljava/net/URI;Lcz/msebera/android/httpclient/HttpHost;Z)Ljava/net/URI;
    ...
    .line 29
    :goto_1
    invoke-virtual {v0, p1}, Lpi/q0;->c(Ljava/net/URI;)Z
    ...
    .line 30
    invoke-virtual {v0, p1}, Lpi/q0;->a(Ljava/net/URI;)V

...
.field public static final h:Ldi/m;
...
.method public constructor <init>(Ljavax/net/ssl/SSLContext;)V
    ...
    .line 1
    sget-object v0, Ldi/f;->i:Ldi/m;

    invoke-direct {p0, p1, v0}, Ldi/f;-><init>(Ljavax/net/ssl/SSLContext;Ldi/m;)V
...
.method public constructor <init>(Ljavax/net/ssl/SSLContext;Ldi/m;)V
    ...
    invoke-direct {p0, p1, v0, v0, p2}, Ldi/f;-><init>(Ljavax/net/ssl/SSLSocketFactory;[Ljava/lang/String;[Ljava/lang/String;Ldi/m;)V
...
.method public constructor <init>(Ljavax/net/ssl/SSLContext;[Ljava/lang/String;[Ljava/lang/String;Ldi/m;)V
    ...
    invoke-direct {p0, p1, p2, p3, p4}, Ldi/f;-><init>(Ljavax/net/ssl/SSLSocketFactory;[Ljava/lang/String;[Ljava/lang/String;Ldi/m;)V
...
.method public constructor <init>(Ljavax/net/ssl/SSLSocketFactory;[Ljava/lang/String;[Ljava/lang/String;Ldi/m;)V
    ...
    iput-object p1, p0, Ldi/f;->a:Ljavax/net/ssl/SSLSocketFactory;

    .line 7
    iput-object p2, p0, Ldi/f;->c:[Ljava/lang/String;

    .line 8
    iput-object p3, p0, Ldi/f;->d:[Ljava/lang/String;
    ...
    .line 9
    :cond_0
    sget-object p4, Ldi/f;->i:Ldi/m;

    :goto_0
    iput-object p4, p0, Ldi/f;->b:Ldi/m;

    return-void
.end method

.method public static b()Ldi/f;
    .locals 3
    ...
    sget-object v2, Ldi/f;->i:Ldi/m;

    invoke-direct {v0, v1, v2}, Ldi/f;-><init>(Ljavax/net/ssl/SSLContext;Ldi/m;)V

    return-object v0
.end method

.method public static c()Ldi/f;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcz/msebera/android/httpclient/conn/ssl/SSLInitializationException;
    ...
    invoke-static {v2}, Ldi/f;->e(Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-static {v3}, Ldi/f;->e(Ljava/lang/String;)[Ljava/lang/String;

    move-result-object v3

    sget-object v4, Ldi/f;->i:Ldi/m;

    invoke-direct {v0, v1, v2, v3, v4}, Ldi/f;-><init>(Ljavax/net/ssl/SSLSocketFactory;[Ljava/lang/String;[Ljava/lang/String;Ldi/m;)V
...
# virtual methods
.method public a()Ldi/m;
    .locals 1

    iget-object v0, p0, Ldi/f;->b:Ldi/m;
...
.method public g(ILjava/net/Socket;Lcz/msebera/android/httpclient/HttpHost;Ljava/net/InetSocketAddress;Ljava/net/InetSocketAddress;Lxi/g;)Ljava/net/Socket;
    ...
    .line 3
    :cond_0
    invoke-virtual {p0, p6}, Ldi/f;->f(Lxi/g;)Ljava/net/Socket;
    ...
    invoke-virtual {p0, p1, p3}, Ldi/f;->i(Ljavax/net/ssl/SSLSocket;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p2, p1, p3, p6}, Ldi/f;->h(Ljava/net/Socket;Ljava/lang/String;ILxi/g;)Ljava/net/Socket;
...
.method public h(Ljava/net/Socket;Ljava/lang/String;ILxi/g;)Ljava/net/Socket;
    ...
    .line 1
    iget-object p4, p0, Ldi/f;->a:Ljavax/net/ssl/SSLSocketFactory;
    ...
    .line 2
    iget-object p3, p0, Ldi/f;->c:[Ljava/lang/String;
    ...
    .line 10
    :goto_1
    iget-object p3, p0, Ldi/f;->d:[Ljava/lang/String;
    ...
    .line 12
    :cond_3
    invoke-virtual {p0, p1}, Ldi/f;->d(Ljavax/net/ssl/SSLSocket;)V

    .line 13
    invoke-virtual {p1}, Ljavax/net/ssl/SSLSocket;->startHandshake()V

    .line 14
    invoke-virtual {p0, p1, p2}, Ldi/f;->i(Ljavax/net/ssl/SSLSocket;Ljava/lang/String;)V

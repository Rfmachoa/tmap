...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lmf/f;->a:Lcz/msebera/android/httpclient/extras/b;
...
# virtual methods
.method public final a(Lcz/msebera/android/httpclient/HttpHost;Lef/c;Lef/h;Lgf/g;)V
    .locals 4
    ...
    .line 2
    iget-object v1, p0, Lmf/f;->a:Lcz/msebera/android/httpclient/extras/b;
    ...
    sget-object v2, Lef/g;->g:Ljava/lang/String;

    invoke-direct {v1, p1, v2, v0}, Lef/g;-><init>(Lcz/msebera/android/httpclient/HttpHost;Ljava/lang/String;Ljava/lang/String;)V

    .line 5
    invoke-interface {p4, v1}, Lgf/g;->b(Lef/g;)Lef/j;
    ...
    invoke-virtual {p3, p4}, Lef/h;->m(Lcz/msebera/android/httpclient/auth/AuthProtocolState;)V
    ...
    .line 9
    :goto_0
    invoke-virtual {p3, p2, p1}, Lef/h;->n(Lef/c;Lef/j;)V

    goto :goto_1

    .line 10
    :cond_2
    iget-object p1, p0, Lmf/f;->a:Lcz/msebera/android/httpclient/extras/b;
...
.method public e(Ldf/q;Lpg/g;)V
    ...
    .line 4
    invoke-virtual {p1}, Lmf/c;->m()Lgf/a;
    ...
    .line 6
    :cond_0
    invoke-virtual {p1}, Lmf/c;->s()Lgf/g;
    ...
    .line 8
    :cond_1
    invoke-virtual {p1}, Lmf/c;->t()Lcz/msebera/android/httpclient/conn/routing/RouteInfo;
    ...
    .line 10
    :cond_2
    invoke-virtual {p1}, Lpg/h;->h()Lcz/msebera/android/httpclient/HttpHost;
    ...
    .line 18
    invoke-virtual {v3}, Lef/h;->e()Lcz/msebera/android/httpclient/auth/AuthProtocolState;
    ...
    .line 19
    invoke-interface {p2, v2}, Lgf/a;->c(Lcz/msebera/android/httpclient/HttpHost;)Lef/c;
    ...
    .line 20
    invoke-virtual {p0, v2, v4, v3, v0}, Lmf/f;->a(Lcz/msebera/android/httpclient/HttpHost;Lef/c;Lef/h;Lgf/g;)V
    ...
    .line 23
    invoke-virtual {p1}, Lef/h;->e()Lcz/msebera/android/httpclient/auth/AuthProtocolState;
    ...
    .line 24
    invoke-interface {p2, v1}, Lgf/a;->c(Lcz/msebera/android/httpclient/HttpHost;)Lef/c;
    ...
    .line 25
    invoke-virtual {p0, v1, p2, p1, v0}, Lmf/f;->a(Lcz/msebera/android/httpclient/HttpHost;Lef/c;Lef/h;Lgf/g;)V

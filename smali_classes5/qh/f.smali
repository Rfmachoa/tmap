...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lqh/f;->a:Lcz/msebera/android/httpclient/extras/b;
...
# virtual methods
.method public final a(Lcz/msebera/android/httpclient/HttpHost;Lih/c;Lih/h;Lkh/g;)V
    .locals 4
    ...
    .line 2
    iget-object v1, p0, Lqh/f;->a:Lcz/msebera/android/httpclient/extras/b;
    ...
    sget-object v2, Lih/g;->g:Ljava/lang/String;

    invoke-direct {v1, p1, v2, v0}, Lih/g;-><init>(Lcz/msebera/android/httpclient/HttpHost;Ljava/lang/String;Ljava/lang/String;)V

    .line 5
    invoke-interface {p4, v1}, Lkh/g;->b(Lih/g;)Lih/j;
    ...
    invoke-virtual {p3, p4}, Lih/h;->m(Lcz/msebera/android/httpclient/auth/AuthProtocolState;)V
    ...
    .line 9
    :goto_0
    invoke-virtual {p3, p2, p1}, Lih/h;->n(Lih/c;Lih/j;)V

    goto :goto_1

    .line 10
    :cond_2
    iget-object p1, p0, Lqh/f;->a:Lcz/msebera/android/httpclient/extras/b;
...
.method public e(Lhh/q;Lti/g;)V
    ...
    .line 4
    invoke-virtual {p1}, Lqh/c;->m()Lkh/a;
    ...
    .line 6
    :cond_0
    invoke-virtual {p1}, Lqh/c;->s()Lkh/g;
    ...
    .line 8
    :cond_1
    invoke-virtual {p1}, Lqh/c;->t()Lcz/msebera/android/httpclient/conn/routing/RouteInfo;
    ...
    .line 10
    :cond_2
    invoke-virtual {p1}, Lti/h;->h()Lcz/msebera/android/httpclient/HttpHost;
    ...
    .line 18
    invoke-virtual {v3}, Lih/h;->e()Lcz/msebera/android/httpclient/auth/AuthProtocolState;
    ...
    .line 19
    invoke-interface {p2, v2}, Lkh/a;->c(Lcz/msebera/android/httpclient/HttpHost;)Lih/c;
    ...
    .line 20
    invoke-virtual {p0, v2, v4, v3, v0}, Lqh/f;->a(Lcz/msebera/android/httpclient/HttpHost;Lih/c;Lih/h;Lkh/g;)V
    ...
    .line 24
    invoke-interface {p2, v1}, Lkh/a;->c(Lcz/msebera/android/httpclient/HttpHost;)Lih/c;
    ...
    .line 25
    invoke-virtual {p0, v1, p2, p1, v0}, Lqh/f;->a(Lcz/msebera/android/httpclient/HttpHost;Lih/c;Lih/h;Lkh/g;)V

...
.method public static p(Ljava/util/UUID;Ljava/util/UUID;Ljava/util/UUID;)Z
    .locals 6
...
.method public static q(Landroid/os/ParcelUuid;Landroid/os/ParcelUuid;Ljava/util/List;)Z
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v4, v3, v2}, Lno/nordicsemi/android/support/v18/scanner/ScanFilter;->p(Ljava/util/UUID;Ljava/util/UUID;Ljava/util/UUID;)Z
...
.method public equals(Ljava/lang/Object;)Z
    ...
    .line 5
    invoke-static {v2, v3}, Lyj/f;->a(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    .line 11
    invoke-static {v2, p1}, Lyj/f;->b(Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method public n(Lno/nordicsemi/android/support/v18/scanner/ScanResult;)Z
    .locals 4
    ...
    .line 8
    invoke-virtual {p1}, Lyj/i;->i()Ljava/util/List;

    move-result-object v3

    .line 9
    invoke-static {v1, v2, v3}, Lno/nordicsemi/android/support/v18/scanner/ScanFilter;->q(Landroid/os/ParcelUuid;Landroid/os/ParcelUuid;Ljava/util/List;)Z
    ...
    .line 12
    invoke-virtual {p1, v1}, Lyj/i;->h(Landroid/os/ParcelUuid;)[B

    move-result-object v1

    .line 13
    invoke-virtual {p0, v2, v3, v1}, Lno/nordicsemi/android/support/v18/scanner/ScanFilter;->o([B[B[B)Z
    ...
    .line 16
    invoke-virtual {p1, v1}, Lyj/i;->f(I)[B

    move-result-object p1

    .line 17
    invoke-virtual {p0, v2, v3, p1}, Lno/nordicsemi/android/support/v18/scanner/ScanFilter;->o([B[B[B)Z

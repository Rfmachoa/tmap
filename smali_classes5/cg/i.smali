...
# static fields
.field public static final a:Lcg/i;
...
.method public a(Ldf/t;Lpg/g;)Z
    ...
    .line 6
    :cond_0
    invoke-virtual {p0, p1}, Lcg/i;->b(Ldf/t;)Z
    ...
    .line 11
    invoke-interface {p1, v0}, Ldf/p;->headerIterator(Ljava/lang/String;)Ldf/g;
    ...
    .line 15
    :try_start_1
    invoke-virtual {p0, v0}, Lcg/i;->c(Ldf/g;)Ldf/c0;
    ...
    :cond_4
    :goto_0
    invoke-interface {p1}, Ldf/c0;->hasNext()Z
    ...
    .line 17
    invoke-interface {p1}, Ldf/c0;->nextToken()Ljava/lang/String;
...
.method public c(Ldf/g;)Ldf/c0;
    .locals 1

    .line 1
    new-instance v0, Lmg/m;

    invoke-direct {v0, p1}, Lmg/m;-><init>(Ldf/g;)V

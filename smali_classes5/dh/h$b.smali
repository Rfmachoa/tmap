...
.method public constructor <init>(Ljava/io/File;[BZ)V
    ...
    .line 4
    :try_start_0
    invoke-static {}, Ldh/h;->a()Ljavax/crypto/Cipher;
    ...
    .line 8
    :goto_3
    iput-boolean p3, p0, Ldh/h$b;->a:Z

    .line 9
    iput-object v0, p0, Ldh/h$b;->b:Ljavax/crypto/Cipher;

    .line 10
    iput-object v1, p0, Ldh/h$b;->c:Ljavax/crypto/spec/SecretKeySpec;
    ...
    :cond_4
    iput-object v2, p0, Ldh/h$b;->d:Ljava/security/SecureRandom;
    ...
    iput-object p2, p0, Ldh/h$b;->e:Lcom/tmapmobility/tmap/exoplayer2/util/b;
...
.method public a()Z
    ...
    .line 1
    iget-object v0, p0, Ldh/h$b;->e:Lcom/tmapmobility/tmap/exoplayer2/util/b;
...
.method public b(Ldh/g;)V
    .locals 0

    const/4 p1, 0x1

    .line 1
    iput-boolean p1, p0, Ldh/h$b;->f:Z
...
.method public c(Ljava/util/HashMap;)V
    ...
    .line 1
    iget-boolean v0, p0, Ldh/h$b;->f:Z
    ...
    .line 2
    :cond_0
    invoke-virtual {p0, p1}, Ldh/h$b;->e(Ljava/util/HashMap;)V
...
.method public e(Ljava/util/HashMap;)V
    ...
    .line 1
    invoke-virtual {p0, p1}, Ldh/h$b;->l(Ljava/util/HashMap;)V
...
.method public g(Ljava/util/HashMap;Landroid/util/SparseArray;)V
    ...
    .line 2
    invoke-virtual {p0, p1, p2}, Ldh/h$b;->j(Ljava/util/HashMap;Landroid/util/SparseArray;)Z
    ...
    .line 5
    iget-object p1, p0, Ldh/h$b;->e:Lcom/tmapmobility/tmap/exoplayer2/util/b;
...
.method public final h(Ldh/g;I)I
    .locals 4

    .line 1
    iget v0, p1, Ldh/g;->a:I

    mul-int/lit8 v0, v0, 0x1f

    .line 2
    iget-object v1, p1, Ldh/g;->b:Ljava/lang/String;
    ...
    invoke-static {p1}, Ldh/i;->d(Ldh/i;)J
    ...
    invoke-virtual {p1}, Ldh/k;->hashCode()I
...
.method public final i(ILjava/io/DataInputStream;)Ldh/g;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-direct {v2}, Ldh/j;-><init>()V

    .line 5
    invoke-static {v2, p1, p2}, Ldh/j;->h(Ldh/j;J)Ldh/j;

    .line 6
    sget-object p1, Ldh/k;->f:Ldh/k;

    invoke-virtual {p1, v2}, Ldh/k;->h(Ldh/j;)Ldh/k;
    ...
    .line 7
    :cond_0
    invoke-static {p2}, Ldh/h;->b(Ljava/io/DataInputStream;)Ldh/k;

    move-result-object p1

    .line 8
    :goto_0
    new-instance p2, Ldh/g;

    invoke-direct {p2, v0, v1, p1}, Ldh/g;-><init>(ILjava/lang/String;Ldh/k;)V
...
.method public final j(Ljava/util/HashMap;Landroid/util/SparseArray;)Z
    ...
    iget-object v4, p0, Ldh/h$b;->e:Lcom/tmapmobility/tmap/exoplayer2/util/b;
    ...
    .line 6
    iget-object v6, p0, Ldh/h$b;->b:Ljavax/crypto/Cipher;
    :try_end_1
    ...
    iget-object v8, p0, Ldh/h$b;->c:Ljavax/crypto/spec/SecretKeySpec;
    ...
    iget-object v7, p0, Ldh/h$b;->b:Ljavax/crypto/Cipher;
    ...
    .line 13
    :cond_3
    iget-boolean v3, p0, Ldh/h$b;->a:Z

    if-eqz v3, :cond_4

    .line 14
    iput-boolean v1, p0, Ldh/h$b;->f:Z
    ...
    .line 16
    invoke-virtual {p0, v0, v4}, Ldh/h$b;->i(ILjava/io/DataInputStream;)Ldh/g;

    move-result-object v7

    .line 17
    iget-object v8, v7, Ldh/g;->b:Ljava/lang/String;

    invoke-virtual {p1, v8, v7}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 18
    iget v8, v7, Ldh/g;->a:I

    iget-object v9, v7, Ldh/g;->b:Ljava/lang/String;

    invoke-virtual {p2, v8, v9}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    .line 19
    invoke-virtual {p0, v7, v0}, Ldh/h$b;->h(Ldh/g;I)I
...
.method public final k(Ldh/g;Ljava/io/DataOutputStream;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 2
    iget-object v0, p1, Ldh/g;->b:Ljava/lang/String;
    ...
    invoke-static {p1, p2}, Ldh/h;->c(Ldh/k;Ljava/io/DataOutputStream;)V
...
.method public final l(Ljava/util/HashMap;)V
    ...
    .line 1
    :try_start_0
    iget-object v1, p0, Ldh/h$b;->e:Lcom/tmapmobility/tmap/exoplayer2/util/b;
    ...
    .line 2
    iget-object v2, p0, Ldh/h$b;->g:Ldh/o;

    if-nez v2, :cond_0

    .line 3
    new-instance v2, Ldh/o;

    invoke-direct {v2, v1}, Ldh/o;-><init>(Ljava/io/OutputStream;)V

    iput-object v2, p0, Ldh/h$b;->g:Ldh/o;

    goto :goto_0

    .line 4
    :cond_0
    invoke-virtual {v2, v1}, Ldh/o;->a(Ljava/io/OutputStream;)V

    .line 5
    :goto_0
    iget-object v1, p0, Ldh/h$b;->g:Ldh/o;
    ...
    .line 8
    iget-boolean v4, p0, Ldh/h$b;->a:Z
    ...
    .line 11
    iget-object v7, p0, Ldh/h$b;->d:Ljava/security/SecureRandom;
    ...
    .line 14
    :try_start_2
    iget-object v4, p0, Ldh/h$b;->b:Ljavax/crypto/Cipher;
    ...
    .line 21
    invoke-virtual {p0, v1, v2}, Ldh/h$b;->k(Ldh/g;Ljava/io/DataOutputStream;)V

    .line 22
    invoke-virtual {p0, v1, v3}, Ldh/h$b;->h(Ldh/g;I)I

...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lyh/f;->a:Lcz/msebera/android/httpclient/extras/b;
...
# virtual methods
.method public final a(Lcz/msebera/android/httpclient/HttpHost;Lqh/c;Lqh/h;Lsh/g;)V
    .locals 4
    ...
    .line 2
    iget-object v1, p0, Lyh/f;->a:Lcz/msebera/android/httpclient/extras/b;
    ...
    sget-object v2, Lqh/g;->g:Ljava/lang/String;

    invoke-direct {v1, p1, v2, v0}, Lqh/g;-><init>(Lcz/msebera/android/httpclient/HttpHost;Ljava/lang/String;Ljava/lang/String;)V

    .line 5
    invoke-interface {p4, v1}, Lsh/g;->a(Lqh/g;)Lqh/j;
    ...
    invoke-virtual {p3, p4}, Lqh/h;->m(Lcz/msebera/android/httpclient/auth/AuthProtocolState;)V
    ...
    .line 9
    :goto_0
    invoke-virtual {p3, p2, p1}, Lqh/h;->o(Lqh/c;Lqh/j;)V

    goto :goto_1

    .line 10
    :cond_2
    iget-object p1, p0, Lyh/f;->a:Lcz/msebera/android/httpclient/extras/b;
...
.method public b(Lph/q;Lbj/g;)V
    ...
    .line 4
    invoke-virtual {p1}, Lyh/c;->m()Lsh/a;
    ...
    .line 6
    :cond_0
    invoke-virtual {p1}, Lyh/c;->s()Lsh/g;
    ...
    .line 8
    :cond_1
    invoke-virtual {p1}, Lyh/c;->t()Lcz/msebera/android/httpclient/conn/routing/RouteInfo;
    ...
    .line 10
    :cond_2
    invoke-virtual {p1}, Lbj/h;->h()Lcz/msebera/android/httpclient/HttpHost;
    ...
    .line 17
    :cond_4
    invoke-virtual {p1}, Lyh/c;->y()Lqh/h;
    ...
    .line 18
    invoke-virtual {v3}, Lqh/h;->e()Lcz/msebera/android/httpclient/auth/AuthProtocolState;
    ...
    .line 19
    invoke-interface {p2, v2}, Lsh/a;->c(Lcz/msebera/android/httpclient/HttpHost;)Lqh/c;
    ...
    .line 20
    invoke-virtual {p0, v2, v4, v3, v0}, Lyh/f;->a(Lcz/msebera/android/httpclient/HttpHost;Lqh/c;Lqh/h;Lsh/g;)V
    ...
    .line 22
    invoke-virtual {p1}, Lyh/c;->v()Lqh/h;
    ...
    .line 24
    invoke-interface {p2, v1}, Lsh/a;->c(Lcz/msebera/android/httpclient/HttpHost;)Lqh/c;
    ...
    .line 25
    invoke-virtual {p0, v1, p2, p1, v0}, Lyh/f;->a(Lcz/msebera/android/httpclient/HttpHost;Lqh/c;Lqh/h;Lsh/g;)V

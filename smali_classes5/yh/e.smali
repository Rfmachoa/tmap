...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lyh/e;->a:Lcz/msebera/android/httpclient/extras/b;
...
.method public b(Lph/q;Lbj/g;)V
    ...
    .line 5
    :cond_0
    invoke-static {p2}, Lyh/c;->k(Lbj/g;)Lyh/c;

    move-result-object v0

    .line 6
    invoke-virtual {v0}, Lyh/c;->r()Lsh/f;
    ...
    .line 7
    iget-object p1, p0, Lyh/e;->a:Lcz/msebera/android/httpclient/extras/b;
    ...
    .line 8
    :cond_1
    invoke-virtual {v0}, Lyh/c;->q()Lbi/b;
    ...
    .line 12
    :cond_3
    invoke-virtual {v0}, Lyh/c;->t()Lcz/msebera/android/httpclient/conn/routing/RouteInfo;
    ...
    .line 15
    invoke-virtual {v5}, Luh/c;->f()Ljava/lang/String;
    ...
    .line 16
    :cond_5
    iget-object v6, p0, Lyh/e;->a:Lcz/msebera/android/httpclient/extras/b;
    ...
    invoke-interface {v6}, Lwh/q;->getURI()Ljava/net/URI;
    ...
    invoke-interface {v8}, Lph/a0;->getUri()Ljava/lang/String;
    ...
    .line 26
    :goto_1
    invoke-static {v7}, Lcj/i;->b(Ljava/lang/CharSequence;)Z
    ...
    invoke-direct {v8, v6, v3, v7, v4}, Lji/d;-><init>(Ljava/lang/String;ILjava/lang/String;Z)V

    .line 28
    invoke-interface {v2, v5}, Lbi/b;->lookup(Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 29
    invoke-interface {v2, v0}, Lji/g;->b(Lbj/g;)Lji/e;
    ...
    invoke-interface {v1}, Lsh/f;->getCookies()Ljava/util/List;
    ...
    .line 34
    invoke-interface {v4, v3}, Lji/b;->isExpired(Ljava/util/Date;)Z
    ...
    .line 35
    invoke-interface {v0, v4, v8}, Lji/e;->a(Lji/b;Lji/d;)Z
    ...
    .line 36
    iget-object v5, p0, Lyh/e;->a:Lcz/msebera/android/httpclient/extras/b;
    ...
    .line 42
    invoke-interface {v0, v1}, Lji/e;->formatCookies(Ljava/util/List;)Ljava/util/List;
    ...
    .line 45
    :cond_10
    invoke-interface {v0}, Lji/e;->getVersion()I
    ...
    .line 48
    invoke-interface {v0}, Lji/e;->getVersionHeader()Lph/d;
    ...
    .line 51
    invoke-interface {p2, p1, v8}, Lbj/g;->setAttribute(Ljava/lang/String;Ljava/lang/Object;)V

...
# direct methods
.method public constructor <init>(Lth/b;Luh/t;Luh/j;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object v0, p0, Lii/s;->a:Lcz/msebera/android/httpclient/extras/b;
    ...
    .line 4
    iput-object p1, p0, Lii/s;->b:Lth/b;
    ...
    .line 5
    :cond_0
    sget-object p2, Lii/r;->a:Lii/r;

    :goto_0
    iput-object p2, p0, Lii/s;->c:Luh/t;
    ...
    .line 6
    :cond_1
    sget-object p3, Lii/j0;->a:Lii/j0;

    :goto_1
    iput-object p3, p0, Lii/s;->d:Luh/j;
...
# virtual methods
.method public a(Luh/q;Lcz/msebera/android/httpclient/HttpHost;Ljava/net/InetSocketAddress;ILth/f;Lti/g;)V
    .locals 20
    ...
    .line 1
    invoke-virtual {v1, v11}, Lii/s;->b(Lti/g;)Lth/b;
    ...
    invoke-interface {v0, v3}, Lth/b;->lookup(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v0

    move-object v12, v0

    check-cast v12, Lyh/a;
    ...
    :cond_0
    iget-object v0, v1, Lii/s;->d:Luh/j;

    invoke-virtual/range {p2 .. p2}, Lcz/msebera/android/httpclient/HttpHost;->getHostName()Ljava/lang/String;

    move-result-object v3

    invoke-interface {v0, v3}, Luh/j;->resolve(Ljava/lang/String;)[Ljava/net/InetAddress;
    ...
    .line 5
    iget-object v0, v1, Lii/s;->c:Luh/t;

    invoke-interface {v0, v10}, Luh/t;->a(Lcz/msebera/android/httpclient/HttpHost;)I
    ...
    .line 9
    :goto_2
    invoke-interface {v12, v11}, Lyh/a;->a(Lti/g;)Ljava/net/Socket;

    move-result-object v5

    .line 10
    invoke-virtual/range {p5 .. p5}, Lth/f;->e()I
    ...
    .line 11
    invoke-virtual/range {p5 .. p5}, Lth/f;->g()Z
    ...
    .line 12
    invoke-virtual/range {p5 .. p5}, Lth/f;->h()Z
    ...
    .line 13
    invoke-virtual/range {p5 .. p5}, Lth/f;->f()Z
    ...
    .line 14
    invoke-virtual/range {p5 .. p5}, Lth/f;->d()I
    ...
    .line 16
    :cond_3
    invoke-interface {v2, v5}, Luh/q;->R1(Ljava/net/Socket;)V
    ...
    .line 18
    iget-object v0, v1, Lii/s;->a:Lcz/msebera/android/httpclient/extras/b;
    ...
    .line 20
    :try_start_0
    invoke-interface/range {v3 .. v9}, Lyh/a;->b(ILjava/net/Socket;Lcz/msebera/android/httpclient/HttpHost;Ljava/net/InetSocketAddress;Ljava/net/InetSocketAddress;Lti/g;)Ljava/net/Socket;

    move-result-object v0

    .line 21
    invoke-interface {v2, v0}, Luh/q;->R1(Ljava/net/Socket;)V
...
.method public final b(Lti/g;)Lth/b;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iget-object p1, p0, Lii/s;->b:Lth/b;

    :cond_0
    return-object p1
.end method

.method public c(Luh/q;Lcz/msebera/android/httpclient/HttpHost;Lti/g;)V
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 2
    invoke-virtual {p0, v0}, Lii/s;->b(Lti/g;)Lth/b;
    ...
    invoke-interface {v0, v1}, Lth/b;->lookup(Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 6
    invoke-interface {p1}, Luh/q;->getSocket()Ljava/net/Socket;

    move-result-object v1

    .line 7
    iget-object v2, p0, Lii/s;->c:Luh/t;

    invoke-interface {v2, p2}, Luh/t;->a(Lcz/msebera/android/httpclient/HttpHost;)I
    ...
    invoke-interface {v0, v1, p2, v2, p3}, Lyh/b;->h(Ljava/net/Socket;Ljava/lang/String;ILti/g;)Ljava/net/Socket;

    move-result-object p2

    .line 9
    invoke-interface {p1, p2}, Luh/q;->R1(Ljava/net/Socket;)V

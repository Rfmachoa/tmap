...
.field public final c:Lyh/t;

.field public final d:Lyh/j;


# direct methods
.method public constructor <init>(Lxh/b;Lyh/t;Lyh/j;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object v0, p0, Lmi/s;->a:Lcz/msebera/android/httpclient/extras/b;
    ...
    .line 4
    iput-object p1, p0, Lmi/s;->b:Lxh/b;
    ...
    .line 5
    :cond_0
    sget-object p2, Lmi/r;->a:Lmi/r;

    :goto_0
    iput-object p2, p0, Lmi/s;->c:Lyh/t;
    ...
    .line 6
    :cond_1
    sget-object p3, Lmi/j0;->a:Lmi/j0;

    :goto_1
    iput-object p3, p0, Lmi/s;->d:Lyh/j;
...
# virtual methods
.method public a(Lyh/q;Lcz/msebera/android/httpclient/HttpHost;Ljava/net/InetSocketAddress;ILxh/f;Lxi/g;)V
    .locals 20
    ...
    .line 1
    invoke-virtual {v1, v11}, Lmi/s;->b(Lxi/g;)Lxh/b;
    ...
    invoke-interface {v0, v3}, Lxh/b;->lookup(Ljava/lang/String;)Ljava/lang/Object;
    ...
    :cond_0
    iget-object v0, v1, Lmi/s;->d:Lyh/j;

    invoke-virtual/range {p2 .. p2}, Lcz/msebera/android/httpclient/HttpHost;->getHostName()Ljava/lang/String;

    move-result-object v3

    invoke-interface {v0, v3}, Lyh/j;->resolve(Ljava/lang/String;)[Ljava/net/InetAddress;
    ...
    .line 5
    iget-object v0, v1, Lmi/s;->c:Lyh/t;

    invoke-interface {v0, v10}, Lyh/t;->a(Lcz/msebera/android/httpclient/HttpHost;)I
    ...
    .line 9
    :goto_2
    invoke-interface {v12, v11}, Lci/a;->f(Lxi/g;)Ljava/net/Socket;

    move-result-object v5

    .line 10
    invoke-virtual/range {p5 .. p5}, Lxh/f;->e()I
    ...
    .line 11
    invoke-virtual/range {p5 .. p5}, Lxh/f;->g()Z
    ...
    .line 12
    invoke-virtual/range {p5 .. p5}, Lxh/f;->h()Z
    ...
    .line 13
    invoke-virtual/range {p5 .. p5}, Lxh/f;->f()Z
    ...
    .line 14
    invoke-virtual/range {p5 .. p5}, Lxh/f;->d()I
    ...
    .line 16
    :cond_3
    invoke-interface {v2, v5}, Lyh/q;->Q1(Ljava/net/Socket;)V
    ...
    .line 18
    iget-object v0, v1, Lmi/s;->a:Lcz/msebera/android/httpclient/extras/b;
    ...
    .line 20
    :try_start_0
    invoke-interface/range {v3 .. v9}, Lci/a;->g(ILjava/net/Socket;Lcz/msebera/android/httpclient/HttpHost;Ljava/net/InetSocketAddress;Ljava/net/InetSocketAddress;Lxi/g;)Ljava/net/Socket;

    move-result-object v0

    .line 21
    invoke-interface {v2, v0}, Lyh/q;->Q1(Ljava/net/Socket;)V
...
.method public final b(Lxi/g;)Lxh/b;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iget-object p1, p0, Lmi/s;->b:Lxh/b;

    :cond_0
    return-object p1
.end method

.method public c(Lyh/q;Lcz/msebera/android/httpclient/HttpHost;Lxi/g;)V
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 2
    invoke-virtual {p0, v0}, Lmi/s;->b(Lxi/g;)Lxh/b;
    ...
    invoke-interface {v0, v1}, Lxh/b;->lookup(Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 6
    invoke-interface {p1}, Lyh/q;->getSocket()Ljava/net/Socket;

    move-result-object v1

    .line 7
    iget-object v2, p0, Lmi/s;->c:Lyh/t;

    invoke-interface {v2, p2}, Lyh/t;->a(Lcz/msebera/android/httpclient/HttpHost;)I
    ...
    invoke-interface {v0, v1, p2, v2, p3}, Lci/b;->h(Ljava/net/Socket;Ljava/lang/String;ILxi/g;)Ljava/net/Socket;

    move-result-object p2

    .line 9
    invoke-interface {p1, p2}, Lyh/q;->Q1(Ljava/net/Socket;)V

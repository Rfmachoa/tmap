...
.method public constructor <init>(Lni/u;I)V
    ...
    .line 12
    invoke-direct/range {v0 .. v5}, Lni/x;-><init>(Lni/u;IILth/c;Ljava/nio/charset/CharsetDecoder;)V

    return-void
.end method

.method public constructor <init>(Lni/u;IILth/c;Ljava/nio/charset/CharsetDecoder;)V
    .locals 1
    ...
    .line 4
    iput-object p1, p0, Lni/x;->a:Lni/u;

    .line 5
    new-array p1, p2, [B

    iput-object p1, p0, Lni/x;->b:[B

    const/4 p1, 0x0

    .line 6
    iput p1, p0, Lni/x;->h:I

    .line 7
    iput p1, p0, Lni/x;->i:I
    ...
    .line 9
    :cond_1
    sget-object p4, Lth/c;->c:Lth/c;

    :goto_1
    iput-object p4, p0, Lni/x;->e:Lth/c;
    ...
    iput-object p1, p0, Lni/x;->c:Lcz/msebera/android/httpclient/util/ByteArrayBuffer;

    .line 11
    iput-object p5, p0, Lni/x;->f:Ljava/nio/charset/CharsetDecoder;
...
.method public a(Lcz/msebera/android/httpclient/util/CharArrayBuffer;)I
    ...
    .line 3
    iget-object v0, p0, Lni/x;->c:Lcz/msebera/android/httpclient/util/ByteArrayBuffer;
    ...
    .line 4
    invoke-virtual {p0, p1, v4}, Lni/x;->k(Lcz/msebera/android/httpclient/util/CharArrayBuffer;I)I
    ...
    .line 5
    iget v0, p0, Lni/x;->h:I

    sub-int v3, v4, v0

    .line 6
    iget-object v5, p0, Lni/x;->c:Lcz/msebera/android/httpclient/util/ByteArrayBuffer;

    iget-object v6, p0, Lni/x;->b:[B

    invoke-virtual {v5, v6, v0, v3}, Lcz/msebera/android/httpclient/util/ByteArrayBuffer;->append([BII)V

    .line 7
    iput v4, p0, Lni/x;->h:I
    ...
    .line 9
    iget v2, p0, Lni/x;->i:I

    iget v4, p0, Lni/x;->h:I
    ...
    iput v2, p0, Lni/x;->h:I

    .line 12
    :cond_3
    invoke-virtual {p0}, Lni/x;->f()I
    ...
    :cond_4
    :goto_2
    iget-object v3, p0, Lni/x;->e:Lth/c;

    invoke-virtual {v3}, Lth/c;->e()I
    ...
    .line 14
    iget-object v4, p0, Lni/x;->c:Lcz/msebera/android/httpclient/util/ByteArrayBuffer;
    ...
    .line 17
    :cond_7
    invoke-virtual {p0, p1}, Lni/x;->j(Lcz/msebera/android/httpclient/util/CharArrayBuffer;)I
...
.method public available()I
    ...
    .line 1
    invoke-virtual {p0}, Lni/x;->b()I

    move-result v0

    invoke-virtual {p0}, Lni/x;->length()I
...
.method public final c(Lcz/msebera/android/httpclient/util/CharArrayBuffer;Ljava/nio/ByteBuffer;)I
    ...
    .line 2
    :cond_0
    iget-object v0, p0, Lni/x;->j:Ljava/nio/CharBuffer;
    ...
    iput-object v0, p0, Lni/x;->j:Ljava/nio/CharBuffer;

    .line 4
    :cond_1
    iget-object v0, p0, Lni/x;->f:Ljava/nio/charset/CharsetDecoder;
    ...
    iget-object v2, p0, Lni/x;->j:Ljava/nio/CharBuffer;
    ...
    .line 7
    invoke-virtual {p0, v0, p1, p2}, Lni/x;->g(Ljava/nio/charset/CoderResult;Lcz/msebera/android/httpclient/util/CharArrayBuffer;Ljava/nio/ByteBuffer;)I
    ...
    .line 10
    iget-object p2, p0, Lni/x;->j:Ljava/nio/CharBuffer;
...
.method public d(Ljava/io/InputStream;)V
    ...
    .line 1
    iput-object p1, p0, Lni/x;->g:Ljava/io/InputStream;
...
.method public e()V
    ...
    .line 1
    iput v0, p0, Lni/x;->h:I

    .line 2
    iput v0, p0, Lni/x;->i:I
...
.method public f()I
    ...
    .line 5
    iput v1, p0, Lni/x;->i:I

    .line 6
    :cond_1
    iget v0, p0, Lni/x;->i:I

    .line 7
    iget-object v1, p0, Lni/x;->b:[B
    ...
    .line 8
    invoke-virtual {p0, v1, v0, v2}, Lni/x;->m([BII)I
    ...
    .line 10
    iget-object v0, p0, Lni/x;->a:Lni/u;
...
.method public final g(Ljava/nio/charset/CoderResult;Lcz/msebera/android/httpclient/util/CharArrayBuffer;Ljava/nio/ByteBuffer;)I
    ...
    .line 3
    :cond_0
    iget-object p1, p0, Lni/x;->j:Ljava/nio/CharBuffer;
    ...
    .line 5
    :goto_0
    iget-object p3, p0, Lni/x;->j:Ljava/nio/CharBuffer;
...
.method public i()Z
    ...
    .line 1
    iget-object v0, p0, Lni/x;->g:Ljava/io/InputStream;
...
.method public final j(Lcz/msebera/android/httpclient/util/CharArrayBuffer;)I
    ...
    .line 2
    iget-object v1, p0, Lni/x;->c:Lcz/msebera/android/httpclient/util/ByteArrayBuffer;
    ...
    .line 4
    :cond_1
    iget-object v1, p0, Lni/x;->f:Ljava/nio/charset/CharsetDecoder;
    ...
    .line 7
    invoke-virtual {p0, p1, v0}, Lni/x;->c(Lcz/msebera/android/httpclient/util/CharArrayBuffer;Ljava/nio/ByteBuffer;)I

    move-result v0

    .line 8
    :goto_0
    iget-object p1, p0, Lni/x;->c:Lcz/msebera/android/httpclient/util/ByteArrayBuffer;
...
.method public final k(Lcz/msebera/android/httpclient/util/CharArrayBuffer;I)I
    ...
    .line 7
    invoke-virtual {p0, p1, p2}, Lni/x;->c(Lcz/msebera/android/httpclient/util/CharArrayBuffer;Ljava/nio/ByteBuffer;)I
...
.method public read([B)I
    ...
    invoke-virtual {p0, p1, v0, v1}, Lni/x;->read([BII)I
...
.method public read([BII)I
    ...
    .line 8
    :cond_1
    iget v0, p0, Lni/x;->d:I

    if-le p3, v0, :cond_3

    .line 9
    invoke-virtual {p0, p1, p2, p3}, Lni/x;->m([BII)I
    ...
    .line 10
    iget-object p2, p0, Lni/x;->a:Lni/u;
...
.method public readLine()Ljava/lang/String;
    ...
    .line 2
    invoke-virtual {p0, v0}, Lni/x;->a(Lcz/msebera/android/httpclient/util/CharArrayBuffer;)I

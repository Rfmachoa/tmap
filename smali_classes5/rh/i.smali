...
.method public static b(Ljava/net/URI;)Lcz/msebera/android/httpclient/HttpHost;
    ...
    .line 14
    invoke-static {v2}, Lui/i;->a(Ljava/lang/CharSequence;)Z
...
.method public static d(Ljava/net/URI;Lcz/msebera/android/httpclient/HttpHost;Ljava/util/List;)Ljava/net/URI;
    ...
    invoke-static {p2, v1}, Ll/c;->a(Ljava/util/List;I)Ljava/lang/Object;
    ...
    .line 4
    invoke-virtual {v0}, Lrh/h;->k()Ljava/lang/String;
    ...
    .line 7
    :cond_1
    invoke-virtual {v0, v1}, Lrh/h;->x(Ljava/lang/String;)Lrh/h;
    ...
    invoke-direct {v0, p0}, Lrh/h;-><init>(Ljava/net/URI;)V
    ...
    invoke-virtual {v0, p0}, Lrh/h;->x(Ljava/lang/String;)Lrh/h;

    :cond_3
    if-eqz p1, :cond_4

    .line 11
    invoke-virtual {v0}, Lrh/h;->r()Z
    ...
    invoke-virtual {v0, p0}, Lrh/h;->F(Ljava/lang/String;)Lrh/h;
    ...
    invoke-virtual {v0, p0}, Lrh/h;->y(Ljava/lang/String;)Lrh/h;
    ...
    invoke-virtual {v0, p0}, Lrh/h;->D(I)Lrh/h;
...
.method public static e(Ljava/net/URI;Ljava/lang/String;)Ljava/net/URI;
    ...
    invoke-static {p0, p1}, Lrh/i;->f(Ljava/net/URI;Ljava/net/URI;)Ljava/net/URI;
...
.method public static f(Ljava/net/URI;Ljava/net/URI;)Ljava/net/URI;
    ...
    .line 5
    invoke-static {p0, p1}, Lrh/i;->g(Ljava/net/URI;Ljava/net/URI;)Ljava/net/URI;
    ...
    .line 12
    :cond_3
    invoke-static {p0}, Lrh/i;->c(Ljava/net/URI;)Ljava/net/URI;
...
.method public static h(Ljava/net/URI;)Ljava/net/URI;
    ...
    .line 4
    invoke-virtual {v0}, Lrh/h;->q()Ljava/lang/String;
    ...
    .line 5
    invoke-virtual {v0, v1}, Lrh/h;->G(Ljava/lang/String;)Lrh/h;
    ...
    invoke-static {p0}, Lui/i;->b(Ljava/lang/CharSequence;)Z
    ...
    .line 7
    invoke-virtual {v0, p0}, Lrh/h;->C(Ljava/lang/String;)Lrh/h;
...
.method public static i(Ljava/net/URI;Lcz/msebera/android/httpclient/HttpHost;)Ljava/net/URI;
    ...
    .line 1
    invoke-static {p0, p1, v0}, Lrh/i;->j(Ljava/net/URI;Lcz/msebera/android/httpclient/HttpHost;Z)Ljava/net/URI;
...
.method public static j(Ljava/net/URI;Lcz/msebera/android/httpclient/HttpHost;Z)Ljava/net/URI;
    ...
    invoke-virtual {v0, v1}, Lrh/h;->F(Ljava/lang/String;)Lrh/h;
    ...
    invoke-virtual {v0, p1}, Lrh/h;->D(I)Lrh/h;

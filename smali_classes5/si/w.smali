...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lsi/w;->d:Lcz/msebera/android/httpclient/cookie/CookiePathComparator;
    ...
    sput-object v0, Lsi/w;->e:[Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    .line 12
    invoke-direct {p0, v0, v1}, Lsi/w;-><init>([Ljava/lang/String;Z)V
...
.method public constructor <init>([Ljava/lang/String;Z)V
    ...
    iput-object p1, p0, Lsi/w;->b:[Ljava/lang/String;

    goto :goto_0

    .line 3
    :cond_0
    sget-object p1, Lsi/w;->e:[Ljava/lang/String;

    iput-object p1, p0, Lsi/w;->b:[Ljava/lang/String;

    .line 4
    :goto_0
    iput-boolean p2, p0, Lsi/w;->c:Z
    ...
    .line 7
    new-instance p1, Lsi/v;

    invoke-direct {p1}, Lsi/v;-><init>()V
    ...
    iget-object p2, p0, Lsi/w;->b:[Ljava/lang/String;
...
.method public b(Lji/b;Lji/d;)V
    ...
    .line 5
    invoke-super {p0, p1, p2}, Lsi/l;->b(Lji/b;Lji/d;)V
...
.method public c(Lph/d;Lji/d;)Ljava/util/List;
    ...
    .line 5
    invoke-virtual {p0, p1, p2}, Lsi/l;->j([Lph/e;Lji/d;)Ljava/util/List;
...
.method public formatCookies(Ljava/util/List;)Ljava/util/List;
    ...
    .line 4
    sget-object p1, Lsi/w;->d:Lcz/msebera/android/httpclient/cookie/CookiePathComparator;
    ...
    .line 5
    :cond_0
    iget-boolean v0, p0, Lsi/w;->c:Z

    if-eqz v0, :cond_1

    .line 6
    invoke-virtual {p0, p1}, Lsi/w;->l(Ljava/util/List;)Ljava/util/List;
    ...
    .line 7
    :cond_1
    invoke-virtual {p0, p1}, Lsi/w;->k(Ljava/util/List;)Ljava/util/List;
...
.method public final k(Ljava/util/List;)Ljava/util/List;
    ...
    .line 3
    invoke-interface {v1}, Lji/b;->getVersion()I
    ...
    .line 9
    invoke-virtual {p0, v3, v1, v2}, Lsi/w;->m(Lcz/msebera/android/httpclient/util/CharArrayBuffer;Lji/b;I)V
...
.method public final l(Ljava/util/List;)Ljava/util/List;
    ...
    .line 2
    invoke-interface {v2}, Lji/b;->getVersion()I
    ...
    .line 11
    invoke-virtual {p0, v0, v2, v1}, Lsi/w;->m(Lcz/msebera/android/httpclient/util/CharArrayBuffer;Lji/b;I)V
...
.method public m(Lcz/msebera/android/httpclient/util/CharArrayBuffer;Lji/b;I)V
    .locals 3

    .line 1
    invoke-interface {p2}, Lji/b;->getName()Ljava/lang/String;

    move-result-object v0

    invoke-interface {p2}, Lji/b;->getValue()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p0, p1, v0, v1, p3}, Lsi/w;->n(Lcz/msebera/android/httpclient/util/CharArrayBuffer;Ljava/lang/String;Ljava/lang/String;I)V

    .line 2
    invoke-interface {p2}, Lji/b;->getPath()Ljava/lang/String;
    ...
    .line 4
    invoke-interface {v0, v2}, Lji/a;->containsAttribute(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, p1, v2, v0, p3}, Lsi/w;->n(Lcz/msebera/android/httpclient/util/CharArrayBuffer;Ljava/lang/String;Ljava/lang/String;I)V

    .line 7
    :cond_0
    invoke-interface {p2}, Lji/b;->getDomain()Ljava/lang/String;
    ...
    invoke-virtual {p0, p1, v0, p2, p3}, Lsi/w;->n(Lcz/msebera/android/httpclient/util/CharArrayBuffer;Ljava/lang/String;Ljava/lang/String;I)V

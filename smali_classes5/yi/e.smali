...
.method public static a(Llh/l;)V
    .locals 1
    ...
    .line 1
    :cond_0
    invoke-interface {p0}, Llh/l;->isStreaming()Z
    ...
    .line 2
    invoke-interface {p0}, Llh/l;->getContent()Ljava/io/InputStream;
...
.method public static b(Llh/l;)V
    .locals 0

    :try_start_0
    invoke-static {p0}, Lyi/e;->a(Llh/l;)V
    :try_end_0
...
.method public static c(Llh/l;)Ljava/lang/String;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    invoke-interface {p0, v0}, Llh/e;->getParameterByName(Ljava/lang/String;)Llh/y;
    ...
    .line 6
    invoke-interface {p0}, Llh/y;->getValue()Ljava/lang/String;
...
.method public static d(Llh/l;)Ljava/lang/String;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcz/msebera/android/httpclient/ParseException;
...
.method public static e(Llh/l;)[B
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-static {v1, v3}, Lyi/a;->a(ZLjava/lang/String;)V
...
.method public static f(Llh/l;)Ljava/lang/String;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
    ...
    invoke-static {p0, v0}, Lyi/e;->h(Llh/l;Ljava/nio/charset/Charset;)Ljava/lang/String;
...
.method public static g(Llh/l;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
    ...
    :goto_0
    invoke-static {p0, p1}, Lyi/e;->h(Llh/l;Ljava/nio/charset/Charset;)Ljava/lang/String;
...
.method public static h(Llh/l;Ljava/nio/charset/Charset;)Ljava/lang/String;
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
    ...
    invoke-static {v2, v4}, Lyi/a;->a(ZLjava/lang/String;)V
    ...
    .line 7
    :try_start_2
    sget-object p1, Lxi/f;->t:Ljava/nio/charset/Charset;
...
.method public static i(Llh/t;Llh/l;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 3
    invoke-interface {p0, p1}, Llh/t;->b(Llh/l;)V

...
# virtual methods
.method public final a(Lph/q;Lph/t;)Z
    .locals 1
...
.method public final b(Lph/t;)V
    ...
    .line 2
    invoke-static {p1}, Lcz/msebera/android/httpclient/impl/client/cache/a0;->b(Lph/l;)V

    :cond_0
    return-void
.end method

.method public final c(Lph/q;Lph/t;)V
    .locals 1
...
.method public final d(Lph/t;)V
    ...
    invoke-static {v1}, Lzh/b;->b(Ljava/util/Date;)Ljava/lang/String;

    move-result-object v1

    invoke-interface {p1, v0, v1}, Lph/p;->addHeader(Ljava/lang/String;Ljava/lang/String;)V

    :cond_0
    return-void
.end method

.method public final e(Lph/t;)V
    .locals 8
    ...
    .line 4
    invoke-interface {p1, v2}, Lph/p;->removeHeaders(Ljava/lang/String;)V
...
.method public final f(Lph/q;Lph/t;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 3
    :cond_0
    invoke-virtual {p0, p2}, Lcz/msebera/android/httpclient/impl/client/cache/j0;->b(Lph/t;)V
...
.method public g(Lwh/o;Lph/t;)V
    ...
    .line 1
    invoke-virtual {p0, p1, p2}, Lcz/msebera/android/httpclient/impl/client/cache/j0;->a(Lph/q;Lph/t;)Z
    ...
    .line 4
    :cond_0
    invoke-virtual {p0, p1, p2}, Lcz/msebera/android/httpclient/impl/client/cache/j0;->j(Lwh/o;Lph/t;)V

    .line 5
    invoke-virtual {p0, p1, p2}, Lcz/msebera/android/httpclient/impl/client/cache/j0;->k(Lwh/o;Lph/t;)V

    .line 6
    invoke-virtual {p0, p1, p2}, Lcz/msebera/android/httpclient/impl/client/cache/j0;->f(Lph/q;Lph/t;)V

    .line 7
    invoke-virtual {p0, p1, p2}, Lcz/msebera/android/httpclient/impl/client/cache/j0;->c(Lph/q;Lph/t;)V

    .line 8
    invoke-virtual {p0, p2}, Lcz/msebera/android/httpclient/impl/client/cache/j0;->d(Lph/t;)V

    .line 9
    invoke-virtual {p0, p2}, Lcz/msebera/android/httpclient/impl/client/cache/j0;->e(Lph/t;)V

    .line 10
    invoke-virtual {p0, p2}, Lcz/msebera/android/httpclient/impl/client/cache/j0;->h(Lph/t;)V

    .line 11
    invoke-virtual {p0, p2}, Lcz/msebera/android/httpclient/impl/client/cache/j0;->l(Lph/t;)V

    return-void
.end method

.method public final h(Lph/t;)V
    .locals 16
    ...
    .line 1
    invoke-interface {v0, v1}, Lph/p;->getHeaders(Ljava/lang/String;)[Lph/d;
    ...
    .line 7
    invoke-interface {v14}, Lph/e;->getName()Ljava/lang/String;
    ...
    .line 13
    :cond_6
    invoke-interface {v0, v1}, Lph/p;->removeHeaders(Ljava/lang/String;)V
    ...
    .line 15
    invoke-interface {v0, v2}, Lph/p;->h(Lph/d;)V
...
.method public final j(Lwh/o;Lph/t;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-interface {p1}, Lph/m;->expectContinue()Z
...
.method public final k(Lwh/o;Lph/t;)V
    .locals 1
    ...
    .line 3
    :cond_0
    invoke-virtual {p0, p2}, Lcz/msebera/android/httpclient/impl/client/cache/j0;->i(Lph/t;)V
...
.method public final l(Lph/t;)V
    ...
    invoke-static {v0}, Lzh/b;->d(Ljava/lang/String;)Ljava/util/Date;
    ...
    .line 6
    invoke-static {v8}, Lcz/msebera/android/httpclient/impl/client/cache/o0;->o(Lph/d;)[Lcz/msebera/android/httpclient/impl/client/cache/o0;
    ...
    .line 12
    invoke-interface {p1, v1}, Lph/p;->h(Lph/d;)V

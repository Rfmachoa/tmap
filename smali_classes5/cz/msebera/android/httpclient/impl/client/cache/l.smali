...
# virtual methods
.method public final a(Llh/t;Llh/l;)V
    .locals 4

    .line 1
    invoke-virtual {p0, p1}, Lcz/msebera/android/httpclient/impl/client/cache/l;->d(Llh/t;)Z
    ...
    .line 6
    invoke-interface {p1, v1}, Llh/p;->c(Llh/d;)V

    :cond_1
    return-void
.end method

.method public b(Lcz/msebera/android/httpclient/client/cache/HttpCacheEntry;)Lsh/c;
    .locals 4
    ...
    invoke-direct {v0, v1, v2, v3}, Lui/i;-><init>(Lcz/msebera/android/httpclient/ProtocolVersion;ILjava/lang/String;)V
    ...
    invoke-static {v3}, Lvh/b;->b(Ljava/util/Date;)Ljava/lang/String;
    ...
    .line 4
    :cond_0
    invoke-virtual {v0, v2}, Lui/a;->f(Llh/d;)V
    ...
    .line 6
    invoke-virtual {v0, v1}, Lui/a;->f(Llh/d;)V
    ...
    .line 14
    invoke-virtual {v0, p1}, Lui/a;->f(Llh/d;)V

    .line 15
    :cond_5
    invoke-static {v0}, Lcz/msebera/android/httpclient/impl/client/cache/f0;->a(Llh/t;)Lsh/c;
...
.method public c(Lcz/msebera/android/httpclient/client/cache/HttpCacheEntry;)Lsh/c;
    .locals 6
    ...
    invoke-virtual {v1, v2}, Lui/a;->l([Llh/d;)V
    ...
    .line 7
    invoke-virtual {p0, v1, v2}, Lcz/msebera/android/httpclient/impl/client/cache/l;->a(Llh/t;Llh/l;)V

    .line 8
    iput-object v2, v1, Lui/i;->g:Llh/l;
    ...
    .line 10
    invoke-virtual {v1, v0, p1}, Lui/a;->setHeader(Ljava/lang/String;Ljava/lang/String;)V

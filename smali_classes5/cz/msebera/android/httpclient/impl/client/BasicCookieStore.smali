...
# virtual methods
.method public declared-synchronized addCookie(Lfi/b;)V
    .locals 1
    ...
    invoke-interface {p1, v0}, Lfi/b;->isExpired(Ljava/util/Date;)Z
...
.method public declared-synchronized addCookies([Lfi/b;)V
    .locals 3
    ...
    .line 2
    invoke-virtual {p0, v2}, Lcz/msebera/android/httpclient/impl/client/BasicCookieStore;->addCookie(Lfi/b;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized clearExpired(Ljava/util/Date;)Z
    ...
    invoke-interface {v2, p1}, Lfi/b;->isExpired(Ljava/util/Date;)Z

...
.method public c(Lph/q;Lqh/h;Lbj/g;)V
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    .line 1
    invoke-virtual {p2}, Lqh/h;->b()Lqh/c;

    move-result-object v0

    .line 2
    invoke-virtual {p2}, Lqh/h;->d()Lqh/j;
    ...
    invoke-virtual {p2}, Lqh/h;->e()Lcz/msebera/android/httpclient/auth/AuthProtocolState;
    ...
    .line 4
    :cond_1
    invoke-virtual {p0, v0}, Lcz/msebera/android/httpclient/impl/auth/f;->b(Lqh/c;)V
    ...
    .line 6
    :cond_2
    invoke-virtual {p2}, Lqh/h;->a()Ljava/util/Queue;
    ...
    .line 12
    invoke-virtual {p2, v1, v0}, Lqh/h;->o(Lqh/c;Lqh/j;)V
    ...
    :cond_4
    :try_start_0
    invoke-virtual {p0, v1, v0, p1, p3}, Lcz/msebera/android/httpclient/impl/auth/f;->a(Lqh/c;Lqh/j;Lph/q;Lbj/g;)Lph/d;

    move-result-object v0

    .line 19
    invoke-interface {p1, v0}, Lph/p;->h(Lph/d;)V
    :try_end_0
    ...
    .line 23
    :try_start_1
    invoke-virtual {p0, v0, v1, p1, p3}, Lcz/msebera/android/httpclient/impl/auth/f;->a(Lqh/c;Lqh/j;Lph/q;Lbj/g;)Lph/d;

    move-result-object p2

    .line 24
    invoke-interface {p1, p2}, Lph/p;->h(Lph/d;)V
    :try_end_1
...
.method public d(Lcz/msebera/android/httpclient/HttpHost;Lph/t;Lsh/c;Lqh/h;Lbj/g;)Z
    .locals 6
    ...
    .line 3
    :cond_0
    invoke-interface {p3, p1, p2, p5}, Lsh/c;->a(Lcz/msebera/android/httpclient/HttpHost;Lph/t;Lbj/g;)Ljava/util/Map;
    ...
    .line 6
    :cond_1
    invoke-virtual {p4}, Lqh/h;->b()Lqh/c;
    ...
    invoke-virtual {p4}, Lqh/h;->e()Lcz/msebera/android/httpclient/auth/AuthProtocolState;
    ...
    .line 10
    invoke-interface {p3, p1, p2, p5}, Lsh/c;->d(Lcz/msebera/android/httpclient/HttpHost;Lqh/c;Lbj/g;)V
    ...
    invoke-virtual {p4, p1}, Lqh/h;->m(Lcz/msebera/android/httpclient/auth/AuthProtocolState;)V
    ...
    .line 13
    invoke-interface {v2}, Lqh/c;->getSchemeName()Ljava/lang/String;
    ...
    .line 16
    invoke-interface {v2, v3}, Lqh/c;->c(Lph/d;)V

    .line 17
    invoke-interface {v2}, Lqh/c;->isComplete()Z
    ...
    :cond_8
    :goto_0
    invoke-interface {p3, v1, p1, p2, p5}, Lsh/c;->b(Ljava/util/Map;Lcz/msebera/android/httpclient/HttpHost;Lph/t;Lbj/g;)Ljava/util/Queue;
    ...
    invoke-virtual {p4, p2}, Lqh/h;->m(Lcz/msebera/android/httpclient/auth/AuthProtocolState;)V

    .line 29
    invoke-virtual {p4, p1}, Lqh/h;->n(Ljava/util/Queue;)V
    :try_end_0
...
.method public e(Lcz/msebera/android/httpclient/HttpHost;Lph/t;Lsh/c;Lqh/h;Lbj/g;)Z
    .locals 2

    .line 1
    invoke-interface {p3, p1, p2, p5}, Lsh/c;->c(Lcz/msebera/android/httpclient/HttpHost;Lph/t;Lbj/g;)Z
    ...
    invoke-interface {p3, p1, p2, p5}, Lsh/c;->e(Lcz/msebera/android/httpclient/HttpHost;Lqh/c;Lbj/g;)V

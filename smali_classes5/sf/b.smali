...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lsf/b;->b:Landroid/content/Context;

    invoke-virtual {p0, p1}, Lsf/b;->h(Landroid/content/Context;)V
...
.method public declared-synchronized a(Ljava/lang/String;I)I
    ...
    iget-object p1, p0, Lsf/b;->d:Ljava/lang/String;

    invoke-virtual {p0, v0, v1, v2, p1}, Lsf/b;->d([Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
...
.method public final declared-synchronized b(Landroid/content/ContentValues;)J
    ...
    iget-object v1, p0, Lsf/b;->b:Landroid/content/Context;

    invoke-direct {v0, v1}, Lsf/a;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lsf/b;->a:Lsf/a;

    :cond_0
    invoke-virtual {p0}, Lsf/b;->l()Landroid/database/sqlite/SQLiteDatabase;
...
.method public declared-synchronized f()Ljava/util/List;
    ...
    :try_start_1
    invoke-virtual {p0}, Lsf/b;->s()Landroid/database/Cursor;
...
.method public declared-synchronized g(Ljava/lang/String;)Lrf/b;
    .locals 39
    ...
    invoke-virtual {v1, v3, v0, v2, v3}, Lsf/b;->k([Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    invoke-direct/range {v4 .. v38}, Lrf/b;-><init>(JJJJIIFJJJJJJJIJJJJ)V
...
.method public declared-synchronized h(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p1}, Lsf/a;-><init>(Landroid/content/Context;)V
...
.method public declared-synchronized i(JLcom/smart/sklb/edge/nepkt/nepkt_hrnBzCx;)Z
    ...
    invoke-virtual {p0, v0}, Lsf/b;->j(Landroid/content/ContentValues;)J
...
.method public declared-synchronized l()Landroid/database/sqlite/SQLiteDatabase;
    ...
    :try_start_0
    iget-object v0, p0, Lsf/b;->c:Landroid/database/sqlite/SQLiteDatabase;
    ...
    iput-object v0, p0, Lsf/b;->c:Landroid/database/sqlite/SQLiteDatabase;
...
.method public declared-synchronized m(Ljava/lang/String;I)Z
    ...
    invoke-virtual {p0, v0}, Lsf/b;->b(Landroid/content/ContentValues;)J
...
.method public declared-synchronized p()V
    ...
    :try_start_0
    invoke-virtual {p0}, Lsf/b;->r()V

    invoke-virtual {p0}, Lsf/b;->q()V

    iget-object v0, p0, Lsf/b;->b:Landroid/content/Context;

    if-eqz v0, :cond_0

    const/4 v0, 0x0

    iput-object v0, p0, Lsf/b;->b:Landroid/content/Context;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

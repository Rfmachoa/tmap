...
.field public final d:Lci/j;


# direct methods
.method public constructor <init>(Lbi/b;Lci/t;Lci/j;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object v0, p0, Lqi/s;->a:Lcz/msebera/android/httpclient/extras/b;
    ...
    .line 4
    iput-object p1, p0, Lqi/s;->b:Lbi/b;
    ...
    .line 5
    :cond_0
    sget-object p2, Lqi/r;->a:Lqi/r;

    :goto_0
    iput-object p2, p0, Lqi/s;->c:Lci/t;
    ...
    .line 6
    :cond_1
    sget-object p3, Lqi/j0;->a:Lqi/j0;

    :goto_1
    iput-object p3, p0, Lqi/s;->d:Lci/j;
...
# virtual methods
.method public a(Lci/q;Lcz/msebera/android/httpclient/HttpHost;Ljava/net/InetSocketAddress;ILbi/f;Lbj/g;)V
    .locals 20
    ...
    .line 1
    invoke-virtual {v1, v11}, Lqi/s;->b(Lbj/g;)Lbi/b;
    ...
    invoke-interface {v0, v3}, Lbi/b;->lookup(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v0

    move-object v12, v0

    check-cast v12, Lgi/a;
    ...
    :cond_0
    iget-object v0, v1, Lqi/s;->d:Lci/j;

    invoke-virtual/range {p2 .. p2}, Lcz/msebera/android/httpclient/HttpHost;->getHostName()Ljava/lang/String;

    move-result-object v3

    invoke-interface {v0, v3}, Lci/j;->resolve(Ljava/lang/String;)[Ljava/net/InetAddress;
    ...
    .line 5
    iget-object v0, v1, Lqi/s;->c:Lci/t;

    invoke-interface {v0, v10}, Lci/t;->a(Lcz/msebera/android/httpclient/HttpHost;)I
    ...
    .line 9
    :goto_2
    invoke-interface {v12, v11}, Lgi/a;->f(Lbj/g;)Ljava/net/Socket;

    move-result-object v5

    .line 10
    invoke-virtual/range {p5 .. p5}, Lbi/f;->e()I
    ...
    .line 11
    invoke-virtual/range {p5 .. p5}, Lbi/f;->g()Z
    ...
    .line 12
    invoke-virtual/range {p5 .. p5}, Lbi/f;->h()Z
    ...
    .line 13
    invoke-virtual/range {p5 .. p5}, Lbi/f;->f()Z
    ...
    .line 14
    invoke-virtual/range {p5 .. p5}, Lbi/f;->d()I
    ...
    .line 16
    :cond_3
    invoke-interface {v2, v5}, Lci/q;->U1(Ljava/net/Socket;)V
    ...
    .line 18
    iget-object v0, v1, Lqi/s;->a:Lcz/msebera/android/httpclient/extras/b;
    ...
    .line 20
    :try_start_0
    invoke-interface/range {v3 .. v9}, Lgi/a;->h(ILjava/net/Socket;Lcz/msebera/android/httpclient/HttpHost;Ljava/net/InetSocketAddress;Ljava/net/InetSocketAddress;Lbj/g;)Ljava/net/Socket;

    move-result-object v0

    .line 21
    invoke-interface {v2, v0}, Lci/q;->U1(Ljava/net/Socket;)V
...
.method public final b(Lbj/g;)Lbi/b;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iget-object p1, p0, Lqi/s;->b:Lbi/b;

    :cond_0
    return-object p1
.end method

.method public c(Lci/q;Lcz/msebera/android/httpclient/HttpHost;Lbj/g;)V
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 2
    invoke-virtual {p0, v0}, Lqi/s;->b(Lbj/g;)Lbi/b;
    ...
    invoke-interface {v0, v1}, Lbi/b;->lookup(Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 6
    invoke-interface {p1}, Lci/q;->getSocket()Ljava/net/Socket;

    move-result-object v1

    .line 7
    iget-object v2, p0, Lqi/s;->c:Lci/t;

    invoke-interface {v2, p2}, Lci/t;->a(Lcz/msebera/android/httpclient/HttpHost;)I
    ...
    invoke-interface {v0, v1, p2, v2, p3}, Lgi/b;->e(Ljava/net/Socket;Ljava/lang/String;ILbj/g;)Ljava/net/Socket;

    move-result-object p2

    .line 9
    invoke-interface {p1, p2}, Lci/q;->U1(Ljava/net/Socket;)V

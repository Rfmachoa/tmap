...
.method public constructor <init>(Lxi/h;)V
    ...
    invoke-direct {p0, p1, v1, v1, v0}, Lqi/k;-><init>(Lxi/h;Lyi/q;Lph/u;Lbi/c;)V
...
.method public constructor <init>(Lxi/h;Lbi/c;)V
    ...
    .line 10
    invoke-direct {p0, p1, v0, v0, p2}, Lqi/k;-><init>(Lxi/h;Lyi/q;Lph/u;Lbi/c;)V
...
.method public constructor <init>(Lxi/h;Lyi/q;Lph/u;Lbi/c;)V
    ...
    iput-object p1, p0, Lqi/k;->i:Lcz/msebera/android/httpclient/extras/b;
    ...
    :goto_0
    iput-object p3, p0, Lqi/k;->j:Lph/u;
    ...
    iput-object p1, p0, Lqi/k;->k:Lcz/msebera/android/httpclient/util/CharArrayBuffer;
...
.method public bridge synthetic a(Lxi/h;)Lph/p;
    ...
    invoke-virtual {p0, p1}, Lqi/k;->d(Lxi/h;)Lph/t;
...
.method public d(Lxi/h;)Lph/t;
    ...
    .line 1
    :goto_0
    iget-object v2, p0, Lqi/k;->k:Lcz/msebera/android/httpclient/util/CharArrayBuffer;
    ...
    invoke-interface {p1, v2}, Lxi/h;->a(Lcz/msebera/android/httpclient/util/CharArrayBuffer;)I
    ...
    iget-object v5, p0, Lqi/k;->k:Lcz/msebera/android/httpclient/util/CharArrayBuffer;

    invoke-virtual {v5}, Lcz/msebera/android/httpclient/util/CharArrayBuffer;->length()I

    move-result v5

    invoke-direct {v4, v0, v5}, Lyi/r;-><init>(II)V

    .line 5
    iget-object v5, p0, Lvi/a;->d:Lyi/q;

    iget-object v6, p0, Lqi/k;->k:Lcz/msebera/android/httpclient/util/CharArrayBuffer;

    invoke-interface {v5, v6, v4}, Lyi/q;->c(Lcz/msebera/android/httpclient/util/CharArrayBuffer;Lyi/r;)Z
    ...
    .line 6
    iget-object p1, p0, Lvi/a;->d:Lyi/q;

    iget-object v0, p0, Lqi/k;->k:Lcz/msebera/android/httpclient/util/CharArrayBuffer;

    invoke-interface {p1, v0, v4}, Lyi/q;->a(Lcz/msebera/android/httpclient/util/CharArrayBuffer;Lyi/r;)Lph/b0;

    move-result-object p1

    .line 7
    iget-object v0, p0, Lqi/k;->j:Lph/u;
    ...
    invoke-virtual {p0, v2, v1}, Lqi/k;->e(Lcz/msebera/android/httpclient/util/CharArrayBuffer;I)Z
    ...
    .line 9
    iget-object v2, p0, Lqi/k;->i:Lcz/msebera/android/httpclient/extras/b;
    ...
    .line 12
    iget-object v4, p0, Lqi/k;->k:Lcz/msebera/android/httpclient/util/CharArrayBuffer;

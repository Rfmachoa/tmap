...
.method public static EdgeView(Landroid/content/Context;Landroid/widget/LinearLayout;Lcom/smart/sklb/edge/nepkt/AD_TYPE;Lcom/smart/sklb/edge/op/EdgeViewCallback;)V
    ...
    invoke-virtual {v1, v2, v0}, Lvf/b;->e(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static smartDriving(Landroid/content/Context;Z)V
    ...
    invoke-direct {p1, p0}, Lvf/b;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {p1, p0, v2, v3}, Lvf/b;->c(Ljava/lang/String;J)J
    ...
    invoke-virtual {p1, p0, v0, v1}, Lvf/b;->n(Ljava/lang/String;J)Z

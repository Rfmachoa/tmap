...
.method public run()V
    ...
    invoke-virtual {v0, v3, v1, v2}, Lsf/b;->n(Ljava/lang/String;J)Z
    ...
    invoke-direct {v0, v1}, Ltf/a;-><init>(Landroid/content/Context;)V

    const v1, 0x26e3e

    invoke-virtual {v0, v1}, Ltf/a;->b(I)Z

    move-result v1

    if-nez v1, :cond_0

    invoke-virtual {v0}, Ltf/a;->d()V

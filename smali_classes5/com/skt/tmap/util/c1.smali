.class public Lcom/skt/tmap/util/c1;
.super Ljava/lang/Object;
.source "SettingUtil.java"


# static fields
.field public static final a:Ljava/lang/String; = "c1"
...
.method public static synthetic a(Landroid/app/Activity;Landroid/content/Context;Landroid/net/Uri;)V
    ...
    invoke-static {p0, p1, p2}, Lcom/skt/tmap/util/c1;->g(Landroid/app/Activity;Landroid/content/Context;Landroid/net/Uri;)V
...
.method public static f(Landroid/content/Context;Lcom/skt/tmap/network/ndds/dto/response/PushInfo;)V
    ...
    invoke-static {p0, p1}, Lcom/skt/tmap/util/TmapSharedPreference;->l3(Landroid/content/Context;Z)V
...
.method public static synthetic g(Landroid/app/Activity;Landroid/content/Context;Landroid/net/Uri;)V
    ...
    invoke-virtual {p0, v0, v1, v2}, Lcom/skt/tmap/dialog/d0;->a0(Lcom/skt/tmap/dialog/TmapBaseDialog$DialogButtonType;Ljava/lang/String;Ljava/lang/String;)V

    .line 4
    new-instance v0, Lcom/skt/tmap/util/c1$b;

    invoke-direct {v0, p0, p2, p1}, Lcom/skt/tmap/util/c1$b;-><init>(Lcom/skt/tmap/dialog/d0;Landroid/net/Uri;Landroid/content/Context;)V
...
.method public static h(Landroid/content/Context;Landroid/net/Uri;)V
    ...
    .line 3
    new-instance v1, Lcom/skt/tmap/util/b1;

    invoke-direct {v1, v0, p0, p1}, Lcom/skt/tmap/util/b1;-><init>(Landroid/app/Activity;Landroid/content/Context;Landroid/net/Uri;)V
    ...
    .line 4
    sget-object p1, Lcom/skt/tmap/util/c1;->a:Ljava/lang/String;
...
.method public static i(Landroid/app/Activity;Lcom/skt/tmap/engine/navigation/network/NetworkRequester$OnComplete;Lcom/skt/tmap/engine/navigation/network/NetworkRequester$OnFail;)V
    ...
    .line 4
    sget-object p0, Lcom/skt/tmap/util/c1;->a:Ljava/lang/String;
    ...
    .line 5
    :cond_0
    sget-object v2, Lcom/skt/tmap/util/c1;->a:Ljava/lang/String;
    ...
    invoke-direct {v1, p0, v3, v2}, Lye/d;-><init>(Landroid/app/Activity;ZZ)V
    ...
    .line 11
    invoke-virtual {v1, v0}, Lye/d;->request(Lcom/skt/tmap/engine/navigation/network/ndds/dto/RequestDto;)Z
...
.method public static k(Landroid/app/Activity;Z)V
    ...
    .line 7
    invoke-static {p0}, Lcom/skt/tmap/util/f;->l0(Landroid/content/Context;)V
...
.method public static l(Landroid/content/Context;Lcom/skt/voice/tyche/AiConstant$NuguRequestType;)V
    ...
    .line 1
    :try_start_0
    sget-object v0, Lcom/skt/tmap/util/c1$e;->a:[I
    ...
    .line 3
    new-instance v0, Lcom/skt/tmap/util/c1$a;

    invoke-direct {v0, p0}, Lcom/skt/tmap/util/c1$a;-><init>(Landroid/content/Context;)V

    invoke-virtual {p1, v0}, Lcom/skt/tmap/engine/TmapAiManager;->q2(Lcom/skt/tmap/engine/TmapAiManager$y1;)V
    ...
    .line 4
    invoke-static {p0, p1}, Lcom/skt/tmap/util/c1;->m(Landroid/content/Context;Ljava/lang/String;)V
    ...
    .line 7
    sget-object v0, Lcom/skt/tmap/util/c1;->a:Ljava/lang/String;
    ...
    const-string v0, "com.skt.aladdin"

    .line 10
    invoke-static {p0, v0, p1}, Lcom/skt/tmap/util/m;->w(Landroid/content/Context;Ljava/lang/String;I)Z
    ...
    invoke-static {p0, p1}, Lcom/skt/tmap/util/c1;->h(Landroid/content/Context;Landroid/net/Uri;)V
...
.method public static m(Landroid/content/Context;Ljava/lang/String;)V
    ...
    .line 1
    invoke-static {p0, v1, v2}, Lcom/skt/tmap/util/m;->w(Landroid/content/Context;Ljava/lang/String;I)Z
    ...
    .line 6
    sget-object v1, Lcom/skt/tmap/util/c1;->a:Ljava/lang/String;
...
.method public static n(Landroid/app/Activity;)V
    ...
    .line 2
    invoke-static {p0}, Lcom/skt/tmap/util/u2;->z(Landroid/content/Context;)Ljava/lang/String;
...
.method public static o(Landroid/app/Activity;ZLcom/skt/tmap/engine/navigation/network/NetworkRequester$OnComplete;Lcom/skt/tmap/engine/navigation/network/NetworkRequester$OnFail;)V
    ...
    invoke-direct {p1, p0, v2, v2, v1}, Lye/d;-><init>(Landroid/app/Activity;ZZZ)V
...
.method public static p(Landroid/app/Activity;)V
    ...
    .line 3
    invoke-static {p0, v1}, Lcom/skt/tmap/util/c1;->q(Landroid/app/Activity;Z)V
...
.method public static q(Landroid/app/Activity;Z)V
    ...
    .line 3
    :cond_1
    invoke-static {p0}, Lcom/skt/tmap/util/TmapSharedPreference;->C0(Landroid/content/Context;)Z
    ...
    .line 4
    invoke-static {p0}, Lcom/skt/tmap/util/TmapSharedPreference;->D0(Landroid/content/Context;)Z

    move-result v2

    invoke-static {v2}, Lcom/skt/tmap/util/i1;->g(Z)Ljava/lang/String;

    move-result-object v2

    .line 5
    invoke-static {p0}, Lcom/skt/tmap/util/c1;->c(Landroid/app/Activity;)Ljava/lang/String;
    ...
    .line 8
    new-instance v4, Lcom/skt/tmap/util/c1$c;

    invoke-direct {v4, p0}, Lcom/skt/tmap/util/c1$c;-><init>(Landroid/app/Activity;)V

    goto :goto_0

    .line 9
    :cond_2
    new-instance v4, Lcom/skt/tmap/util/c1$d;

    invoke-direct {v4}, Lcom/skt/tmap/util/c1$d;-><init>()V
    ...
    invoke-direct {v1, p0, p1, v2, v5}, Lye/d;-><init>(Landroid/app/Activity;ZZZ)V
    ...
    .line 19
    invoke-virtual {v1, v6}, Lye/d;->request(Lcom/skt/tmap/engine/navigation/network/ndds/dto/RequestDto;)Z

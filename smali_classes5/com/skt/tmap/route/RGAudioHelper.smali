...
.method private sendMomentVoiceInventory(IIIZ)Z
    ...
    invoke-virtual {v0, v1}, Lpe/b;->h(Landroid/content/Context;)Z
    ...
    invoke-virtual/range {v1 .. v6}, Lpe/b;->s(Landroid/content/Context;IIIZ)Lcom/skt/moment/net/vo/HappenForTTS;
    ...
    invoke-virtual {p4}, Lpe/b;->b()Ljava/util/HashMap;
    ...
    invoke-interface/range {v2 .. v7}, Lcom/skt/tmap/engine/navigation/TmapNavigationEngineInterface;->getMatchedPoint(DDI)Lcom/skt/tmap/engine/navigation/data/MatchedPoint;
    ...
    invoke-direct {v3, v1, v2}, Lpe/c;-><init>(Lcom/skt/moment/net/vo/Poi;Lcom/skt/tmap/engine/navigation/data/MatchedPoint;)V
...
.method public checkMomentResponse(Lcom/skt/moment/net/vo/HappenForTTS;I)Z
    ...
    invoke-virtual {v2, v6, v3, v4, v5}, Lke/e;->m(Ljava/lang/String;JLjava/lang/String;)V
    ...
    invoke-static {p2}, Lke/e;->a(Landroid/content/Context;)Lke/e;
    ...
    invoke-virtual {p2, v6, v4, v5, v2}, Lke/e;->m(Ljava/lang/String;JLjava/lang/String;)V
...
.method public playEffectSound(Landroid/content/Context;)V
    ...
    invoke-virtual {v0, p1, v2, v1}, Lae/c;->g(Landroid/content/Context;Ljava/lang/String;Lae/c$a;)V
...
.method public writeAudioScript(IIIIIZ[Ljava/lang/String;)Z
    ...
    invoke-static {v2}, Lcom/skt/tmap/util/TmapSharedPreference;->G1(Landroid/content/Context;)I
    ...
    invoke-static {v10}, Lae/b;->h(Landroid/content/Context;)Lae/b;

    move-result-object v10

    iget-object v13, v7, Lcom/skt/tmap/route/RGAudioHelper;->mContext:Landroid/content/Context;

    invoke-virtual {v10, v13}, Lae/b;->m(Landroid/content/Context;)Z
    ...
    invoke-static {v9}, Lae/b;->h(Landroid/content/Context;)Lae/b;

    move-result-object v9

    iget-object v10, v7, Lcom/skt/tmap/route/RGAudioHelper;->mContext:Landroid/content/Context;

    invoke-virtual {v9, v10}, Lae/b;->m(Landroid/content/Context;)Z
    ...
    invoke-static {v9}, Lif/a;->i(Landroid/content/Context;)Z
    ...
    .line 42
    :cond_d
    new-instance v9, Lae/c;

    invoke-direct {v9}, Lae/c;-><init>()V
    ...
    invoke-virtual/range {v9 .. v14}, Lae/c;->h(Landroid/content/Context;Ljava/lang/String;[Ljava/lang/String;ZLae/c$a;)Z
